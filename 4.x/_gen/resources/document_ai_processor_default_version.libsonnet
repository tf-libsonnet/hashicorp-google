...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withProcessor':: d.fn(help='`google.document_ai_processor_default_version.withProcessor` constructs a mixin object that can be merged into the `document_ai_processor_default_version`\nTerraform resource block to set or update the processor field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `processor` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.document_ai_processor_default_version.withTimeouts` constructs a mixin object that can be merged into the `document_ai_processor_default_version`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.document_ai_processor_default_version.withTimeoutsMixin` constructs a mixin object that can be merged into the `document_ai_processor_default_version`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.document_ai_processor_default_version.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withVersion':: d.fn(help='`google.document_ai_processor_default_version.withVersion` constructs a mixin object that can be merged into the `document_ai_processor_default_version`\nTerraform resource block to set or update the version field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `version` field.\n', args=[]),
