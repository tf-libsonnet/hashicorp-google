...
{
  '#':: d.pkg(name='healthcare_fhir_store_iam_policy', url='', help='`healthcare_fhir_store_iam_policy` represents the `google_healthcare_fhir_store_iam_policy` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withFhirStoreId':: d.fn(help='`google.healthcare_fhir_store_iam_policy.withFhirStoreId` constructs a mixin object that can be merged into the `healthcare_fhir_store_iam_policy`\nTerraform resource block to set or update the fhir_store_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `fhir_store_id` field.\n', args=[]),
  ...
  '#withPolicyData':: d.fn(help='`google.healthcare_fhir_store_iam_policy.withPolicyData` constructs a mixin object that can be merged into the `healthcare_fhir_store_iam_policy`\nTerraform resource block to set or update the policy_data field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy_data` field.\n', args=[]),
