...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withMetricsScope':: d.fn(help='`google.monitoring_monitored_project.withMetricsScope` constructs a mixin object that can be merged into the `monitoring_monitored_project`\nTerraform resource block to set or update the metrics_scope field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `metrics_scope` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`google.monitoring_monitored_project.withName` constructs a mixin object that can be merged into the `monitoring_monitored_project`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.monitoring_monitored_project.withTimeouts` constructs a mixin object that can be merged into the `monitoring_monitored_project`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.monitoring_monitored_project.withTimeoutsMixin` constructs a mixin object that can be merged into the `monitoring_monitored_project`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.monitoring_monitored_project.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
