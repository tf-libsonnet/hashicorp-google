...
{
  '#':: d.pkg(name='logging_organization_sink', url='', help='`logging_organization_sink` represents the `google_logging_organization_sink` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  bigquery_options:: {
    '#new':: d.fn(help='\n`google.logging_organization_sink.bigquery_options.new` constructs a new object with attributes and blocks configured for the `bigquery_options`\nTerraform sub block.\n\n\n\n**Args**:\n  - `use_partitioned_tables` (`bool`): Whether to use BigQuery&#39;s partition tables. By default, Logging creates dated tables based on the log entries&#39; timestamps, e.g. syslog_20170523. With partitioned tables the date suffix is no longer present and special query syntax has to be used instead. In both cases, tables are sharded based on UTC timezone.\n\n**Returns**:\n  - An attribute object that represents the `bigquery_options` sub block.\n', args=[]),
    new(
  ...
  '#withBigqueryOptions':: d.fn(help='`google.logging_organization_sink.withBigqueryOptions` constructs a mixin object that can be merged into the `logging_organization_sink`\nTerraform resource block to set or update the bigquery_options field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `bigquery_options` field.\n', args=[]),
  ...
  '#withBigqueryOptionsMixin':: d.fn(help='`google.logging_organization_sink.withBigqueryOptionsMixin` constructs a mixin object that can be merged into the `logging_organization_sink`\nTerraform resource block to set or update the bigquery_options field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google.logging_organization_sink.withBigqueryOptions](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `bigquery_options` field.\n', args=[]),
  ...
  '#withDescription':: d.fn(help='`google.logging_organization_sink.withDescription` constructs a mixin object that can be merged into the `logging_organization_sink`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withDestination':: d.fn(help='`google.logging_organization_sink.withDestination` constructs a mixin object that can be merged into the `logging_organization_sink`\nTerraform resource block to set or update the destination field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `destination` field.\n', args=[]),
  ...
  '#withDisabled':: d.fn(help='`google.logging_organization_sink.withDisabled` constructs a mixin object that can be merged into the `logging_organization_sink`\nTerraform resource block to set or update the disabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `disabled` field.\n', args=[]),
  ...
  '#withExclusions':: d.fn(help='`google.logging_organization_sink.withExclusions` constructs a mixin object that can be merged into the `logging_organization_sink`\nTerraform resource block to set or update the exclusions field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `exclusions` field.\n', args=[]),
  ...
  '#withExclusionsMixin':: d.fn(help='`google.logging_organization_sink.withExclusionsMixin` constructs a mixin object that can be merged into the `logging_organization_sink`\nTerraform resource block to set or update the exclusions field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google.logging_organization_sink.withExclusions](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `exclusions` field.\n', args=[]),
  ...
  '#withFilter':: d.fn(help='`google.logging_organization_sink.withFilter` constructs a mixin object that can be merged into the `logging_organization_sink`\nTerraform resource block to set or update the filter field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `filter` field.\n', args=[]),
  ...
  '#withIncludeChildren':: d.fn(help='`google.logging_organization_sink.withIncludeChildren` constructs a mixin object that can be merged into the `logging_organization_sink`\nTerraform resource block to set or update the include_children field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `include_children` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`google.logging_organization_sink.withName` constructs a mixin object that can be merged into the `logging_organization_sink`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withOrgId':: d.fn(help='`google.logging_organization_sink.withOrgId` constructs a mixin object that can be merged into the `logging_organization_sink`\nTerraform resource block to set or update the org_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `org_id` field.\n', args=[]),
