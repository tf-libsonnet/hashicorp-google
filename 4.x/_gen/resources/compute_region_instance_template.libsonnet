...
{
  '#':: d.pkg(name='compute_region_instance_template', url='', help='`compute_region_instance_template` represents the `google_compute_region_instance_template` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
