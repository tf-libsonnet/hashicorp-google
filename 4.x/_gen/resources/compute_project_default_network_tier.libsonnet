...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withNetworkTier':: d.fn(help='`google.compute_project_default_network_tier.withNetworkTier` constructs a mixin object that can be merged into the `compute_project_default_network_tier`\nTerraform resource block to set or update the network_tier field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `network_tier` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google.compute_project_default_network_tier.withProject` constructs a mixin object that can be merged into the `compute_project_default_network_tier`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.compute_project_default_network_tier.withTimeouts` constructs a mixin object that can be merged into the `compute_project_default_network_tier`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.compute_project_default_network_tier.withTimeoutsMixin` constructs a mixin object that can be merged into the `compute_project_default_network_tier`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.compute_project_default_network_tier.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
