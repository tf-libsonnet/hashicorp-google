...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withKeepers':: d.fn(help='`google.service_account_key.withKeepers` constructs a mixin object that can be merged into the `service_account_key`\nTerraform resource block to set or update the keepers field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `keepers` field.\n', args=[]),
  ...
  '#withKeyAlgorithm':: d.fn(help='`google.service_account_key.withKeyAlgorithm` constructs a mixin object that can be merged into the `service_account_key`\nTerraform resource block to set or update the key_algorithm field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `key_algorithm` field.\n', args=[]),
  ...
  '#withPrivateKeyType':: d.fn(help='`google.service_account_key.withPrivateKeyType` constructs a mixin object that can be merged into the `service_account_key`\nTerraform resource block to set or update the private_key_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `private_key_type` field.\n', args=[]),
  ...
  '#withPublicKeyData':: d.fn(help='`google.service_account_key.withPublicKeyData` constructs a mixin object that can be merged into the `service_account_key`\nTerraform resource block to set or update the public_key_data field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `public_key_data` field.\n', args=[]),
  ...
  '#withPublicKeyType':: d.fn(help='`google.service_account_key.withPublicKeyType` constructs a mixin object that can be merged into the `service_account_key`\nTerraform resource block to set or update the public_key_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `public_key_type` field.\n', args=[]),
  ...
  '#withServiceAccountId':: d.fn(help='`google.service_account_key.withServiceAccountId` constructs a mixin object that can be merged into the `service_account_key`\nTerraform resource block to set or update the service_account_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `service_account_id` field.\n', args=[]),
