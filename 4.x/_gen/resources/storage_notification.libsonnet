...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withBucket':: d.fn(help='`google.storage_notification.withBucket` constructs a mixin object that can be merged into the `storage_notification`\nTerraform resource block to set or update the bucket field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `bucket` field.\n', args=[]),
  ...
  '#withCustomAttributes':: d.fn(help='`google.storage_notification.withCustomAttributes` constructs a mixin object that can be merged into the `storage_notification`\nTerraform resource block to set or update the custom_attributes field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `custom_attributes` field.\n', args=[]),
  ...
  '#withEventTypes':: d.fn(help='`google.storage_notification.withEventTypes` constructs a mixin object that can be merged into the `storage_notification`\nTerraform resource block to set or update the event_types field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `event_types` field.\n', args=[]),
  ...
  '#withObjectNamePrefix':: d.fn(help='`google.storage_notification.withObjectNamePrefix` constructs a mixin object that can be merged into the `storage_notification`\nTerraform resource block to set or update the object_name_prefix field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `object_name_prefix` field.\n', args=[]),
  ...
  '#withPayloadFormat':: d.fn(help='`google.storage_notification.withPayloadFormat` constructs a mixin object that can be merged into the `storage_notification`\nTerraform resource block to set or update the payload_format field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `payload_format` field.\n', args=[]),
  ...
  '#withTopic':: d.fn(help='`google.storage_notification.withTopic` constructs a mixin object that can be merged into the `storage_notification`\nTerraform resource block to set or update the topic field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `topic` field.\n', args=[]),
