...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDescription':: d.fn(help='`google.compute_ha_vpn_gateway.withDescription` constructs a mixin object that can be merged into the `compute_ha_vpn_gateway`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withNetwork':: d.fn(help='`google.compute_ha_vpn_gateway.withNetwork` constructs a mixin object that can be merged into the `compute_ha_vpn_gateway`\nTerraform resource block to set or update the network field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `network` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.compute_ha_vpn_gateway.withTimeouts` constructs a mixin object that can be merged into the `compute_ha_vpn_gateway`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.compute_ha_vpn_gateway.withTimeoutsMixin` constructs a mixin object that can be merged into the `compute_ha_vpn_gateway`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.compute_ha_vpn_gateway.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withVpnInterfaces':: d.fn(help='`google.compute_ha_vpn_gateway.withVpnInterfaces` constructs a mixin object that can be merged into the `compute_ha_vpn_gateway`\nTerraform resource block to set or update the vpn_interfaces field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vpn_interfaces` field.\n', args=[]),
  ...
  '#withVpnInterfacesMixin':: d.fn(help='`google.compute_ha_vpn_gateway.withVpnInterfacesMixin` constructs a mixin object that can be merged into the `compute_ha_vpn_gateway`\nTerraform resource block to set or update the vpn_interfaces field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google.compute_ha_vpn_gateway.withVpnInterfaces](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `vpn_interfaces` field.\n', args=[]),
