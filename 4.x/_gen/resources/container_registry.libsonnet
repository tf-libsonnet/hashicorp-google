...
{
  '#':: d.pkg(name='container_registry', url='', help='`container_registry` represents the `google_container_registry` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withLocation':: d.fn(help='`google.container_registry.withLocation` constructs a mixin object that can be merged into the `container_registry`\nTerraform resource block to set or update the location field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `location` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google.container_registry.withProject` constructs a mixin object that can be merged into the `container_registry`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
