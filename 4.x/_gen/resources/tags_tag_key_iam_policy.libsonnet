...
{
  '#':: d.pkg(name='tags_tag_key_iam_policy', url='', help='`tags_tag_key_iam_policy` represents the `google_tags_tag_key_iam_policy` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withPolicyData':: d.fn(help='`google.tags_tag_key_iam_policy.withPolicyData` constructs a mixin object that can be merged into the `tags_tag_key_iam_policy`\nTerraform resource block to set or update the policy_data field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy_data` field.\n', args=[]),
  ...
  '#withTagKey':: d.fn(help='`google.tags_tag_key_iam_policy.withTagKey` constructs a mixin object that can be merged into the `tags_tag_key_iam_policy`\nTerraform resource block to set or update the tag_key field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tag_key` field.\n', args=[]),
