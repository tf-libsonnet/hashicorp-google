...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDnsSuffix':: d.fn(help='`google.service_networking_peered_dns_domain.withDnsSuffix` constructs a mixin object that can be merged into the `service_networking_peered_dns_domain`\nTerraform resource block to set or update the dns_suffix field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `dns_suffix` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`google.service_networking_peered_dns_domain.withName` constructs a mixin object that can be merged into the `service_networking_peered_dns_domain`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withNetwork':: d.fn(help='`google.service_networking_peered_dns_domain.withNetwork` constructs a mixin object that can be merged into the `service_networking_peered_dns_domain`\nTerraform resource block to set or update the network field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `network` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google.service_networking_peered_dns_domain.withProject` constructs a mixin object that can be merged into the `service_networking_peered_dns_domain`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withService':: d.fn(help='`google.service_networking_peered_dns_domain.withService` constructs a mixin object that can be merged into the `service_networking_peered_dns_domain`\nTerraform resource block to set or update the service field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `service` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.service_networking_peered_dns_domain.withTimeouts` constructs a mixin object that can be merged into the `service_networking_peered_dns_domain`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.service_networking_peered_dns_domain.withTimeoutsMixin` constructs a mixin object that can be merged into the `service_networking_peered_dns_domain`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.service_networking_peered_dns_domain.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
