...
{
  '#':: d.pkg(name='access_context_manager_access_policy_iam_policy', url='', help='`access_context_manager_access_policy_iam_policy` represents the `google_access_context_manager_access_policy_iam_policy` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withName':: d.fn(help='`google.access_context_manager_access_policy_iam_policy.withName` constructs a mixin object that can be merged into the `access_context_manager_access_policy_iam_policy`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withPolicyData':: d.fn(help='`google.access_context_manager_access_policy_iam_policy.withPolicyData` constructs a mixin object that can be merged into the `access_context_manager_access_policy_iam_policy`\nTerraform resource block to set or update the policy_data field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy_data` field.\n', args=[]),
