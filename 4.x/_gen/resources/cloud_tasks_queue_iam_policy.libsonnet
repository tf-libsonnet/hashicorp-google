...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withLocation':: d.fn(help='`google.cloud_tasks_queue_iam_policy.withLocation` constructs a mixin object that can be merged into the `cloud_tasks_queue_iam_policy`\nTerraform resource block to set or update the location field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `location` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`google.cloud_tasks_queue_iam_policy.withName` constructs a mixin object that can be merged into the `cloud_tasks_queue_iam_policy`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withPolicyData':: d.fn(help='`google.cloud_tasks_queue_iam_policy.withPolicyData` constructs a mixin object that can be merged into the `cloud_tasks_queue_iam_policy`\nTerraform resource block to set or update the policy_data field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy_data` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google.cloud_tasks_queue_iam_policy.withProject` constructs a mixin object that can be merged into the `cloud_tasks_queue_iam_policy`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
