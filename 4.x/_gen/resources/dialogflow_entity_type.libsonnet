...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDisplayName':: d.fn(help='`google.dialogflow_entity_type.withDisplayName` constructs a mixin object that can be merged into the `dialogflow_entity_type`\nTerraform resource block to set or update the display_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `display_name` field.\n', args=[]),
  ...
  '#withEnableFuzzyExtraction':: d.fn(help='`google.dialogflow_entity_type.withEnableFuzzyExtraction` constructs a mixin object that can be merged into the `dialogflow_entity_type`\nTerraform resource block to set or update the enable_fuzzy_extraction field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `enable_fuzzy_extraction` field.\n', args=[]),
  ...
  '#withEntities':: d.fn(help='`google.dialogflow_entity_type.withEntities` constructs a mixin object that can be merged into the `dialogflow_entity_type`\nTerraform resource block to set or update the entities field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `entities` field.\n', args=[]),
  ...
  '#withEntitiesMixin':: d.fn(help='`google.dialogflow_entity_type.withEntitiesMixin` constructs a mixin object that can be merged into the `dialogflow_entity_type`\nTerraform resource block to set or update the entities field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google.dialogflow_entity_type.withEntities](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `entities` field.\n', args=[]),
  ...
  '#withKind':: d.fn(help='`google.dialogflow_entity_type.withKind` constructs a mixin object that can be merged into the `dialogflow_entity_type`\nTerraform resource block to set or update the kind field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `kind` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google.dialogflow_entity_type.withProject` constructs a mixin object that can be merged into the `dialogflow_entity_type`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.dialogflow_entity_type.withTimeouts` constructs a mixin object that can be merged into the `dialogflow_entity_type`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.dialogflow_entity_type.withTimeoutsMixin` constructs a mixin object that can be merged into the `dialogflow_entity_type`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.dialogflow_entity_type.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
