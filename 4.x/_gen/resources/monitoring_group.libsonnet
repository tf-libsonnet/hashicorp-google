...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDisplayName':: d.fn(help='`google.monitoring_group.withDisplayName` constructs a mixin object that can be merged into the `monitoring_group`\nTerraform resource block to set or update the display_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `display_name` field.\n', args=[]),
  ...
  '#withFilter':: d.fn(help='`google.monitoring_group.withFilter` constructs a mixin object that can be merged into the `monitoring_group`\nTerraform resource block to set or update the filter field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `filter` field.\n', args=[]),
  ...
  '#withIsCluster':: d.fn(help='`google.monitoring_group.withIsCluster` constructs a mixin object that can be merged into the `monitoring_group`\nTerraform resource block to set or update the is_cluster field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `is_cluster` field.\n', args=[]),
  ...
  '#withParentName':: d.fn(help='`google.monitoring_group.withParentName` constructs a mixin object that can be merged into the `monitoring_group`\nTerraform resource block to set or update the parent_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `parent_name` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google.monitoring_group.withProject` constructs a mixin object that can be merged into the `monitoring_group`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.monitoring_group.withTimeouts` constructs a mixin object that can be merged into the `monitoring_group`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.monitoring_group.withTimeoutsMixin` constructs a mixin object that can be merged into the `monitoring_group`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.monitoring_group.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
