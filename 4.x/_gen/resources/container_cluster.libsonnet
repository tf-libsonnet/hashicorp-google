...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  ip_allocation_policy:: {
    ...
    pod_cidr_overprovision_config:: {
      '#new':: d.fn(help='\n`google.container_cluster.ip_allocation_policy.pod_cidr_overprovision_config.new` constructs a new object with attributes and blocks configured for the `pod_cidr_overprovision_config`\nTerraform sub block.\n\n\n\n**Args**:\n  - `disabled` (`bool`): Set the `disabled` field on the resulting object.\n\n**Returns**:\n  - An attribute object that represents the `pod_cidr_overprovision_config` sub block.\n', args=[]),
      new(
        disabled
      ):: std.prune(a={
        disabled: disabled,
  ...
  node_pool:: {
    ...
    network_config:: {
      ...
      pod_cidr_overprovision_config:: {
        '#new':: d.fn(help='\n`google.container_cluster.node_pool.network_config.pod_cidr_overprovision_config.new` constructs a new object with attributes and blocks configured for the `pod_cidr_overprovision_config`\nTerraform sub block.\n\n\n\n**Args**:\n  - `disabled` (`bool`): Set the `disabled` field on the resulting object.\n\n**Returns**:\n  - An attribute object that represents the `pod_cidr_overprovision_config` sub block.\n', args=[]),
        new(
          disabled
        ):: std.prune(a={
          disabled: disabled,
  ...
  '#withEnableK8SBetaApisMixin':: d.fn(help='`google.list[obj].withEnableK8SBetaApisMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the enable_k8s_beta_apis field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google.list[obj].withEnableK8SBetaApis](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `enable_k8s_beta_apis` field.\n', args=[]),
  ...
  '#withIdentityServiceConfigMixin':: d.fn(help='`google.list[obj].withIdentityServiceConfigMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the identity_service_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google.list[obj].withIdentityServiceConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `identity_service_config` field.\n', args=[]),
  ...
  '#withNodePoolAutoConfigMixin':: d.fn(help='`google.list[obj].withNodePoolAutoConfigMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the node_pool_auto_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google.list[obj].withNodePoolAutoConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `node_pool_auto_config` field.\n', args=[]),
  ...
  '#withSecurityPostureConfigMixin':: d.fn(help='`google.list[obj].withSecurityPostureConfigMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the security_posture_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google.list[obj].withSecurityPostureConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `security_posture_config` field.\n', args=[]),
