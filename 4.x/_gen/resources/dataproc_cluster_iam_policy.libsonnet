...
{
  '#':: d.pkg(name='dataproc_cluster_iam_policy', url='', help='`dataproc_cluster_iam_policy` represents the `google_dataproc_cluster_iam_policy` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withCluster':: d.fn(help='`google.dataproc_cluster_iam_policy.withCluster` constructs a mixin object that can be merged into the `dataproc_cluster_iam_policy`\nTerraform resource block to set or update the cluster field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cluster` field.\n', args=[]),
  ...
  '#withPolicyData':: d.fn(help='`google.dataproc_cluster_iam_policy.withPolicyData` constructs a mixin object that can be merged into the `dataproc_cluster_iam_policy`\nTerraform resource block to set or update the policy_data field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy_data` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google.dataproc_cluster_iam_policy.withProject` constructs a mixin object that can be merged into the `dataproc_cluster_iam_policy`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withRegion':: d.fn(help='`google.dataproc_cluster_iam_policy.withRegion` constructs a mixin object that can be merged into the `dataproc_cluster_iam_policy`\nTerraform resource block to set or update the region field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `region` field.\n', args=[]),
