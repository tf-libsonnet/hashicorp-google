...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withEntryGroup':: d.fn(help='`google.data_catalog_entry_group_iam_policy.withEntryGroup` constructs a mixin object that can be merged into the `data_catalog_entry_group_iam_policy`\nTerraform resource block to set or update the entry_group field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `entry_group` field.\n', args=[]),
  ...
  '#withPolicyData':: d.fn(help='`google.data_catalog_entry_group_iam_policy.withPolicyData` constructs a mixin object that can be merged into the `data_catalog_entry_group_iam_policy`\nTerraform resource block to set or update the policy_data field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy_data` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google.data_catalog_entry_group_iam_policy.withProject` constructs a mixin object that can be merged into the `data_catalog_entry_group_iam_policy`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withRegion':: d.fn(help='`google.data_catalog_entry_group_iam_policy.withRegion` constructs a mixin object that can be merged into the `data_catalog_entry_group_iam_policy`\nTerraform resource block to set or update the region field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `region` field.\n', args=[]),
