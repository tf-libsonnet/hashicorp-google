...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withOrigin':: d.fn(help='`google.resource_manager_lien.withOrigin` constructs a mixin object that can be merged into the `resource_manager_lien`\nTerraform resource block to set or update the origin field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `origin` field.\n', args=[]),
  ...
  '#withParent':: d.fn(help='`google.resource_manager_lien.withParent` constructs a mixin object that can be merged into the `resource_manager_lien`\nTerraform resource block to set or update the parent field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `parent` field.\n', args=[]),
  ...
  '#withReason':: d.fn(help='`google.resource_manager_lien.withReason` constructs a mixin object that can be merged into the `resource_manager_lien`\nTerraform resource block to set or update the reason field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `reason` field.\n', args=[]),
  ...
  '#withRestrictions':: d.fn(help='`google.resource_manager_lien.withRestrictions` constructs a mixin object that can be merged into the `resource_manager_lien`\nTerraform resource block to set or update the restrictions field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `restrictions` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.resource_manager_lien.withTimeouts` constructs a mixin object that can be merged into the `resource_manager_lien`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.resource_manager_lien.withTimeoutsMixin` constructs a mixin object that can be merged into the `resource_manager_lien`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.resource_manager_lien.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
