...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCollection':: d.fn(help='`google.firestore_document.withCollection` constructs a mixin object that can be merged into the `firestore_document`\nTerraform resource block to set or update the collection field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `collection` field.\n', args=[]),
  ...
  '#withDatabase':: d.fn(help='`google.firestore_document.withDatabase` constructs a mixin object that can be merged into the `firestore_document`\nTerraform resource block to set or update the database field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `database` field.\n', args=[]),
  ...
  '#withDocumentId':: d.fn(help='`google.firestore_document.withDocumentId` constructs a mixin object that can be merged into the `firestore_document`\nTerraform resource block to set or update the document_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `document_id` field.\n', args=[]),
  ...
  '#withFields':: d.fn(help='`google.firestore_document.withFields` constructs a mixin object that can be merged into the `firestore_document`\nTerraform resource block to set or update the fields field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `fields` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google.firestore_document.withProject` constructs a mixin object that can be merged into the `firestore_document`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.firestore_document.withTimeouts` constructs a mixin object that can be merged into the `firestore_document`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.firestore_document.withTimeoutsMixin` constructs a mixin object that can be merged into the `firestore_document`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.firestore_document.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
