...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCryptoKeyId':: d.fn(help='`google.kms_crypto_key_iam_policy.withCryptoKeyId` constructs a mixin object that can be merged into the `kms_crypto_key_iam_policy`\nTerraform resource block to set or update the crypto_key_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `crypto_key_id` field.\n', args=[]),
  ...
  '#withPolicyData':: d.fn(help='`google.kms_crypto_key_iam_policy.withPolicyData` constructs a mixin object that can be merged into the `kms_crypto_key_iam_policy`\nTerraform resource block to set or update the policy_data field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy_data` field.\n', args=[]),
