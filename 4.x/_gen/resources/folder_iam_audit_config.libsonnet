...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAuditLogConfig':: d.fn(help='`google.folder_iam_audit_config.withAuditLogConfig` constructs a mixin object that can be merged into the `folder_iam_audit_config`\nTerraform resource block to set or update the audit_log_config field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `audit_log_config` field.\n', args=[]),
  ...
  '#withAuditLogConfigMixin':: d.fn(help='`google.folder_iam_audit_config.withAuditLogConfigMixin` constructs a mixin object that can be merged into the `folder_iam_audit_config`\nTerraform resource block to set or update the audit_log_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google.folder_iam_audit_config.withAuditLogConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `audit_log_config` field.\n', args=[]),
  ...
  '#withFolder':: d.fn(help='`google.folder_iam_audit_config.withFolder` constructs a mixin object that can be merged into the `folder_iam_audit_config`\nTerraform resource block to set or update the folder field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `folder` field.\n', args=[]),
  ...
  '#withService':: d.fn(help='`google.folder_iam_audit_config.withService` constructs a mixin object that can be merged into the `folder_iam_audit_config`\nTerraform resource block to set or update the service field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `service` field.\n', args=[]),
