...
{
  '#':: d.pkg(name='billing_subaccount', url='', help='`billing_subaccount` represents the `google_billing_subaccount` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withDeletionPolicy':: d.fn(help='`google.billing_subaccount.withDeletionPolicy` constructs a mixin object that can be merged into the `billing_subaccount`\nTerraform resource block to set or update the deletion_policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `deletion_policy` field.\n', args=[]),
  ...
  '#withDisplayName':: d.fn(help='`google.billing_subaccount.withDisplayName` constructs a mixin object that can be merged into the `billing_subaccount`\nTerraform resource block to set or update the display_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `display_name` field.\n', args=[]),
  ...
  '#withMasterBillingAccount':: d.fn(help='`google.billing_subaccount.withMasterBillingAccount` constructs a mixin object that can be merged into the `billing_subaccount`\nTerraform resource block to set or update the master_billing_account field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `master_billing_account` field.\n', args=[]),
