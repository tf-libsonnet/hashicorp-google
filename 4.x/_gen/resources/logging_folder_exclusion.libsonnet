...
{
  '#':: d.pkg(name='logging_folder_exclusion', url='', help='`logging_folder_exclusion` represents the `google_logging_folder_exclusion` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withDescription':: d.fn(help='`google.logging_folder_exclusion.withDescription` constructs a mixin object that can be merged into the `logging_folder_exclusion`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withDisabled':: d.fn(help='`google.logging_folder_exclusion.withDisabled` constructs a mixin object that can be merged into the `logging_folder_exclusion`\nTerraform resource block to set or update the disabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `disabled` field.\n', args=[]),
  ...
  '#withFilter':: d.fn(help='`google.logging_folder_exclusion.withFilter` constructs a mixin object that can be merged into the `logging_folder_exclusion`\nTerraform resource block to set or update the filter field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `filter` field.\n', args=[]),
  ...
  '#withFolder':: d.fn(help='`google.logging_folder_exclusion.withFolder` constructs a mixin object that can be merged into the `logging_folder_exclusion`\nTerraform resource block to set or update the folder field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `folder` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`google.logging_folder_exclusion.withName` constructs a mixin object that can be merged into the `logging_folder_exclusion`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
