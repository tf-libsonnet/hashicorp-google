...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAction':: d.fn(help='`google.project_default_service_accounts.withAction` constructs a mixin object that can be merged into the `project_default_service_accounts`\nTerraform resource block to set or update the action field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `action` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google.project_default_service_accounts.withProject` constructs a mixin object that can be merged into the `project_default_service_accounts`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withRestorePolicy':: d.fn(help='`google.project_default_service_accounts.withRestorePolicy` constructs a mixin object that can be merged into the `project_default_service_accounts`\nTerraform resource block to set or update the restore_policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `restore_policy` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.project_default_service_accounts.withTimeouts` constructs a mixin object that can be merged into the `project_default_service_accounts`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.project_default_service_accounts.withTimeoutsMixin` constructs a mixin object that can be merged into the `project_default_service_accounts`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.project_default_service_accounts.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
