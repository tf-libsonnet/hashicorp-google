...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAttachmentTarget':: d.fn(help='`google.compute_firewall_policy_association.withAttachmentTarget` constructs a mixin object that can be merged into the `compute_firewall_policy_association`\nTerraform resource block to set or update the attachment_target field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `attachment_target` field.\n', args=[]),
  ...
  '#withFirewallPolicy':: d.fn(help='`google.compute_firewall_policy_association.withFirewallPolicy` constructs a mixin object that can be merged into the `compute_firewall_policy_association`\nTerraform resource block to set or update the firewall_policy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `firewall_policy` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`google.compute_firewall_policy_association.withName` constructs a mixin object that can be merged into the `compute_firewall_policy_association`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.compute_firewall_policy_association.withTimeouts` constructs a mixin object that can be merged into the `compute_firewall_policy_association`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.compute_firewall_policy_association.withTimeoutsMixin` constructs a mixin object that can be merged into the `compute_firewall_policy_association`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.compute_firewall_policy_association.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
