...
{
  '#':: d.pkg(name='healthcare_dicom_store_iam_policy', url='', help='`healthcare_dicom_store_iam_policy` represents the `google_healthcare_dicom_store_iam_policy` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withDicomStoreId':: d.fn(help='`google.healthcare_dicom_store_iam_policy.withDicomStoreId` constructs a mixin object that can be merged into the `healthcare_dicom_store_iam_policy`\nTerraform resource block to set or update the dicom_store_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `dicom_store_id` field.\n', args=[]),
  ...
  '#withPolicyData':: d.fn(help='`google.healthcare_dicom_store_iam_policy.withPolicyData` constructs a mixin object that can be merged into the `healthcare_dicom_store_iam_policy`\nTerraform resource block to set or update the policy_data field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy_data` field.\n', args=[]),
