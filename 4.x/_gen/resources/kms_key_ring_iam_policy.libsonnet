...
{
  '#':: d.pkg(name='kms_key_ring_iam_policy', url='', help='`kms_key_ring_iam_policy` represents the `google_kms_key_ring_iam_policy` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withKeyRingId':: d.fn(help='`google.kms_key_ring_iam_policy.withKeyRingId` constructs a mixin object that can be merged into the `kms_key_ring_iam_policy`\nTerraform resource block to set or update the key_ring_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `key_ring_id` field.\n', args=[]),
  ...
  '#withPolicyData':: d.fn(help='`google.kms_key_ring_iam_policy.withPolicyData` constructs a mixin object that can be merged into the `kms_key_ring_iam_policy`\nTerraform resource block to set or update the policy_data field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy_data` field.\n', args=[]),
