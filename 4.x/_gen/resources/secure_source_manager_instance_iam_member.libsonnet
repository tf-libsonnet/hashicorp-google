...
{
  '#':: d.pkg(name='secure_source_manager_instance_iam_member', url='', help='`secure_source_manager_instance_iam_member` represents the `google_secure_source_manager_instance_iam_member` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  condition:: {
