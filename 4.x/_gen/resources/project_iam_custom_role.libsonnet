...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDescription':: d.fn(help='`google.project_iam_custom_role.withDescription` constructs a mixin object that can be merged into the `project_iam_custom_role`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withPermissions':: d.fn(help='`google.project_iam_custom_role.withPermissions` constructs a mixin object that can be merged into the `project_iam_custom_role`\nTerraform resource block to set or update the permissions field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `permissions` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google.project_iam_custom_role.withProject` constructs a mixin object that can be merged into the `project_iam_custom_role`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withRoleId':: d.fn(help='`google.project_iam_custom_role.withRoleId` constructs a mixin object that can be merged into the `project_iam_custom_role`\nTerraform resource block to set or update the role_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `role_id` field.\n', args=[]),
  ...
  '#withStage':: d.fn(help='`google.project_iam_custom_role.withStage` constructs a mixin object that can be merged into the `project_iam_custom_role`\nTerraform resource block to set or update the stage field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `stage` field.\n', args=[]),
  ...
  '#withTitle':: d.fn(help='`google.project_iam_custom_role.withTitle` constructs a mixin object that can be merged into the `project_iam_custom_role`\nTerraform resource block to set or update the title field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `title` field.\n', args=[]),
