...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withExpirationTimeUsec':: d.fn(help='`google.os_login_ssh_public_key.withExpirationTimeUsec` constructs a mixin object that can be merged into the `os_login_ssh_public_key`\nTerraform resource block to set or update the expiration_time_usec field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `expiration_time_usec` field.\n', args=[]),
  ...
  '#withKey':: d.fn(help='`google.os_login_ssh_public_key.withKey` constructs a mixin object that can be merged into the `os_login_ssh_public_key`\nTerraform resource block to set or update the key field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `key` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google.os_login_ssh_public_key.withProject` constructs a mixin object that can be merged into the `os_login_ssh_public_key`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.os_login_ssh_public_key.withTimeouts` constructs a mixin object that can be merged into the `os_login_ssh_public_key`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.os_login_ssh_public_key.withTimeoutsMixin` constructs a mixin object that can be merged into the `os_login_ssh_public_key`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.os_login_ssh_public_key.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withUser':: d.fn(help='`google.os_login_ssh_public_key.withUser` constructs a mixin object that can be merged into the `os_login_ssh_public_key`\nTerraform resource block to set or update the user field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `user` field.\n', args=[]),
