...
{
  '#':: d.pkg(name='kms_key_ring_iam_member', url='', help='`kms_key_ring_iam_member` represents the `google_kms_key_ring_iam_member` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  condition:: {
  ...
  '#withCondition':: d.fn(help='`google.kms_key_ring_iam_member.withCondition` constructs a mixin object that can be merged into the `kms_key_ring_iam_member`\nTerraform resource block to set or update the condition field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `condition` field.\n', args=[]),
  ...
  '#withConditionMixin':: d.fn(help='`google.kms_key_ring_iam_member.withConditionMixin` constructs a mixin object that can be merged into the `kms_key_ring_iam_member`\nTerraform resource block to set or update the condition field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google.kms_key_ring_iam_member.withCondition](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `condition` field.\n', args=[]),
  ...
  '#withKeyRingId':: d.fn(help='`google.kms_key_ring_iam_member.withKeyRingId` constructs a mixin object that can be merged into the `kms_key_ring_iam_member`\nTerraform resource block to set or update the key_ring_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `key_ring_id` field.\n', args=[]),
  ...
  '#withMember':: d.fn(help='`google.kms_key_ring_iam_member.withMember` constructs a mixin object that can be merged into the `kms_key_ring_iam_member`\nTerraform resource block to set or update the member field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `member` field.\n', args=[]),
  ...
  '#withRole':: d.fn(help='`google.kms_key_ring_iam_member.withRole` constructs a mixin object that can be merged into the `kms_key_ring_iam_member`\nTerraform resource block to set or update the role field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `role` field.\n', args=[]),
