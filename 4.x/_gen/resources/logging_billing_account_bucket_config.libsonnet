...
{
  '#':: d.pkg(name='logging_billing_account_bucket_config', url='', help='`logging_billing_account_bucket_config` represents the `google_logging_billing_account_bucket_config` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  cmek_settings:: {
  ...
  '#withBillingAccount':: d.fn(help='`google.logging_billing_account_bucket_config.withBillingAccount` constructs a mixin object that can be merged into the `logging_billing_account_bucket_config`\nTerraform resource block to set or update the billing_account field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `billing_account` field.\n', args=[]),
  ...
  '#withBucketId':: d.fn(help='`google.logging_billing_account_bucket_config.withBucketId` constructs a mixin object that can be merged into the `logging_billing_account_bucket_config`\nTerraform resource block to set or update the bucket_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `bucket_id` field.\n', args=[]),
  ...
  '#withCmekSettings':: d.fn(help='`google.logging_billing_account_bucket_config.withCmekSettings` constructs a mixin object that can be merged into the `logging_billing_account_bucket_config`\nTerraform resource block to set or update the cmek_settings field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cmek_settings` field.\n', args=[]),
  ...
  '#withCmekSettingsMixin':: d.fn(help='`google.logging_billing_account_bucket_config.withCmekSettingsMixin` constructs a mixin object that can be merged into the `logging_billing_account_bucket_config`\nTerraform resource block to set or update the cmek_settings field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google.logging_billing_account_bucket_config.withCmekSettings](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cmek_settings` field.\n', args=[]),
  ...
  '#withDescription':: d.fn(help='`google.logging_billing_account_bucket_config.withDescription` constructs a mixin object that can be merged into the `logging_billing_account_bucket_config`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withLocation':: d.fn(help='`google.logging_billing_account_bucket_config.withLocation` constructs a mixin object that can be merged into the `logging_billing_account_bucket_config`\nTerraform resource block to set or update the location field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `location` field.\n', args=[]),
  ...
  '#withRetentionDays':: d.fn(help='`google.logging_billing_account_bucket_config.withRetentionDays` constructs a mixin object that can be merged into the `logging_billing_account_bucket_config`\nTerraform resource block to set or update the retention_days field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `retention_days` field.\n', args=[]),
