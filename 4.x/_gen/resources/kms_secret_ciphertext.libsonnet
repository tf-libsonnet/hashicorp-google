...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAdditionalAuthenticatedData':: d.fn(help='`google.kms_secret_ciphertext.withAdditionalAuthenticatedData` constructs a mixin object that can be merged into the `kms_secret_ciphertext`\nTerraform resource block to set or update the additional_authenticated_data field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `additional_authenticated_data` field.\n', args=[]),
  ...
  '#withCryptoKey':: d.fn(help='`google.kms_secret_ciphertext.withCryptoKey` constructs a mixin object that can be merged into the `kms_secret_ciphertext`\nTerraform resource block to set or update the crypto_key field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `crypto_key` field.\n', args=[]),
  ...
  '#withPlaintext':: d.fn(help='`google.kms_secret_ciphertext.withPlaintext` constructs a mixin object that can be merged into the `kms_secret_ciphertext`\nTerraform resource block to set or update the plaintext field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `plaintext` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.kms_secret_ciphertext.withTimeouts` constructs a mixin object that can be merged into the `kms_secret_ciphertext`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.kms_secret_ciphertext.withTimeoutsMixin` constructs a mixin object that can be merged into the `kms_secret_ciphertext`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.kms_secret_ciphertext.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
