...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withPerimeterName':: d.fn(help='`google.access_context_manager_service_perimeter_resource.withPerimeterName` constructs a mixin object that can be merged into the `access_context_manager_service_perimeter_resource`\nTerraform resource block to set or update the perimeter_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `perimeter_name` field.\n', args=[]),
  ...
  '#withResource':: d.fn(help='`google.access_context_manager_service_perimeter_resource.withResource` constructs a mixin object that can be merged into the `access_context_manager_service_perimeter_resource`\nTerraform resource block to set or update the resource field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.access_context_manager_service_perimeter_resource.withTimeouts` constructs a mixin object that can be merged into the `access_context_manager_service_perimeter_resource`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.access_context_manager_service_perimeter_resource.withTimeoutsMixin` constructs a mixin object that can be merged into the `access_context_manager_service_perimeter_resource`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.access_context_manager_service_perimeter_resource.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
