...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withEnvironment':: d.fn(help='`google.apigee_instance_attachment.withEnvironment` constructs a mixin object that can be merged into the `apigee_instance_attachment`\nTerraform resource block to set or update the environment field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `environment` field.\n', args=[]),
  ...
  '#withInstanceId':: d.fn(help='`google.apigee_instance_attachment.withInstanceId` constructs a mixin object that can be merged into the `apigee_instance_attachment`\nTerraform resource block to set or update the instance_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `instance_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.apigee_instance_attachment.withTimeouts` constructs a mixin object that can be merged into the `apigee_instance_attachment`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.apigee_instance_attachment.withTimeoutsMixin` constructs a mixin object that can be merged into the `apigee_instance_attachment`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.apigee_instance_attachment.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
