...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withProject':: d.fn(help='`google.storage_hmac_key.withProject` constructs a mixin object that can be merged into the `storage_hmac_key`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withServiceAccountEmail':: d.fn(help='`google.storage_hmac_key.withServiceAccountEmail` constructs a mixin object that can be merged into the `storage_hmac_key`\nTerraform resource block to set or update the service_account_email field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `service_account_email` field.\n', args=[]),
  ...
  '#withState':: d.fn(help='`google.storage_hmac_key.withState` constructs a mixin object that can be merged into the `storage_hmac_key`\nTerraform resource block to set or update the state field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `state` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.storage_hmac_key.withTimeouts` constructs a mixin object that can be merged into the `storage_hmac_key`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.storage_hmac_key.withTimeoutsMixin` constructs a mixin object that can be merged into the `storage_hmac_key`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.storage_hmac_key.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
