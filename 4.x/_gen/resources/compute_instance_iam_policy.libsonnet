...
{
  '#':: d.pkg(name='compute_instance_iam_policy', url='', help='`compute_instance_iam_policy` represents the `google_compute_instance_iam_policy` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withInstanceName':: d.fn(help='`google.compute_instance_iam_policy.withInstanceName` constructs a mixin object that can be merged into the `compute_instance_iam_policy`\nTerraform resource block to set or update the instance_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `instance_name` field.\n', args=[]),
  ...
  '#withPolicyData':: d.fn(help='`google.compute_instance_iam_policy.withPolicyData` constructs a mixin object that can be merged into the `compute_instance_iam_policy`\nTerraform resource block to set or update the policy_data field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy_data` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google.compute_instance_iam_policy.withProject` constructs a mixin object that can be merged into the `compute_instance_iam_policy`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withZone':: d.fn(help='`google.compute_instance_iam_policy.withZone` constructs a mixin object that can be merged into the `compute_instance_iam_policy`\nTerraform resource block to set or update the zone field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `zone` field.\n', args=[]),
