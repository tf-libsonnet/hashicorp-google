...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAncestor':: d.fn(help='`google.datastore_index.withAncestor` constructs a mixin object that can be merged into the `datastore_index`\nTerraform resource block to set or update the ancestor field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ancestor` field.\n', args=[]),
  ...
  '#withKind':: d.fn(help='`google.datastore_index.withKind` constructs a mixin object that can be merged into the `datastore_index`\nTerraform resource block to set or update the kind field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `kind` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google.datastore_index.withProject` constructs a mixin object that can be merged into the `datastore_index`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withProperties':: d.fn(help='`google.datastore_index.withProperties` constructs a mixin object that can be merged into the `datastore_index`\nTerraform resource block to set or update the properties field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `properties` field.\n', args=[]),
  ...
  '#withPropertiesMixin':: d.fn(help='`google.datastore_index.withPropertiesMixin` constructs a mixin object that can be merged into the `datastore_index`\nTerraform resource block to set or update the properties field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google.datastore_index.withProperties](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `properties` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.datastore_index.withTimeouts` constructs a mixin object that can be merged into the `datastore_index`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.datastore_index.withTimeoutsMixin` constructs a mixin object that can be merged into the `datastore_index`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.datastore_index.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
