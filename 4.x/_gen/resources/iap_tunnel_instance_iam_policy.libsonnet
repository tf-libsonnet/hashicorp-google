...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withInstance':: d.fn(help='`google.iap_tunnel_instance_iam_policy.withInstance` constructs a mixin object that can be merged into the `iap_tunnel_instance_iam_policy`\nTerraform resource block to set or update the instance field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `instance` field.\n', args=[]),
  ...
  '#withPolicyData':: d.fn(help='`google.iap_tunnel_instance_iam_policy.withPolicyData` constructs a mixin object that can be merged into the `iap_tunnel_instance_iam_policy`\nTerraform resource block to set or update the policy_data field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy_data` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google.iap_tunnel_instance_iam_policy.withProject` constructs a mixin object that can be merged into the `iap_tunnel_instance_iam_policy`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withZone':: d.fn(help='`google.iap_tunnel_instance_iam_policy.withZone` constructs a mixin object that can be merged into the `iap_tunnel_instance_iam_policy`\nTerraform resource block to set or update the zone field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `zone` field.\n', args=[]),
