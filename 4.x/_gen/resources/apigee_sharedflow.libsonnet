...
{
  '#':: d.pkg(name='apigee_sharedflow', url='', help='`apigee_sharedflow` represents the `google_apigee_sharedflow` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
