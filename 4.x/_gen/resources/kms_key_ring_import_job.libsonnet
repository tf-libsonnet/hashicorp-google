...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withImportJobId':: d.fn(help='`google.kms_key_ring_import_job.withImportJobId` constructs a mixin object that can be merged into the `kms_key_ring_import_job`\nTerraform resource block to set or update the import_job_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `import_job_id` field.\n', args=[]),
  ...
  '#withImportMethod':: d.fn(help='`google.kms_key_ring_import_job.withImportMethod` constructs a mixin object that can be merged into the `kms_key_ring_import_job`\nTerraform resource block to set or update the import_method field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `import_method` field.\n', args=[]),
  ...
  '#withKeyRing':: d.fn(help='`google.kms_key_ring_import_job.withKeyRing` constructs a mixin object that can be merged into the `kms_key_ring_import_job`\nTerraform resource block to set or update the key_ring field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `key_ring` field.\n', args=[]),
  ...
  '#withProtectionLevel':: d.fn(help='`google.kms_key_ring_import_job.withProtectionLevel` constructs a mixin object that can be merged into the `kms_key_ring_import_job`\nTerraform resource block to set or update the protection_level field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `protection_level` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.kms_key_ring_import_job.withTimeouts` constructs a mixin object that can be merged into the `kms_key_ring_import_job`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.kms_key_ring_import_job.withTimeoutsMixin` constructs a mixin object that can be merged into the `kms_key_ring_import_job`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.kms_key_ring_import_job.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
