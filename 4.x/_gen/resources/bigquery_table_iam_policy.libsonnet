...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDatasetId':: d.fn(help='`google.bigquery_table_iam_policy.withDatasetId` constructs a mixin object that can be merged into the `bigquery_table_iam_policy`\nTerraform resource block to set or update the dataset_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `dataset_id` field.\n', args=[]),
  ...
  '#withPolicyData':: d.fn(help='`google.bigquery_table_iam_policy.withPolicyData` constructs a mixin object that can be merged into the `bigquery_table_iam_policy`\nTerraform resource block to set or update the policy_data field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy_data` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google.bigquery_table_iam_policy.withProject` constructs a mixin object that can be merged into the `bigquery_table_iam_policy`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withTableId':: d.fn(help='`google.bigquery_table_iam_policy.withTableId` constructs a mixin object that can be merged into the `bigquery_table_iam_policy`\nTerraform resource block to set or update the table_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `table_id` field.\n', args=[]),
