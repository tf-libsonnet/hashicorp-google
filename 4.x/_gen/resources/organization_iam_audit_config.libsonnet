...
{
  '#':: d.pkg(name='organization_iam_audit_config', url='', help='`organization_iam_audit_config` represents the `google_organization_iam_audit_config` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  audit_log_config:: {
  ...
  '#withAuditLogConfig':: d.fn(help='`google.organization_iam_audit_config.withAuditLogConfig` constructs a mixin object that can be merged into the `organization_iam_audit_config`\nTerraform resource block to set or update the audit_log_config field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `audit_log_config` field.\n', args=[]),
  ...
  '#withAuditLogConfigMixin':: d.fn(help='`google.organization_iam_audit_config.withAuditLogConfigMixin` constructs a mixin object that can be merged into the `organization_iam_audit_config`\nTerraform resource block to set or update the audit_log_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google.organization_iam_audit_config.withAuditLogConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `audit_log_config` field.\n', args=[]),
  ...
  '#withOrgId':: d.fn(help='`google.organization_iam_audit_config.withOrgId` constructs a mixin object that can be merged into the `organization_iam_audit_config`\nTerraform resource block to set or update the org_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `org_id` field.\n', args=[]),
  ...
  '#withService':: d.fn(help='`google.organization_iam_audit_config.withService` constructs a mixin object that can be merged into the `organization_iam_audit_config`\nTerraform resource block to set or update the service field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `service` field.\n', args=[]),
