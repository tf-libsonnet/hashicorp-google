...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAssignee':: d.fn(help='`google.bigquery_reservation_assignment.withAssignee` constructs a mixin object that can be merged into the `bigquery_reservation_assignment`\nTerraform resource block to set or update the assignee field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `assignee` field.\n', args=[]),
  ...
  '#withJobType':: d.fn(help='`google.bigquery_reservation_assignment.withJobType` constructs a mixin object that can be merged into the `bigquery_reservation_assignment`\nTerraform resource block to set or update the job_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `job_type` field.\n', args=[]),
  ...
  '#withLocation':: d.fn(help='`google.bigquery_reservation_assignment.withLocation` constructs a mixin object that can be merged into the `bigquery_reservation_assignment`\nTerraform resource block to set or update the location field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `location` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google.bigquery_reservation_assignment.withProject` constructs a mixin object that can be merged into the `bigquery_reservation_assignment`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withReservation':: d.fn(help='`google.bigquery_reservation_assignment.withReservation` constructs a mixin object that can be merged into the `bigquery_reservation_assignment`\nTerraform resource block to set or update the reservation field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `reservation` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.bigquery_reservation_assignment.withTimeouts` constructs a mixin object that can be merged into the `bigquery_reservation_assignment`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.bigquery_reservation_assignment.withTimeoutsMixin` constructs a mixin object that can be merged into the `bigquery_reservation_assignment`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.bigquery_reservation_assignment.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
