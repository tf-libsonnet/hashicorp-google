...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDescription':: d.fn(help='`google.tags_tag_value.withDescription` constructs a mixin object that can be merged into the `tags_tag_value`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withParent':: d.fn(help='`google.tags_tag_value.withParent` constructs a mixin object that can be merged into the `tags_tag_value`\nTerraform resource block to set or update the parent field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `parent` field.\n', args=[]),
  ...
  '#withShortName':: d.fn(help='`google.tags_tag_value.withShortName` constructs a mixin object that can be merged into the `tags_tag_value`\nTerraform resource block to set or update the short_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `short_name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.tags_tag_value.withTimeouts` constructs a mixin object that can be merged into the `tags_tag_value`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.tags_tag_value.withTimeoutsMixin` constructs a mixin object that can be merged into the `tags_tag_value`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.tags_tag_value.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
