...
{
  '#':: d.pkg(name='identity_platform_tenant', url='', help='`identity_platform_tenant` represents the `google_identity_platform_tenant` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withAllowPasswordSignup':: d.fn(help='`google.identity_platform_tenant.withAllowPasswordSignup` constructs a mixin object that can be merged into the `identity_platform_tenant`\nTerraform resource block to set or update the allow_password_signup field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `allow_password_signup` field.\n', args=[]),
  ...
  '#withDisableAuth':: d.fn(help='`google.identity_platform_tenant.withDisableAuth` constructs a mixin object that can be merged into the `identity_platform_tenant`\nTerraform resource block to set or update the disable_auth field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `disable_auth` field.\n', args=[]),
  ...
  '#withDisplayName':: d.fn(help='`google.identity_platform_tenant.withDisplayName` constructs a mixin object that can be merged into the `identity_platform_tenant`\nTerraform resource block to set or update the display_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `display_name` field.\n', args=[]),
  ...
  '#withEnableEmailLinkSignin':: d.fn(help='`google.identity_platform_tenant.withEnableEmailLinkSignin` constructs a mixin object that can be merged into the `identity_platform_tenant`\nTerraform resource block to set or update the enable_email_link_signin field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `enable_email_link_signin` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google.identity_platform_tenant.withProject` constructs a mixin object that can be merged into the `identity_platform_tenant`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.identity_platform_tenant.withTimeouts` constructs a mixin object that can be merged into the `identity_platform_tenant`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.identity_platform_tenant.withTimeoutsMixin` constructs a mixin object that can be merged into the `identity_platform_tenant`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.identity_platform_tenant.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
