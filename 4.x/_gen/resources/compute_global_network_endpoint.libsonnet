...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withFqdn':: d.fn(help='`google.compute_global_network_endpoint.withFqdn` constructs a mixin object that can be merged into the `compute_global_network_endpoint`\nTerraform resource block to set or update the fqdn field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `fqdn` field.\n', args=[]),
  ...
  '#withGlobalNetworkEndpointGroup':: d.fn(help='`google.compute_global_network_endpoint.withGlobalNetworkEndpointGroup` constructs a mixin object that can be merged into the `compute_global_network_endpoint`\nTerraform resource block to set or update the global_network_endpoint_group field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `global_network_endpoint_group` field.\n', args=[]),
  ...
  '#withIpAddress':: d.fn(help='`google.compute_global_network_endpoint.withIpAddress` constructs a mixin object that can be merged into the `compute_global_network_endpoint`\nTerraform resource block to set or update the ip_address field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ip_address` field.\n', args=[]),
  ...
  '#withPort':: d.fn(help='`google.compute_global_network_endpoint.withPort` constructs a mixin object that can be merged into the `compute_global_network_endpoint`\nTerraform resource block to set or update the port field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `port` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google.compute_global_network_endpoint.withProject` constructs a mixin object that can be merged into the `compute_global_network_endpoint`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.compute_global_network_endpoint.withTimeouts` constructs a mixin object that can be merged into the `compute_global_network_endpoint`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.compute_global_network_endpoint.withTimeoutsMixin` constructs a mixin object that can be merged into the `compute_global_network_endpoint`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.compute_global_network_endpoint.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
