...
{
  '#':: d.pkg(name='container_analysis_note_iam_binding', url='', help='`container_analysis_note_iam_binding` represents the `google_container_analysis_note_iam_binding` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  condition:: {
