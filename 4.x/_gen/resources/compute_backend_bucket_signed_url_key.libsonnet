...
{
  '#':: d.pkg(name='compute_backend_bucket_signed_url_key', url='', help='`compute_backend_bucket_signed_url_key` represents the `google_compute_backend_bucket_signed_url_key` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withBackendBucket':: d.fn(help='`google.compute_backend_bucket_signed_url_key.withBackendBucket` constructs a mixin object that can be merged into the `compute_backend_bucket_signed_url_key`\nTerraform resource block to set or update the backend_bucket field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `backend_bucket` field.\n', args=[]),
  ...
  '#withKeyValue':: d.fn(help='`google.compute_backend_bucket_signed_url_key.withKeyValue` constructs a mixin object that can be merged into the `compute_backend_bucket_signed_url_key`\nTerraform resource block to set or update the key_value field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `key_value` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`google.compute_backend_bucket_signed_url_key.withName` constructs a mixin object that can be merged into the `compute_backend_bucket_signed_url_key`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google.compute_backend_bucket_signed_url_key.withProject` constructs a mixin object that can be merged into the `compute_backend_bucket_signed_url_key`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.compute_backend_bucket_signed_url_key.withTimeouts` constructs a mixin object that can be merged into the `compute_backend_bucket_signed_url_key`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.compute_backend_bucket_signed_url_key.withTimeoutsMixin` constructs a mixin object that can be merged into the `compute_backend_bucket_signed_url_key`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.compute_backend_bucket_signed_url_key.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
