...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCryptoKey':: d.fn(help='`google.kms_crypto_key_version.withCryptoKey` constructs a mixin object that can be merged into the `kms_crypto_key_version`\nTerraform resource block to set or update the crypto_key field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `crypto_key` field.\n', args=[]),
  ...
  '#withState':: d.fn(help='`google.kms_crypto_key_version.withState` constructs a mixin object that can be merged into the `kms_crypto_key_version`\nTerraform resource block to set or update the state field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `state` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.kms_crypto_key_version.withTimeouts` constructs a mixin object that can be merged into the `kms_crypto_key_version`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.kms_crypto_key_version.withTimeoutsMixin` constructs a mixin object that can be merged into the `kms_crypto_key_version`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.kms_crypto_key_version.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
