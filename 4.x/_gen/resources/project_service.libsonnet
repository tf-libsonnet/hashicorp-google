...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDisableDependentServices':: d.fn(help='`google.project_service.withDisableDependentServices` constructs a mixin object that can be merged into the `project_service`\nTerraform resource block to set or update the disable_dependent_services field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `disable_dependent_services` field.\n', args=[]),
  ...
  '#withDisableOnDestroy':: d.fn(help='`google.project_service.withDisableOnDestroy` constructs a mixin object that can be merged into the `project_service`\nTerraform resource block to set or update the disable_on_destroy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `disable_on_destroy` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google.project_service.withProject` constructs a mixin object that can be merged into the `project_service`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withService':: d.fn(help='`google.project_service.withService` constructs a mixin object that can be merged into the `project_service`\nTerraform resource block to set or update the service field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `service` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.project_service.withTimeouts` constructs a mixin object that can be merged into the `project_service`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.project_service.withTimeoutsMixin` constructs a mixin object that can be merged into the `project_service`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.project_service.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
