...
{
  '#':: d.pkg(name='bigquery_connection_iam_policy', url='', help='`bigquery_connection_iam_policy` represents the `google_bigquery_connection_iam_policy` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withConnectionId':: d.fn(help='`google.bigquery_connection_iam_policy.withConnectionId` constructs a mixin object that can be merged into the `bigquery_connection_iam_policy`\nTerraform resource block to set or update the connection_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `connection_id` field.\n', args=[]),
  ...
  '#withLocation':: d.fn(help='`google.bigquery_connection_iam_policy.withLocation` constructs a mixin object that can be merged into the `bigquery_connection_iam_policy`\nTerraform resource block to set or update the location field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `location` field.\n', args=[]),
  ...
  '#withPolicyData':: d.fn(help='`google.bigquery_connection_iam_policy.withPolicyData` constructs a mixin object that can be merged into the `bigquery_connection_iam_policy`\nTerraform resource block to set or update the policy_data field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy_data` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google.bigquery_connection_iam_policy.withProject` constructs a mixin object that can be merged into the `bigquery_connection_iam_policy`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
