...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withBucketName':: d.fn(help='`google.project_usage_export_bucket.withBucketName` constructs a mixin object that can be merged into the `project_usage_export_bucket`\nTerraform resource block to set or update the bucket_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `bucket_name` field.\n', args=[]),
  ...
  '#withPrefix':: d.fn(help='`google.project_usage_export_bucket.withPrefix` constructs a mixin object that can be merged into the `project_usage_export_bucket`\nTerraform resource block to set or update the prefix field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `prefix` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google.project_usage_export_bucket.withProject` constructs a mixin object that can be merged into the `project_usage_export_bucket`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.project_usage_export_bucket.withTimeouts` constructs a mixin object that can be merged into the `project_usage_export_bucket`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.project_usage_export_bucket.withTimeoutsMixin` constructs a mixin object that can be merged into the `project_usage_export_bucket`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.project_usage_export_bucket.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
