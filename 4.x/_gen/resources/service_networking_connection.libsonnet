...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withNetwork':: d.fn(help='`google.service_networking_connection.withNetwork` constructs a mixin object that can be merged into the `service_networking_connection`\nTerraform resource block to set or update the network field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `network` field.\n', args=[]),
  ...
  '#withReservedPeeringRanges':: d.fn(help='`google.service_networking_connection.withReservedPeeringRanges` constructs a mixin object that can be merged into the `service_networking_connection`\nTerraform resource block to set or update the reserved_peering_ranges field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `reserved_peering_ranges` field.\n', args=[]),
  ...
  '#withService':: d.fn(help='`google.service_networking_connection.withService` constructs a mixin object that can be merged into the `service_networking_connection`\nTerraform resource block to set or update the service field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `service` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.service_networking_connection.withTimeouts` constructs a mixin object that can be merged into the `service_networking_connection`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.service_networking_connection.withTimeoutsMixin` constructs a mixin object that can be merged into the `service_networking_connection`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.service_networking_connection.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
