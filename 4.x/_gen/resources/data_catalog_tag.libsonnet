...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withColumn':: d.fn(help='`google.data_catalog_tag.withColumn` constructs a mixin object that can be merged into the `data_catalog_tag`\nTerraform resource block to set or update the column field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `column` field.\n', args=[]),
  ...
  '#withFields':: d.fn(help='`google.data_catalog_tag.withFields` constructs a mixin object that can be merged into the `data_catalog_tag`\nTerraform resource block to set or update the fields field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `fields` field.\n', args=[]),
  ...
  '#withFieldsMixin':: d.fn(help='`google.data_catalog_tag.withFieldsMixin` constructs a mixin object that can be merged into the `data_catalog_tag`\nTerraform resource block to set or update the fields field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google.data_catalog_tag.withFields](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `fields` field.\n', args=[]),
  ...
  '#withParent':: d.fn(help='`google.data_catalog_tag.withParent` constructs a mixin object that can be merged into the `data_catalog_tag`\nTerraform resource block to set or update the parent field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `parent` field.\n', args=[]),
  ...
  '#withTemplate':: d.fn(help='`google.data_catalog_tag.withTemplate` constructs a mixin object that can be merged into the `data_catalog_tag`\nTerraform resource block to set or update the template field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `template` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.data_catalog_tag.withTimeouts` constructs a mixin object that can be merged into the `data_catalog_tag`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.data_catalog_tag.withTimeoutsMixin` constructs a mixin object that can be merged into the `data_catalog_tag`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.data_catalog_tag.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
