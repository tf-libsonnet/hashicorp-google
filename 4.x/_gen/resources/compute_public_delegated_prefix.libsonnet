...
{
  '#':: d.pkg(name='compute_public_delegated_prefix', url='', help='`compute_public_delegated_prefix` represents the `google_compute_public_delegated_prefix` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
