...
{
  '#':: d.pkg(name='data_catalog_entry_group_iam_member', url='', help='`data_catalog_entry_group_iam_member` represents the `google_data_catalog_entry_group_iam_member` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  condition:: {
  ...
  '#withCondition':: d.fn(help='`google.data_catalog_entry_group_iam_member.withCondition` constructs a mixin object that can be merged into the `data_catalog_entry_group_iam_member`\nTerraform resource block to set or update the condition field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `condition` field.\n', args=[]),
  ...
  '#withConditionMixin':: d.fn(help='`google.data_catalog_entry_group_iam_member.withConditionMixin` constructs a mixin object that can be merged into the `data_catalog_entry_group_iam_member`\nTerraform resource block to set or update the condition field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google.data_catalog_entry_group_iam_member.withCondition](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `condition` field.\n', args=[]),
  ...
  '#withEntryGroup':: d.fn(help='`google.data_catalog_entry_group_iam_member.withEntryGroup` constructs a mixin object that can be merged into the `data_catalog_entry_group_iam_member`\nTerraform resource block to set or update the entry_group field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `entry_group` field.\n', args=[]),
  ...
  '#withMember':: d.fn(help='`google.data_catalog_entry_group_iam_member.withMember` constructs a mixin object that can be merged into the `data_catalog_entry_group_iam_member`\nTerraform resource block to set or update the member field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `member` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google.data_catalog_entry_group_iam_member.withProject` constructs a mixin object that can be merged into the `data_catalog_entry_group_iam_member`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withRegion':: d.fn(help='`google.data_catalog_entry_group_iam_member.withRegion` constructs a mixin object that can be merged into the `data_catalog_entry_group_iam_member`\nTerraform resource block to set or update the region field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `region` field.\n', args=[]),
  ...
  '#withRole':: d.fn(help='`google.data_catalog_entry_group_iam_member.withRole` constructs a mixin object that can be merged into the `data_catalog_entry_group_iam_member`\nTerraform resource block to set or update the role field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `role` field.\n', args=[]),
