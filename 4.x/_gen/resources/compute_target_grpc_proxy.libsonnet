...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDescription':: d.fn(help='`google.compute_target_grpc_proxy.withDescription` constructs a mixin object that can be merged into the `compute_target_grpc_proxy`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`google.compute_target_grpc_proxy.withName` constructs a mixin object that can be merged into the `compute_target_grpc_proxy`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google.compute_target_grpc_proxy.withProject` constructs a mixin object that can be merged into the `compute_target_grpc_proxy`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.compute_target_grpc_proxy.withTimeouts` constructs a mixin object that can be merged into the `compute_target_grpc_proxy`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.compute_target_grpc_proxy.withTimeoutsMixin` constructs a mixin object that can be merged into the `compute_target_grpc_proxy`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.compute_target_grpc_proxy.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withUrlMap':: d.fn(help='`google.compute_target_grpc_proxy.withUrlMap` constructs a mixin object that can be merged into the `compute_target_grpc_proxy`\nTerraform resource block to set or update the url_map field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `url_map` field.\n', args=[]),
  ...
  '#withValidateForProxyless':: d.fn(help='`google.compute_target_grpc_proxy.withValidateForProxyless` constructs a mixin object that can be merged into the `compute_target_grpc_proxy`\nTerraform resource block to set or update the validate_for_proxyless field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `validate_for_proxyless` field.\n', args=[]),
