...
{
  '#':: d.pkg(name='pubsub_topic_iam_binding', url='', help='`pubsub_topic_iam_binding` represents the `google_pubsub_topic_iam_binding` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  condition:: {
  ...
  '#withCondition':: d.fn(help='`google.pubsub_topic_iam_binding.withCondition` constructs a mixin object that can be merged into the `pubsub_topic_iam_binding`\nTerraform resource block to set or update the condition field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `condition` field.\n', args=[]),
  ...
  '#withConditionMixin':: d.fn(help='`google.pubsub_topic_iam_binding.withConditionMixin` constructs a mixin object that can be merged into the `pubsub_topic_iam_binding`\nTerraform resource block to set or update the condition field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google.pubsub_topic_iam_binding.withCondition](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `condition` field.\n', args=[]),
  ...
  '#withMembers':: d.fn(help='`google.pubsub_topic_iam_binding.withMembers` constructs a mixin object that can be merged into the `pubsub_topic_iam_binding`\nTerraform resource block to set or update the members field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `members` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google.pubsub_topic_iam_binding.withProject` constructs a mixin object that can be merged into the `pubsub_topic_iam_binding`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withRole':: d.fn(help='`google.pubsub_topic_iam_binding.withRole` constructs a mixin object that can be merged into the `pubsub_topic_iam_binding`\nTerraform resource block to set or update the role field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `role` field.\n', args=[]),
  ...
  '#withTopic':: d.fn(help='`google.pubsub_topic_iam_binding.withTopic` constructs a mixin object that can be merged into the `pubsub_topic_iam_binding`\nTerraform resource block to set or update the topic field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `topic` field.\n', args=[]),
