...
{
  '#':: d.pkg(name='gke_hub_membership_iam_policy', url='', help='`gke_hub_membership_iam_policy` represents the `google_gke_hub_membership_iam_policy` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withMembershipId':: d.fn(help='`google.gke_hub_membership_iam_policy.withMembershipId` constructs a mixin object that can be merged into the `gke_hub_membership_iam_policy`\nTerraform resource block to set or update the membership_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `membership_id` field.\n', args=[]),
  ...
  '#withPolicyData':: d.fn(help='`google.gke_hub_membership_iam_policy.withPolicyData` constructs a mixin object that can be merged into the `gke_hub_membership_iam_policy`\nTerraform resource block to set or update the policy_data field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy_data` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google.gke_hub_membership_iam_policy.withProject` constructs a mixin object that can be merged into the `gke_hub_membership_iam_policy`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
