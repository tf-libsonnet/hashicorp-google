...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withExportCustomRoutes':: d.fn(help='`google.compute_network_peering_routes_config.withExportCustomRoutes` constructs a mixin object that can be merged into the `compute_network_peering_routes_config`\nTerraform resource block to set or update the export_custom_routes field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `export_custom_routes` field.\n', args=[]),
  ...
  '#withImportCustomRoutes':: d.fn(help='`google.compute_network_peering_routes_config.withImportCustomRoutes` constructs a mixin object that can be merged into the `compute_network_peering_routes_config`\nTerraform resource block to set or update the import_custom_routes field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `import_custom_routes` field.\n', args=[]),
  ...
  '#withNetwork':: d.fn(help='`google.compute_network_peering_routes_config.withNetwork` constructs a mixin object that can be merged into the `compute_network_peering_routes_config`\nTerraform resource block to set or update the network field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `network` field.\n', args=[]),
  ...
  '#withPeering':: d.fn(help='`google.compute_network_peering_routes_config.withPeering` constructs a mixin object that can be merged into the `compute_network_peering_routes_config`\nTerraform resource block to set or update the peering field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `peering` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google.compute_network_peering_routes_config.withProject` constructs a mixin object that can be merged into the `compute_network_peering_routes_config`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.compute_network_peering_routes_config.withTimeouts` constructs a mixin object that can be merged into the `compute_network_peering_routes_config`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.compute_network_peering_routes_config.withTimeoutsMixin` constructs a mixin object that can be merged into the `compute_network_peering_routes_config`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.compute_network_peering_routes_config.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
