...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  jobs:: {
    ...
    '#new':: d.fn(help='\n`google.dataproc_workflow_template.jobs.new` constructs a new object with attributes and blocks configured for the `jobs`\nTerraform sub block.\n\n\n\n**Args**:\n  - `labels` (`obj`): Optional. The labels to associate with this job. Label keys must be between 1 and 63 characters long, and must conform to the following regular expression: p{Ll}p{Lo}{0,62} Label values must be between 1 and 63 characters long, and must conform to the following regular expression: [p{Ll}p{Lo}p{N}_-]{0,63} No more than 32 labels can be associated with a given job. When `null`, the `labels` field will be omitted from the resulting object.\n  - `prerequisite_step_ids` (`list`): Optional. The optional list of prerequisite job step_ids. If not specified, the job will start at the beginning of workflow. When `null`, the `prerequisite_step_ids` field will be omitted from the resulting object.\n  - `step_id` (`string`): Required. The step id. The id must be unique among all jobs within the template. The step id is used as prefix for job id, as job `goog-dataproc-workflow-step-id` label, and in prerequisiteStepIds field from other steps. The id must contain only letters (a-z, A-Z), numbers (0-9), underscores (_), and hyphens (-). Cannot begin or end with underscore or hyphen. Must consist of between 3 and 50 characters.\n  - `hadoop_job` (`list[obj]`): Optional. Job is a Hadoop job. When `null`, the `hadoop_job` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google.dataproc_workflow_template.jobs.hadoop_job.new](#fn-jobshadoopjobnew) constructor.\n  - `hive_job` (`list[obj]`): Optional. Job is a Hive job. When `null`, the `hive_job` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google.dataproc_workflow_template.jobs.hive_job.new](#fn-jobshivejobnew) constructor.\n  - `pig_job` (`list[obj]`): Optional. Job is a Pig job. When `null`, the `pig_job` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google.dataproc_workflow_template.jobs.pig_job.new](#fn-jobspigjobnew) constructor.\n  - `presto_job` (`list[obj]`): Optional. Job is a Presto job. When `null`, the `presto_job` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google.dataproc_workflow_template.jobs.presto_job.new](#fn-jobsprestojobnew) constructor.\n  - `pyspark_job` (`list[obj]`): Optional. Job is a PySpark job. When `null`, the `pyspark_job` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google.dataproc_workflow_template.jobs.pyspark_job.new](#fn-jobspysparkjobnew) constructor.\n  - `scheduling` (`list[obj]`): Optional. Job scheduling configuration. When `null`, the `scheduling` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google.dataproc_workflow_template.jobs.scheduling.new](#fn-jobsschedulingnew) constructor.\n  - `spark_job` (`list[obj]`): Optional. Job is a Spark job. When `null`, the `spark_job` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google.dataproc_workflow_template.jobs.spark_job.new](#fn-jobssparkjobnew) constructor.\n  - `spark_r_job` (`list[obj]`): Optional. Job is a SparkR job. When `null`, the `spark_r_job` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google.dataproc_workflow_template.jobs.spark_r_job.new](#fn-jobssparkrjobnew) constructor.\n  - `spark_sql_job` (`list[obj]`): Optional. Job is a SparkSql job. When `null`, the `spark_sql_job` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google.dataproc_workflow_template.jobs.spark_sql_job.new](#fn-jobssparksqljobnew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `jobs` sub block.\n', args=[]),
    new(
      step_id,
      hadoop_job=null,
      hive_job=null,
    ...
    managed_cluster:: {
      config:: {
        ...
        worker_config:: {
          ...
          '#new':: d.fn(help='\n`google.dataproc_workflow_template.placement.managed_cluster.config.worker_config.new` constructs a new object with attributes and blocks configured for the `worker_config`\nTerraform sub block.\n\n\n\n**Args**:\n  - `image` (`string`): Optional. The Compute Engine image resource used for cluster instances. The URI can represent an image or image family. Image examples: * `https://www.googleapis.com/compute/beta/projects/[project_id]/global/images/[image-id]` * `projects/[project_id]/global/images/[image-id]` * `image-id` Image family examples. Dataproc will use the most recent image from the family: * `https://www.googleapis.com/compute/beta/projects/[project_id]/global/images/family/[custom-image-family-name]` * `projects/[project_id]/global/images/family/[custom-image-family-name]` If the URI is unspecified, it will be inferred from `SoftwareConfig.image_version` or the system default. When `null`, the `image` field will be omitted from the resulting object.\n  - `machine_type` (`string`): Optional. The Compute Engine machine type used for cluster instances. A full URL, partial URI, or short name are valid. Examples: * `https://www.googleapis.com/compute/v1/projects/[project_id]/zones/us-east1-a/machineTypes/n1-standard-2` * `projects/[project_id]/zones/us-east1-a/machineTypes/n1-standard-2` * `n1-standard-2` **Auto Zone Exception**: If you are using the Dataproc [Auto Zone Placement](https://cloud.google.com/dataproc/docs/concepts/configuring-clusters/auto-zone#using_auto_zone_placement) feature, you must use the short name of the machine type resource, for example, `n1-standard-2`. When `null`, the `machine_type` field will be omitted from the resulting object.\n  - `min_cpu_platform` (`string`): Optional. Specifies the minimum cpu platform for the Instance Group. See [Dataproc -&gt; Minimum CPU Platform](https://cloud.google.com/dataproc/docs/concepts/compute/dataproc-min-cpu). When `null`, the `min_cpu_platform` field will be omitted from the resulting object.\n  - `num_instances` (`number`): Optional. The number of VM instances in the instance group. For [HA cluster](/dataproc/docs/concepts/configuring-clusters/high-availability) [master_config](#FIELDS.master_config) groups, **must be set to 3**. For standard cluster [master_config](#FIELDS.master_config) groups, **must be set to 1**. When `null`, the `num_instances` field will be omitted from the resulting object.\n  - `preemptibility` (`string`): Optional. Specifies the preemptibility of the instance group. The default value for master and worker groups is `NON_PREEMPTIBLE`. This default cannot be changed. The default value for secondary instances is `PREEMPTIBLE`. Possible values: PREEMPTIBILITY_UNSPECIFIED, NON_PREEMPTIBLE, PREEMPTIBLE When `null`, the `preemptibility` field will be omitted from the resulting object.\n  - `accelerators` (`list[obj]`): Optional. The Compute Engine accelerator configuration for these instances. When `null`, the `accelerators` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google.dataproc_workflow_template.placement.managed_cluster.config.worker_config.accelerators.new](#fn-workerconfigacceleratorsnew) constructor.\n  - `disk_config` (`list[obj]`): Optional. Disk option config settings. When `null`, the `disk_config` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google.dataproc_workflow_template.placement.managed_cluster.config.worker_config.disk_config.new](#fn-workerconfigdiskconfignew) constructor.\n\n**Returns**:\n  - An attribute object that represents the `worker_config` sub block.\n', args=[]),
          new(
            accelerators=null,
            disk_config=null,
            image=null,
  ...
  '#withDagTimeout':: d.fn(help='`google.dataproc_workflow_template.withDagTimeout` constructs a mixin object that can be merged into the `dataproc_workflow_template`\nTerraform resource block to set or update the dag_timeout field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `dag_timeout` field.\n', args=[]),
  ...
  '#withJobs':: d.fn(help='`google.dataproc_workflow_template.withJobs` constructs a mixin object that can be merged into the `dataproc_workflow_template`\nTerraform resource block to set or update the jobs field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `jobs` field.\n', args=[]),
  ...
  '#withJobsMixin':: d.fn(help='`google.dataproc_workflow_template.withJobsMixin` constructs a mixin object that can be merged into the `dataproc_workflow_template`\nTerraform resource block to set or update the jobs field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google.dataproc_workflow_template.withJobs](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `jobs` field.\n', args=[]),
  ...
  '#withLabels':: d.fn(help='`google.dataproc_workflow_template.withLabels` constructs a mixin object that can be merged into the `dataproc_workflow_template`\nTerraform resource block to set or update the labels field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `labels` field.\n', args=[]),
  ...
  '#withLocation':: d.fn(help='`google.dataproc_workflow_template.withLocation` constructs a mixin object that can be merged into the `dataproc_workflow_template`\nTerraform resource block to set or update the location field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `location` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`google.dataproc_workflow_template.withName` constructs a mixin object that can be merged into the `dataproc_workflow_template`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withParameters':: d.fn(help='`google.dataproc_workflow_template.withParameters` constructs a mixin object that can be merged into the `dataproc_workflow_template`\nTerraform resource block to set or update the parameters field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `parameters` field.\n', args=[]),
  ...
  '#withParametersMixin':: d.fn(help='`google.dataproc_workflow_template.withParametersMixin` constructs a mixin object that can be merged into the `dataproc_workflow_template`\nTerraform resource block to set or update the parameters field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google.dataproc_workflow_template.withParameters](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `parameters` field.\n', args=[]),
  ...
  '#withPlacement':: d.fn(help='`google.dataproc_workflow_template.withPlacement` constructs a mixin object that can be merged into the `dataproc_workflow_template`\nTerraform resource block to set or update the placement field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `placement` field.\n', args=[]),
  ...
  '#withPlacementMixin':: d.fn(help='`google.dataproc_workflow_template.withPlacementMixin` constructs a mixin object that can be merged into the `dataproc_workflow_template`\nTerraform resource block to set or update the placement field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google.dataproc_workflow_template.withPlacement](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `placement` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google.dataproc_workflow_template.withProject` constructs a mixin object that can be merged into the `dataproc_workflow_template`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.dataproc_workflow_template.withTimeouts` constructs a mixin object that can be merged into the `dataproc_workflow_template`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.dataproc_workflow_template.withTimeoutsMixin` constructs a mixin object that can be merged into the `dataproc_workflow_template`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.dataproc_workflow_template.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withVersion':: d.fn(help='`google.dataproc_workflow_template.withVersion` constructs a mixin object that can be merged into the `dataproc_workflow_template`\nTerraform resource block to set or update the version field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `version` field.\n', args=[]),
