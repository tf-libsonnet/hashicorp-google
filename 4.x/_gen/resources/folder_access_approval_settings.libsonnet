...
{
  '#':: d.pkg(name='folder_access_approval_settings', url='', help='`folder_access_approval_settings` represents the `google_folder_access_approval_settings` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  enrolled_services:: {
  ...
  '#withEnrolledServicesMixin':: d.fn(help='`google.list[obj].withEnrolledServicesMixin` constructs a mixin object that can be merged into the `list[obj]`\nTerraform resource block to set or update the enrolled_services field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google.list[obj].withEnrolledServices](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list[obj]`): The value to set for the `enrolled_services` field.\n', args=[]),
