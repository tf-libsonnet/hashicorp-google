...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withMigrateTraffic':: d.fn(help='`google.app_engine_service_split_traffic.withMigrateTraffic` constructs a mixin object that can be merged into the `app_engine_service_split_traffic`\nTerraform resource block to set or update the migrate_traffic field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `migrate_traffic` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google.app_engine_service_split_traffic.withProject` constructs a mixin object that can be merged into the `app_engine_service_split_traffic`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withService':: d.fn(help='`google.app_engine_service_split_traffic.withService` constructs a mixin object that can be merged into the `app_engine_service_split_traffic`\nTerraform resource block to set or update the service field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `service` field.\n', args=[]),
  ...
  '#withSplit':: d.fn(help='`google.app_engine_service_split_traffic.withSplit` constructs a mixin object that can be merged into the `app_engine_service_split_traffic`\nTerraform resource block to set or update the split field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `split` field.\n', args=[]),
  ...
  '#withSplitMixin':: d.fn(help='`google.app_engine_service_split_traffic.withSplitMixin` constructs a mixin object that can be merged into the `app_engine_service_split_traffic`\nTerraform resource block to set or update the split field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google.app_engine_service_split_traffic.withSplit](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `split` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.app_engine_service_split_traffic.withTimeouts` constructs a mixin object that can be merged into the `app_engine_service_split_traffic`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.app_engine_service_split_traffic.withTimeoutsMixin` constructs a mixin object that can be merged into the `app_engine_service_split_traffic`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.app_engine_service_split_traffic.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
