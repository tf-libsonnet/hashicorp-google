...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDataset':: d.fn(help='`google.healthcare_consent_store.withDataset` constructs a mixin object that can be merged into the `healthcare_consent_store`\nTerraform resource block to set or update the dataset field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `dataset` field.\n', args=[]),
  ...
  '#withDefaultConsentTtl':: d.fn(help='`google.healthcare_consent_store.withDefaultConsentTtl` constructs a mixin object that can be merged into the `healthcare_consent_store`\nTerraform resource block to set or update the default_consent_ttl field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `default_consent_ttl` field.\n', args=[]),
  ...
  '#withEnableConsentCreateOnUpdate':: d.fn(help='`google.healthcare_consent_store.withEnableConsentCreateOnUpdate` constructs a mixin object that can be merged into the `healthcare_consent_store`\nTerraform resource block to set or update the enable_consent_create_on_update field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `enable_consent_create_on_update` field.\n', args=[]),
  ...
  '#withLabels':: d.fn(help='`google.healthcare_consent_store.withLabels` constructs a mixin object that can be merged into the `healthcare_consent_store`\nTerraform resource block to set or update the labels field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `labels` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`google.healthcare_consent_store.withName` constructs a mixin object that can be merged into the `healthcare_consent_store`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.healthcare_consent_store.withTimeouts` constructs a mixin object that can be merged into the `healthcare_consent_store`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.healthcare_consent_store.withTimeoutsMixin` constructs a mixin object that can be merged into the `healthcare_consent_store`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.healthcare_consent_store.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
