...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withPolicyData':: d.fn(help='`google.tags_tag_value_iam_policy.withPolicyData` constructs a mixin object that can be merged into the `tags_tag_value_iam_policy`\nTerraform resource block to set or update the policy_data field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy_data` field.\n', args=[]),
  ...
  '#withTagValue':: d.fn(help='`google.tags_tag_value_iam_policy.withTagValue` constructs a mixin object that can be merged into the `tags_tag_value_iam_policy`\nTerraform resource block to set or update the tag_value field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tag_value` field.\n', args=[]),
