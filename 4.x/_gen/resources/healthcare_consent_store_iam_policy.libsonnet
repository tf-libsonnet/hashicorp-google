...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withConsentStoreId':: d.fn(help='`google.healthcare_consent_store_iam_policy.withConsentStoreId` constructs a mixin object that can be merged into the `healthcare_consent_store_iam_policy`\nTerraform resource block to set or update the consent_store_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `consent_store_id` field.\n', args=[]),
  ...
  '#withDataset':: d.fn(help='`google.healthcare_consent_store_iam_policy.withDataset` constructs a mixin object that can be merged into the `healthcare_consent_store_iam_policy`\nTerraform resource block to set or update the dataset field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `dataset` field.\n', args=[]),
  ...
  '#withPolicyData':: d.fn(help='`google.healthcare_consent_store_iam_policy.withPolicyData` constructs a mixin object that can be merged into the `healthcare_consent_store_iam_policy`\nTerraform resource block to set or update the policy_data field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy_data` field.\n', args=[]),
