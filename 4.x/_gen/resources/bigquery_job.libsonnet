...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#new':: d.fn(help="\n`google.bigquery_job.new` injects a new `google_bigquery_job` Terraform `resource`\nblock into the root module document.\n\nAdditionally, this inserts a private function into the `_ref` attribute that generates references to attributes of the\nresource. For example, if you added a new instance to the root using:\n\n    # arguments omitted for brevity\n    google.bigquery_job.new('some_id')\n\nYou can get the reference to the `id` field of the created `google.bigquery_job` using the reference:\n\n    $._ref.google_bigquery_job.some_id.get('id')\n\nThis is the same as directly entering `\"${ google_bigquery_job.some_id.id }\"` as the value.\n\nNOTE: if you are chaining multiple resources together in a merge operation, you may not be able to use `super`, `self`,\nor `$` to refer to the root object. Instead, make an explicit outer object using `local`.\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block.\n  - `job_id` (`string`): The ID of the job. The ID must contain only letters (a-z, A-Z), numbers (0-9), underscores (_), or dashes (-). The maximum length is 1,024 characters.\n  - `job_timeout_ms` (`string`): Job timeout in milliseconds. If this time limit is exceeded, BigQuery may attempt to terminate the job. When `null`, the `job_timeout_ms` field will be omitted from the resulting object.\n  - `labels` (`obj`): The labels associated with this job. You can use these to organize and group your jobs. When `null`, the `labels` field will be omitted from the resulting object.\n  - `location` (`string`): The geographic location of the job. The default value is US. When `null`, the `location` field will be omitted from the resulting object.\n  - `project` (`string`):  When `null`, the `project` field will be omitted from the resulting object.\n  - `copy` (`list[obj]`): Copies a table. When `null`, the `copy` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google.bigquery_job.copy.new](#fn-bigqueryjobcopynew) constructor.\n  - `extract` (`list[obj]`): Configures an extract job. When `null`, the `extract` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google.bigquery_job.extract.new](#fn-bigqueryjobextractnew) constructor.\n  - `load` (`list[obj]`): Configures a load job. When `null`, the `load` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google.bigquery_job.load.new](#fn-bigqueryjobloadnew) constructor.\n  - `query` (`list[obj]`): Configures a query job. When `null`, the `query` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google.bigquery_job.query.new](#fn-bigqueryjobquerynew) constructor.\n  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google.bigquery_job.timeouts.new](#fn-bigqueryjobtimeoutsnew) constructor.\n\n**Returns**:\n- A mixin object that injects the new resource into the root Terraform configuration.\n", args=[]),
  new(
    resourceLabel,
    job_id,
    copy=null,
  ...
  '#withCopy':: d.fn(help='`google.bigquery_job.withCopy` constructs a mixin object that can be merged into the `bigquery_job`\nTerraform resource block to set or update the copy field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `copy` field.\n', args=[]),
  ...
  '#withCopyMixin':: d.fn(help='`google.bigquery_job.withCopyMixin` constructs a mixin object that can be merged into the `bigquery_job`\nTerraform resource block to set or update the copy field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google.bigquery_job.withCopy](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `copy` field.\n', args=[]),
  ...
  '#withExtract':: d.fn(help='`google.bigquery_job.withExtract` constructs a mixin object that can be merged into the `bigquery_job`\nTerraform resource block to set or update the extract field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `extract` field.\n', args=[]),
  ...
  '#withExtractMixin':: d.fn(help='`google.bigquery_job.withExtractMixin` constructs a mixin object that can be merged into the `bigquery_job`\nTerraform resource block to set or update the extract field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google.bigquery_job.withExtract](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `extract` field.\n', args=[]),
  ...
  '#withJobId':: d.fn(help='`google.bigquery_job.withJobId` constructs a mixin object that can be merged into the `bigquery_job`\nTerraform resource block to set or update the job_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `job_id` field.\n', args=[]),
  ...
  '#withJobTimeoutMs':: d.fn(help='`google.bigquery_job.withJobTimeoutMs` constructs a mixin object that can be merged into the `bigquery_job`\nTerraform resource block to set or update the job_timeout_ms field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `job_timeout_ms` field.\n', args=[]),
  ...
  '#withLabels':: d.fn(help='`google.bigquery_job.withLabels` constructs a mixin object that can be merged into the `bigquery_job`\nTerraform resource block to set or update the labels field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `labels` field.\n', args=[]),
  ...
  '#withLoad':: d.fn(help='`google.bigquery_job.withLoad` constructs a mixin object that can be merged into the `bigquery_job`\nTerraform resource block to set or update the load field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `load` field.\n', args=[]),
  ...
  '#withLoadMixin':: d.fn(help='`google.bigquery_job.withLoadMixin` constructs a mixin object that can be merged into the `bigquery_job`\nTerraform resource block to set or update the load field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google.bigquery_job.withLoad](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `load` field.\n', args=[]),
  ...
  '#withLocation':: d.fn(help='`google.bigquery_job.withLocation` constructs a mixin object that can be merged into the `bigquery_job`\nTerraform resource block to set or update the location field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `location` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google.bigquery_job.withProject` constructs a mixin object that can be merged into the `bigquery_job`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withQuery':: d.fn(help='`google.bigquery_job.withQuery` constructs a mixin object that can be merged into the `bigquery_job`\nTerraform resource block to set or update the query field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `query` field.\n', args=[]),
  ...
  '#withQueryMixin':: d.fn(help='`google.bigquery_job.withQueryMixin` constructs a mixin object that can be merged into the `bigquery_job`\nTerraform resource block to set or update the query field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google.bigquery_job.withQuery](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `query` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.bigquery_job.withTimeouts` constructs a mixin object that can be merged into the `bigquery_job`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.bigquery_job.withTimeoutsMixin` constructs a mixin object that can be merged into the `bigquery_job`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.bigquery_job.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
