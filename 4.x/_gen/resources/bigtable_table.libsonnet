...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withColumnFamily':: d.fn(help='`google.bigtable_table.withColumnFamily` constructs a mixin object that can be merged into the `bigtable_table`\nTerraform resource block to set or update the column_family field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `column_family` field.\n', args=[]),
  ...
  '#withColumnFamilyMixin':: d.fn(help='`google.bigtable_table.withColumnFamilyMixin` constructs a mixin object that can be merged into the `bigtable_table`\nTerraform resource block to set or update the column_family field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google.bigtable_table.withColumnFamily](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `column_family` field.\n', args=[]),
  ...
  '#withInstanceName':: d.fn(help='`google.bigtable_table.withInstanceName` constructs a mixin object that can be merged into the `bigtable_table`\nTerraform resource block to set or update the instance_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `instance_name` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`google.bigtable_table.withName` constructs a mixin object that can be merged into the `bigtable_table`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google.bigtable_table.withProject` constructs a mixin object that can be merged into the `bigtable_table`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withSplitKeys':: d.fn(help='`google.bigtable_table.withSplitKeys` constructs a mixin object that can be merged into the `bigtable_table`\nTerraform resource block to set or update the split_keys field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `split_keys` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.bigtable_table.withTimeouts` constructs a mixin object that can be merged into the `bigtable_table`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.bigtable_table.withTimeoutsMixin` constructs a mixin object that can be merged into the `bigtable_table`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.bigtable_table.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
