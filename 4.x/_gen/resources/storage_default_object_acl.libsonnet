...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withBucket':: d.fn(help='`google.storage_default_object_acl.withBucket` constructs a mixin object that can be merged into the `storage_default_object_acl`\nTerraform resource block to set or update the bucket field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `bucket` field.\n', args=[]),
  ...
  '#withRoleEntity':: d.fn(help='`google.storage_default_object_acl.withRoleEntity` constructs a mixin object that can be merged into the `storage_default_object_acl`\nTerraform resource block to set or update the role_entity field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `role_entity` field.\n', args=[]),
