...
{
  '#':: d.pkg(name='eventarc_channel', url='', help='`eventarc_channel` represents the `google_eventarc_channel` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withCryptoKeyName':: d.fn(help='`google.eventarc_channel.withCryptoKeyName` constructs a mixin object that can be merged into the `eventarc_channel`\nTerraform resource block to set or update the crypto_key_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `crypto_key_name` field.\n', args=[]),
  ...
  '#withLocation':: d.fn(help='`google.eventarc_channel.withLocation` constructs a mixin object that can be merged into the `eventarc_channel`\nTerraform resource block to set or update the location field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `location` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`google.eventarc_channel.withName` constructs a mixin object that can be merged into the `eventarc_channel`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google.eventarc_channel.withProject` constructs a mixin object that can be merged into the `eventarc_channel`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withThirdPartyProvider':: d.fn(help='`google.eventarc_channel.withThirdPartyProvider` constructs a mixin object that can be merged into the `eventarc_channel`\nTerraform resource block to set or update the third_party_provider field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `third_party_provider` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.eventarc_channel.withTimeouts` constructs a mixin object that can be merged into the `eventarc_channel`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.eventarc_channel.withTimeoutsMixin` constructs a mixin object that can be merged into the `eventarc_channel`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.eventarc_channel.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
