...
{
  '#':: d.pkg(name='dialogflow_cx_version', url='', help='`dialogflow_cx_version` represents the `google_dialogflow_cx_version` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withDescription':: d.fn(help='`google.dialogflow_cx_version.withDescription` constructs a mixin object that can be merged into the `dialogflow_cx_version`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withDisplayName':: d.fn(help='`google.dialogflow_cx_version.withDisplayName` constructs a mixin object that can be merged into the `dialogflow_cx_version`\nTerraform resource block to set or update the display_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `display_name` field.\n', args=[]),
  ...
  '#withParent':: d.fn(help='`google.dialogflow_cx_version.withParent` constructs a mixin object that can be merged into the `dialogflow_cx_version`\nTerraform resource block to set or update the parent field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `parent` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.dialogflow_cx_version.withTimeouts` constructs a mixin object that can be merged into the `dialogflow_cx_version`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.dialogflow_cx_version.withTimeoutsMixin` constructs a mixin object that can be merged into the `dialogflow_cx_version`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.dialogflow_cx_version.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
