...
{
  '#':: d.pkg(name='compute_ssl_certificate', url='', help='`compute_ssl_certificate` represents the `google_compute_ssl_certificate` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withCertificate':: d.fn(help='`google.compute_ssl_certificate.withCertificate` constructs a mixin object that can be merged into the `compute_ssl_certificate`\nTerraform resource block to set or update the certificate field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `certificate` field.\n', args=[]),
  ...
  '#withDescription':: d.fn(help='`google.compute_ssl_certificate.withDescription` constructs a mixin object that can be merged into the `compute_ssl_certificate`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`google.compute_ssl_certificate.withName` constructs a mixin object that can be merged into the `compute_ssl_certificate`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withNamePrefix':: d.fn(help='`google.compute_ssl_certificate.withNamePrefix` constructs a mixin object that can be merged into the `compute_ssl_certificate`\nTerraform resource block to set or update the name_prefix field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name_prefix` field.\n', args=[]),
  ...
  '#withPrivateKey':: d.fn(help='`google.compute_ssl_certificate.withPrivateKey` constructs a mixin object that can be merged into the `compute_ssl_certificate`\nTerraform resource block to set or update the private_key field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `private_key` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google.compute_ssl_certificate.withProject` constructs a mixin object that can be merged into the `compute_ssl_certificate`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.compute_ssl_certificate.withTimeouts` constructs a mixin object that can be merged into the `compute_ssl_certificate`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.compute_ssl_certificate.withTimeoutsMixin` constructs a mixin object that can be merged into the `compute_ssl_certificate`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.compute_ssl_certificate.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
