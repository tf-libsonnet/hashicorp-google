...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDescription':: d.fn(help='`google.vertex_ai_featurestore_entitytype_feature.withDescription` constructs a mixin object that can be merged into the `vertex_ai_featurestore_entitytype_feature`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withEntitytype':: d.fn(help='`google.vertex_ai_featurestore_entitytype_feature.withEntitytype` constructs a mixin object that can be merged into the `vertex_ai_featurestore_entitytype_feature`\nTerraform resource block to set or update the entitytype field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `entitytype` field.\n', args=[]),
  ...
  '#withLabels':: d.fn(help='`google.vertex_ai_featurestore_entitytype_feature.withLabels` constructs a mixin object that can be merged into the `vertex_ai_featurestore_entitytype_feature`\nTerraform resource block to set or update the labels field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `labels` field.\n', args=[]),
  ...
  '#withName':: d.fn(help='`google.vertex_ai_featurestore_entitytype_feature.withName` constructs a mixin object that can be merged into the `vertex_ai_featurestore_entitytype_feature`\nTerraform resource block to set or update the name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `name` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.vertex_ai_featurestore_entitytype_feature.withTimeouts` constructs a mixin object that can be merged into the `vertex_ai_featurestore_entitytype_feature`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.vertex_ai_featurestore_entitytype_feature.withTimeoutsMixin` constructs a mixin object that can be merged into the `vertex_ai_featurestore_entitytype_feature`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.vertex_ai_featurestore_entitytype_feature.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withValueType':: d.fn(help='`google.vertex_ai_featurestore_entitytype_feature.withValueType` constructs a mixin object that can be merged into the `vertex_ai_featurestore_entitytype_feature`\nTerraform resource block to set or update the value_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `value_type` field.\n', args=[]),
