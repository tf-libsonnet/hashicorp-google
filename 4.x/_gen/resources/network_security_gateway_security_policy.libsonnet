...
{
  '#':: d.pkg(name='network_security_gateway_security_policy', url='', help='`network_security_gateway_security_policy` represents the `google_network_security_gateway_security_policy` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
