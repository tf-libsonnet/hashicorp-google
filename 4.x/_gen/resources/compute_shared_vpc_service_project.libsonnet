...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withHostProject':: d.fn(help='`google.compute_shared_vpc_service_project.withHostProject` constructs a mixin object that can be merged into the `compute_shared_vpc_service_project`\nTerraform resource block to set or update the host_project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `host_project` field.\n', args=[]),
  ...
  '#withServiceProject':: d.fn(help='`google.compute_shared_vpc_service_project.withServiceProject` constructs a mixin object that can be merged into the `compute_shared_vpc_service_project`\nTerraform resource block to set or update the service_project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `service_project` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.compute_shared_vpc_service_project.withTimeouts` constructs a mixin object that can be merged into the `compute_shared_vpc_service_project`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.compute_shared_vpc_service_project.withTimeoutsMixin` constructs a mixin object that can be merged into the `compute_shared_vpc_service_project`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.compute_shared_vpc_service_project.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
