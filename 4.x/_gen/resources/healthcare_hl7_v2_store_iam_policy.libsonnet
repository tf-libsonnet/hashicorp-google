...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withHl7V2StoreId':: d.fn(help='`google.healthcare_hl7_v2_store_iam_policy.withHl7V2StoreId` constructs a mixin object that can be merged into the `healthcare_hl7_v2_store_iam_policy`\nTerraform resource block to set or update the hl7_v2_store_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `hl7_v2_store_id` field.\n', args=[]),
  ...
  '#withPolicyData':: d.fn(help='`google.healthcare_hl7_v2_store_iam_policy.withPolicyData` constructs a mixin object that can be merged into the `healthcare_hl7_v2_store_iam_policy`\nTerraform resource block to set or update the policy_data field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy_data` field.\n', args=[]),
