...
{
  '#':: d.pkg(name='storage_object_acl', url='', help='`storage_object_acl` represents the `google_storage_object_acl` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withBucket':: d.fn(help='`google.storage_object_acl.withBucket` constructs a mixin object that can be merged into the `storage_object_acl`\nTerraform resource block to set or update the bucket field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `bucket` field.\n', args=[]),
  ...
  '#withObject':: d.fn(help='`google.storage_object_acl.withObject` constructs a mixin object that can be merged into the `storage_object_acl`\nTerraform resource block to set or update the object field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `object` field.\n', args=[]),
  ...
  '#withPredefinedAcl':: d.fn(help='`google.storage_object_acl.withPredefinedAcl` constructs a mixin object that can be merged into the `storage_object_acl`\nTerraform resource block to set or update the predefined_acl field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `predefined_acl` field.\n', args=[]),
  ...
  '#withRoleEntity':: d.fn(help='`google.storage_object_acl.withRoleEntity` constructs a mixin object that can be merged into the `storage_object_acl`\nTerraform resource block to set or update the role_entity field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `role_entity` field.\n', args=[]),
