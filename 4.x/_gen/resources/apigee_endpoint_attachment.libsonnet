...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withEndpointAttachmentId':: d.fn(help='`google.apigee_endpoint_attachment.withEndpointAttachmentId` constructs a mixin object that can be merged into the `apigee_endpoint_attachment`\nTerraform resource block to set or update the endpoint_attachment_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `endpoint_attachment_id` field.\n', args=[]),
  ...
  '#withLocation':: d.fn(help='`google.apigee_endpoint_attachment.withLocation` constructs a mixin object that can be merged into the `apigee_endpoint_attachment`\nTerraform resource block to set or update the location field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `location` field.\n', args=[]),
  ...
  '#withOrgId':: d.fn(help='`google.apigee_endpoint_attachment.withOrgId` constructs a mixin object that can be merged into the `apigee_endpoint_attachment`\nTerraform resource block to set or update the org_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `org_id` field.\n', args=[]),
  ...
  '#withServiceAttachment':: d.fn(help='`google.apigee_endpoint_attachment.withServiceAttachment` constructs a mixin object that can be merged into the `apigee_endpoint_attachment`\nTerraform resource block to set or update the service_attachment field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `service_attachment` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.apigee_endpoint_attachment.withTimeouts` constructs a mixin object that can be merged into the `apigee_endpoint_attachment`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.apigee_endpoint_attachment.withTimeoutsMixin` constructs a mixin object that can be merged into the `apigee_endpoint_attachment`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.apigee_endpoint_attachment.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
