...
{
  '#':: d.pkg(name='storage_object_access_control', url='', help='`storage_object_access_control` represents the `google_storage_object_access_control` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withBucket':: d.fn(help='`google.storage_object_access_control.withBucket` constructs a mixin object that can be merged into the `storage_object_access_control`\nTerraform resource block to set or update the bucket field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `bucket` field.\n', args=[]),
  ...
  '#withEntity':: d.fn(help='`google.storage_object_access_control.withEntity` constructs a mixin object that can be merged into the `storage_object_access_control`\nTerraform resource block to set or update the entity field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `entity` field.\n', args=[]),
  ...
  '#withObject':: d.fn(help='`google.storage_object_access_control.withObject` constructs a mixin object that can be merged into the `storage_object_access_control`\nTerraform resource block to set or update the object field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `object` field.\n', args=[]),
  ...
  '#withRole':: d.fn(help='`google.storage_object_access_control.withRole` constructs a mixin object that can be merged into the `storage_object_access_control`\nTerraform resource block to set or update the role field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `role` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.storage_object_access_control.withTimeouts` constructs a mixin object that can be merged into the `storage_object_access_control`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.storage_object_access_control.withTimeoutsMixin` constructs a mixin object that can be merged into the `storage_object_access_control`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.storage_object_access_control.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
