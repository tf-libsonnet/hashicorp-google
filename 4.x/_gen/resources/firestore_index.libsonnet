...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCollection':: d.fn(help='`google.firestore_index.withCollection` constructs a mixin object that can be merged into the `firestore_index`\nTerraform resource block to set or update the collection field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `collection` field.\n', args=[]),
  ...
  '#withDatabase':: d.fn(help='`google.firestore_index.withDatabase` constructs a mixin object that can be merged into the `firestore_index`\nTerraform resource block to set or update the database field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `database` field.\n', args=[]),
  ...
  '#withFields':: d.fn(help='`google.firestore_index.withFields` constructs a mixin object that can be merged into the `firestore_index`\nTerraform resource block to set or update the fields field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `fields` field.\n', args=[]),
  ...
  '#withFieldsMixin':: d.fn(help='`google.firestore_index.withFieldsMixin` constructs a mixin object that can be merged into the `firestore_index`\nTerraform resource block to set or update the fields field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google.firestore_index.withFields](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `fields` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google.firestore_index.withProject` constructs a mixin object that can be merged into the `firestore_index`\nTerraform resource block to set or update the project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withQueryScope':: d.fn(help='`google.firestore_index.withQueryScope` constructs a mixin object that can be merged into the `firestore_index`\nTerraform resource block to set or update the query_scope field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `query_scope` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.firestore_index.withTimeouts` constructs a mixin object that can be merged into the `firestore_index`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.firestore_index.withTimeoutsMixin` constructs a mixin object that can be merged into the `firestore_index`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.firestore_index.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
