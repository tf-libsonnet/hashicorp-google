...
{
  '#':: d.pkg(name='endpoints_service_consumers_iam_policy', url='', help='`endpoints_service_consumers_iam_policy` represents the `google_endpoints_service_consumers_iam_policy` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withConsumerProject':: d.fn(help='`google.endpoints_service_consumers_iam_policy.withConsumerProject` constructs a mixin object that can be merged into the `endpoints_service_consumers_iam_policy`\nTerraform resource block to set or update the consumer_project field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `consumer_project` field.\n', args=[]),
  ...
  '#withPolicyData':: d.fn(help='`google.endpoints_service_consumers_iam_policy.withPolicyData` constructs a mixin object that can be merged into the `endpoints_service_consumers_iam_policy`\nTerraform resource block to set or update the policy_data field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `policy_data` field.\n', args=[]),
  ...
  '#withServiceName':: d.fn(help='`google.endpoints_service_consumers_iam_policy.withServiceName` constructs a mixin object that can be merged into the `endpoints_service_consumers_iam_policy`\nTerraform resource block to set or update the service_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `service_name` field.\n', args=[]),
