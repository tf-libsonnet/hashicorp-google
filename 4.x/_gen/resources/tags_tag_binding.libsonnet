...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withParent':: d.fn(help='`google.tags_tag_binding.withParent` constructs a mixin object that can be merged into the `tags_tag_binding`\nTerraform resource block to set or update the parent field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `parent` field.\n', args=[]),
  ...
  '#withTagValue':: d.fn(help='`google.tags_tag_binding.withTagValue` constructs a mixin object that can be merged into the `tags_tag_binding`\nTerraform resource block to set or update the tag_value field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `tag_value` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.tags_tag_binding.withTimeouts` constructs a mixin object that can be merged into the `tags_tag_binding`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.tags_tag_binding.withTimeoutsMixin` constructs a mixin object that can be merged into the `tags_tag_binding`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.tags_tag_binding.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
