...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCustomFeatures':: d.fn(help='`google.compute_ssl_policy.withCustomFeatures` constructs a mixin object that can be merged into the `compute_ssl_policy`\nTerraform resource block to set or update the custom_features field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `custom_features` field.\n', args=[]),
  ...
  '#withDescription':: d.fn(help='`google.compute_ssl_policy.withDescription` constructs a mixin object that can be merged into the `compute_ssl_policy`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withMinTlsVersion':: d.fn(help='`google.compute_ssl_policy.withMinTlsVersion` constructs a mixin object that can be merged into the `compute_ssl_policy`\nTerraform resource block to set or update the min_tls_version field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `min_tls_version` field.\n', args=[]),
  ...
  '#withProfile':: d.fn(help='`google.compute_ssl_policy.withProfile` constructs a mixin object that can be merged into the `compute_ssl_policy`\nTerraform resource block to set or update the profile field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `profile` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`google.compute_ssl_policy.withTimeouts` constructs a mixin object that can be merged into the `compute_ssl_policy`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`google.compute_ssl_policy.withTimeoutsMixin` constructs a mixin object that can be merged into the `compute_ssl_policy`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [google.compute_ssl_policy.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
