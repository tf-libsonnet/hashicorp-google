...
{
  '#':: d.pkg(name='secret_manager_secret_version_access', url='', help='`secret_manager_secret_version_access` represents the `google_secret_manager_secret_version_access` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
