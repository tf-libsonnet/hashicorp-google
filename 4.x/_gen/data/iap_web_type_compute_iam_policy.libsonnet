...
{
  '#':: d.pkg(name='iap_web_type_compute_iam_policy', url='', help='`iap_web_type_compute_iam_policy` represents the `google_iap_web_type_compute_iam_policy` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
