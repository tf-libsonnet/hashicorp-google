...
{
  '#':: d.pkg(name='vmwareengine_nsx_credentials', url='', help='`vmwareengine_nsx_credentials` represents the `google_vmwareengine_nsx_credentials` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
