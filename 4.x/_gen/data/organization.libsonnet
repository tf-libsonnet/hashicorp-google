...
{
  '#':: d.pkg(name='organization', url='', help='`organization` represents the `google_organization` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withOrganization':: d.fn(help='`google.organization.withOrganization` constructs a mixin object that can be merged into the `organization`\nTerraform data source block to set or update the organization field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `organization` field.\n', args=[]),
