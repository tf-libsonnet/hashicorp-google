...
{
  '#':: d.pkg(name='secure_source_manager_instance_iam_policy', url='', help='`secure_source_manager_instance_iam_policy` represents the `google_secure_source_manager_instance_iam_policy` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
