...
{
  '#':: d.pkg(name='sql_backup_run', url='', help='`sql_backup_run` represents the `google_sql_backup_run` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withBackupId':: d.fn(help='`google.sql_backup_run.withBackupId` constructs a mixin object that can be merged into the `sql_backup_run`\nTerraform data source block to set or update the backup_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `backup_id` field.\n', args=[]),
  ...
  '#withInstance':: d.fn(help='`google.sql_backup_run.withInstance` constructs a mixin object that can be merged into the `sql_backup_run`\nTerraform data source block to set or update the instance field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `instance` field.\n', args=[]),
  ...
  '#withMostRecent':: d.fn(help='`google.sql_backup_run.withMostRecent` constructs a mixin object that can be merged into the `sql_backup_run`\nTerraform data source block to set or update the most_recent field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `most_recent` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google.sql_backup_run.withProject` constructs a mixin object that can be merged into the `sql_backup_run`\nTerraform data source block to set or update the project field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
