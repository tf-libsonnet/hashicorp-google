...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCustomSupportLevel':: d.fn(help='`google.iam_testable_permissions.withCustomSupportLevel` constructs a mixin object that can be merged into the `iam_testable_permissions`\nTerraform data source block to set or update the custom_support_level field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `custom_support_level` field.\n', args=[]),
  ...
  '#withFullResourceName':: d.fn(help='`google.iam_testable_permissions.withFullResourceName` constructs a mixin object that can be merged into the `iam_testable_permissions`\nTerraform data source block to set or update the full_resource_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `full_resource_name` field.\n', args=[]),
  ...
  '#withStages':: d.fn(help='`google.iam_testable_permissions.withStages` constructs a mixin object that can be merged into the `iam_testable_permissions`\nTerraform data source block to set or update the stages field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `stages` field.\n', args=[]),
