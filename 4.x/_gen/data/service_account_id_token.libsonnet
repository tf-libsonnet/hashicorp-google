...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDelegates':: d.fn(help='`google.service_account_id_token.withDelegates` constructs a mixin object that can be merged into the `service_account_id_token`\nTerraform data source block to set or update the delegates field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `delegates` field.\n', args=[]),
  ...
  '#withIncludeEmail':: d.fn(help='`google.service_account_id_token.withIncludeEmail` constructs a mixin object that can be merged into the `service_account_id_token`\nTerraform data source block to set or update the include_email field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `include_email` field.\n', args=[]),
  ...
  '#withTargetAudience':: d.fn(help='`google.service_account_id_token.withTargetAudience` constructs a mixin object that can be merged into the `service_account_id_token`\nTerraform data source block to set or update the target_audience field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `target_audience` field.\n', args=[]),
  ...
  '#withTargetServiceAccount':: d.fn(help='`google.service_account_id_token.withTargetServiceAccount` constructs a mixin object that can be merged into the `service_account_id_token`\nTerraform data source block to set or update the target_service_account field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `target_service_account` field.\n', args=[]),
