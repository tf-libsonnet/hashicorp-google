...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withClusterName':: d.fn(help='`google.monitoring_cluster_istio_service.withClusterName` constructs a mixin object that can be merged into the `monitoring_cluster_istio_service`\nTerraform data source block to set or update the cluster_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `cluster_name` field.\n', args=[]),
  ...
  '#withLocation':: d.fn(help='`google.monitoring_cluster_istio_service.withLocation` constructs a mixin object that can be merged into the `monitoring_cluster_istio_service`\nTerraform data source block to set or update the location field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `location` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google.monitoring_cluster_istio_service.withProject` constructs a mixin object that can be merged into the `monitoring_cluster_istio_service`\nTerraform data source block to set or update the project field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withServiceName':: d.fn(help='`google.monitoring_cluster_istio_service.withServiceName` constructs a mixin object that can be merged into the `monitoring_cluster_istio_service`\nTerraform data source block to set or update the service_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `service_name` field.\n', args=[]),
  ...
  '#withServiceNamespace':: d.fn(help='`google.monitoring_cluster_istio_service.withServiceNamespace` constructs a mixin object that can be merged into the `monitoring_cluster_istio_service`\nTerraform data source block to set or update the service_namespace field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `service_namespace` field.\n', args=[]),
