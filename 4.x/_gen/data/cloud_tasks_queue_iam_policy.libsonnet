...
{
  '#':: d.pkg(name='cloud_tasks_queue_iam_policy', url='', help='`cloud_tasks_queue_iam_policy` represents the `google_cloud_tasks_queue_iam_policy` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
