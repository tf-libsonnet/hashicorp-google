...
{
  '#':: d.pkg(name='cloud_identity_groups', url='', help='`cloud_identity_groups` represents the `google_cloud_identity_groups` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withParent':: d.fn(help='`google.cloud_identity_groups.withParent` constructs a mixin object that can be merged into the `cloud_identity_groups`\nTerraform data source block to set or update the parent field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `parent` field.\n', args=[]),
