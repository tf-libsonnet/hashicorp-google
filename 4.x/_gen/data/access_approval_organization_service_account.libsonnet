...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withOrganizationId':: d.fn(help='`google.access_approval_organization_service_account.withOrganizationId` constructs a mixin object that can be merged into the `access_approval_organization_service_account`\nTerraform data source block to set or update the organization_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `organization_id` field.\n', args=[]),
