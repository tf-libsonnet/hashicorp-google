...
{
  '#':: d.pkg(name='storage_project_service_account', url='', help='`storage_project_service_account` represents the `google_storage_project_service_account` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withProject':: d.fn(help='`google.storage_project_service_account.withProject` constructs a mixin object that can be merged into the `storage_project_service_account`\nTerraform data source block to set or update the project field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withUserProject':: d.fn(help='`google.storage_project_service_account.withUserProject` constructs a mixin object that can be merged into the `storage_project_service_account`\nTerraform data source block to set or update the user_project field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `user_project` field.\n', args=[]),
