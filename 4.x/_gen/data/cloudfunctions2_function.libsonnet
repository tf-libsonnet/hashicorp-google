...
{
  '#':: d.pkg(name='cloudfunctions2_function', url='', help='`cloudfunctions2_function` represents the `google_cloudfunctions2_function` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
