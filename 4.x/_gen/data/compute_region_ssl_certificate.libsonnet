...
{
  '#':: d.pkg(name='compute_region_ssl_certificate', url='', help='`compute_region_ssl_certificate` represents the `google_compute_region_ssl_certificate` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
