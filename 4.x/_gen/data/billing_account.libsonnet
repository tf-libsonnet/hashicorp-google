...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withBillingAccount':: d.fn(help='`google.billing_account.withBillingAccount` constructs a mixin object that can be merged into the `billing_account`\nTerraform data source block to set or update the billing_account field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `billing_account` field.\n', args=[]),
  ...
  '#withDisplayName':: d.fn(help='`google.billing_account.withDisplayName` constructs a mixin object that can be merged into the `billing_account`\nTerraform data source block to set or update the display_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `display_name` field.\n', args=[]),
  ...
  '#withOpen':: d.fn(help='`google.billing_account.withOpen` constructs a mixin object that can be merged into the `billing_account`\nTerraform data source block to set or update the open field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `open` field.\n', args=[]),
