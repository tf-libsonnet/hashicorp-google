...
{
  '#':: d.pkg(name='service_account', url='', help='`service_account` represents the `google_service_account` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
