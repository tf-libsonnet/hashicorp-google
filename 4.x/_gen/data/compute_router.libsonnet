...
{
  '#':: d.pkg(name='compute_router', url='', help='`compute_router` represents the `google_compute_router` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
