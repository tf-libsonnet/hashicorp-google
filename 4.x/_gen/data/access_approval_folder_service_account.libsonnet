...
{
  '#':: d.pkg(name='access_approval_folder_service_account', url='', help='`access_approval_folder_service_account` represents the `google_access_approval_folder_service_account` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withFolderId':: d.fn(help='`google.access_approval_folder_service_account.withFolderId` constructs a mixin object that can be merged into the `access_approval_folder_service_account`\nTerraform data source block to set or update the folder_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `folder_id` field.\n', args=[]),
