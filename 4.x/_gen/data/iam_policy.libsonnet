...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAuditConfigMixin':: d.fn(help='`google.iam_policy.withAuditConfigMixin` constructs a mixin object that can be merged into the `iam_policy`\nTerraform data source block to set or update the audit_config field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google.iam_policy.withAuditConfig](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `audit_config` field.\n', args=[]),
  ...
  '#withBinding':: d.fn(help='`google.iam_policy.withBinding` constructs a mixin object that can be merged into the `iam_policy`\nTerraform data source block to set or update the binding field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `binding` field.\n', args=[]),
  ...
  '#withBindingMixin':: d.fn(help='`google.iam_policy.withBindingMixin` constructs a mixin object that can be merged into the `iam_policy`\nTerraform data source block to set or update the binding field.\n\nThis function will append the passed in array or object to the existing array. If you wish\nto instead replace the array with the passed in `value`, use the [google.iam_policy.withBinding](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `binding` field.\n', args=[]),
