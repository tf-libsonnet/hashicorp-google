...
{
  '#':: d.pkg(name='cloudfunctions_function', url='', help='`cloudfunctions_function` represents the `google_cloudfunctions_function` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
