...
{
  '#':: d.pkg(name='compute_zones', url='', help='`compute_zones` represents the `google_compute_zones` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withProject':: d.fn(help='`google.compute_zones.withProject` constructs a mixin object that can be merged into the `compute_zones`\nTerraform data source block to set or update the project field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withRegion':: d.fn(help='`google.compute_zones.withRegion` constructs a mixin object that can be merged into the `compute_zones`\nTerraform data source block to set or update the region field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `region` field.\n', args=[]),
  ...
  '#withStatus':: d.fn(help='`google.compute_zones.withStatus` constructs a mixin object that can be merged into the `compute_zones`\nTerraform data source block to set or update the status field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `status` field.\n', args=[]),
