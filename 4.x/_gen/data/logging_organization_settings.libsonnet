...
{
  '#':: d.pkg(name='logging_organization_settings', url='', help='`logging_organization_settings` represents the `google_logging_organization_settings` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
