...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDelegates':: d.fn(help='`google.service_account_jwt.withDelegates` constructs a mixin object that can be merged into the `service_account_jwt`\nTerraform data source block to set or update the delegates field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `delegates` field.\n', args=[]),
  ...
  '#withExpiresIn':: d.fn(help='`google.service_account_jwt.withExpiresIn` constructs a mixin object that can be merged into the `service_account_jwt`\nTerraform data source block to set or update the expires_in field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `expires_in` field.\n', args=[]),
  ...
  '#withPayload':: d.fn(help='`google.service_account_jwt.withPayload` constructs a mixin object that can be merged into the `service_account_jwt`\nTerraform data source block to set or update the payload field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `payload` field.\n', args=[]),
  ...
  '#withTargetServiceAccount':: d.fn(help='`google.service_account_jwt.withTargetServiceAccount` constructs a mixin object that can be merged into the `service_account_jwt`\nTerraform data source block to set or update the target_service_account field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `target_service_account` field.\n', args=[]),
