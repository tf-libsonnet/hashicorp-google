...
{
  '#':: d.pkg(name='sourcerepo_repository_iam_policy', url='', help='`sourcerepo_repository_iam_policy` represents the `google_sourcerepo_repository_iam_policy` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
