...
{
  '#':: d.pkg(name='project', url='', help='`project` represents the `google_project` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
