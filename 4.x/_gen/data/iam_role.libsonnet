...
{
  '#':: d.pkg(name='iam_role', url='', help='`iam_role` represents the `google_iam_role` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
