...
{
  '#':: d.pkg(name='data_catalog_taxonomy_iam_policy', url='', help='`data_catalog_taxonomy_iam_policy` represents the `google_data_catalog_taxonomy_iam_policy` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
