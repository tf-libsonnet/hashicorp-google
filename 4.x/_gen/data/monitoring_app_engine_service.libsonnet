...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withModuleId':: d.fn(help='`google.monitoring_app_engine_service.withModuleId` constructs a mixin object that can be merged into the `monitoring_app_engine_service`\nTerraform data source block to set or update the module_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `module_id` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google.monitoring_app_engine_service.withProject` constructs a mixin object that can be merged into the `monitoring_app_engine_service`\nTerraform data source block to set or update the project field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
