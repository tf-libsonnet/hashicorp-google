...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withInstance':: d.fn(help='`google.compute_instance_serial_port.withInstance` constructs a mixin object that can be merged into the `compute_instance_serial_port`\nTerraform data source block to set or update the instance field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `instance` field.\n', args=[]),
  ...
  '#withPort':: d.fn(help='`google.compute_instance_serial_port.withPort` constructs a mixin object that can be merged into the `compute_instance_serial_port`\nTerraform data source block to set or update the port field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `port` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google.compute_instance_serial_port.withProject` constructs a mixin object that can be merged into the `compute_instance_serial_port`\nTerraform data source block to set or update the project field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withZone':: d.fn(help='`google.compute_instance_serial_port.withZone` constructs a mixin object that can be merged into the `compute_instance_serial_port`\nTerraform data source block to set or update the zone field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `zone` field.\n', args=[]),
