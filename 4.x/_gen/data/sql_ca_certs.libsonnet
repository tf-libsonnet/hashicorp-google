...
{
  '#':: d.pkg(name='sql_ca_certs', url='', help='`sql_ca_certs` represents the `google_sql_ca_certs` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withProject':: d.fn(help='`google.sql_ca_certs.withProject` constructs a mixin object that can be merged into the `sql_ca_certs`\nTerraform data source block to set or update the project field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
