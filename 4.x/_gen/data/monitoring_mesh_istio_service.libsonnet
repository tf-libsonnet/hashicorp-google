...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withMeshUid':: d.fn(help='`google.monitoring_mesh_istio_service.withMeshUid` constructs a mixin object that can be merged into the `monitoring_mesh_istio_service`\nTerraform data source block to set or update the mesh_uid field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `mesh_uid` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google.monitoring_mesh_istio_service.withProject` constructs a mixin object that can be merged into the `monitoring_mesh_istio_service`\nTerraform data source block to set or update the project field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
  ...
  '#withServiceName':: d.fn(help='`google.monitoring_mesh_istio_service.withServiceName` constructs a mixin object that can be merged into the `monitoring_mesh_istio_service`\nTerraform data source block to set or update the service_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `service_name` field.\n', args=[]),
  ...
  '#withServiceNamespace':: d.fn(help='`google.monitoring_mesh_istio_service.withServiceNamespace` constructs a mixin object that can be merged into the `monitoring_mesh_istio_service`\nTerraform data source block to set or update the service_namespace field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `service_namespace` field.\n', args=[]),
