...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withSelfLink':: d.fn(help='`google.compute_instance.withSelfLink` constructs a mixin object that can be merged into the `compute_instance`\nTerraform data source block to set or update the self_link field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `self_link` field.\n', args=[]),
