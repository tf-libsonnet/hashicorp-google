...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDelegates':: d.fn(help='`google.service_account_access_token.withDelegates` constructs a mixin object that can be merged into the `service_account_access_token`\nTerraform data source block to set or update the delegates field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `delegates` field.\n', args=[]),
  ...
  '#withLifetime':: d.fn(help='`google.service_account_access_token.withLifetime` constructs a mixin object that can be merged into the `service_account_access_token`\nTerraform data source block to set or update the lifetime field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `lifetime` field.\n', args=[]),
  ...
  '#withScopes':: d.fn(help='`google.service_account_access_token.withScopes` constructs a mixin object that can be merged into the `service_account_access_token`\nTerraform data source block to set or update the scopes field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `scopes` field.\n', args=[]),
  ...
  '#withTargetServiceAccount':: d.fn(help='`google.service_account_access_token.withTargetServiceAccount` constructs a mixin object that can be merged into the `service_account_access_token`\nTerraform data source block to set or update the target_service_account field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `target_service_account` field.\n', args=[]),
