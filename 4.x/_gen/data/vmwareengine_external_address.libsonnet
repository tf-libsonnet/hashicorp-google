...
{
  '#':: d.pkg(name='vmwareengine_external_address', url='', help='`vmwareengine_external_address` represents the `google_vmwareengine_external_address` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
