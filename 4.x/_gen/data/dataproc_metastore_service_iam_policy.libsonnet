...
{
  '#':: d.pkg(name='dataproc_metastore_service_iam_policy', url='', help='`dataproc_metastore_service_iam_policy` represents the `google_dataproc_metastore_service_iam_policy` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
