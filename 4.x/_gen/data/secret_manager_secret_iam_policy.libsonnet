...
{
  '#':: d.pkg(name='secret_manager_secret_iam_policy', url='', help='`secret_manager_secret_iam_policy` represents the `google_secret_manager_secret_iam_policy` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
