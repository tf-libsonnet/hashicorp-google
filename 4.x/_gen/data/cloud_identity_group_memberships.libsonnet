...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withGroup':: d.fn(help='`google.cloud_identity_group_memberships.withGroup` constructs a mixin object that can be merged into the `cloud_identity_group_memberships`\nTerraform data source block to set or update the group field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `group` field.\n', args=[]),
