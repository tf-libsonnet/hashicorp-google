...
{
  '#':: d.pkg(name='tags_tag_value', url='', help='`tags_tag_value` represents the `google_tags_tag_value` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
