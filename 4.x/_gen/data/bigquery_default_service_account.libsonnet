...
{
  '#':: d.pkg(name='bigquery_default_service_account', url='', help='`bigquery_default_service_account` represents the `google_bigquery_default_service_account` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
