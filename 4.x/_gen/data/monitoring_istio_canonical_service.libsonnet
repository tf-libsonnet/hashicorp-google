...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCanonicalService':: d.fn(help='`google.monitoring_istio_canonical_service.withCanonicalService` constructs a mixin object that can be merged into the `monitoring_istio_canonical_service`\nTerraform data source block to set or update the canonical_service field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `canonical_service` field.\n', args=[]),
  ...
  '#withCanonicalServiceNamespace':: d.fn(help='`google.monitoring_istio_canonical_service.withCanonicalServiceNamespace` constructs a mixin object that can be merged into the `monitoring_istio_canonical_service`\nTerraform data source block to set or update the canonical_service_namespace field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `canonical_service_namespace` field.\n', args=[]),
  ...
  '#withMeshUid':: d.fn(help='`google.monitoring_istio_canonical_service.withMeshUid` constructs a mixin object that can be merged into the `monitoring_istio_canonical_service`\nTerraform data source block to set or update the mesh_uid field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `mesh_uid` field.\n', args=[]),
  ...
  '#withProject':: d.fn(help='`google.monitoring_istio_canonical_service.withProject` constructs a mixin object that can be merged into the `monitoring_istio_canonical_service`\nTerraform data source block to set or update the project field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `project` field.\n', args=[]),
