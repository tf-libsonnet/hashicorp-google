...
{
  '#':: d.pkg(name='active_folder', url='', help='`active_folder` represents the `google_active_folder` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withDisplayName':: d.fn(help='`google.active_folder.withDisplayName` constructs a mixin object that can be merged into the `active_folder`\nTerraform data source block to set or update the display_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `display_name` field.\n', args=[]),
  ...
  '#withParent':: d.fn(help='`google.active_folder.withParent` constructs a mixin object that can be merged into the `active_folder`\nTerraform data source block to set or update the parent field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `parent` field.\n', args=[]),
