...
`google.bigquery_dataset_access.withDataset` constructs a mixin object that can be merged into the `bigquery_dataset_access`
...
`google.bigquery_dataset_access.withDatasetId` constructs a mixin object that can be merged into the `bigquery_dataset_access`
...
`google.bigquery_dataset_access.withDatasetMixin` constructs a mixin object that can be merged into the `bigquery_dataset_access`
Terraform resource block to set or update the dataset field.
...
`google.bigquery_dataset_access.withDomain` constructs a mixin object that can be merged into the `bigquery_dataset_access`
...
`google.bigquery_dataset_access.withGroupByEmail` constructs a mixin object that can be merged into the `bigquery_dataset_access`
...
`google.bigquery_dataset_access.withIamMember` constructs a mixin object that can be merged into the `bigquery_dataset_access`
...
`google.bigquery_dataset_access.withProject` constructs a mixin object that can be merged into the `bigquery_dataset_access`
...
`google.bigquery_dataset_access.withRole` constructs a mixin object that can be merged into the `bigquery_dataset_access`
...
`google.bigquery_dataset_access.withRoutine` constructs a mixin object that can be merged into the `bigquery_dataset_access`
...
`google.bigquery_dataset_access.withRoutineMixin` constructs a mixin object that can be merged into the `bigquery_dataset_access`
Terraform resource block to set or update the routine field.
...
`google.bigquery_dataset_access.withSpecialGroup` constructs a mixin object that can be merged into the `bigquery_dataset_access`
...
`google.bigquery_dataset_access.withTimeouts` constructs a mixin object that can be merged into the `bigquery_dataset_access`
...
`google.bigquery_dataset_access.withTimeoutsMixin` constructs a mixin object that can be merged into the `bigquery_dataset_access`
Terraform resource block to set or update the timeouts field.
...
`google.bigquery_dataset_access.withUserByEmail` constructs a mixin object that can be merged into the `bigquery_dataset_access`
...
`google.bigquery_dataset_access.withView` constructs a mixin object that can be merged into the `bigquery_dataset_access`
...
`google.bigquery_dataset_access.withViewMixin` constructs a mixin object that can be merged into the `bigquery_dataset_access`
Terraform resource block to set or update the view field.
