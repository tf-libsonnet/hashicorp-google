---
permalink: /cloudbuildv2_connection_iam_member/
---

# cloudbuildv2_connection_iam_member

`cloudbuildv2_connection_iam_member` represents the `google_cloudbuildv2_connection_iam_member` Terraform resource.
