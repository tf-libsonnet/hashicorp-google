...
`google.cloudiot_device.withBlocked` constructs a mixin object that can be merged into the `cloudiot_device`
...
`google.cloudiot_device.withCredentials` constructs a mixin object that can be merged into the `cloudiot_device`
...
`google.cloudiot_device.withCredentialsMixin` constructs a mixin object that can be merged into the `cloudiot_device`
Terraform resource block to set or update the credentials field.
...
`google.cloudiot_device.withGatewayConfig` constructs a mixin object that can be merged into the `cloudiot_device`
...
`google.cloudiot_device.withGatewayConfigMixin` constructs a mixin object that can be merged into the `cloudiot_device`
Terraform resource block to set or update the gateway_config field.
...
`google.cloudiot_device.withLogLevel` constructs a mixin object that can be merged into the `cloudiot_device`
...
`google.cloudiot_device.withMetadata` constructs a mixin object that can be merged into the `cloudiot_device`
...
`google.cloudiot_device.withName` constructs a mixin object that can be merged into the `cloudiot_device`
...
`google.cloudiot_device.withRegistry` constructs a mixin object that can be merged into the `cloudiot_device`
...
`google.cloudiot_device.withTimeouts` constructs a mixin object that can be merged into the `cloudiot_device`
...
`google.cloudiot_device.withTimeoutsMixin` constructs a mixin object that can be merged into the `cloudiot_device`
Terraform resource block to set or update the timeouts field.
