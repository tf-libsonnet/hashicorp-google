...
`google.logging_log_view.withBucket` constructs a mixin object that can be merged into the `logging_log_view`
...
`google.logging_log_view.withDescription` constructs a mixin object that can be merged into the `logging_log_view`
...
`google.logging_log_view.withFilter` constructs a mixin object that can be merged into the `logging_log_view`
...
`google.logging_log_view.withLocation` constructs a mixin object that can be merged into the `logging_log_view`
...
`google.logging_log_view.withName` constructs a mixin object that can be merged into the `logging_log_view`
...
`google.logging_log_view.withParent` constructs a mixin object that can be merged into the `logging_log_view`
...
`google.logging_log_view.withTimeouts` constructs a mixin object that can be merged into the `logging_log_view`
...
`google.logging_log_view.withTimeoutsMixin` constructs a mixin object that can be merged into the `logging_log_view`
Terraform resource block to set or update the timeouts field.
