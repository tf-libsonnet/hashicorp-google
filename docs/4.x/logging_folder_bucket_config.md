...
`google.logging_folder_bucket_config.withBucketId` constructs a mixin object that can be merged into the `logging_folder_bucket_config`
...
`google.logging_folder_bucket_config.withCmekSettings` constructs a mixin object that can be merged into the `logging_folder_bucket_config`
...
`google.logging_folder_bucket_config.withCmekSettingsMixin` constructs a mixin object that can be merged into the `logging_folder_bucket_config`
Terraform resource block to set or update the cmek_settings field.
...
`google.logging_folder_bucket_config.withDescription` constructs a mixin object that can be merged into the `logging_folder_bucket_config`
...
`google.logging_folder_bucket_config.withFolder` constructs a mixin object that can be merged into the `logging_folder_bucket_config`
...
`google.logging_folder_bucket_config.withLocation` constructs a mixin object that can be merged into the `logging_folder_bucket_config`
...
`google.logging_folder_bucket_config.withRetentionDays` constructs a mixin object that can be merged into the `logging_folder_bucket_config`
