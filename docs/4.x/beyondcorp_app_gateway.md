...
`google.beyondcorp_app_gateway.withDisplayName` constructs a mixin object that can be merged into the `beyondcorp_app_gateway`
...
`google.beyondcorp_app_gateway.withHostType` constructs a mixin object that can be merged into the `beyondcorp_app_gateway`
...
`google.beyondcorp_app_gateway.withLabels` constructs a mixin object that can be merged into the `beyondcorp_app_gateway`
...
`google.beyondcorp_app_gateway.withName` constructs a mixin object that can be merged into the `beyondcorp_app_gateway`
...
`google.beyondcorp_app_gateway.withProject` constructs a mixin object that can be merged into the `beyondcorp_app_gateway`
...
`google.beyondcorp_app_gateway.withRegion` constructs a mixin object that can be merged into the `beyondcorp_app_gateway`
...
`google.beyondcorp_app_gateway.withTimeouts` constructs a mixin object that can be merged into the `beyondcorp_app_gateway`
...
`google.beyondcorp_app_gateway.withTimeoutsMixin` constructs a mixin object that can be merged into the `beyondcorp_app_gateway`
Terraform resource block to set or update the timeouts field.
...
`google.beyondcorp_app_gateway.withType` constructs a mixin object that can be merged into the `beyondcorp_app_gateway`
