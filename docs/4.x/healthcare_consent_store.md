...
`google.healthcare_consent_store.withDataset` constructs a mixin object that can be merged into the `healthcare_consent_store`
...
`google.healthcare_consent_store.withDefaultConsentTtl` constructs a mixin object that can be merged into the `healthcare_consent_store`
...
`google.healthcare_consent_store.withEnableConsentCreateOnUpdate` constructs a mixin object that can be merged into the `healthcare_consent_store`
...
`google.healthcare_consent_store.withLabels` constructs a mixin object that can be merged into the `healthcare_consent_store`
...
`google.healthcare_consent_store.withName` constructs a mixin object that can be merged into the `healthcare_consent_store`
...
`google.healthcare_consent_store.withTimeouts` constructs a mixin object that can be merged into the `healthcare_consent_store`
...
`google.healthcare_consent_store.withTimeoutsMixin` constructs a mixin object that can be merged into the `healthcare_consent_store`
Terraform resource block to set or update the timeouts field.
