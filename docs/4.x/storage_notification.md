...
`google.storage_notification.withBucket` constructs a mixin object that can be merged into the `storage_notification`
...
`google.storage_notification.withCustomAttributes` constructs a mixin object that can be merged into the `storage_notification`
...
`google.storage_notification.withEventTypes` constructs a mixin object that can be merged into the `storage_notification`
...
`google.storage_notification.withObjectNamePrefix` constructs a mixin object that can be merged into the `storage_notification`
...
`google.storage_notification.withPayloadFormat` constructs a mixin object that can be merged into the `storage_notification`
...
`google.storage_notification.withTopic` constructs a mixin object that can be merged into the `storage_notification`
