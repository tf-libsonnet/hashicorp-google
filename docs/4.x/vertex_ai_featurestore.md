...
`google.vertex_ai_featurestore.withEncryptionSpec` constructs a mixin object that can be merged into the `vertex_ai_featurestore`
...
`google.vertex_ai_featurestore.withEncryptionSpecMixin` constructs a mixin object that can be merged into the `vertex_ai_featurestore`
Terraform resource block to set or update the encryption_spec field.
...
`google.vertex_ai_featurestore.withForceDestroy` constructs a mixin object that can be merged into the `vertex_ai_featurestore`
...
`google.vertex_ai_featurestore.withLabels` constructs a mixin object that can be merged into the `vertex_ai_featurestore`
...
`google.vertex_ai_featurestore.withName` constructs a mixin object that can be merged into the `vertex_ai_featurestore`
...
`google.vertex_ai_featurestore.withOnlineServingConfig` constructs a mixin object that can be merged into the `vertex_ai_featurestore`
...
`google.vertex_ai_featurestore.withOnlineServingConfigMixin` constructs a mixin object that can be merged into the `vertex_ai_featurestore`
Terraform resource block to set or update the online_serving_config field.
...
`google.vertex_ai_featurestore.withProject` constructs a mixin object that can be merged into the `vertex_ai_featurestore`
...
`google.vertex_ai_featurestore.withRegion` constructs a mixin object that can be merged into the `vertex_ai_featurestore`
...
`google.vertex_ai_featurestore.withTimeouts` constructs a mixin object that can be merged into the `vertex_ai_featurestore`
...
`google.vertex_ai_featurestore.withTimeoutsMixin` constructs a mixin object that can be merged into the `vertex_ai_featurestore`
Terraform resource block to set or update the timeouts field.
