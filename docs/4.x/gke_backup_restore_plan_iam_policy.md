---
permalink: /gke_backup_restore_plan_iam_policy/
---

# gke_backup_restore_plan_iam_policy

`gke_backup_restore_plan_iam_policy` represents the `google_gke_backup_restore_plan_iam_policy` Terraform resource.
