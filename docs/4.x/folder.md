...
`google.folder.withDisplayName` constructs a mixin object that can be merged into the `folder`
...
`google.folder.withParent` constructs a mixin object that can be merged into the `folder`
...
`google.folder.withTimeouts` constructs a mixin object that can be merged into the `folder`
...
`google.folder.withTimeoutsMixin` constructs a mixin object that can be merged into the `folder`
Terraform resource block to set or update the timeouts field.
