...
`google.dialogflow_fulfillment.withDisplayName` constructs a mixin object that can be merged into the `dialogflow_fulfillment`
...
`google.dialogflow_fulfillment.withEnabled` constructs a mixin object that can be merged into the `dialogflow_fulfillment`
...
`google.dialogflow_fulfillment.withFeatures` constructs a mixin object that can be merged into the `dialogflow_fulfillment`
...
`google.dialogflow_fulfillment.withFeaturesMixin` constructs a mixin object that can be merged into the `dialogflow_fulfillment`
Terraform resource block to set or update the features field.
...
`google.dialogflow_fulfillment.withGenericWebService` constructs a mixin object that can be merged into the `dialogflow_fulfillment`
...
`google.dialogflow_fulfillment.withGenericWebServiceMixin` constructs a mixin object that can be merged into the `dialogflow_fulfillment`
Terraform resource block to set or update the generic_web_service field.
...
`google.dialogflow_fulfillment.withProject` constructs a mixin object that can be merged into the `dialogflow_fulfillment`
...
`google.dialogflow_fulfillment.withTimeouts` constructs a mixin object that can be merged into the `dialogflow_fulfillment`
...
`google.dialogflow_fulfillment.withTimeoutsMixin` constructs a mixin object that can be merged into the `dialogflow_fulfillment`
Terraform resource block to set or update the timeouts field.
