...
`google.secret_manager_secret_iam_member.withCondition` constructs a mixin object that can be merged into the `secret_manager_secret_iam_member`
...
`google.secret_manager_secret_iam_member.withConditionMixin` constructs a mixin object that can be merged into the `secret_manager_secret_iam_member`
Terraform resource block to set or update the condition field.
...
`google.secret_manager_secret_iam_member.withMember` constructs a mixin object that can be merged into the `secret_manager_secret_iam_member`
...
`google.secret_manager_secret_iam_member.withProject` constructs a mixin object that can be merged into the `secret_manager_secret_iam_member`
...
`google.secret_manager_secret_iam_member.withRole` constructs a mixin object that can be merged into the `secret_manager_secret_iam_member`
...
`google.secret_manager_secret_iam_member.withSecretId` constructs a mixin object that can be merged into the `secret_manager_secret_iam_member`
