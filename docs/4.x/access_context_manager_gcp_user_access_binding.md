...
Unlike [google.access_context_manager_gcp_user_access_binding.new](#fn-access_context_manager_gcp_user_access_bindingnew), this function will not inject the `resource`
