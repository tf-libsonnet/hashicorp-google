...
`google.compute_region_per_instance_config.withMinimalAction` constructs a mixin object that can be merged into the `compute_region_per_instance_config`
...
`google.compute_region_per_instance_config.withMostDisruptiveAllowedAction` constructs a mixin object that can be merged into the `compute_region_per_instance_config`
...
`google.compute_region_per_instance_config.withName` constructs a mixin object that can be merged into the `compute_region_per_instance_config`
...
`google.compute_region_per_instance_config.withPreservedState` constructs a mixin object that can be merged into the `compute_region_per_instance_config`
...
`google.compute_region_per_instance_config.withPreservedStateMixin` constructs a mixin object that can be merged into the `compute_region_per_instance_config`
Terraform resource block to set or update the preserved_state field.
...
`google.compute_region_per_instance_config.withProject` constructs a mixin object that can be merged into the `compute_region_per_instance_config`
...
`google.compute_region_per_instance_config.withRegion` constructs a mixin object that can be merged into the `compute_region_per_instance_config`
...
`google.compute_region_per_instance_config.withRegionInstanceGroupManager` constructs a mixin object that can be merged into the `compute_region_per_instance_config`
...
`google.compute_region_per_instance_config.withRemoveInstanceStateOnDestroy` constructs a mixin object that can be merged into the `compute_region_per_instance_config`
...
`google.compute_region_per_instance_config.withTimeouts` constructs a mixin object that can be merged into the `compute_region_per_instance_config`
...
`google.compute_region_per_instance_config.withTimeoutsMixin` constructs a mixin object that can be merged into the `compute_region_per_instance_config`
Terraform resource block to set or update the timeouts field.
