---
permalink: /data/compute_region_disk_iam_policy/
---

# data.compute_region_disk_iam_policy

`compute_region_disk_iam_policy` represents the `google_compute_region_disk_iam_policy` Terraform data source.
