---
permalink: /data/dataplex_lake_iam_policy/
---

# data.dataplex_lake_iam_policy

`dataplex_lake_iam_policy` represents the `google_dataplex_lake_iam_policy` Terraform data source.
