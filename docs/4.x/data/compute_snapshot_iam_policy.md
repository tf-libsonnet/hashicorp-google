---
permalink: /data/compute_snapshot_iam_policy/
---

# data.compute_snapshot_iam_policy

`compute_snapshot_iam_policy` represents the `google_compute_snapshot_iam_policy` Terraform data source.
