...
`google.compute_snapshot.withFilter` constructs a mixin object that can be merged into the `compute_snapshot`
...
`google.compute_snapshot.withMostRecent` constructs a mixin object that can be merged into the `compute_snapshot`
