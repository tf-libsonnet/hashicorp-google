---
permalink: /data/endpoints_service_iam_policy/
---

# data.endpoints_service_iam_policy

`endpoints_service_iam_policy` represents the `google_endpoints_service_iam_policy` Terraform data source.
