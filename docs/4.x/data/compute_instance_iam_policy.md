---
permalink: /data/compute_instance_iam_policy/
---

# data.compute_instance_iam_policy

`compute_instance_iam_policy` represents the `google_compute_instance_iam_policy` Terraform data source.
