---
permalink: /data/bigquery_analytics_hub_data_exchange_iam_policy/
---

# data.bigquery_analytics_hub_data_exchange_iam_policy

`bigquery_analytics_hub_data_exchange_iam_policy` represents the `google_bigquery_analytics_hub_data_exchange_iam_policy` Terraform data source.
