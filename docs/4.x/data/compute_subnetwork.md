---
permalink: /data/compute_subnetwork/
---

# data.compute_subnetwork

`compute_subnetwork` represents the `google_compute_subnetwork` Terraform data source.
...
`google.compute_subnetwork.withSelfLink` constructs a mixin object that can be merged into the `compute_subnetwork`
