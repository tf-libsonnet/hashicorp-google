---
permalink: /data/privateca_certificate_template_iam_policy/
---

# data.privateca_certificate_template_iam_policy

`privateca_certificate_template_iam_policy` represents the `google_privateca_certificate_template_iam_policy` Terraform data source.
