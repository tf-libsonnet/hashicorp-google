---
permalink: /data/vmwareengine_external_address/
---

# data.vmwareengine_external_address

`vmwareengine_external_address` represents the `google_vmwareengine_external_address` Terraform data source.
