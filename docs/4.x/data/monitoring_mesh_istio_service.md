---
permalink: /data/monitoring_mesh_istio_service/
---

# data.monitoring_mesh_istio_service

`monitoring_mesh_istio_service` represents the `google_monitoring_mesh_istio_service` Terraform data source.
...
`google.monitoring_mesh_istio_service.withMeshUid` constructs a mixin object that can be merged into the `monitoring_mesh_istio_service`
...
`google.monitoring_mesh_istio_service.withProject` constructs a mixin object that can be merged into the `monitoring_mesh_istio_service`
...
`google.monitoring_mesh_istio_service.withServiceName` constructs a mixin object that can be merged into the `monitoring_mesh_istio_service`
...
`google.monitoring_mesh_istio_service.withServiceNamespace` constructs a mixin object that can be merged into the `monitoring_mesh_istio_service`
