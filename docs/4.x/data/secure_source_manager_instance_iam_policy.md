---
permalink: /data/secure_source_manager_instance_iam_policy/
---

# data.secure_source_manager_instance_iam_policy

`secure_source_manager_instance_iam_policy` represents the `google_secure_source_manager_instance_iam_policy` Terraform data source.
