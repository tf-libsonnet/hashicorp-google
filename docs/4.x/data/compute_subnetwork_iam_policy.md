---
permalink: /data/compute_subnetwork_iam_policy/
---

# data.compute_subnetwork_iam_policy

`compute_subnetwork_iam_policy` represents the `google_compute_subnetwork_iam_policy` Terraform data source.
