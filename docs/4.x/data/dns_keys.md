...
`google.dns_keys.withManagedZone` constructs a mixin object that can be merged into the `dns_keys`
...
`google.dns_keys.withProject` constructs a mixin object that can be merged into the `dns_keys`
