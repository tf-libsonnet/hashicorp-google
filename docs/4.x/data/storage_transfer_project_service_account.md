...
Unlike [google.data.storage_transfer_project_service_account.new](#fn-storage_transfer_project_service_accountnew), this function will not inject the `data source`
