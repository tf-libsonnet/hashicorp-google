---
permalink: /data/pubsub_topic/
---

# data.pubsub_topic

`pubsub_topic` represents the `google_pubsub_topic` Terraform data source.
...
Unlike [google.data.pubsub_topic.new](#fn-pubsub_topicnew), this function will not inject the `data source`
