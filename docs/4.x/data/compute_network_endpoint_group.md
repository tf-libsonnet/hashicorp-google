---
permalink: /data/compute_network_endpoint_group/
---

# data.compute_network_endpoint_group

`compute_network_endpoint_group` represents the `google_compute_network_endpoint_group` Terraform data source.
...
`google.compute_network_endpoint_group.withSelfLink` constructs a mixin object that can be merged into the `compute_network_endpoint_group`
