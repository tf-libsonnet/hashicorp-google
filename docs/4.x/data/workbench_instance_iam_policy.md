---
permalink: /data/workbench_instance_iam_policy/
---

# data.workbench_instance_iam_policy

`workbench_instance_iam_policy` represents the `google_workbench_instance_iam_policy` Terraform data source.
