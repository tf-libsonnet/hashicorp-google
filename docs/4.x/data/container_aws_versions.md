---
permalink: /data/container_aws_versions/
---

# data.container_aws_versions

`container_aws_versions` represents the `google_container_aws_versions` Terraform data source.
...
`google.container_aws_versions.withLocation` constructs a mixin object that can be merged into the `container_aws_versions`
...
`google.container_aws_versions.withProject` constructs a mixin object that can be merged into the `container_aws_versions`
