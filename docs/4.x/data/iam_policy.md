...
`google.iam_policy.withAuditConfig` constructs a mixin object that can be merged into the `iam_policy`
...
`google.iam_policy.withAuditConfigMixin` constructs a mixin object that can be merged into the `iam_policy`
Terraform data source block to set or update the audit_config field.
...
`google.iam_policy.withBinding` constructs a mixin object that can be merged into the `iam_policy`
...
`google.iam_policy.withBindingMixin` constructs a mixin object that can be merged into the `iam_policy`
Terraform data source block to set or update the binding field.
