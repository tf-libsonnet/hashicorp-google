...
`google.active_folder.withDisplayName` constructs a mixin object that can be merged into the `active_folder`
...
`google.active_folder.withParent` constructs a mixin object that can be merged into the `active_folder`
