---
permalink: /data/data_fusion_instance_iam_policy/
---

# data.data_fusion_instance_iam_policy

`data_fusion_instance_iam_policy` represents the `google_data_fusion_instance_iam_policy` Terraform data source.
