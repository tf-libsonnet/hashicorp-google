...
`google.secret_manager_secret_version.withProject` constructs a mixin object that can be merged into the `secret_manager_secret_version`
...
`google.secret_manager_secret_version.withVersion` constructs a mixin object that can be merged into the `secret_manager_secret_version`
