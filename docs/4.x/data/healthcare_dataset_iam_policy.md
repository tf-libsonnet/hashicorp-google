---
permalink: /data/healthcare_dataset_iam_policy/
---

# data.healthcare_dataset_iam_policy

`healthcare_dataset_iam_policy` represents the `google_healthcare_dataset_iam_policy` Terraform data source.
