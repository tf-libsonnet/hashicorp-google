...
`google.composer_image_versions.withProject` constructs a mixin object that can be merged into the `composer_image_versions`
...
`google.composer_image_versions.withRegion` constructs a mixin object that can be merged into the `composer_image_versions`
