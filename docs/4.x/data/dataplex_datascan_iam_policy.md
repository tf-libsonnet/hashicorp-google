---
permalink: /data/dataplex_datascan_iam_policy/
---

# data.dataplex_datascan_iam_policy

`dataplex_datascan_iam_policy` represents the `google_dataplex_datascan_iam_policy` Terraform data source.
