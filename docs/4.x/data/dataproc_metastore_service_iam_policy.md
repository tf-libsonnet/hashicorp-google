---
permalink: /data/dataproc_metastore_service_iam_policy/
---

# data.dataproc_metastore_service_iam_policy

`dataproc_metastore_service_iam_policy` represents the `google_dataproc_metastore_service_iam_policy` Terraform data source.
