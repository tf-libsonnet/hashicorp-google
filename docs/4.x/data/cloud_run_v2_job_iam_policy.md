---
permalink: /data/cloud_run_v2_job_iam_policy/
---

# data.cloud_run_v2_job_iam_policy

`cloud_run_v2_job_iam_policy` represents the `google_cloud_run_v2_job_iam_policy` Terraform data source.
