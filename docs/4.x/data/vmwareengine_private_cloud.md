---
permalink: /data/vmwareengine_private_cloud/
---

# data.vmwareengine_private_cloud

`vmwareengine_private_cloud` represents the `google_vmwareengine_private_cloud` Terraform data source.
