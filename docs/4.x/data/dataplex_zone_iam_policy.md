---
permalink: /data/dataplex_zone_iam_policy/
---

# data.dataplex_zone_iam_policy

`dataplex_zone_iam_policy` represents the `google_dataplex_zone_iam_policy` Terraform data source.
