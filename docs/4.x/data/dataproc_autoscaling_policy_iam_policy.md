---
permalink: /data/dataproc_autoscaling_policy_iam_policy/
---

# data.dataproc_autoscaling_policy_iam_policy

`dataproc_autoscaling_policy_iam_policy` represents the `google_dataproc_autoscaling_policy_iam_policy` Terraform data source.
