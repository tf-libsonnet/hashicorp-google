---
permalink: /data/cloudiot_registry_iam_policy/
---

# data.cloudiot_registry_iam_policy

`cloudiot_registry_iam_policy` represents the `google_cloudiot_registry_iam_policy` Terraform data source.
