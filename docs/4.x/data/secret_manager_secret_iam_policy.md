---
permalink: /data/secret_manager_secret_iam_policy/
---

# data.secret_manager_secret_iam_policy

`secret_manager_secret_iam_policy` represents the `google_secret_manager_secret_iam_policy` Terraform data source.
