---
permalink: /data/privateca_ca_pool_iam_policy/
---

# data.privateca_ca_pool_iam_policy

`privateca_ca_pool_iam_policy` represents the `google_privateca_ca_pool_iam_policy` Terraform data source.
