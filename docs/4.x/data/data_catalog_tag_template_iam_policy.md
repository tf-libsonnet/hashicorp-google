---
permalink: /data/data_catalog_tag_template_iam_policy/
---

# data.data_catalog_tag_template_iam_policy

`data_catalog_tag_template_iam_policy` represents the `google_data_catalog_tag_template_iam_policy` Terraform data source.
