...
`google.logging_project_cmek_settings.withKmsKeyName` constructs a mixin object that can be merged into the `logging_project_cmek_settings`
...
`google.logging_project_cmek_settings.withProject` constructs a mixin object that can be merged into the `logging_project_cmek_settings`
