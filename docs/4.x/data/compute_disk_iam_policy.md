---
permalink: /data/compute_disk_iam_policy/
---

# data.compute_disk_iam_policy

`compute_disk_iam_policy` represents the `google_compute_disk_iam_policy` Terraform data source.
