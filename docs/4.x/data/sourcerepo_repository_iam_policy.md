---
permalink: /data/sourcerepo_repository_iam_policy/
---

# data.sourcerepo_repository_iam_policy

`sourcerepo_repository_iam_policy` represents the `google_sourcerepo_repository_iam_policy` Terraform data source.
