---
permalink: /data/gke_backup_backup_plan_iam_policy/
---

# data.gke_backup_backup_plan_iam_policy

`gke_backup_backup_plan_iam_policy` represents the `google_gke_backup_backup_plan_iam_policy` Terraform data source.
