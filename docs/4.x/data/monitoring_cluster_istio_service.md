...
`google.monitoring_cluster_istio_service.withClusterName` constructs a mixin object that can be merged into the `monitoring_cluster_istio_service`
...
`google.monitoring_cluster_istio_service.withLocation` constructs a mixin object that can be merged into the `monitoring_cluster_istio_service`
...
`google.monitoring_cluster_istio_service.withProject` constructs a mixin object that can be merged into the `monitoring_cluster_istio_service`
...
`google.monitoring_cluster_istio_service.withServiceName` constructs a mixin object that can be merged into the `monitoring_cluster_istio_service`
...
`google.monitoring_cluster_istio_service.withServiceNamespace` constructs a mixin object that can be merged into the `monitoring_cluster_istio_service`
