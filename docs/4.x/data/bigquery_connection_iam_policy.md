---
permalink: /data/bigquery_connection_iam_policy/
---

# data.bigquery_connection_iam_policy

`bigquery_connection_iam_policy` represents the `google_bigquery_connection_iam_policy` Terraform data source.
