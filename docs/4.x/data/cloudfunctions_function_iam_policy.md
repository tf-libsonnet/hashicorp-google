---
permalink: /data/cloudfunctions_function_iam_policy/
---

# data.cloudfunctions_function_iam_policy

`cloudfunctions_function_iam_policy` represents the `google_cloudfunctions_function_iam_policy` Terraform data source.
