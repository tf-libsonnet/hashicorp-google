---
permalink: /data/dns_managed_zone_iam_policy/
---

# data.dns_managed_zone_iam_policy

`dns_managed_zone_iam_policy` represents the `google_dns_managed_zone_iam_policy` Terraform data source.
