---
permalink: /data/dataproc_job_iam_policy/
---

# data.dataproc_job_iam_policy

`dataproc_job_iam_policy` represents the `google_dataproc_job_iam_policy` Terraform data source.
