---
permalink: /data/iap_app_engine_service_iam_policy/
---

# data.iap_app_engine_service_iam_policy

`iap_app_engine_service_iam_policy` represents the `google_iap_app_engine_service_iam_policy` Terraform data source.
