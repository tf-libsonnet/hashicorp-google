---
permalink: /data/iap_web_type_app_engine_iam_policy/
---

# data.iap_web_type_app_engine_iam_policy

`iap_web_type_app_engine_iam_policy` represents the `google_iap_web_type_app_engine_iam_policy` Terraform data source.
