---
permalink: /data/bigtable_instance_iam_policy/
---

# data.bigtable_instance_iam_policy

`bigtable_instance_iam_policy` represents the `google_bigtable_instance_iam_policy` Terraform data source.
