---
permalink: /data/cloud_tasks_queue_iam_policy/
---

# data.cloud_tasks_queue_iam_policy

`cloud_tasks_queue_iam_policy` represents the `google_cloud_tasks_queue_iam_policy` Terraform data source.
