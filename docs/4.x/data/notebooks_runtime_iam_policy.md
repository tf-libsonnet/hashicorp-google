---
permalink: /data/notebooks_runtime_iam_policy/
---

# data.notebooks_runtime_iam_policy

`notebooks_runtime_iam_policy` represents the `google_notebooks_runtime_iam_policy` Terraform data source.
