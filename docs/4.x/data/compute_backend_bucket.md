---
permalink: /data/compute_backend_bucket/
---

# data.compute_backend_bucket

`compute_backend_bucket` represents the `google_compute_backend_bucket` Terraform data source.
...
Unlike [google.data.compute_backend_bucket.new](#fn-compute_backend_bucketnew), this function will not inject the `data source`
