---
permalink: /data/gke_hub_membership_iam_policy/
---

# data.gke_hub_membership_iam_policy

`gke_hub_membership_iam_policy` represents the `google_gke_hub_membership_iam_policy` Terraform data source.
