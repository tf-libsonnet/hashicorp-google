...
`google.healthcare_dicom_store.withDataset` constructs a mixin object that can be merged into the `healthcare_dicom_store`
...
`google.healthcare_dicom_store.withLabels` constructs a mixin object that can be merged into the `healthcare_dicom_store`
...
`google.healthcare_dicom_store.withName` constructs a mixin object that can be merged into the `healthcare_dicom_store`
...
`google.healthcare_dicom_store.withNotificationConfig` constructs a mixin object that can be merged into the `healthcare_dicom_store`
...
`google.healthcare_dicom_store.withNotificationConfigMixin` constructs a mixin object that can be merged into the `healthcare_dicom_store`
Terraform resource block to set or update the notification_config field.
...
`google.healthcare_dicom_store.withTimeouts` constructs a mixin object that can be merged into the `healthcare_dicom_store`
...
`google.healthcare_dicom_store.withTimeoutsMixin` constructs a mixin object that can be merged into the `healthcare_dicom_store`
Terraform resource block to set or update the timeouts field.
