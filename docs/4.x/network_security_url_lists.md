---
permalink: /network_security_url_lists/
---

# network_security_url_lists

`network_security_url_lists` represents the `google_network_security_url_lists` Terraform resource.
...
`google.list.withValues` constructs a mixin object that can be merged into the `list`
