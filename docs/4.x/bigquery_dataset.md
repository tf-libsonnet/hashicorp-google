...
`google.bigquery_dataset.withAccess` constructs a mixin object that can be merged into the `bigquery_dataset`
...
`google.bigquery_dataset.withAccessMixin` constructs a mixin object that can be merged into the `bigquery_dataset`
Terraform resource block to set or update the access field.
...
`google.bigquery_dataset.withDatasetId` constructs a mixin object that can be merged into the `bigquery_dataset`
...
`google.bigquery_dataset.withDefaultEncryptionConfiguration` constructs a mixin object that can be merged into the `bigquery_dataset`
...
`google.bigquery_dataset.withDefaultEncryptionConfigurationMixin` constructs a mixin object that can be merged into the `bigquery_dataset`
Terraform resource block to set or update the default_encryption_configuration field.
...
`google.bigquery_dataset.withDefaultPartitionExpirationMs` constructs a mixin object that can be merged into the `bigquery_dataset`
...
`google.bigquery_dataset.withDefaultTableExpirationMs` constructs a mixin object that can be merged into the `bigquery_dataset`
...
`google.bigquery_dataset.withDeleteContentsOnDestroy` constructs a mixin object that can be merged into the `bigquery_dataset`
...
`google.bigquery_dataset.withDescription` constructs a mixin object that can be merged into the `bigquery_dataset`
...
`google.bigquery_dataset.withFriendlyName` constructs a mixin object that can be merged into the `bigquery_dataset`
...
`google.bigquery_dataset.withLabels` constructs a mixin object that can be merged into the `bigquery_dataset`
...
`google.bigquery_dataset.withLocation` constructs a mixin object that can be merged into the `bigquery_dataset`
...
`google.bigquery_dataset.withMaxTimeTravelHours` constructs a mixin object that can be merged into the `bigquery_dataset`
...
`google.bigquery_dataset.withProject` constructs a mixin object that can be merged into the `bigquery_dataset`
...
`google.bigquery_dataset.withTimeouts` constructs a mixin object that can be merged into the `bigquery_dataset`
...
`google.bigquery_dataset.withTimeoutsMixin` constructs a mixin object that can be merged into the `bigquery_dataset`
Terraform resource block to set or update the timeouts field.
