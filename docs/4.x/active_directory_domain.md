...
`google.active_directory_domain.withAdmin` constructs a mixin object that can be merged into the `active_directory_domain`
...
`google.active_directory_domain.withAuthorizedNetworks` constructs a mixin object that can be merged into the `active_directory_domain`
...
`google.active_directory_domain.withDomainName` constructs a mixin object that can be merged into the `active_directory_domain`
...
`google.active_directory_domain.withLabels` constructs a mixin object that can be merged into the `active_directory_domain`
...
`google.active_directory_domain.withLocations` constructs a mixin object that can be merged into the `active_directory_domain`
...
`google.active_directory_domain.withProject` constructs a mixin object that can be merged into the `active_directory_domain`
...
`google.active_directory_domain.withReservedIpRange` constructs a mixin object that can be merged into the `active_directory_domain`
...
`google.active_directory_domain.withTimeouts` constructs a mixin object that can be merged into the `active_directory_domain`
...
`google.active_directory_domain.withTimeoutsMixin` constructs a mixin object that can be merged into the `active_directory_domain`
Terraform resource block to set or update the timeouts field.
