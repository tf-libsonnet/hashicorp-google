...
`google.sql_source_representation_instance.withDatabaseVersion` constructs a mixin object that can be merged into the `sql_source_representation_instance`
...
`google.sql_source_representation_instance.withHost` constructs a mixin object that can be merged into the `sql_source_representation_instance`
...
`google.sql_source_representation_instance.withName` constructs a mixin object that can be merged into the `sql_source_representation_instance`
...
`google.sql_source_representation_instance.withPort` constructs a mixin object that can be merged into the `sql_source_representation_instance`
...
`google.sql_source_representation_instance.withProject` constructs a mixin object that can be merged into the `sql_source_representation_instance`
...
`google.sql_source_representation_instance.withRegion` constructs a mixin object that can be merged into the `sql_source_representation_instance`
...
`google.sql_source_representation_instance.withTimeouts` constructs a mixin object that can be merged into the `sql_source_representation_instance`
...
`google.sql_source_representation_instance.withTimeoutsMixin` constructs a mixin object that can be merged into the `sql_source_representation_instance`
Terraform resource block to set or update the timeouts field.
