...
`google.compute_forwarding_rule.withAllPorts` constructs a mixin object that can be merged into the `compute_forwarding_rule`
...
`google.compute_forwarding_rule.withAllowGlobalAccess` constructs a mixin object that can be merged into the `compute_forwarding_rule`
...
`google.compute_forwarding_rule.withBackendService` constructs a mixin object that can be merged into the `compute_forwarding_rule`
...
`google.compute_forwarding_rule.withDescription` constructs a mixin object that can be merged into the `compute_forwarding_rule`
...
`google.compute_forwarding_rule.withIpAddress` constructs a mixin object that can be merged into the `compute_forwarding_rule`
...
`google.compute_forwarding_rule.withIpProtocol` constructs a mixin object that can be merged into the `compute_forwarding_rule`
...
`google.compute_forwarding_rule.withIsMirroringCollector` constructs a mixin object that can be merged into the `compute_forwarding_rule`
...
`google.compute_forwarding_rule.withLabels` constructs a mixin object that can be merged into the `compute_forwarding_rule`
...
`google.compute_forwarding_rule.withLoadBalancingScheme` constructs a mixin object that can be merged into the `compute_forwarding_rule`
...
`google.compute_forwarding_rule.withName` constructs a mixin object that can be merged into the `compute_forwarding_rule`
...
`google.compute_forwarding_rule.withNetwork` constructs a mixin object that can be merged into the `compute_forwarding_rule`
...
`google.compute_forwarding_rule.withNetworkTier` constructs a mixin object that can be merged into the `compute_forwarding_rule`
...
`google.compute_forwarding_rule.withPortRange` constructs a mixin object that can be merged into the `compute_forwarding_rule`
...
`google.compute_forwarding_rule.withPorts` constructs a mixin object that can be merged into the `compute_forwarding_rule`
...
`google.compute_forwarding_rule.withProject` constructs a mixin object that can be merged into the `compute_forwarding_rule`
...
`google.compute_forwarding_rule.withRegion` constructs a mixin object that can be merged into the `compute_forwarding_rule`
...
`google.compute_forwarding_rule.withServiceDirectoryRegistrations` constructs a mixin object that can be merged into the `compute_forwarding_rule`
...
`google.compute_forwarding_rule.withServiceDirectoryRegistrationsMixin` constructs a mixin object that can be merged into the `compute_forwarding_rule`
Terraform resource block to set or update the service_directory_registrations field.
...
`google.compute_forwarding_rule.withServiceLabel` constructs a mixin object that can be merged into the `compute_forwarding_rule`
...
`google.compute_forwarding_rule.withSubnetwork` constructs a mixin object that can be merged into the `compute_forwarding_rule`
...
`google.compute_forwarding_rule.withTarget` constructs a mixin object that can be merged into the `compute_forwarding_rule`
...
`google.compute_forwarding_rule.withTimeouts` constructs a mixin object that can be merged into the `compute_forwarding_rule`
...
`google.compute_forwarding_rule.withTimeoutsMixin` constructs a mixin object that can be merged into the `compute_forwarding_rule`
Terraform resource block to set or update the timeouts field.
