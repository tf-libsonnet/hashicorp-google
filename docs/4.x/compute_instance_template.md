...
`google.compute_instance_template.withAdvancedMachineFeatures` constructs a mixin object that can be merged into the `compute_instance_template`
...
`google.compute_instance_template.withAdvancedMachineFeaturesMixin` constructs a mixin object that can be merged into the `compute_instance_template`
Terraform resource block to set or update the advanced_machine_features field.
...
`google.compute_instance_template.withCanIpForward` constructs a mixin object that can be merged into the `compute_instance_template`
...
`google.compute_instance_template.withConfidentialInstanceConfig` constructs a mixin object that can be merged into the `compute_instance_template`
...
`google.compute_instance_template.withConfidentialInstanceConfigMixin` constructs a mixin object that can be merged into the `compute_instance_template`
Terraform resource block to set or update the confidential_instance_config field.
...
`google.compute_instance_template.withDescription` constructs a mixin object that can be merged into the `compute_instance_template`
...
`google.compute_instance_template.withDisk` constructs a mixin object that can be merged into the `compute_instance_template`
...
`google.compute_instance_template.withDiskMixin` constructs a mixin object that can be merged into the `compute_instance_template`
Terraform resource block to set or update the disk field.
...
`google.compute_instance_template.withGuestAccelerator` constructs a mixin object that can be merged into the `compute_instance_template`
...
`google.compute_instance_template.withGuestAcceleratorMixin` constructs a mixin object that can be merged into the `compute_instance_template`
Terraform resource block to set or update the guest_accelerator field.
...
`google.compute_instance_template.withInstanceDescription` constructs a mixin object that can be merged into the `compute_instance_template`
...
`google.compute_instance_template.withLabels` constructs a mixin object that can be merged into the `compute_instance_template`
...
`google.compute_instance_template.withMachineType` constructs a mixin object that can be merged into the `compute_instance_template`
...
`google.compute_instance_template.withMetadata` constructs a mixin object that can be merged into the `compute_instance_template`
...
`google.compute_instance_template.withMetadataStartupScript` constructs a mixin object that can be merged into the `compute_instance_template`
...
`google.compute_instance_template.withMinCpuPlatform` constructs a mixin object that can be merged into the `compute_instance_template`
...
`google.compute_instance_template.withNamePrefix` constructs a mixin object that can be merged into the `compute_instance_template`
...
`google.compute_instance_template.withNetworkInterface` constructs a mixin object that can be merged into the `compute_instance_template`
...
`google.compute_instance_template.withNetworkInterfaceMixin` constructs a mixin object that can be merged into the `compute_instance_template`
Terraform resource block to set or update the network_interface field.
...
`google.compute_instance_template.withRegion` constructs a mixin object that can be merged into the `compute_instance_template`
...
`google.compute_instance_template.withReservationAffinity` constructs a mixin object that can be merged into the `compute_instance_template`
...
`google.compute_instance_template.withReservationAffinityMixin` constructs a mixin object that can be merged into the `compute_instance_template`
Terraform resource block to set or update the reservation_affinity field.
...
`google.compute_instance_template.withScheduling` constructs a mixin object that can be merged into the `compute_instance_template`
...
`google.compute_instance_template.withSchedulingMixin` constructs a mixin object that can be merged into the `compute_instance_template`
Terraform resource block to set or update the scheduling field.
...
`google.compute_instance_template.withServiceAccount` constructs a mixin object that can be merged into the `compute_instance_template`
...
`google.compute_instance_template.withServiceAccountMixin` constructs a mixin object that can be merged into the `compute_instance_template`
Terraform resource block to set or update the service_account field.
...
`google.compute_instance_template.withShieldedInstanceConfig` constructs a mixin object that can be merged into the `compute_instance_template`
...
`google.compute_instance_template.withShieldedInstanceConfigMixin` constructs a mixin object that can be merged into the `compute_instance_template`
Terraform resource block to set or update the shielded_instance_config field.
...
`google.compute_instance_template.withTags` constructs a mixin object that can be merged into the `compute_instance_template`
...
`google.compute_instance_template.withTimeouts` constructs a mixin object that can be merged into the `compute_instance_template`
...
`google.compute_instance_template.withTimeoutsMixin` constructs a mixin object that can be merged into the `compute_instance_template`
Terraform resource block to set or update the timeouts field.
