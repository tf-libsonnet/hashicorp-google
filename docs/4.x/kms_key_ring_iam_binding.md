...
**Args**:
  ...
  - `members` (`list`): 
  - `role` (`string`): 
  - `condition` (`list[obj]`):  When `null`, the `condition` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google.kms_key_ring_iam_binding.condition.new](#fn-kms_key_ring_iam_bindingconditionnew) constructor.
...
Unlike [google.kms_key_ring_iam_binding.new](#fn-kms_key_ring_iam_bindingnew), this function will not inject the `resource`
