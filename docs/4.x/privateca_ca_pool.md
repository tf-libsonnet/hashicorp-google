...
`google.privateca_ca_pool.withIssuancePolicy` constructs a mixin object that can be merged into the `privateca_ca_pool`
...
`google.privateca_ca_pool.withIssuancePolicyMixin` constructs a mixin object that can be merged into the `privateca_ca_pool`
Terraform resource block to set or update the issuance_policy field.
...
`google.privateca_ca_pool.withLabels` constructs a mixin object that can be merged into the `privateca_ca_pool`
...
`google.privateca_ca_pool.withLocation` constructs a mixin object that can be merged into the `privateca_ca_pool`
...
`google.privateca_ca_pool.withName` constructs a mixin object that can be merged into the `privateca_ca_pool`
...
`google.privateca_ca_pool.withProject` constructs a mixin object that can be merged into the `privateca_ca_pool`
...
`google.privateca_ca_pool.withPublishingOptions` constructs a mixin object that can be merged into the `privateca_ca_pool`
...
`google.privateca_ca_pool.withPublishingOptionsMixin` constructs a mixin object that can be merged into the `privateca_ca_pool`
Terraform resource block to set or update the publishing_options field.
...
`google.privateca_ca_pool.withTier` constructs a mixin object that can be merged into the `privateca_ca_pool`
...
`google.privateca_ca_pool.withTimeouts` constructs a mixin object that can be merged into the `privateca_ca_pool`
...
`google.privateca_ca_pool.withTimeoutsMixin` constructs a mixin object that can be merged into the `privateca_ca_pool`
Terraform resource block to set or update the timeouts field.
