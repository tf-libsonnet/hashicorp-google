...
`google.identity_platform_tenant.withAllowPasswordSignup` constructs a mixin object that can be merged into the `identity_platform_tenant`
...
`google.identity_platform_tenant.withDisableAuth` constructs a mixin object that can be merged into the `identity_platform_tenant`
...
`google.identity_platform_tenant.withDisplayName` constructs a mixin object that can be merged into the `identity_platform_tenant`
...
`google.identity_platform_tenant.withEnableEmailLinkSignin` constructs a mixin object that can be merged into the `identity_platform_tenant`
...
`google.identity_platform_tenant.withProject` constructs a mixin object that can be merged into the `identity_platform_tenant`
...
`google.identity_platform_tenant.withTimeouts` constructs a mixin object that can be merged into the `identity_platform_tenant`
...
`google.identity_platform_tenant.withTimeoutsMixin` constructs a mixin object that can be merged into the `identity_platform_tenant`
Terraform resource block to set or update the timeouts field.
