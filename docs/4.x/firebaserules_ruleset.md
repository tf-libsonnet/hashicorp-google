...
`google.firebaserules_ruleset.withProject` constructs a mixin object that can be merged into the `firebaserules_ruleset`
...
`google.firebaserules_ruleset.withSource` constructs a mixin object that can be merged into the `firebaserules_ruleset`
...
`google.firebaserules_ruleset.withSourceMixin` constructs a mixin object that can be merged into the `firebaserules_ruleset`
Terraform resource block to set or update the source field.
...
`google.firebaserules_ruleset.withTimeouts` constructs a mixin object that can be merged into the `firebaserules_ruleset`
...
`google.firebaserules_ruleset.withTimeoutsMixin` constructs a mixin object that can be merged into the `firebaserules_ruleset`
Terraform resource block to set or update the timeouts field.
