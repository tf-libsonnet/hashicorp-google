...
`google.artifact_registry_repository.withDescription` constructs a mixin object that can be merged into the `artifact_registry_repository`
...
`google.artifact_registry_repository.withFormat` constructs a mixin object that can be merged into the `artifact_registry_repository`
...
`google.artifact_registry_repository.withKmsKeyName` constructs a mixin object that can be merged into the `artifact_registry_repository`
...
`google.artifact_registry_repository.withLabels` constructs a mixin object that can be merged into the `artifact_registry_repository`
...
`google.artifact_registry_repository.withMavenConfig` constructs a mixin object that can be merged into the `artifact_registry_repository`
...
`google.artifact_registry_repository.withMavenConfigMixin` constructs a mixin object that can be merged into the `artifact_registry_repository`
Terraform resource block to set or update the maven_config field.
...
`google.artifact_registry_repository.withTimeouts` constructs a mixin object that can be merged into the `artifact_registry_repository`
...
`google.artifact_registry_repository.withTimeoutsMixin` constructs a mixin object that can be merged into the `artifact_registry_repository`
Terraform resource block to set or update the timeouts field.
