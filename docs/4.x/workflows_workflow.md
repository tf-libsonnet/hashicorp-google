...
`google.workflows_workflow.withDescription` constructs a mixin object that can be merged into the `workflows_workflow`
...
`google.workflows_workflow.withLabels` constructs a mixin object that can be merged into the `workflows_workflow`
...
`google.workflows_workflow.withName` constructs a mixin object that can be merged into the `workflows_workflow`
...
`google.workflows_workflow.withNamePrefix` constructs a mixin object that can be merged into the `workflows_workflow`
...
`google.workflows_workflow.withProject` constructs a mixin object that can be merged into the `workflows_workflow`
...
`google.workflows_workflow.withRegion` constructs a mixin object that can be merged into the `workflows_workflow`
...
`google.workflows_workflow.withServiceAccount` constructs a mixin object that can be merged into the `workflows_workflow`
...
`google.workflows_workflow.withSourceContents` constructs a mixin object that can be merged into the `workflows_workflow`
...
`google.workflows_workflow.withTimeouts` constructs a mixin object that can be merged into the `workflows_workflow`
...
`google.workflows_workflow.withTimeoutsMixin` constructs a mixin object that can be merged into the `workflows_workflow`
Terraform resource block to set or update the timeouts field.
