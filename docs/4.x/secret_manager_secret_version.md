...
`google.secret_manager_secret_version.withEnabled` constructs a mixin object that can be merged into the `secret_manager_secret_version`
...
`google.secret_manager_secret_version.withSecret` constructs a mixin object that can be merged into the `secret_manager_secret_version`
...
`google.secret_manager_secret_version.withSecretData` constructs a mixin object that can be merged into the `secret_manager_secret_version`
...
`google.secret_manager_secret_version.withTimeouts` constructs a mixin object that can be merged into the `secret_manager_secret_version`
...
`google.secret_manager_secret_version.withTimeoutsMixin` constructs a mixin object that can be merged into the `secret_manager_secret_version`
Terraform resource block to set or update the timeouts field.
