...
`google.notebooks_runtime.withAccessConfig` constructs a mixin object that can be merged into the `notebooks_runtime`
...
`google.notebooks_runtime.withAccessConfigMixin` constructs a mixin object that can be merged into the `notebooks_runtime`
Terraform resource block to set or update the access_config field.
...
`google.notebooks_runtime.withLocation` constructs a mixin object that can be merged into the `notebooks_runtime`
...
`google.notebooks_runtime.withName` constructs a mixin object that can be merged into the `notebooks_runtime`
...
`google.notebooks_runtime.withProject` constructs a mixin object that can be merged into the `notebooks_runtime`
...
`google.notebooks_runtime.withSoftwareConfig` constructs a mixin object that can be merged into the `notebooks_runtime`
...
`google.notebooks_runtime.withSoftwareConfigMixin` constructs a mixin object that can be merged into the `notebooks_runtime`
Terraform resource block to set or update the software_config field.
...
`google.notebooks_runtime.withTimeouts` constructs a mixin object that can be merged into the `notebooks_runtime`
...
`google.notebooks_runtime.withTimeoutsMixin` constructs a mixin object that can be merged into the `notebooks_runtime`
Terraform resource block to set or update the timeouts field.
...
`google.notebooks_runtime.withVirtualMachine` constructs a mixin object that can be merged into the `notebooks_runtime`
...
`google.notebooks_runtime.withVirtualMachineMixin` constructs a mixin object that can be merged into the `notebooks_runtime`
Terraform resource block to set or update the virtual_machine field.
