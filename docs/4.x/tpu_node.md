...
`google.tpu_node.withAcceleratorType` constructs a mixin object that can be merged into the `tpu_node`
...
`google.tpu_node.withCidrBlock` constructs a mixin object that can be merged into the `tpu_node`
...
`google.tpu_node.withDescription` constructs a mixin object that can be merged into the `tpu_node`
...
`google.tpu_node.withLabels` constructs a mixin object that can be merged into the `tpu_node`
...
`google.tpu_node.withName` constructs a mixin object that can be merged into the `tpu_node`
...
`google.tpu_node.withNetwork` constructs a mixin object that can be merged into the `tpu_node`
...
`google.tpu_node.withProject` constructs a mixin object that can be merged into the `tpu_node`
...
`google.tpu_node.withSchedulingConfig` constructs a mixin object that can be merged into the `tpu_node`
...
`google.tpu_node.withSchedulingConfigMixin` constructs a mixin object that can be merged into the `tpu_node`
Terraform resource block to set or update the scheduling_config field.
...
`google.tpu_node.withTensorflowVersion` constructs a mixin object that can be merged into the `tpu_node`
...
`google.tpu_node.withTimeouts` constructs a mixin object that can be merged into the `tpu_node`
...
`google.tpu_node.withTimeoutsMixin` constructs a mixin object that can be merged into the `tpu_node`
Terraform resource block to set or update the timeouts field.
...
`google.tpu_node.withUseServiceNetworking` constructs a mixin object that can be merged into the `tpu_node`
...
`google.tpu_node.withZone` constructs a mixin object that can be merged into the `tpu_node`
