...
`google.dialogflow_entity_type.withDisplayName` constructs a mixin object that can be merged into the `dialogflow_entity_type`
...
`google.dialogflow_entity_type.withEnableFuzzyExtraction` constructs a mixin object that can be merged into the `dialogflow_entity_type`
...
`google.dialogflow_entity_type.withEntities` constructs a mixin object that can be merged into the `dialogflow_entity_type`
...
`google.dialogflow_entity_type.withEntitiesMixin` constructs a mixin object that can be merged into the `dialogflow_entity_type`
Terraform resource block to set or update the entities field.
...
`google.dialogflow_entity_type.withKind` constructs a mixin object that can be merged into the `dialogflow_entity_type`
...
`google.dialogflow_entity_type.withProject` constructs a mixin object that can be merged into the `dialogflow_entity_type`
...
`google.dialogflow_entity_type.withTimeouts` constructs a mixin object that can be merged into the `dialogflow_entity_type`
...
`google.dialogflow_entity_type.withTimeoutsMixin` constructs a mixin object that can be merged into the `dialogflow_entity_type`
Terraform resource block to set or update the timeouts field.
