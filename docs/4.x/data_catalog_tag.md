...
`google.data_catalog_tag.withColumn` constructs a mixin object that can be merged into the `data_catalog_tag`
...
`google.data_catalog_tag.withFields` constructs a mixin object that can be merged into the `data_catalog_tag`
...
`google.data_catalog_tag.withFieldsMixin` constructs a mixin object that can be merged into the `data_catalog_tag`
Terraform resource block to set or update the fields field.
...
`google.data_catalog_tag.withParent` constructs a mixin object that can be merged into the `data_catalog_tag`
...
`google.data_catalog_tag.withTemplate` constructs a mixin object that can be merged into the `data_catalog_tag`
...
`google.data_catalog_tag.withTimeouts` constructs a mixin object that can be merged into the `data_catalog_tag`
...
`google.data_catalog_tag.withTimeoutsMixin` constructs a mixin object that can be merged into the `data_catalog_tag`
Terraform resource block to set or update the timeouts field.
