...
`google.compute_address.withAddress` constructs a mixin object that can be merged into the `compute_address`
...
`google.compute_address.withAddressType` constructs a mixin object that can be merged into the `compute_address`
...
`google.compute_address.withDescription` constructs a mixin object that can be merged into the `compute_address`
...
`google.compute_address.withNetwork` constructs a mixin object that can be merged into the `compute_address`
...
`google.compute_address.withNetworkTier` constructs a mixin object that can be merged into the `compute_address`
...
`google.compute_address.withPrefixLength` constructs a mixin object that can be merged into the `compute_address`
...
`google.compute_address.withPurpose` constructs a mixin object that can be merged into the `compute_address`
...
`google.compute_address.withSubnetwork` constructs a mixin object that can be merged into the `compute_address`
...
`google.compute_address.withTimeouts` constructs a mixin object that can be merged into the `compute_address`
...
`google.compute_address.withTimeoutsMixin` constructs a mixin object that can be merged into the `compute_address`
Terraform resource block to set or update the timeouts field.
