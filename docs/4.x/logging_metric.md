...
`google.logging_metric.withBucketOptions` constructs a mixin object that can be merged into the `logging_metric`
...
`google.logging_metric.withBucketOptionsMixin` constructs a mixin object that can be merged into the `logging_metric`
Terraform resource block to set or update the bucket_options field.
...
`google.logging_metric.withDescription` constructs a mixin object that can be merged into the `logging_metric`
...
`google.logging_metric.withFilter` constructs a mixin object that can be merged into the `logging_metric`
...
`google.logging_metric.withLabelExtractors` constructs a mixin object that can be merged into the `logging_metric`
...
`google.logging_metric.withMetricDescriptor` constructs a mixin object that can be merged into the `logging_metric`
...
`google.logging_metric.withMetricDescriptorMixin` constructs a mixin object that can be merged into the `logging_metric`
Terraform resource block to set or update the metric_descriptor field.
...
`google.logging_metric.withName` constructs a mixin object that can be merged into the `logging_metric`
...
`google.logging_metric.withProject` constructs a mixin object that can be merged into the `logging_metric`
...
`google.logging_metric.withTimeouts` constructs a mixin object that can be merged into the `logging_metric`
...
`google.logging_metric.withTimeoutsMixin` constructs a mixin object that can be merged into the `logging_metric`
Terraform resource block to set or update the timeouts field.
...
`google.logging_metric.withValueExtractor` constructs a mixin object that can be merged into the `logging_metric`
