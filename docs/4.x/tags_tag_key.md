...
`google.tags_tag_key.withDescription` constructs a mixin object that can be merged into the `tags_tag_key`
...
`google.tags_tag_key.withPurpose` constructs a mixin object that can be merged into the `tags_tag_key`
...
`google.tags_tag_key.withPurposeData` constructs a mixin object that can be merged into the `tags_tag_key`
...
`google.tags_tag_key.withTimeouts` constructs a mixin object that can be merged into the `tags_tag_key`
...
`google.tags_tag_key.withTimeoutsMixin` constructs a mixin object that can be merged into the `tags_tag_key`
Terraform resource block to set or update the timeouts field.
