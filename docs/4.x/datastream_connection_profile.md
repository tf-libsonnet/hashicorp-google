...
`google.datastream_connection_profile.withBigqueryProfile` constructs a mixin object that can be merged into the `datastream_connection_profile`
...
`google.datastream_connection_profile.withBigqueryProfileMixin` constructs a mixin object that can be merged into the `datastream_connection_profile`
Terraform resource block to set or update the bigquery_profile field.
...
`google.datastream_connection_profile.withConnectionProfileId` constructs a mixin object that can be merged into the `datastream_connection_profile`
...
`google.datastream_connection_profile.withDisplayName` constructs a mixin object that can be merged into the `datastream_connection_profile`
...
`google.datastream_connection_profile.withForwardSshConnectivity` constructs a mixin object that can be merged into the `datastream_connection_profile`
...
`google.datastream_connection_profile.withForwardSshConnectivityMixin` constructs a mixin object that can be merged into the `datastream_connection_profile`
Terraform resource block to set or update the forward_ssh_connectivity field.
...
`google.datastream_connection_profile.withGcsProfile` constructs a mixin object that can be merged into the `datastream_connection_profile`
...
`google.datastream_connection_profile.withGcsProfileMixin` constructs a mixin object that can be merged into the `datastream_connection_profile`
Terraform resource block to set or update the gcs_profile field.
...
`google.datastream_connection_profile.withLabels` constructs a mixin object that can be merged into the `datastream_connection_profile`
...
`google.datastream_connection_profile.withLocation` constructs a mixin object that can be merged into the `datastream_connection_profile`
...
`google.datastream_connection_profile.withMysqlProfile` constructs a mixin object that can be merged into the `datastream_connection_profile`
...
`google.datastream_connection_profile.withMysqlProfileMixin` constructs a mixin object that can be merged into the `datastream_connection_profile`
Terraform resource block to set or update the mysql_profile field.
...
`google.datastream_connection_profile.withOracleProfile` constructs a mixin object that can be merged into the `datastream_connection_profile`
...
`google.datastream_connection_profile.withOracleProfileMixin` constructs a mixin object that can be merged into the `datastream_connection_profile`
Terraform resource block to set or update the oracle_profile field.
...
`google.datastream_connection_profile.withPostgresqlProfile` constructs a mixin object that can be merged into the `datastream_connection_profile`
...
`google.datastream_connection_profile.withPostgresqlProfileMixin` constructs a mixin object that can be merged into the `datastream_connection_profile`
Terraform resource block to set or update the postgresql_profile field.
...
`google.datastream_connection_profile.withPrivateConnectivity` constructs a mixin object that can be merged into the `datastream_connection_profile`
...
`google.datastream_connection_profile.withPrivateConnectivityMixin` constructs a mixin object that can be merged into the `datastream_connection_profile`
Terraform resource block to set or update the private_connectivity field.
...
`google.datastream_connection_profile.withProject` constructs a mixin object that can be merged into the `datastream_connection_profile`
...
`google.datastream_connection_profile.withTimeouts` constructs a mixin object that can be merged into the `datastream_connection_profile`
...
`google.datastream_connection_profile.withTimeoutsMixin` constructs a mixin object that can be merged into the `datastream_connection_profile`
Terraform resource block to set or update the timeouts field.
