---
permalink: /network_security_address_group_iam_member/
---

# network_security_address_group_iam_member

`network_security_address_group_iam_member` represents the `google_network_security_address_group_iam_member` Terraform resource.
