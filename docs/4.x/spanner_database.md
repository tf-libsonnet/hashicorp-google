...
`google.spanner_database.withDatabaseDialect` constructs a mixin object that can be merged into the `spanner_database`
...
`google.spanner_database.withDdl` constructs a mixin object that can be merged into the `spanner_database`
...
`google.spanner_database.withDeletionProtection` constructs a mixin object that can be merged into the `spanner_database`
...
`google.spanner_database.withEncryptionConfig` constructs a mixin object that can be merged into the `spanner_database`
...
`google.spanner_database.withEncryptionConfigMixin` constructs a mixin object that can be merged into the `spanner_database`
Terraform resource block to set or update the encryption_config field.
...
`google.spanner_database.withInstance` constructs a mixin object that can be merged into the `spanner_database`
...
`google.spanner_database.withName` constructs a mixin object that can be merged into the `spanner_database`
...
`google.spanner_database.withProject` constructs a mixin object that can be merged into the `spanner_database`
...
`google.spanner_database.withTimeouts` constructs a mixin object that can be merged into the `spanner_database`
...
`google.spanner_database.withTimeoutsMixin` constructs a mixin object that can be merged into the `spanner_database`
Terraform resource block to set or update the timeouts field.
...
`google.spanner_database.withVersionRetentionPeriod` constructs a mixin object that can be merged into the `spanner_database`
