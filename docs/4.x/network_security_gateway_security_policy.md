---
permalink: /network_security_gateway_security_policy/
---

# network_security_gateway_security_policy

`network_security_gateway_security_policy` represents the `google_network_security_gateway_security_policy` Terraform resource.
