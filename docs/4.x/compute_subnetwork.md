...
`google.compute_subnetwork.withDescription` constructs a mixin object that can be merged into the `compute_subnetwork`
...
`google.compute_subnetwork.withIpCidrRange` constructs a mixin object that can be merged into the `compute_subnetwork`
...
`google.compute_subnetwork.withIpv6AccessType` constructs a mixin object that can be merged into the `compute_subnetwork`
...
`google.compute_subnetwork.withLogConfig` constructs a mixin object that can be merged into the `compute_subnetwork`
...
`google.compute_subnetwork.withLogConfigMixin` constructs a mixin object that can be merged into the `compute_subnetwork`
Terraform resource block to set or update the log_config field.
...
`google.compute_subnetwork.withName` constructs a mixin object that can be merged into the `compute_subnetwork`
...
`google.compute_subnetwork.withNetwork` constructs a mixin object that can be merged into the `compute_subnetwork`
...
`google.compute_subnetwork.withPrivateIpGoogleAccess` constructs a mixin object that can be merged into the `compute_subnetwork`
...
`google.compute_subnetwork.withPrivateIpv6GoogleAccess` constructs a mixin object that can be merged into the `compute_subnetwork`
...
`google.compute_subnetwork.withProject` constructs a mixin object that can be merged into the `compute_subnetwork`
...
`google.compute_subnetwork.withPurpose` constructs a mixin object that can be merged into the `compute_subnetwork`
...
`google.compute_subnetwork.withRegion` constructs a mixin object that can be merged into the `compute_subnetwork`
...
`google.compute_subnetwork.withRole` constructs a mixin object that can be merged into the `compute_subnetwork`
...
`google.compute_subnetwork.withSecondaryIpRange` constructs a mixin object that can be merged into the `compute_subnetwork`
...
`google.compute_subnetwork.withStackType` constructs a mixin object that can be merged into the `compute_subnetwork`
...
`google.compute_subnetwork.withTimeouts` constructs a mixin object that can be merged into the `compute_subnetwork`
...
`google.compute_subnetwork.withTimeoutsMixin` constructs a mixin object that can be merged into the `compute_subnetwork`
Terraform resource block to set or update the timeouts field.
