...
`google.monitoring_custom_service.withDisplayName` constructs a mixin object that can be merged into the `monitoring_custom_service`
...
`google.monitoring_custom_service.withProject` constructs a mixin object that can be merged into the `monitoring_custom_service`
...
`google.monitoring_custom_service.withServiceId` constructs a mixin object that can be merged into the `monitoring_custom_service`
...
`google.monitoring_custom_service.withTelemetry` constructs a mixin object that can be merged into the `monitoring_custom_service`
...
`google.monitoring_custom_service.withTelemetryMixin` constructs a mixin object that can be merged into the `monitoring_custom_service`
Terraform resource block to set or update the telemetry field.
...
`google.monitoring_custom_service.withTimeouts` constructs a mixin object that can be merged into the `monitoring_custom_service`
...
`google.monitoring_custom_service.withTimeoutsMixin` constructs a mixin object that can be merged into the `monitoring_custom_service`
Terraform resource block to set or update the timeouts field.
...
`google.monitoring_custom_service.withUserLabels` constructs a mixin object that can be merged into the `monitoring_custom_service`
