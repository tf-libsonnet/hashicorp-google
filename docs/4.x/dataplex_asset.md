...
`google.dataplex_asset.withDataplexZone` constructs a mixin object that can be merged into the `dataplex_asset`
...
`google.dataplex_asset.withDescription` constructs a mixin object that can be merged into the `dataplex_asset`
...
`google.dataplex_asset.withDiscoverySpec` constructs a mixin object that can be merged into the `dataplex_asset`
...
`google.dataplex_asset.withDiscoverySpecMixin` constructs a mixin object that can be merged into the `dataplex_asset`
Terraform resource block to set or update the discovery_spec field.
...
`google.dataplex_asset.withDisplayName` constructs a mixin object that can be merged into the `dataplex_asset`
...
`google.dataplex_asset.withLabels` constructs a mixin object that can be merged into the `dataplex_asset`
...
`google.dataplex_asset.withLake` constructs a mixin object that can be merged into the `dataplex_asset`
...
`google.dataplex_asset.withLocation` constructs a mixin object that can be merged into the `dataplex_asset`
...
`google.dataplex_asset.withName` constructs a mixin object that can be merged into the `dataplex_asset`
...
`google.dataplex_asset.withProject` constructs a mixin object that can be merged into the `dataplex_asset`
...
`google.dataplex_asset.withResourceSpec` constructs a mixin object that can be merged into the `dataplex_asset`
...
`google.dataplex_asset.withResourceSpecMixin` constructs a mixin object that can be merged into the `dataplex_asset`
Terraform resource block to set or update the resource_spec field.
...
`google.dataplex_asset.withTimeouts` constructs a mixin object that can be merged into the `dataplex_asset`
...
`google.dataplex_asset.withTimeoutsMixin` constructs a mixin object that can be merged into the `dataplex_asset`
Terraform resource block to set or update the timeouts field.
