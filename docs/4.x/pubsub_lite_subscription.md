...
`google.pubsub_lite_subscription.withDeliveryConfig` constructs a mixin object that can be merged into the `pubsub_lite_subscription`
...
`google.pubsub_lite_subscription.withDeliveryConfigMixin` constructs a mixin object that can be merged into the `pubsub_lite_subscription`
Terraform resource block to set or update the delivery_config field.
...
`google.pubsub_lite_subscription.withName` constructs a mixin object that can be merged into the `pubsub_lite_subscription`
...
`google.pubsub_lite_subscription.withProject` constructs a mixin object that can be merged into the `pubsub_lite_subscription`
...
`google.pubsub_lite_subscription.withRegion` constructs a mixin object that can be merged into the `pubsub_lite_subscription`
...
`google.pubsub_lite_subscription.withTimeouts` constructs a mixin object that can be merged into the `pubsub_lite_subscription`
...
`google.pubsub_lite_subscription.withTimeoutsMixin` constructs a mixin object that can be merged into the `pubsub_lite_subscription`
Terraform resource block to set or update the timeouts field.
...
`google.pubsub_lite_subscription.withTopic` constructs a mixin object that can be merged into the `pubsub_lite_subscription`
...
`google.pubsub_lite_subscription.withZone` constructs a mixin object that can be merged into the `pubsub_lite_subscription`
