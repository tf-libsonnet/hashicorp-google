---
permalink: /secure_source_manager_instance_iam_binding/
---

# secure_source_manager_instance_iam_binding

`secure_source_manager_instance_iam_binding` represents the `google_secure_source_manager_instance_iam_binding` Terraform resource.
