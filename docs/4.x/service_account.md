...
`google.service_account.withDescription` constructs a mixin object that can be merged into the `service_account`
...
`google.service_account.withDisabled` constructs a mixin object that can be merged into the `service_account`
...
`google.service_account.withDisplayName` constructs a mixin object that can be merged into the `service_account`
...
`google.service_account.withTimeouts` constructs a mixin object that can be merged into the `service_account`
...
`google.service_account.withTimeoutsMixin` constructs a mixin object that can be merged into the `service_account`
Terraform resource block to set or update the timeouts field.
