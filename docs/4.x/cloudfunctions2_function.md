...
`google.cloudfunctions2_function.withBuildConfig` constructs a mixin object that can be merged into the `cloudfunctions2_function`
...
`google.cloudfunctions2_function.withBuildConfigMixin` constructs a mixin object that can be merged into the `cloudfunctions2_function`
Terraform resource block to set or update the build_config field.
...
`google.cloudfunctions2_function.withDescription` constructs a mixin object that can be merged into the `cloudfunctions2_function`
...
`google.cloudfunctions2_function.withEventTrigger` constructs a mixin object that can be merged into the `cloudfunctions2_function`
...
`google.cloudfunctions2_function.withEventTriggerMixin` constructs a mixin object that can be merged into the `cloudfunctions2_function`
Terraform resource block to set or update the event_trigger field.
...
`google.cloudfunctions2_function.withLabels` constructs a mixin object that can be merged into the `cloudfunctions2_function`
...
`google.cloudfunctions2_function.withServiceConfig` constructs a mixin object that can be merged into the `cloudfunctions2_function`
...
`google.cloudfunctions2_function.withServiceConfigMixin` constructs a mixin object that can be merged into the `cloudfunctions2_function`
Terraform resource block to set or update the service_config field.
...
`google.cloudfunctions2_function.withTimeouts` constructs a mixin object that can be merged into the `cloudfunctions2_function`
...
`google.cloudfunctions2_function.withTimeoutsMixin` constructs a mixin object that can be merged into the `cloudfunctions2_function`
Terraform resource block to set or update the timeouts field.
