...
`google.compute_global_forwarding_rule.withDescription` constructs a mixin object that can be merged into the `compute_global_forwarding_rule`
...
`google.compute_global_forwarding_rule.withIpAddress` constructs a mixin object that can be merged into the `compute_global_forwarding_rule`
...
`google.compute_global_forwarding_rule.withIpProtocol` constructs a mixin object that can be merged into the `compute_global_forwarding_rule`
...
`google.compute_global_forwarding_rule.withIpVersion` constructs a mixin object that can be merged into the `compute_global_forwarding_rule`
...
`google.compute_global_forwarding_rule.withLabels` constructs a mixin object that can be merged into the `compute_global_forwarding_rule`
...
`google.compute_global_forwarding_rule.withLoadBalancingScheme` constructs a mixin object that can be merged into the `compute_global_forwarding_rule`
...
`google.compute_global_forwarding_rule.withMetadataFilters` constructs a mixin object that can be merged into the `compute_global_forwarding_rule`
...
`google.compute_global_forwarding_rule.withMetadataFiltersMixin` constructs a mixin object that can be merged into the `compute_global_forwarding_rule`
Terraform resource block to set or update the metadata_filters field.
...
`google.compute_global_forwarding_rule.withName` constructs a mixin object that can be merged into the `compute_global_forwarding_rule`
...
`google.compute_global_forwarding_rule.withNetwork` constructs a mixin object that can be merged into the `compute_global_forwarding_rule`
...
`google.compute_global_forwarding_rule.withPortRange` constructs a mixin object that can be merged into the `compute_global_forwarding_rule`
...
`google.compute_global_forwarding_rule.withProject` constructs a mixin object that can be merged into the `compute_global_forwarding_rule`
...
`google.compute_global_forwarding_rule.withTarget` constructs a mixin object that can be merged into the `compute_global_forwarding_rule`
...
`google.compute_global_forwarding_rule.withTimeouts` constructs a mixin object that can be merged into the `compute_global_forwarding_rule`
...
`google.compute_global_forwarding_rule.withTimeoutsMixin` constructs a mixin object that can be merged into the `compute_global_forwarding_rule`
Terraform resource block to set or update the timeouts field.
