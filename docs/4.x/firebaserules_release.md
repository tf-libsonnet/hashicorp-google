...
`google.firebaserules_release.withName` constructs a mixin object that can be merged into the `firebaserules_release`
...
`google.firebaserules_release.withProject` constructs a mixin object that can be merged into the `firebaserules_release`
...
`google.firebaserules_release.withRulesetName` constructs a mixin object that can be merged into the `firebaserules_release`
...
`google.firebaserules_release.withTimeouts` constructs a mixin object that can be merged into the `firebaserules_release`
...
`google.firebaserules_release.withTimeoutsMixin` constructs a mixin object that can be merged into the `firebaserules_release`
Terraform resource block to set or update the timeouts field.
