...
`google.project_organization_policy.withBooleanPolicy` constructs a mixin object that can be merged into the `project_organization_policy`
...
`google.project_organization_policy.withBooleanPolicyMixin` constructs a mixin object that can be merged into the `project_organization_policy`
Terraform resource block to set or update the boolean_policy field.
...
`google.project_organization_policy.withListPolicy` constructs a mixin object that can be merged into the `project_organization_policy`
...
`google.project_organization_policy.withListPolicyMixin` constructs a mixin object that can be merged into the `project_organization_policy`
Terraform resource block to set or update the list_policy field.
...
`google.project_organization_policy.withRestorePolicy` constructs a mixin object that can be merged into the `project_organization_policy`
...
`google.project_organization_policy.withRestorePolicyMixin` constructs a mixin object that can be merged into the `project_organization_policy`
Terraform resource block to set or update the restore_policy field.
...
`google.project_organization_policy.withTimeouts` constructs a mixin object that can be merged into the `project_organization_policy`
...
`google.project_organization_policy.withTimeoutsMixin` constructs a mixin object that can be merged into the `project_organization_policy`
Terraform resource block to set or update the timeouts field.
...
`google.project_organization_policy.withVersion` constructs a mixin object that can be merged into the `project_organization_policy`
