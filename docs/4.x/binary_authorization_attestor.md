...
`google.binary_authorization_attestor.withAttestationAuthorityNote` constructs a mixin object that can be merged into the `binary_authorization_attestor`
...
`google.binary_authorization_attestor.withAttestationAuthorityNoteMixin` constructs a mixin object that can be merged into the `binary_authorization_attestor`
Terraform resource block to set or update the attestation_authority_note field.
...
`google.binary_authorization_attestor.withDescription` constructs a mixin object that can be merged into the `binary_authorization_attestor`
...
`google.binary_authorization_attestor.withName` constructs a mixin object that can be merged into the `binary_authorization_attestor`
...
`google.binary_authorization_attestor.withProject` constructs a mixin object that can be merged into the `binary_authorization_attestor`
...
`google.binary_authorization_attestor.withTimeouts` constructs a mixin object that can be merged into the `binary_authorization_attestor`
...
`google.binary_authorization_attestor.withTimeoutsMixin` constructs a mixin object that can be merged into the `binary_authorization_attestor`
Terraform resource block to set or update the timeouts field.
