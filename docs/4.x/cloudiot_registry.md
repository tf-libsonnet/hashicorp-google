...
`google.cloudiot_registry.withCredentials` constructs a mixin object that can be merged into the `cloudiot_registry`
...
`google.cloudiot_registry.withCredentialsMixin` constructs a mixin object that can be merged into the `cloudiot_registry`
Terraform resource block to set or update the credentials field.
...
`google.cloudiot_registry.withEventNotificationConfigs` constructs a mixin object that can be merged into the `cloudiot_registry`
...
`google.cloudiot_registry.withEventNotificationConfigsMixin` constructs a mixin object that can be merged into the `cloudiot_registry`
Terraform resource block to set or update the event_notification_configs field.
...
`google.cloudiot_registry.withHttpConfig` constructs a mixin object that can be merged into the `cloudiot_registry`
...
`google.cloudiot_registry.withLogLevel` constructs a mixin object that can be merged into the `cloudiot_registry`
...
`google.cloudiot_registry.withMqttConfig` constructs a mixin object that can be merged into the `cloudiot_registry`
...
`google.cloudiot_registry.withName` constructs a mixin object that can be merged into the `cloudiot_registry`
...
`google.cloudiot_registry.withProject` constructs a mixin object that can be merged into the `cloudiot_registry`
...
`google.cloudiot_registry.withRegion` constructs a mixin object that can be merged into the `cloudiot_registry`
...
`google.cloudiot_registry.withStateNotificationConfig` constructs a mixin object that can be merged into the `cloudiot_registry`
...
`google.cloudiot_registry.withTimeouts` constructs a mixin object that can be merged into the `cloudiot_registry`
...
`google.cloudiot_registry.withTimeoutsMixin` constructs a mixin object that can be merged into the `cloudiot_registry`
Terraform resource block to set or update the timeouts field.
