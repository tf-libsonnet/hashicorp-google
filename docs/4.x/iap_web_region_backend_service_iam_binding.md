---
permalink: /iap_web_region_backend_service_iam_binding/
---

# iap_web_region_backend_service_iam_binding

`iap_web_region_backend_service_iam_binding` represents the `google_iap_web_region_backend_service_iam_binding` Terraform resource.
