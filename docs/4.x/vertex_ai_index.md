...
`google.vertex_ai_index.withDescription` constructs a mixin object that can be merged into the `vertex_ai_index`
...
`google.vertex_ai_index.withDisplayName` constructs a mixin object that can be merged into the `vertex_ai_index`
...
`google.vertex_ai_index.withIndexUpdateMethod` constructs a mixin object that can be merged into the `vertex_ai_index`
...
`google.vertex_ai_index.withLabels` constructs a mixin object that can be merged into the `vertex_ai_index`
...
`google.vertex_ai_index.withMetadata` constructs a mixin object that can be merged into the `vertex_ai_index`
...
`google.vertex_ai_index.withMetadataMixin` constructs a mixin object that can be merged into the `vertex_ai_index`
Terraform resource block to set or update the metadata field.
...
`google.vertex_ai_index.withProject` constructs a mixin object that can be merged into the `vertex_ai_index`
...
`google.vertex_ai_index.withRegion` constructs a mixin object that can be merged into the `vertex_ai_index`
...
`google.vertex_ai_index.withTimeouts` constructs a mixin object that can be merged into the `vertex_ai_index`
...
`google.vertex_ai_index.withTimeoutsMixin` constructs a mixin object that can be merged into the `vertex_ai_index`
Terraform resource block to set or update the timeouts field.
