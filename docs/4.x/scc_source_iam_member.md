...
`google.scc_source_iam_member.withCondition` constructs a mixin object that can be merged into the `scc_source_iam_member`
...
`google.scc_source_iam_member.withConditionMixin` constructs a mixin object that can be merged into the `scc_source_iam_member`
Terraform resource block to set or update the condition field.
...
`google.scc_source_iam_member.withMember` constructs a mixin object that can be merged into the `scc_source_iam_member`
...
`google.scc_source_iam_member.withOrganization` constructs a mixin object that can be merged into the `scc_source_iam_member`
...
`google.scc_source_iam_member.withRole` constructs a mixin object that can be merged into the `scc_source_iam_member`
...
`google.scc_source_iam_member.withSource` constructs a mixin object that can be merged into the `scc_source_iam_member`
