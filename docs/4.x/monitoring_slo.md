...
`google.monitoring_slo.withBasicSli` constructs a mixin object that can be merged into the `monitoring_slo`
...
`google.monitoring_slo.withBasicSliMixin` constructs a mixin object that can be merged into the `monitoring_slo`
Terraform resource block to set or update the basic_sli field.
...
`google.monitoring_slo.withCalendarPeriod` constructs a mixin object that can be merged into the `monitoring_slo`
...
`google.monitoring_slo.withDisplayName` constructs a mixin object that can be merged into the `monitoring_slo`
...
`google.monitoring_slo.withGoal` constructs a mixin object that can be merged into the `monitoring_slo`
...
`google.monitoring_slo.withProject` constructs a mixin object that can be merged into the `monitoring_slo`
...
`google.monitoring_slo.withRequestBasedSli` constructs a mixin object that can be merged into the `monitoring_slo`
...
`google.monitoring_slo.withRequestBasedSliMixin` constructs a mixin object that can be merged into the `monitoring_slo`
Terraform resource block to set or update the request_based_sli field.
...
`google.monitoring_slo.withRollingPeriodDays` constructs a mixin object that can be merged into the `monitoring_slo`
...
`google.monitoring_slo.withService` constructs a mixin object that can be merged into the `monitoring_slo`
...
`google.monitoring_slo.withSloId` constructs a mixin object that can be merged into the `monitoring_slo`
...
`google.monitoring_slo.withTimeouts` constructs a mixin object that can be merged into the `monitoring_slo`
...
`google.monitoring_slo.withTimeoutsMixin` constructs a mixin object that can be merged into the `monitoring_slo`
Terraform resource block to set or update the timeouts field.
...
`google.monitoring_slo.withUserLabels` constructs a mixin object that can be merged into the `monitoring_slo`
...
`google.monitoring_slo.withWindowsBasedSli` constructs a mixin object that can be merged into the `monitoring_slo`
...
`google.monitoring_slo.withWindowsBasedSliMixin` constructs a mixin object that can be merged into the `monitoring_slo`
Terraform resource block to set or update the windows_based_sli field.
