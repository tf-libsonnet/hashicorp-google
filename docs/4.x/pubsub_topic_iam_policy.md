---
permalink: /pubsub_topic_iam_policy/
---

# pubsub_topic_iam_policy

`pubsub_topic_iam_policy` represents the `google_pubsub_topic_iam_policy` Terraform resource.
...
Unlike [google.pubsub_topic_iam_policy.new](#fn-pubsubtopiciampolicynew), this function will not inject the `resource`
...
`google.pubsub_topic_iam_policy.withPolicyData` constructs a mixin object that can be merged into the `pubsub_topic_iam_policy`
...
`google.pubsub_topic_iam_policy.withProject` constructs a mixin object that can be merged into the `pubsub_topic_iam_policy`
...
`google.pubsub_topic_iam_policy.withTopic` constructs a mixin object that can be merged into the `pubsub_topic_iam_policy`
