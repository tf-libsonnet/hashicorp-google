...
`google.filestore_instance.withDescription` constructs a mixin object that can be merged into the `filestore_instance`
...
`google.filestore_instance.withFileShares` constructs a mixin object that can be merged into the `filestore_instance`
...
`google.filestore_instance.withFileSharesMixin` constructs a mixin object that can be merged into the `filestore_instance`
Terraform resource block to set or update the file_shares field.
...
`google.filestore_instance.withKmsKeyName` constructs a mixin object that can be merged into the `filestore_instance`
...
`google.filestore_instance.withLabels` constructs a mixin object that can be merged into the `filestore_instance`
...
`google.filestore_instance.withLocation` constructs a mixin object that can be merged into the `filestore_instance`
...
`google.filestore_instance.withName` constructs a mixin object that can be merged into the `filestore_instance`
...
`google.filestore_instance.withNetworks` constructs a mixin object that can be merged into the `filestore_instance`
...
`google.filestore_instance.withNetworksMixin` constructs a mixin object that can be merged into the `filestore_instance`
Terraform resource block to set or update the networks field.
...
`google.filestore_instance.withProject` constructs a mixin object that can be merged into the `filestore_instance`
...
`google.filestore_instance.withTier` constructs a mixin object that can be merged into the `filestore_instance`
...
`google.filestore_instance.withTimeouts` constructs a mixin object that can be merged into the `filestore_instance`
...
`google.filestore_instance.withTimeoutsMixin` constructs a mixin object that can be merged into the `filestore_instance`
Terraform resource block to set or update the timeouts field.
...
`google.filestore_instance.withZone` constructs a mixin object that can be merged into the `filestore_instance`
