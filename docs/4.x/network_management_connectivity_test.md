...
`google.network_management_connectivity_test.withDescription` constructs a mixin object that can be merged into the `network_management_connectivity_test`
...
`google.network_management_connectivity_test.withDestination` constructs a mixin object that can be merged into the `network_management_connectivity_test`
...
`google.network_management_connectivity_test.withDestinationMixin` constructs a mixin object that can be merged into the `network_management_connectivity_test`
Terraform resource block to set or update the destination field.
...
`google.network_management_connectivity_test.withLabels` constructs a mixin object that can be merged into the `network_management_connectivity_test`
...
`google.network_management_connectivity_test.withName` constructs a mixin object that can be merged into the `network_management_connectivity_test`
...
`google.network_management_connectivity_test.withProject` constructs a mixin object that can be merged into the `network_management_connectivity_test`
...
`google.network_management_connectivity_test.withProtocol` constructs a mixin object that can be merged into the `network_management_connectivity_test`
...
`google.network_management_connectivity_test.withRelatedProjects` constructs a mixin object that can be merged into the `network_management_connectivity_test`
...
`google.network_management_connectivity_test.withSource` constructs a mixin object that can be merged into the `network_management_connectivity_test`
...
`google.network_management_connectivity_test.withSourceMixin` constructs a mixin object that can be merged into the `network_management_connectivity_test`
Terraform resource block to set or update the source field.
...
`google.network_management_connectivity_test.withTimeouts` constructs a mixin object that can be merged into the `network_management_connectivity_test`
...
`google.network_management_connectivity_test.withTimeoutsMixin` constructs a mixin object that can be merged into the `network_management_connectivity_test`
Terraform resource block to set or update the timeouts field.
