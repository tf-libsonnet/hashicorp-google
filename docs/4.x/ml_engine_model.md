...
`google.ml_engine_model.withDefaultVersion` constructs a mixin object that can be merged into the `ml_engine_model`
...
`google.ml_engine_model.withDefaultVersionMixin` constructs a mixin object that can be merged into the `ml_engine_model`
Terraform resource block to set or update the default_version field.
...
`google.ml_engine_model.withDescription` constructs a mixin object that can be merged into the `ml_engine_model`
...
`google.ml_engine_model.withLabels` constructs a mixin object that can be merged into the `ml_engine_model`
...
`google.ml_engine_model.withName` constructs a mixin object that can be merged into the `ml_engine_model`
...
`google.ml_engine_model.withOnlinePredictionConsoleLogging` constructs a mixin object that can be merged into the `ml_engine_model`
...
`google.ml_engine_model.withOnlinePredictionLogging` constructs a mixin object that can be merged into the `ml_engine_model`
...
`google.ml_engine_model.withProject` constructs a mixin object that can be merged into the `ml_engine_model`
...
`google.ml_engine_model.withRegions` constructs a mixin object that can be merged into the `ml_engine_model`
...
`google.ml_engine_model.withTimeouts` constructs a mixin object that can be merged into the `ml_engine_model`
...
`google.ml_engine_model.withTimeoutsMixin` constructs a mixin object that can be merged into the `ml_engine_model`
Terraform resource block to set or update the timeouts field.
