...
`google.bigquery_analytics_hub_data_exchange.withDescription` constructs a mixin object that can be merged into the `bigquery_analytics_hub_data_exchange`
