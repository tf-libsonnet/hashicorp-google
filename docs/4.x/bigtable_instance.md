...
`google.bigtable_instance.withCluster` constructs a mixin object that can be merged into the `bigtable_instance`
...
`google.bigtable_instance.withClusterMixin` constructs a mixin object that can be merged into the `bigtable_instance`
Terraform resource block to set or update the cluster field.
...
`google.bigtable_instance.withDeletionProtection` constructs a mixin object that can be merged into the `bigtable_instance`
...
`google.bigtable_instance.withDisplayName` constructs a mixin object that can be merged into the `bigtable_instance`
...
`google.bigtable_instance.withInstanceType` constructs a mixin object that can be merged into the `bigtable_instance`
...
`google.bigtable_instance.withLabels` constructs a mixin object that can be merged into the `bigtable_instance`
...
`google.bigtable_instance.withName` constructs a mixin object that can be merged into the `bigtable_instance`
...
`google.bigtable_instance.withProject` constructs a mixin object that can be merged into the `bigtable_instance`
