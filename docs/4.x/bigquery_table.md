...
`google.bigquery_table.withClustering` constructs a mixin object that can be merged into the `bigquery_table`
...
`google.bigquery_table.withDatasetId` constructs a mixin object that can be merged into the `bigquery_table`
...
`google.bigquery_table.withDeletionProtection` constructs a mixin object that can be merged into the `bigquery_table`
...
`google.bigquery_table.withDescription` constructs a mixin object that can be merged into the `bigquery_table`
...
`google.bigquery_table.withEncryptionConfiguration` constructs a mixin object that can be merged into the `bigquery_table`
...
`google.bigquery_table.withEncryptionConfigurationMixin` constructs a mixin object that can be merged into the `bigquery_table`
Terraform resource block to set or update the encryption_configuration field.
...
`google.bigquery_table.withExpirationTime` constructs a mixin object that can be merged into the `bigquery_table`
...
`google.bigquery_table.withExternalDataConfiguration` constructs a mixin object that can be merged into the `bigquery_table`
...
`google.bigquery_table.withExternalDataConfigurationMixin` constructs a mixin object that can be merged into the `bigquery_table`
Terraform resource block to set or update the external_data_configuration field.
...
`google.bigquery_table.withFriendlyName` constructs a mixin object that can be merged into the `bigquery_table`
...
`google.bigquery_table.withLabels` constructs a mixin object that can be merged into the `bigquery_table`
...
`google.bigquery_table.withMaterializedView` constructs a mixin object that can be merged into the `bigquery_table`
...
`google.bigquery_table.withMaterializedViewMixin` constructs a mixin object that can be merged into the `bigquery_table`
Terraform resource block to set or update the materialized_view field.
...
`google.bigquery_table.withProject` constructs a mixin object that can be merged into the `bigquery_table`
...
`google.bigquery_table.withRangePartitioning` constructs a mixin object that can be merged into the `bigquery_table`
...
`google.bigquery_table.withRangePartitioningMixin` constructs a mixin object that can be merged into the `bigquery_table`
Terraform resource block to set or update the range_partitioning field.
...
`google.bigquery_table.withSchema` constructs a mixin object that can be merged into the `bigquery_table`
...
`google.bigquery_table.withTableId` constructs a mixin object that can be merged into the `bigquery_table`
...
`google.bigquery_table.withTimePartitioning` constructs a mixin object that can be merged into the `bigquery_table`
...
`google.bigquery_table.withTimePartitioningMixin` constructs a mixin object that can be merged into the `bigquery_table`
Terraform resource block to set or update the time_partitioning field.
...
`google.bigquery_table.withView` constructs a mixin object that can be merged into the `bigquery_table`
...
`google.bigquery_table.withViewMixin` constructs a mixin object that can be merged into the `bigquery_table`
Terraform resource block to set or update the view field.
