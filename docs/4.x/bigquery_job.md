...
`google.bigquery_job.withCopy` constructs a mixin object that can be merged into the `bigquery_job`
...
`google.bigquery_job.withCopyMixin` constructs a mixin object that can be merged into the `bigquery_job`
Terraform resource block to set or update the copy field.
...
`google.bigquery_job.withExtract` constructs a mixin object that can be merged into the `bigquery_job`
...
`google.bigquery_job.withExtractMixin` constructs a mixin object that can be merged into the `bigquery_job`
Terraform resource block to set or update the extract field.
...
`google.bigquery_job.withJobId` constructs a mixin object that can be merged into the `bigquery_job`
...
`google.bigquery_job.withJobTimeoutMs` constructs a mixin object that can be merged into the `bigquery_job`
...
`google.bigquery_job.withLabels` constructs a mixin object that can be merged into the `bigquery_job`
...
`google.bigquery_job.withLoad` constructs a mixin object that can be merged into the `bigquery_job`
...
`google.bigquery_job.withLoadMixin` constructs a mixin object that can be merged into the `bigquery_job`
Terraform resource block to set or update the load field.
...
`google.bigquery_job.withLocation` constructs a mixin object that can be merged into the `bigquery_job`
...
`google.bigquery_job.withProject` constructs a mixin object that can be merged into the `bigquery_job`
...
`google.bigquery_job.withQuery` constructs a mixin object that can be merged into the `bigquery_job`
...
`google.bigquery_job.withQueryMixin` constructs a mixin object that can be merged into the `bigquery_job`
Terraform resource block to set or update the query field.
...
`google.bigquery_job.withTimeouts` constructs a mixin object that can be merged into the `bigquery_job`
...
`google.bigquery_job.withTimeoutsMixin` constructs a mixin object that can be merged into the `bigquery_job`
Terraform resource block to set or update the timeouts field.
