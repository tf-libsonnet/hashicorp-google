...
`google.compute_route.withDescription` constructs a mixin object that can be merged into the `compute_route`
...
`google.compute_route.withDestRange` constructs a mixin object that can be merged into the `compute_route`
...
`google.compute_route.withName` constructs a mixin object that can be merged into the `compute_route`
...
`google.compute_route.withNetwork` constructs a mixin object that can be merged into the `compute_route`
...
`google.compute_route.withNextHopGateway` constructs a mixin object that can be merged into the `compute_route`
...
`google.compute_route.withNextHopIlb` constructs a mixin object that can be merged into the `compute_route`
...
`google.compute_route.withNextHopInstance` constructs a mixin object that can be merged into the `compute_route`
...
`google.compute_route.withNextHopInstanceZone` constructs a mixin object that can be merged into the `compute_route`
...
`google.compute_route.withNextHopIp` constructs a mixin object that can be merged into the `compute_route`
...
`google.compute_route.withNextHopVpnTunnel` constructs a mixin object that can be merged into the `compute_route`
...
`google.compute_route.withPriority` constructs a mixin object that can be merged into the `compute_route`
...
`google.compute_route.withProject` constructs a mixin object that can be merged into the `compute_route`
...
`google.compute_route.withTags` constructs a mixin object that can be merged into the `compute_route`
...
`google.compute_route.withTimeouts` constructs a mixin object that can be merged into the `compute_route`
...
`google.compute_route.withTimeoutsMixin` constructs a mixin object that can be merged into the `compute_route`
Terraform resource block to set or update the timeouts field.
