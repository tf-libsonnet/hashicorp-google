...
`google.compute_instance_group_manager.withAutoHealingPolicies` constructs a mixin object that can be merged into the `compute_instance_group_manager`
...
`google.compute_instance_group_manager.withAutoHealingPoliciesMixin` constructs a mixin object that can be merged into the `compute_instance_group_manager`
Terraform resource block to set or update the auto_healing_policies field.
...
`google.compute_instance_group_manager.withBaseInstanceName` constructs a mixin object that can be merged into the `compute_instance_group_manager`
...
`google.compute_instance_group_manager.withDescription` constructs a mixin object that can be merged into the `compute_instance_group_manager`
...
`google.compute_instance_group_manager.withListManagedInstancesResults` constructs a mixin object that can be merged into the `compute_instance_group_manager`
...
`google.compute_instance_group_manager.withName` constructs a mixin object that can be merged into the `compute_instance_group_manager`
...
`google.compute_instance_group_manager.withNamedPort` constructs a mixin object that can be merged into the `compute_instance_group_manager`
...
`google.compute_instance_group_manager.withNamedPortMixin` constructs a mixin object that can be merged into the `compute_instance_group_manager`
Terraform resource block to set or update the named_port field.
...
`google.compute_instance_group_manager.withProject` constructs a mixin object that can be merged into the `compute_instance_group_manager`
...
`google.compute_instance_group_manager.withStatefulDisk` constructs a mixin object that can be merged into the `compute_instance_group_manager`
...
`google.compute_instance_group_manager.withStatefulDiskMixin` constructs a mixin object that can be merged into the `compute_instance_group_manager`
Terraform resource block to set or update the stateful_disk field.
...
`google.compute_instance_group_manager.withTargetPools` constructs a mixin object that can be merged into the `compute_instance_group_manager`
...
`google.compute_instance_group_manager.withTargetSize` constructs a mixin object that can be merged into the `compute_instance_group_manager`
...
`google.compute_instance_group_manager.withTimeouts` constructs a mixin object that can be merged into the `compute_instance_group_manager`
...
`google.compute_instance_group_manager.withTimeoutsMixin` constructs a mixin object that can be merged into the `compute_instance_group_manager`
Terraform resource block to set or update the timeouts field.
...
`google.compute_instance_group_manager.withUpdatePolicy` constructs a mixin object that can be merged into the `compute_instance_group_manager`
...
`google.compute_instance_group_manager.withUpdatePolicyMixin` constructs a mixin object that can be merged into the `compute_instance_group_manager`
Terraform resource block to set or update the update_policy field.
...
`google.compute_instance_group_manager.withVersion` constructs a mixin object that can be merged into the `compute_instance_group_manager`
...
`google.compute_instance_group_manager.withVersionMixin` constructs a mixin object that can be merged into the `compute_instance_group_manager`
Terraform resource block to set or update the version field.
...
`google.compute_instance_group_manager.withWaitForInstances` constructs a mixin object that can be merged into the `compute_instance_group_manager`
...
`google.compute_instance_group_manager.withWaitForInstancesStatus` constructs a mixin object that can be merged into the `compute_instance_group_manager`
...
`google.compute_instance_group_manager.withZone` constructs a mixin object that can be merged into the `compute_instance_group_manager`
