---
permalink: /healthcare_dataset/
---

# healthcare_dataset

`healthcare_dataset` represents the `google_healthcare_dataset` Terraform resource.
...
`google.healthcare_dataset.withLocation` constructs a mixin object that can be merged into the `healthcare_dataset`
...
`google.healthcare_dataset.withName` constructs a mixin object that can be merged into the `healthcare_dataset`
...
`google.healthcare_dataset.withProject` constructs a mixin object that can be merged into the `healthcare_dataset`
...
`google.healthcare_dataset.withTimeZone` constructs a mixin object that can be merged into the `healthcare_dataset`
...
`google.healthcare_dataset.withTimeouts` constructs a mixin object that can be merged into the `healthcare_dataset`
...
`google.healthcare_dataset.withTimeoutsMixin` constructs a mixin object that can be merged into the `healthcare_dataset`
Terraform resource block to set or update the timeouts field.
