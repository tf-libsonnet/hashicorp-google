...
`google.data_catalog_entry.withDescription` constructs a mixin object that can be merged into the `data_catalog_entry`
...
`google.data_catalog_entry.withDisplayName` constructs a mixin object that can be merged into the `data_catalog_entry`
...
`google.data_catalog_entry.withEntryGroup` constructs a mixin object that can be merged into the `data_catalog_entry`
...
`google.data_catalog_entry.withEntryId` constructs a mixin object that can be merged into the `data_catalog_entry`
...
`google.data_catalog_entry.withGcsFilesetSpec` constructs a mixin object that can be merged into the `data_catalog_entry`
...
`google.data_catalog_entry.withGcsFilesetSpecMixin` constructs a mixin object that can be merged into the `data_catalog_entry`
Terraform resource block to set or update the gcs_fileset_spec field.
...
`google.data_catalog_entry.withLinkedResource` constructs a mixin object that can be merged into the `data_catalog_entry`
...
`google.data_catalog_entry.withSchema` constructs a mixin object that can be merged into the `data_catalog_entry`
...
`google.data_catalog_entry.withTimeouts` constructs a mixin object that can be merged into the `data_catalog_entry`
...
`google.data_catalog_entry.withTimeoutsMixin` constructs a mixin object that can be merged into the `data_catalog_entry`
Terraform resource block to set or update the timeouts field.
...
`google.data_catalog_entry.withType` constructs a mixin object that can be merged into the `data_catalog_entry`
...
`google.data_catalog_entry.withUserSpecifiedSystem` constructs a mixin object that can be merged into the `data_catalog_entry`
...
`google.data_catalog_entry.withUserSpecifiedType` constructs a mixin object that can be merged into the `data_catalog_entry`
