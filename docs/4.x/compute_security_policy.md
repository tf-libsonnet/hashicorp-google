...
`google.compute_security_policy.withAdaptiveProtectionConfig` constructs a mixin object that can be merged into the `compute_security_policy`
...
`google.compute_security_policy.withAdaptiveProtectionConfigMixin` constructs a mixin object that can be merged into the `compute_security_policy`
Terraform resource block to set or update the adaptive_protection_config field.
...
`google.compute_security_policy.withAdvancedOptionsConfig` constructs a mixin object that can be merged into the `compute_security_policy`
...
`google.compute_security_policy.withAdvancedOptionsConfigMixin` constructs a mixin object that can be merged into the `compute_security_policy`
Terraform resource block to set or update the advanced_options_config field.
...
`google.compute_security_policy.withDescription` constructs a mixin object that can be merged into the `compute_security_policy`
...
`google.compute_security_policy.withName` constructs a mixin object that can be merged into the `compute_security_policy`
...
`google.compute_security_policy.withProject` constructs a mixin object that can be merged into the `compute_security_policy`
...
`google.compute_security_policy.withRecaptchaOptionsConfig` constructs a mixin object that can be merged into the `compute_security_policy`
...
`google.compute_security_policy.withRecaptchaOptionsConfigMixin` constructs a mixin object that can be merged into the `compute_security_policy`
Terraform resource block to set or update the recaptcha_options_config field.
...
`google.compute_security_policy.withRule` constructs a mixin object that can be merged into the `compute_security_policy`
...
`google.compute_security_policy.withRuleMixin` constructs a mixin object that can be merged into the `compute_security_policy`
Terraform resource block to set or update the rule field.
...
`google.compute_security_policy.withTimeouts` constructs a mixin object that can be merged into the `compute_security_policy`
...
`google.compute_security_policy.withTimeoutsMixin` constructs a mixin object that can be merged into the `compute_security_policy`
Terraform resource block to set or update the timeouts field.
...
`google.compute_security_policy.withType` constructs a mixin object that can be merged into the `compute_security_policy`
