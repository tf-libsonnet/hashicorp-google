...
`google.compute_snapshot.withChainName` constructs a mixin object that can be merged into the `compute_snapshot`
...
`google.compute_snapshot.withDescription` constructs a mixin object that can be merged into the `compute_snapshot`
...
`google.compute_snapshot.withLabels` constructs a mixin object that can be merged into the `compute_snapshot`
...
`google.compute_snapshot.withName` constructs a mixin object that can be merged into the `compute_snapshot`
...
`google.compute_snapshot.withProject` constructs a mixin object that can be merged into the `compute_snapshot`
...
`google.compute_snapshot.withSnapshotEncryptionKey` constructs a mixin object that can be merged into the `compute_snapshot`
...
`google.compute_snapshot.withSnapshotEncryptionKeyMixin` constructs a mixin object that can be merged into the `compute_snapshot`
Terraform resource block to set or update the snapshot_encryption_key field.
...
`google.compute_snapshot.withSourceDisk` constructs a mixin object that can be merged into the `compute_snapshot`
...
`google.compute_snapshot.withSourceDiskEncryptionKey` constructs a mixin object that can be merged into the `compute_snapshot`
...
`google.compute_snapshot.withSourceDiskEncryptionKeyMixin` constructs a mixin object that can be merged into the `compute_snapshot`
Terraform resource block to set or update the source_disk_encryption_key field.
...
`google.compute_snapshot.withStorageLocations` constructs a mixin object that can be merged into the `compute_snapshot`
...
`google.compute_snapshot.withTimeouts` constructs a mixin object that can be merged into the `compute_snapshot`
...
`google.compute_snapshot.withTimeoutsMixin` constructs a mixin object that can be merged into the `compute_snapshot`
Terraform resource block to set or update the timeouts field.
...
`google.compute_snapshot.withZone` constructs a mixin object that can be merged into the `compute_snapshot`
