---
permalink: /iap_tunnel_instance_iam_policy/
---

# iap_tunnel_instance_iam_policy

`iap_tunnel_instance_iam_policy` represents the `google_iap_tunnel_instance_iam_policy` Terraform resource.
...
Unlike [google.iap_tunnel_instance_iam_policy.new](#fn-iaptunnelinstanceiampolicynew), this function will not inject the `resource`
...
`google.iap_tunnel_instance_iam_policy.withInstance` constructs a mixin object that can be merged into the `iap_tunnel_instance_iam_policy`
...
`google.iap_tunnel_instance_iam_policy.withPolicyData` constructs a mixin object that can be merged into the `iap_tunnel_instance_iam_policy`
...
`google.iap_tunnel_instance_iam_policy.withProject` constructs a mixin object that can be merged into the `iap_tunnel_instance_iam_policy`
...
`google.iap_tunnel_instance_iam_policy.withZone` constructs a mixin object that can be merged into the `iap_tunnel_instance_iam_policy`
