...
`google.secret_manager_secret.withExpireTime` constructs a mixin object that can be merged into the `secret_manager_secret`
...
`google.secret_manager_secret.withLabels` constructs a mixin object that can be merged into the `secret_manager_secret`
...
`google.secret_manager_secret.withProject` constructs a mixin object that can be merged into the `secret_manager_secret`
...
`google.secret_manager_secret.withReplication` constructs a mixin object that can be merged into the `secret_manager_secret`
...
`google.secret_manager_secret.withReplicationMixin` constructs a mixin object that can be merged into the `secret_manager_secret`
Terraform resource block to set or update the replication field.
...
`google.secret_manager_secret.withRotation` constructs a mixin object that can be merged into the `secret_manager_secret`
...
`google.secret_manager_secret.withRotationMixin` constructs a mixin object that can be merged into the `secret_manager_secret`
Terraform resource block to set or update the rotation field.
...
`google.secret_manager_secret.withSecretId` constructs a mixin object that can be merged into the `secret_manager_secret`
...
`google.secret_manager_secret.withTimeouts` constructs a mixin object that can be merged into the `secret_manager_secret`
...
`google.secret_manager_secret.withTimeoutsMixin` constructs a mixin object that can be merged into the `secret_manager_secret`
Terraform resource block to set or update the timeouts field.
...
`google.secret_manager_secret.withTopics` constructs a mixin object that can be merged into the `secret_manager_secret`
...
`google.secret_manager_secret.withTopicsMixin` constructs a mixin object that can be merged into the `secret_manager_secret`
Terraform resource block to set or update the topics field.
...
`google.secret_manager_secret.withTtl` constructs a mixin object that can be merged into the `secret_manager_secret`
