...
`google.cloudfunctions_function.withAvailableMemoryMb` constructs a mixin object that can be merged into the `cloudfunctions_function`
...
`google.cloudfunctions_function.withBuildEnvironmentVariables` constructs a mixin object that can be merged into the `cloudfunctions_function`
...
`google.cloudfunctions_function.withBuildWorkerPool` constructs a mixin object that can be merged into the `cloudfunctions_function`
...
`google.cloudfunctions_function.withDescription` constructs a mixin object that can be merged into the `cloudfunctions_function`
...
`google.cloudfunctions_function.withDockerRegistry` constructs a mixin object that can be merged into the `cloudfunctions_function`
...
`google.cloudfunctions_function.withDockerRepository` constructs a mixin object that can be merged into the `cloudfunctions_function`
...
`google.cloudfunctions_function.withEntryPoint` constructs a mixin object that can be merged into the `cloudfunctions_function`
...
`google.cloudfunctions_function.withEnvironmentVariables` constructs a mixin object that can be merged into the `cloudfunctions_function`
...
`google.cloudfunctions_function.withEventTrigger` constructs a mixin object that can be merged into the `cloudfunctions_function`
...
`google.cloudfunctions_function.withEventTriggerMixin` constructs a mixin object that can be merged into the `cloudfunctions_function`
Terraform resource block to set or update the event_trigger field.
...
`google.cloudfunctions_function.withHttpsTriggerSecurityLevel` constructs a mixin object that can be merged into the `cloudfunctions_function`
...
`google.cloudfunctions_function.withHttpsTriggerUrl` constructs a mixin object that can be merged into the `cloudfunctions_function`
...
`google.cloudfunctions_function.withIngressSettings` constructs a mixin object that can be merged into the `cloudfunctions_function`
...
`google.cloudfunctions_function.withKmsKeyName` constructs a mixin object that can be merged into the `cloudfunctions_function`
...
`google.cloudfunctions_function.withLabels` constructs a mixin object that can be merged into the `cloudfunctions_function`
...
`google.cloudfunctions_function.withMaxInstances` constructs a mixin object that can be merged into the `cloudfunctions_function`
...
`google.cloudfunctions_function.withMinInstances` constructs a mixin object that can be merged into the `cloudfunctions_function`
...
`google.cloudfunctions_function.withName` constructs a mixin object that can be merged into the `cloudfunctions_function`
...
`google.cloudfunctions_function.withProject` constructs a mixin object that can be merged into the `cloudfunctions_function`
...
`google.cloudfunctions_function.withRegion` constructs a mixin object that can be merged into the `cloudfunctions_function`
...
`google.cloudfunctions_function.withRuntime` constructs a mixin object that can be merged into the `cloudfunctions_function`
...
`google.cloudfunctions_function.withSecretEnvironmentVariables` constructs a mixin object that can be merged into the `cloudfunctions_function`
...
`google.cloudfunctions_function.withSecretEnvironmentVariablesMixin` constructs a mixin object that can be merged into the `cloudfunctions_function`
Terraform resource block to set or update the secret_environment_variables field.
...
`google.cloudfunctions_function.withSecretVolumes` constructs a mixin object that can be merged into the `cloudfunctions_function`
...
`google.cloudfunctions_function.withSecretVolumesMixin` constructs a mixin object that can be merged into the `cloudfunctions_function`
Terraform resource block to set or update the secret_volumes field.
...
`google.cloudfunctions_function.withServiceAccountEmail` constructs a mixin object that can be merged into the `cloudfunctions_function`
...
`google.cloudfunctions_function.withSourceArchiveBucket` constructs a mixin object that can be merged into the `cloudfunctions_function`
...
`google.cloudfunctions_function.withSourceArchiveObject` constructs a mixin object that can be merged into the `cloudfunctions_function`
...
`google.cloudfunctions_function.withSourceRepository` constructs a mixin object that can be merged into the `cloudfunctions_function`
...
`google.cloudfunctions_function.withSourceRepositoryMixin` constructs a mixin object that can be merged into the `cloudfunctions_function`
Terraform resource block to set or update the source_repository field.
...
`google.cloudfunctions_function.withTimeout` constructs a mixin object that can be merged into the `cloudfunctions_function`
...
`google.cloudfunctions_function.withTimeouts` constructs a mixin object that can be merged into the `cloudfunctions_function`
...
`google.cloudfunctions_function.withTimeoutsMixin` constructs a mixin object that can be merged into the `cloudfunctions_function`
Terraform resource block to set or update the timeouts field.
...
`google.cloudfunctions_function.withTriggerHttp` constructs a mixin object that can be merged into the `cloudfunctions_function`
...
`google.cloudfunctions_function.withVpcConnector` constructs a mixin object that can be merged into the `cloudfunctions_function`
...
`google.cloudfunctions_function.withVpcConnectorEgressSettings` constructs a mixin object that can be merged into the `cloudfunctions_function`
