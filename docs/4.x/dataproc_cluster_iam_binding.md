...
**Args**:
  ...
  - `role` (`string`): 
  - `condition` (`list[obj]`):  When `null`, the `condition` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google.dataproc_cluster_iam_binding.condition.new](#fn-dataproc_cluster_iam_bindingconditionnew) constructor.
...
Unlike [google.dataproc_cluster_iam_binding.new](#fn-dataproc_cluster_iam_bindingnew), this function will not inject the `resource`
