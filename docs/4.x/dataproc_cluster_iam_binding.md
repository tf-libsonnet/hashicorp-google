---
permalink: /dataproc_cluster_iam_binding/
---

# dataproc_cluster_iam_binding

`dataproc_cluster_iam_binding` represents the `google_dataproc_cluster_iam_binding` Terraform resource.
...
`google.dataproc_cluster_iam_binding.withCluster` constructs a mixin object that can be merged into the `dataproc_cluster_iam_binding`
...
`google.dataproc_cluster_iam_binding.withCondition` constructs a mixin object that can be merged into the `dataproc_cluster_iam_binding`
...
`google.dataproc_cluster_iam_binding.withConditionMixin` constructs a mixin object that can be merged into the `dataproc_cluster_iam_binding`
Terraform resource block to set or update the condition field.
...
`google.dataproc_cluster_iam_binding.withMembers` constructs a mixin object that can be merged into the `dataproc_cluster_iam_binding`
...
`google.dataproc_cluster_iam_binding.withProject` constructs a mixin object that can be merged into the `dataproc_cluster_iam_binding`
...
`google.dataproc_cluster_iam_binding.withRegion` constructs a mixin object that can be merged into the `dataproc_cluster_iam_binding`
...
`google.dataproc_cluster_iam_binding.withRole` constructs a mixin object that can be merged into the `dataproc_cluster_iam_binding`
