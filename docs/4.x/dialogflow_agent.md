...
`google.dialogflow_agent.withApiVersion` constructs a mixin object that can be merged into the `dialogflow_agent`
...
`google.dialogflow_agent.withAvatarUri` constructs a mixin object that can be merged into the `dialogflow_agent`
...
`google.dialogflow_agent.withClassificationThreshold` constructs a mixin object that can be merged into the `dialogflow_agent`
...
`google.dialogflow_agent.withDefaultLanguageCode` constructs a mixin object that can be merged into the `dialogflow_agent`
...
`google.dialogflow_agent.withDescription` constructs a mixin object that can be merged into the `dialogflow_agent`
...
`google.dialogflow_agent.withDisplayName` constructs a mixin object that can be merged into the `dialogflow_agent`
...
`google.dialogflow_agent.withEnableLogging` constructs a mixin object that can be merged into the `dialogflow_agent`
...
`google.dialogflow_agent.withMatchMode` constructs a mixin object that can be merged into the `dialogflow_agent`
...
`google.dialogflow_agent.withProject` constructs a mixin object that can be merged into the `dialogflow_agent`
...
`google.dialogflow_agent.withSupportedLanguageCodes` constructs a mixin object that can be merged into the `dialogflow_agent`
...
`google.dialogflow_agent.withTier` constructs a mixin object that can be merged into the `dialogflow_agent`
...
`google.dialogflow_agent.withTimeZone` constructs a mixin object that can be merged into the `dialogflow_agent`
...
`google.dialogflow_agent.withTimeouts` constructs a mixin object that can be merged into the `dialogflow_agent`
...
`google.dialogflow_agent.withTimeoutsMixin` constructs a mixin object that can be merged into the `dialogflow_agent`
Terraform resource block to set or update the timeouts field.
