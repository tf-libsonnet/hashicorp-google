...
`google.access_context_manager_access_levels.withAccessLevels` constructs a mixin object that can be merged into the `access_context_manager_access_levels`
...
`google.access_context_manager_access_levels.withAccessLevelsMixin` constructs a mixin object that can be merged into the `access_context_manager_access_levels`
Terraform resource block to set or update the access_levels field.
...
`google.access_context_manager_access_levels.withParent` constructs a mixin object that can be merged into the `access_context_manager_access_levels`
...
`google.access_context_manager_access_levels.withTimeouts` constructs a mixin object that can be merged into the `access_context_manager_access_levels`
...
`google.access_context_manager_access_levels.withTimeoutsMixin` constructs a mixin object that can be merged into the `access_context_manager_access_levels`
Terraform resource block to set or update the timeouts field.
