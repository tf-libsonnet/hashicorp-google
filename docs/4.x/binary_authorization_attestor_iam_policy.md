...
`google.binary_authorization_attestor_iam_policy.withAttestor` constructs a mixin object that can be merged into the `binary_authorization_attestor_iam_policy`
...
`google.binary_authorization_attestor_iam_policy.withPolicyData` constructs a mixin object that can be merged into the `binary_authorization_attestor_iam_policy`
...
`google.binary_authorization_attestor_iam_policy.withProject` constructs a mixin object that can be merged into the `binary_authorization_attestor_iam_policy`
