...
`google.storage_bucket.withAutoclass` constructs a mixin object that can be merged into the `storage_bucket`
...
`google.storage_bucket.withAutoclassMixin` constructs a mixin object that can be merged into the `storage_bucket`
Terraform resource block to set or update the autoclass field.
...
`google.storage_bucket.withCors` constructs a mixin object that can be merged into the `storage_bucket`
...
`google.storage_bucket.withCorsMixin` constructs a mixin object that can be merged into the `storage_bucket`
Terraform resource block to set or update the cors field.
...
`google.storage_bucket.withCustomPlacementConfig` constructs a mixin object that can be merged into the `storage_bucket`
...
`google.storage_bucket.withCustomPlacementConfigMixin` constructs a mixin object that can be merged into the `storage_bucket`
Terraform resource block to set or update the custom_placement_config field.
...
`google.storage_bucket.withDefaultEventBasedHold` constructs a mixin object that can be merged into the `storage_bucket`
...
`google.storage_bucket.withEncryption` constructs a mixin object that can be merged into the `storage_bucket`
...
`google.storage_bucket.withEncryptionMixin` constructs a mixin object that can be merged into the `storage_bucket`
Terraform resource block to set or update the encryption field.
...
`google.storage_bucket.withForceDestroy` constructs a mixin object that can be merged into the `storage_bucket`
...
`google.storage_bucket.withLabels` constructs a mixin object that can be merged into the `storage_bucket`
...
`google.storage_bucket.withLifecycleRule` constructs a mixin object that can be merged into the `storage_bucket`
...
`google.storage_bucket.withLifecycleRuleMixin` constructs a mixin object that can be merged into the `storage_bucket`
Terraform resource block to set or update the lifecycle_rule field.
...
`google.storage_bucket.withLocation` constructs a mixin object that can be merged into the `storage_bucket`
...
`google.storage_bucket.withLogging` constructs a mixin object that can be merged into the `storage_bucket`
...
`google.storage_bucket.withLoggingMixin` constructs a mixin object that can be merged into the `storage_bucket`
Terraform resource block to set or update the logging field.
...
`google.storage_bucket.withProject` constructs a mixin object that can be merged into the `storage_bucket`
...
`google.storage_bucket.withPublicAccessPrevention` constructs a mixin object that can be merged into the `storage_bucket`
...
`google.storage_bucket.withRequesterPays` constructs a mixin object that can be merged into the `storage_bucket`
...
`google.storage_bucket.withRetentionPolicy` constructs a mixin object that can be merged into the `storage_bucket`
...
`google.storage_bucket.withRetentionPolicyMixin` constructs a mixin object that can be merged into the `storage_bucket`
Terraform resource block to set or update the retention_policy field.
...
`google.storage_bucket.withStorageClass` constructs a mixin object that can be merged into the `storage_bucket`
...
`google.storage_bucket.withTimeouts` constructs a mixin object that can be merged into the `storage_bucket`
...
`google.storage_bucket.withTimeoutsMixin` constructs a mixin object that can be merged into the `storage_bucket`
Terraform resource block to set or update the timeouts field.
...
`google.storage_bucket.withUniformBucketLevelAccess` constructs a mixin object that can be merged into the `storage_bucket`
...
`google.storage_bucket.withVersioning` constructs a mixin object that can be merged into the `storage_bucket`
...
`google.storage_bucket.withVersioningMixin` constructs a mixin object that can be merged into the `storage_bucket`
Terraform resource block to set or update the versioning field.
...
`google.storage_bucket.withWebsite` constructs a mixin object that can be merged into the `storage_bucket`
...
`google.storage_bucket.withWebsiteMixin` constructs a mixin object that can be merged into the `storage_bucket`
Terraform resource block to set or update the website field.
