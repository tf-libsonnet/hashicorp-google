...
`google.game_services_realm.withDescription` constructs a mixin object that can be merged into the `game_services_realm`
...
`google.game_services_realm.withLabels` constructs a mixin object that can be merged into the `game_services_realm`
...
`google.game_services_realm.withLocation` constructs a mixin object that can be merged into the `game_services_realm`
...
`google.game_services_realm.withProject` constructs a mixin object that can be merged into the `game_services_realm`
...
`google.game_services_realm.withRealmId` constructs a mixin object that can be merged into the `game_services_realm`
...
`google.game_services_realm.withTimeZone` constructs a mixin object that can be merged into the `game_services_realm`
...
`google.game_services_realm.withTimeouts` constructs a mixin object that can be merged into the `game_services_realm`
...
`google.game_services_realm.withTimeoutsMixin` constructs a mixin object that can be merged into the `game_services_realm`
Terraform resource block to set or update the timeouts field.
