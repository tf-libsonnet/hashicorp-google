...
`google.iam_workload_identity_pool.withDescription` constructs a mixin object that can be merged into the `iam_workload_identity_pool`
...
`google.iam_workload_identity_pool.withDisabled` constructs a mixin object that can be merged into the `iam_workload_identity_pool`
...
`google.iam_workload_identity_pool.withDisplayName` constructs a mixin object that can be merged into the `iam_workload_identity_pool`
...
`google.iam_workload_identity_pool.withProject` constructs a mixin object that can be merged into the `iam_workload_identity_pool`
...
`google.iam_workload_identity_pool.withTimeouts` constructs a mixin object that can be merged into the `iam_workload_identity_pool`
...
`google.iam_workload_identity_pool.withTimeoutsMixin` constructs a mixin object that can be merged into the `iam_workload_identity_pool`
Terraform resource block to set or update the timeouts field.
...
`google.iam_workload_identity_pool.withWorkloadIdentityPoolId` constructs a mixin object that can be merged into the `iam_workload_identity_pool`
