---
permalink: /access_context_manager_ingress_policy/
---

# access_context_manager_ingress_policy

`access_context_manager_ingress_policy` represents the `google_access_context_manager_ingress_policy` Terraform resource.
...
`google.string.withIngressPolicyName` constructs a mixin object that can be merged into the `string`
