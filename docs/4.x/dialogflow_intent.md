...
`google.dialogflow_intent.withAction` constructs a mixin object that can be merged into the `dialogflow_intent`
...
`google.dialogflow_intent.withDefaultResponsePlatforms` constructs a mixin object that can be merged into the `dialogflow_intent`
...
`google.dialogflow_intent.withDisplayName` constructs a mixin object that can be merged into the `dialogflow_intent`
...
`google.dialogflow_intent.withEvents` constructs a mixin object that can be merged into the `dialogflow_intent`
...
`google.dialogflow_intent.withInputContextNames` constructs a mixin object that can be merged into the `dialogflow_intent`
...
`google.dialogflow_intent.withIsFallback` constructs a mixin object that can be merged into the `dialogflow_intent`
...
`google.dialogflow_intent.withMlDisabled` constructs a mixin object that can be merged into the `dialogflow_intent`
...
`google.dialogflow_intent.withParentFollowupIntentName` constructs a mixin object that can be merged into the `dialogflow_intent`
...
`google.dialogflow_intent.withPriority` constructs a mixin object that can be merged into the `dialogflow_intent`
...
`google.dialogflow_intent.withProject` constructs a mixin object that can be merged into the `dialogflow_intent`
...
`google.dialogflow_intent.withResetContexts` constructs a mixin object that can be merged into the `dialogflow_intent`
...
`google.dialogflow_intent.withTimeouts` constructs a mixin object that can be merged into the `dialogflow_intent`
...
`google.dialogflow_intent.withTimeoutsMixin` constructs a mixin object that can be merged into the `dialogflow_intent`
Terraform resource block to set or update the timeouts field.
...
`google.dialogflow_intent.withWebhookState` constructs a mixin object that can be merged into the `dialogflow_intent`
