...
`google.firestore_index.withCollection` constructs a mixin object that can be merged into the `firestore_index`
...
`google.firestore_index.withDatabase` constructs a mixin object that can be merged into the `firestore_index`
...
`google.firestore_index.withFields` constructs a mixin object that can be merged into the `firestore_index`
...
`google.firestore_index.withFieldsMixin` constructs a mixin object that can be merged into the `firestore_index`
Terraform resource block to set or update the fields field.
...
`google.firestore_index.withProject` constructs a mixin object that can be merged into the `firestore_index`
...
`google.firestore_index.withQueryScope` constructs a mixin object that can be merged into the `firestore_index`
...
`google.firestore_index.withTimeouts` constructs a mixin object that can be merged into the `firestore_index`
...
`google.firestore_index.withTimeoutsMixin` constructs a mixin object that can be merged into the `firestore_index`
Terraform resource block to set or update the timeouts field.
