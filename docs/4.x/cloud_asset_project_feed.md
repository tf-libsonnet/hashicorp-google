...
`google.cloud_asset_project_feed.withAssetNames` constructs a mixin object that can be merged into the `cloud_asset_project_feed`
...
`google.cloud_asset_project_feed.withAssetTypes` constructs a mixin object that can be merged into the `cloud_asset_project_feed`
...
`google.cloud_asset_project_feed.withBillingProject` constructs a mixin object that can be merged into the `cloud_asset_project_feed`
...
`google.cloud_asset_project_feed.withCondition` constructs a mixin object that can be merged into the `cloud_asset_project_feed`
...
`google.cloud_asset_project_feed.withConditionMixin` constructs a mixin object that can be merged into the `cloud_asset_project_feed`
Terraform resource block to set or update the condition field.
...
`google.cloud_asset_project_feed.withContentType` constructs a mixin object that can be merged into the `cloud_asset_project_feed`
...
`google.cloud_asset_project_feed.withFeedId` constructs a mixin object that can be merged into the `cloud_asset_project_feed`
...
`google.cloud_asset_project_feed.withFeedOutputConfig` constructs a mixin object that can be merged into the `cloud_asset_project_feed`
...
`google.cloud_asset_project_feed.withFeedOutputConfigMixin` constructs a mixin object that can be merged into the `cloud_asset_project_feed`
Terraform resource block to set or update the feed_output_config field.
...
`google.cloud_asset_project_feed.withProject` constructs a mixin object that can be merged into the `cloud_asset_project_feed`
...
`google.cloud_asset_project_feed.withTimeouts` constructs a mixin object that can be merged into the `cloud_asset_project_feed`
...
`google.cloud_asset_project_feed.withTimeoutsMixin` constructs a mixin object that can be merged into the `cloud_asset_project_feed`
Terraform resource block to set or update the timeouts field.
