...
`google.access_context_manager_service_perimeter.withDescription` constructs a mixin object that can be merged into the `access_context_manager_service_perimeter`
...
`google.access_context_manager_service_perimeter.withName` constructs a mixin object that can be merged into the `access_context_manager_service_perimeter`
...
`google.access_context_manager_service_perimeter.withParent` constructs a mixin object that can be merged into the `access_context_manager_service_perimeter`
...
`google.access_context_manager_service_perimeter.withPerimeterType` constructs a mixin object that can be merged into the `access_context_manager_service_perimeter`
...
`google.access_context_manager_service_perimeter.withSpec` constructs a mixin object that can be merged into the `access_context_manager_service_perimeter`
...
`google.access_context_manager_service_perimeter.withSpecMixin` constructs a mixin object that can be merged into the `access_context_manager_service_perimeter`
Terraform resource block to set or update the spec field.
...
`google.access_context_manager_service_perimeter.withStatus` constructs a mixin object that can be merged into the `access_context_manager_service_perimeter`
...
`google.access_context_manager_service_perimeter.withStatusMixin` constructs a mixin object that can be merged into the `access_context_manager_service_perimeter`
Terraform resource block to set or update the status field.
...
`google.access_context_manager_service_perimeter.withTimeouts` constructs a mixin object that can be merged into the `access_context_manager_service_perimeter`
...
`google.access_context_manager_service_perimeter.withTimeoutsMixin` constructs a mixin object that can be merged into the `access_context_manager_service_perimeter`
Terraform resource block to set or update the timeouts field.
...
`google.access_context_manager_service_perimeter.withTitle` constructs a mixin object that can be merged into the `access_context_manager_service_perimeter`
...
`google.access_context_manager_service_perimeter.withUseExplicitDryRunSpec` constructs a mixin object that can be merged into the `access_context_manager_service_perimeter`
