...
`google.data_loss_prevention_inspect_template.withDescription` constructs a mixin object that can be merged into the `data_loss_prevention_inspect_template`
...
`google.data_loss_prevention_inspect_template.withDisplayName` constructs a mixin object that can be merged into the `data_loss_prevention_inspect_template`
...
`google.data_loss_prevention_inspect_template.withInspectConfig` constructs a mixin object that can be merged into the `data_loss_prevention_inspect_template`
...
`google.data_loss_prevention_inspect_template.withInspectConfigMixin` constructs a mixin object that can be merged into the `data_loss_prevention_inspect_template`
Terraform resource block to set or update the inspect_config field.
...
`google.data_loss_prevention_inspect_template.withParent` constructs a mixin object that can be merged into the `data_loss_prevention_inspect_template`
...
`google.data_loss_prevention_inspect_template.withTimeouts` constructs a mixin object that can be merged into the `data_loss_prevention_inspect_template`
...
`google.data_loss_prevention_inspect_template.withTimeoutsMixin` constructs a mixin object that can be merged into the `data_loss_prevention_inspect_template`
Terraform resource block to set or update the timeouts field.
