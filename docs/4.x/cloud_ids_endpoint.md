...
`google.cloud_ids_endpoint.withDescription` constructs a mixin object that can be merged into the `cloud_ids_endpoint`
...
`google.cloud_ids_endpoint.withLocation` constructs a mixin object that can be merged into the `cloud_ids_endpoint`
...
`google.cloud_ids_endpoint.withName` constructs a mixin object that can be merged into the `cloud_ids_endpoint`
...
`google.cloud_ids_endpoint.withNetwork` constructs a mixin object that can be merged into the `cloud_ids_endpoint`
...
`google.cloud_ids_endpoint.withProject` constructs a mixin object that can be merged into the `cloud_ids_endpoint`
...
`google.cloud_ids_endpoint.withSeverity` constructs a mixin object that can be merged into the `cloud_ids_endpoint`
...
`google.cloud_ids_endpoint.withTimeouts` constructs a mixin object that can be merged into the `cloud_ids_endpoint`
...
`google.cloud_ids_endpoint.withTimeoutsMixin` constructs a mixin object that can be merged into the `cloud_ids_endpoint`
Terraform resource block to set or update the timeouts field.
