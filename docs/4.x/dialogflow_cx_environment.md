...
`google.dialogflow_cx_environment.withDescription` constructs a mixin object that can be merged into the `dialogflow_cx_environment`
...
`google.dialogflow_cx_environment.withDisplayName` constructs a mixin object that can be merged into the `dialogflow_cx_environment`
...
`google.dialogflow_cx_environment.withParent` constructs a mixin object that can be merged into the `dialogflow_cx_environment`
...
`google.dialogflow_cx_environment.withTimeouts` constructs a mixin object that can be merged into the `dialogflow_cx_environment`
...
`google.dialogflow_cx_environment.withTimeoutsMixin` constructs a mixin object that can be merged into the `dialogflow_cx_environment`
Terraform resource block to set or update the timeouts field.
...
`google.dialogflow_cx_environment.withVersionConfigs` constructs a mixin object that can be merged into the `dialogflow_cx_environment`
...
`google.dialogflow_cx_environment.withVersionConfigsMixin` constructs a mixin object that can be merged into the `dialogflow_cx_environment`
Terraform resource block to set or update the version_configs field.
