...
`google.compute_network_firewall_policy.withDescription` constructs a mixin object that can be merged into the `compute_network_firewall_policy`
...
`google.compute_network_firewall_policy.withName` constructs a mixin object that can be merged into the `compute_network_firewall_policy`
...
`google.compute_network_firewall_policy.withProject` constructs a mixin object that can be merged into the `compute_network_firewall_policy`
...
`google.compute_network_firewall_policy.withTimeouts` constructs a mixin object that can be merged into the `compute_network_firewall_policy`
...
`google.compute_network_firewall_policy.withTimeoutsMixin` constructs a mixin object that can be merged into the `compute_network_firewall_policy`
Terraform resource block to set or update the timeouts field.
