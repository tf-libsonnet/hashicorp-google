---
permalink: /data_catalog_policy_tag_iam_binding/
---

# data_catalog_policy_tag_iam_binding

`data_catalog_policy_tag_iam_binding` represents the `google_data_catalog_policy_tag_iam_binding` Terraform resource.
