...
`google.dataproc_cluster.withClusterConfig` constructs a mixin object that can be merged into the `dataproc_cluster`
...
`google.dataproc_cluster.withClusterConfigMixin` constructs a mixin object that can be merged into the `dataproc_cluster`
Terraform resource block to set or update the cluster_config field.
...
`google.dataproc_cluster.withGracefulDecommissionTimeout` constructs a mixin object that can be merged into the `dataproc_cluster`
...
`google.dataproc_cluster.withLabels` constructs a mixin object that can be merged into the `dataproc_cluster`
...
`google.dataproc_cluster.withName` constructs a mixin object that can be merged into the `dataproc_cluster`
...
`google.dataproc_cluster.withProject` constructs a mixin object that can be merged into the `dataproc_cluster`
...
`google.dataproc_cluster.withRegion` constructs a mixin object that can be merged into the `dataproc_cluster`
...
`google.dataproc_cluster.withTimeouts` constructs a mixin object that can be merged into the `dataproc_cluster`
...
`google.dataproc_cluster.withTimeoutsMixin` constructs a mixin object that can be merged into the `dataproc_cluster`
Terraform resource block to set or update the timeouts field.
...
`google.dataproc_cluster.withVirtualClusterConfig` constructs a mixin object that can be merged into the `dataproc_cluster`
...
`google.dataproc_cluster.withVirtualClusterConfigMixin` constructs a mixin object that can be merged into the `dataproc_cluster`
Terraform resource block to set or update the virtual_cluster_config field.
