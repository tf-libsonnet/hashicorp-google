...
`google.bigtable_table.withColumnFamily` constructs a mixin object that can be merged into the `bigtable_table`
...
`google.bigtable_table.withColumnFamilyMixin` constructs a mixin object that can be merged into the `bigtable_table`
Terraform resource block to set or update the column_family field.
...
`google.bigtable_table.withInstanceName` constructs a mixin object that can be merged into the `bigtable_table`
...
`google.bigtable_table.withName` constructs a mixin object that can be merged into the `bigtable_table`
...
`google.bigtable_table.withProject` constructs a mixin object that can be merged into the `bigtable_table`
...
`google.bigtable_table.withSplitKeys` constructs a mixin object that can be merged into the `bigtable_table`
...
`google.bigtable_table.withTimeouts` constructs a mixin object that can be merged into the `bigtable_table`
...
`google.bigtable_table.withTimeoutsMixin` constructs a mixin object that can be merged into the `bigtable_table`
Terraform resource block to set or update the timeouts field.
