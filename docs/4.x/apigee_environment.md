...
`google.apigee_environment.withApiProxyType` constructs a mixin object that can be merged into the `apigee_environment`
...
`google.apigee_environment.withDeploymentType` constructs a mixin object that can be merged into the `apigee_environment`
...
`google.apigee_environment.withDescription` constructs a mixin object that can be merged into the `apigee_environment`
...
`google.apigee_environment.withDisplayName` constructs a mixin object that can be merged into the `apigee_environment`
...
`google.apigee_environment.withName` constructs a mixin object that can be merged into the `apigee_environment`
...
`google.apigee_environment.withNodeConfig` constructs a mixin object that can be merged into the `apigee_environment`
...
`google.apigee_environment.withNodeConfigMixin` constructs a mixin object that can be merged into the `apigee_environment`
Terraform resource block to set or update the node_config field.
...
`google.apigee_environment.withOrgId` constructs a mixin object that can be merged into the `apigee_environment`
...
`google.apigee_environment.withTimeouts` constructs a mixin object that can be merged into the `apigee_environment`
...
`google.apigee_environment.withTimeoutsMixin` constructs a mixin object that can be merged into the `apigee_environment`
Terraform resource block to set or update the timeouts field.
