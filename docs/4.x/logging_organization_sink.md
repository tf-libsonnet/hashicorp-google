---
permalink: /logging_organization_sink/
---

# logging_organization_sink

`logging_organization_sink` represents the `google_logging_organization_sink` Terraform resource.
...
`google.logging_organization_sink.withBigqueryOptions` constructs a mixin object that can be merged into the `logging_organization_sink`
...
`google.logging_organization_sink.withBigqueryOptionsMixin` constructs a mixin object that can be merged into the `logging_organization_sink`
Terraform resource block to set or update the bigquery_options field.
...
`google.logging_organization_sink.withDescription` constructs a mixin object that can be merged into the `logging_organization_sink`
...
`google.logging_organization_sink.withDestination` constructs a mixin object that can be merged into the `logging_organization_sink`
...
`google.logging_organization_sink.withDisabled` constructs a mixin object that can be merged into the `logging_organization_sink`
...
`google.logging_organization_sink.withExclusions` constructs a mixin object that can be merged into the `logging_organization_sink`
...
`google.logging_organization_sink.withExclusionsMixin` constructs a mixin object that can be merged into the `logging_organization_sink`
Terraform resource block to set or update the exclusions field.
...
`google.logging_organization_sink.withFilter` constructs a mixin object that can be merged into the `logging_organization_sink`
...
`google.logging_organization_sink.withIncludeChildren` constructs a mixin object that can be merged into the `logging_organization_sink`
...
`google.logging_organization_sink.withName` constructs a mixin object that can be merged into the `logging_organization_sink`
...
`google.logging_organization_sink.withOrgId` constructs a mixin object that can be merged into the `logging_organization_sink`
