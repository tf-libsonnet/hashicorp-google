...
to the BackendService.
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google.compute_target_http_proxy.timeouts.new](#fn-compute_target_http_proxytimeoutsnew) constructor.
...
Unlike [google.compute_target_http_proxy.new](#fn-compute_target_http_proxynew), this function will not inject the `resource`
