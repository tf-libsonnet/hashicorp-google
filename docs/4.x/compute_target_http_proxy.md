...
`google.compute_target_http_proxy.withDescription` constructs a mixin object that can be merged into the `compute_target_http_proxy`
...
`google.compute_target_http_proxy.withName` constructs a mixin object that can be merged into the `compute_target_http_proxy`
...
`google.compute_target_http_proxy.withProject` constructs a mixin object that can be merged into the `compute_target_http_proxy`
...
`google.compute_target_http_proxy.withProxyBind` constructs a mixin object that can be merged into the `compute_target_http_proxy`
...
`google.compute_target_http_proxy.withTimeouts` constructs a mixin object that can be merged into the `compute_target_http_proxy`
...
`google.compute_target_http_proxy.withTimeoutsMixin` constructs a mixin object that can be merged into the `compute_target_http_proxy`
Terraform resource block to set or update the timeouts field.
...
`google.compute_target_http_proxy.withUrlMap` constructs a mixin object that can be merged into the `compute_target_http_proxy`
