...
`google.identity_platform_inbound_saml_config.withDisplayName` constructs a mixin object that can be merged into the `identity_platform_inbound_saml_config`
...
`google.identity_platform_inbound_saml_config.withEnabled` constructs a mixin object that can be merged into the `identity_platform_inbound_saml_config`
...
`google.identity_platform_inbound_saml_config.withIdpConfig` constructs a mixin object that can be merged into the `identity_platform_inbound_saml_config`
...
`google.identity_platform_inbound_saml_config.withIdpConfigMixin` constructs a mixin object that can be merged into the `identity_platform_inbound_saml_config`
Terraform resource block to set or update the idp_config field.
...
`google.identity_platform_inbound_saml_config.withName` constructs a mixin object that can be merged into the `identity_platform_inbound_saml_config`
...
`google.identity_platform_inbound_saml_config.withProject` constructs a mixin object that can be merged into the `identity_platform_inbound_saml_config`
...
`google.identity_platform_inbound_saml_config.withSpConfig` constructs a mixin object that can be merged into the `identity_platform_inbound_saml_config`
...
`google.identity_platform_inbound_saml_config.withSpConfigMixin` constructs a mixin object that can be merged into the `identity_platform_inbound_saml_config`
Terraform resource block to set or update the sp_config field.
...
`google.identity_platform_inbound_saml_config.withTimeouts` constructs a mixin object that can be merged into the `identity_platform_inbound_saml_config`
...
`google.identity_platform_inbound_saml_config.withTimeoutsMixin` constructs a mixin object that can be merged into the `identity_platform_inbound_saml_config`
Terraform resource block to set or update the timeouts field.
