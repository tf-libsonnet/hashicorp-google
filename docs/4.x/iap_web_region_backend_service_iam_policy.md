---
permalink: /iap_web_region_backend_service_iam_policy/
---

# iap_web_region_backend_service_iam_policy

`iap_web_region_backend_service_iam_policy` represents the `google_iap_web_region_backend_service_iam_policy` Terraform resource.
