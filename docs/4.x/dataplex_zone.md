...
`google.dataplex_zone.withDescription` constructs a mixin object that can be merged into the `dataplex_zone`
...
`google.dataplex_zone.withDiscoverySpec` constructs a mixin object that can be merged into the `dataplex_zone`
...
`google.dataplex_zone.withDiscoverySpecMixin` constructs a mixin object that can be merged into the `dataplex_zone`
Terraform resource block to set or update the discovery_spec field.
...
`google.dataplex_zone.withDisplayName` constructs a mixin object that can be merged into the `dataplex_zone`
...
`google.dataplex_zone.withLabels` constructs a mixin object that can be merged into the `dataplex_zone`
...
`google.dataplex_zone.withLake` constructs a mixin object that can be merged into the `dataplex_zone`
...
`google.dataplex_zone.withLocation` constructs a mixin object that can be merged into the `dataplex_zone`
...
`google.dataplex_zone.withName` constructs a mixin object that can be merged into the `dataplex_zone`
...
`google.dataplex_zone.withProject` constructs a mixin object that can be merged into the `dataplex_zone`
...
`google.dataplex_zone.withResourceSpec` constructs a mixin object that can be merged into the `dataplex_zone`
...
`google.dataplex_zone.withResourceSpecMixin` constructs a mixin object that can be merged into the `dataplex_zone`
Terraform resource block to set or update the resource_spec field.
...
`google.dataplex_zone.withTimeouts` constructs a mixin object that can be merged into the `dataplex_zone`
...
`google.dataplex_zone.withTimeoutsMixin` constructs a mixin object that can be merged into the `dataplex_zone`
Terraform resource block to set or update the timeouts field.
...
`google.dataplex_zone.withType` constructs a mixin object that can be merged into the `dataplex_zone`
