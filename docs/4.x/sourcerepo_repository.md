...
`google.sourcerepo_repository.withName` constructs a mixin object that can be merged into the `sourcerepo_repository`
...
`google.sourcerepo_repository.withProject` constructs a mixin object that can be merged into the `sourcerepo_repository`
...
`google.sourcerepo_repository.withPubsubConfigs` constructs a mixin object that can be merged into the `sourcerepo_repository`
...
`google.sourcerepo_repository.withPubsubConfigsMixin` constructs a mixin object that can be merged into the `sourcerepo_repository`
Terraform resource block to set or update the pubsub_configs field.
...
`google.sourcerepo_repository.withTimeouts` constructs a mixin object that can be merged into the `sourcerepo_repository`
...
`google.sourcerepo_repository.withTimeoutsMixin` constructs a mixin object that can be merged into the `sourcerepo_repository`
Terraform resource block to set or update the timeouts field.
