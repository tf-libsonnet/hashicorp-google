...
`google.data_catalog_entry_group.withDescription` constructs a mixin object that can be merged into the `data_catalog_entry_group`
...
`google.data_catalog_entry_group.withDisplayName` constructs a mixin object that can be merged into the `data_catalog_entry_group`
...
`google.data_catalog_entry_group.withEntryGroupId` constructs a mixin object that can be merged into the `data_catalog_entry_group`
...
`google.data_catalog_entry_group.withProject` constructs a mixin object that can be merged into the `data_catalog_entry_group`
...
`google.data_catalog_entry_group.withRegion` constructs a mixin object that can be merged into the `data_catalog_entry_group`
...
`google.data_catalog_entry_group.withTimeouts` constructs a mixin object that can be merged into the `data_catalog_entry_group`
...
`google.data_catalog_entry_group.withTimeoutsMixin` constructs a mixin object that can be merged into the `data_catalog_entry_group`
Terraform resource block to set or update the timeouts field.
