---
permalink: /document_ai_processor/
---

# document_ai_processor

`document_ai_processor` represents the `google_document_ai_processor` Terraform resource.
...
`google.document_ai_processor.withDisplayName` constructs a mixin object that can be merged into the `document_ai_processor`
...
`google.document_ai_processor.withKmsKeyName` constructs a mixin object that can be merged into the `document_ai_processor`
...
`google.document_ai_processor.withLocation` constructs a mixin object that can be merged into the `document_ai_processor`
...
`google.document_ai_processor.withProject` constructs a mixin object that can be merged into the `document_ai_processor`
...
`google.document_ai_processor.withTimeouts` constructs a mixin object that can be merged into the `document_ai_processor`
...
`google.document_ai_processor.withTimeoutsMixin` constructs a mixin object that can be merged into the `document_ai_processor`
Terraform resource block to set or update the timeouts field.
...
`google.document_ai_processor.withType` constructs a mixin object that can be merged into the `document_ai_processor`
