...
`google.data_loss_prevention_job_trigger.withDescription` constructs a mixin object that can be merged into the `data_loss_prevention_job_trigger`
...
`google.data_loss_prevention_job_trigger.withDisplayName` constructs a mixin object that can be merged into the `data_loss_prevention_job_trigger`
...
`google.data_loss_prevention_job_trigger.withInspectJob` constructs a mixin object that can be merged into the `data_loss_prevention_job_trigger`
...
`google.data_loss_prevention_job_trigger.withInspectJobMixin` constructs a mixin object that can be merged into the `data_loss_prevention_job_trigger`
Terraform resource block to set or update the inspect_job field.
...
`google.data_loss_prevention_job_trigger.withParent` constructs a mixin object that can be merged into the `data_loss_prevention_job_trigger`
...
`google.data_loss_prevention_job_trigger.withStatus` constructs a mixin object that can be merged into the `data_loss_prevention_job_trigger`
...
`google.data_loss_prevention_job_trigger.withTimeouts` constructs a mixin object that can be merged into the `data_loss_prevention_job_trigger`
...
`google.data_loss_prevention_job_trigger.withTimeoutsMixin` constructs a mixin object that can be merged into the `data_loss_prevention_job_trigger`
Terraform resource block to set or update the timeouts field.
...
`google.data_loss_prevention_job_trigger.withTriggers` constructs a mixin object that can be merged into the `data_loss_prevention_job_trigger`
...
`google.data_loss_prevention_job_trigger.withTriggersMixin` constructs a mixin object that can be merged into the `data_loss_prevention_job_trigger`
Terraform resource block to set or update the triggers field.
