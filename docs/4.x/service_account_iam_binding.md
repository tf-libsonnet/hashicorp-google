---
permalink: /service_account_iam_binding/
---

# service_account_iam_binding

`service_account_iam_binding` represents the `google_service_account_iam_binding` Terraform resource.
...
`google.service_account_iam_binding.withCondition` constructs a mixin object that can be merged into the `service_account_iam_binding`
...
`google.service_account_iam_binding.withConditionMixin` constructs a mixin object that can be merged into the `service_account_iam_binding`
Terraform resource block to set or update the condition field.
...
`google.service_account_iam_binding.withMembers` constructs a mixin object that can be merged into the `service_account_iam_binding`
...
`google.service_account_iam_binding.withRole` constructs a mixin object that can be merged into the `service_account_iam_binding`
...
`google.service_account_iam_binding.withServiceAccountId` constructs a mixin object that can be merged into the `service_account_iam_binding`
