...
`google.dialogflow_cx_version.withDescription` constructs a mixin object that can be merged into the `dialogflow_cx_version`
...
`google.dialogflow_cx_version.withDisplayName` constructs a mixin object that can be merged into the `dialogflow_cx_version`
...
`google.dialogflow_cx_version.withParent` constructs a mixin object that can be merged into the `dialogflow_cx_version`
...
`google.dialogflow_cx_version.withTimeouts` constructs a mixin object that can be merged into the `dialogflow_cx_version`
...
`google.dialogflow_cx_version.withTimeoutsMixin` constructs a mixin object that can be merged into the `dialogflow_cx_version`
Terraform resource block to set or update the timeouts field.
