...
`google.dataproc_job.withForceDelete` constructs a mixin object that can be merged into the `dataproc_job`
...
`google.dataproc_job.withHadoopConfig` constructs a mixin object that can be merged into the `dataproc_job`
...
`google.dataproc_job.withHadoopConfigMixin` constructs a mixin object that can be merged into the `dataproc_job`
Terraform resource block to set or update the hadoop_config field.
...
`google.dataproc_job.withHiveConfig` constructs a mixin object that can be merged into the `dataproc_job`
...
`google.dataproc_job.withHiveConfigMixin` constructs a mixin object that can be merged into the `dataproc_job`
Terraform resource block to set or update the hive_config field.
...
`google.dataproc_job.withLabels` constructs a mixin object that can be merged into the `dataproc_job`
...
`google.dataproc_job.withPigConfig` constructs a mixin object that can be merged into the `dataproc_job`
...
`google.dataproc_job.withPigConfigMixin` constructs a mixin object that can be merged into the `dataproc_job`
Terraform resource block to set or update the pig_config field.
...
`google.dataproc_job.withPlacement` constructs a mixin object that can be merged into the `dataproc_job`
...
`google.dataproc_job.withPlacementMixin` constructs a mixin object that can be merged into the `dataproc_job`
Terraform resource block to set or update the placement field.
...
`google.dataproc_job.withPrestoConfig` constructs a mixin object that can be merged into the `dataproc_job`
...
`google.dataproc_job.withPrestoConfigMixin` constructs a mixin object that can be merged into the `dataproc_job`
Terraform resource block to set or update the presto_config field.
...
`google.dataproc_job.withProject` constructs a mixin object that can be merged into the `dataproc_job`
...
`google.dataproc_job.withPysparkConfig` constructs a mixin object that can be merged into the `dataproc_job`
...
`google.dataproc_job.withPysparkConfigMixin` constructs a mixin object that can be merged into the `dataproc_job`
Terraform resource block to set or update the pyspark_config field.
...
`google.dataproc_job.withReference` constructs a mixin object that can be merged into the `dataproc_job`
...
`google.dataproc_job.withReferenceMixin` constructs a mixin object that can be merged into the `dataproc_job`
Terraform resource block to set or update the reference field.
...
`google.dataproc_job.withRegion` constructs a mixin object that can be merged into the `dataproc_job`
...
`google.dataproc_job.withScheduling` constructs a mixin object that can be merged into the `dataproc_job`
...
`google.dataproc_job.withSchedulingMixin` constructs a mixin object that can be merged into the `dataproc_job`
Terraform resource block to set or update the scheduling field.
...
`google.dataproc_job.withSparkConfig` constructs a mixin object that can be merged into the `dataproc_job`
...
`google.dataproc_job.withSparkConfigMixin` constructs a mixin object that can be merged into the `dataproc_job`
Terraform resource block to set or update the spark_config field.
...
`google.dataproc_job.withSparksqlConfig` constructs a mixin object that can be merged into the `dataproc_job`
...
`google.dataproc_job.withSparksqlConfigMixin` constructs a mixin object that can be merged into the `dataproc_job`
Terraform resource block to set or update the sparksql_config field.
...
`google.dataproc_job.withTimeouts` constructs a mixin object that can be merged into the `dataproc_job`
...
`google.dataproc_job.withTimeoutsMixin` constructs a mixin object that can be merged into the `dataproc_job`
Terraform resource block to set or update the timeouts field.
