...
`google.logging_project_exclusion.withDescription` constructs a mixin object that can be merged into the `logging_project_exclusion`
...
`google.logging_project_exclusion.withDisabled` constructs a mixin object that can be merged into the `logging_project_exclusion`
...
`google.logging_project_exclusion.withFilter` constructs a mixin object that can be merged into the `logging_project_exclusion`
...
`google.logging_project_exclusion.withName` constructs a mixin object that can be merged into the `logging_project_exclusion`
...
`google.logging_project_exclusion.withProject` constructs a mixin object that can be merged into the `logging_project_exclusion`
