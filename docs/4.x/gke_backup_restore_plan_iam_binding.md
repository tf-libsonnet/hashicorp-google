---
permalink: /gke_backup_restore_plan_iam_binding/
---

# gke_backup_restore_plan_iam_binding

`gke_backup_restore_plan_iam_binding` represents the `google_gke_backup_restore_plan_iam_binding` Terraform resource.
