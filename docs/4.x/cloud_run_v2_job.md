...
`google.cloud_run_v2_job.withBinaryAuthorization` constructs a mixin object that can be merged into the `cloud_run_v2_job`
...
`google.cloud_run_v2_job.withBinaryAuthorizationMixin` constructs a mixin object that can be merged into the `cloud_run_v2_job`
Terraform resource block to set or update the binary_authorization field.
...
`google.cloud_run_v2_job.withClient` constructs a mixin object that can be merged into the `cloud_run_v2_job`
...
`google.cloud_run_v2_job.withClientVersion` constructs a mixin object that can be merged into the `cloud_run_v2_job`
...
`google.cloud_run_v2_job.withLabels` constructs a mixin object that can be merged into the `cloud_run_v2_job`
...
`google.cloud_run_v2_job.withLaunchStage` constructs a mixin object that can be merged into the `cloud_run_v2_job`
...
`google.cloud_run_v2_job.withLocation` constructs a mixin object that can be merged into the `cloud_run_v2_job`
...
`google.cloud_run_v2_job.withName` constructs a mixin object that can be merged into the `cloud_run_v2_job`
...
`google.cloud_run_v2_job.withProject` constructs a mixin object that can be merged into the `cloud_run_v2_job`
...
`google.cloud_run_v2_job.withTemplate` constructs a mixin object that can be merged into the `cloud_run_v2_job`
...
`google.cloud_run_v2_job.withTemplateMixin` constructs a mixin object that can be merged into the `cloud_run_v2_job`
Terraform resource block to set or update the template field.
...
`google.cloud_run_v2_job.withTimeouts` constructs a mixin object that can be merged into the `cloud_run_v2_job`
...
`google.cloud_run_v2_job.withTimeoutsMixin` constructs a mixin object that can be merged into the `cloud_run_v2_job`
Terraform resource block to set or update the timeouts field.
