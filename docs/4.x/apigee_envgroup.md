...
`google.apigee_envgroup.withHostnames` constructs a mixin object that can be merged into the `apigee_envgroup`
...
`google.apigee_envgroup.withName` constructs a mixin object that can be merged into the `apigee_envgroup`
...
`google.apigee_envgroup.withOrgId` constructs a mixin object that can be merged into the `apigee_envgroup`
...
`google.apigee_envgroup.withTimeouts` constructs a mixin object that can be merged into the `apigee_envgroup`
...
`google.apigee_envgroup.withTimeoutsMixin` constructs a mixin object that can be merged into the `apigee_envgroup`
Terraform resource block to set or update the timeouts field.
