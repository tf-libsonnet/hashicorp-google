...
`google.network_services_edge_cache_service.withDescription` constructs a mixin object that can be merged into the `network_services_edge_cache_service`
...
`google.network_services_edge_cache_service.withDisableHttp2` constructs a mixin object that can be merged into the `network_services_edge_cache_service`
...
`google.network_services_edge_cache_service.withDisableQuic` constructs a mixin object that can be merged into the `network_services_edge_cache_service`
...
`google.network_services_edge_cache_service.withEdgeSecurityPolicy` constructs a mixin object that can be merged into the `network_services_edge_cache_service`
...
`google.network_services_edge_cache_service.withEdgeSslCertificates` constructs a mixin object that can be merged into the `network_services_edge_cache_service`
...
`google.network_services_edge_cache_service.withLabels` constructs a mixin object that can be merged into the `network_services_edge_cache_service`
...
`google.network_services_edge_cache_service.withLogConfig` constructs a mixin object that can be merged into the `network_services_edge_cache_service`
...
`google.network_services_edge_cache_service.withLogConfigMixin` constructs a mixin object that can be merged into the `network_services_edge_cache_service`
Terraform resource block to set or update the log_config field.
...
`google.network_services_edge_cache_service.withName` constructs a mixin object that can be merged into the `network_services_edge_cache_service`
...
`google.network_services_edge_cache_service.withProject` constructs a mixin object that can be merged into the `network_services_edge_cache_service`
...
`google.network_services_edge_cache_service.withRequireTls` constructs a mixin object that can be merged into the `network_services_edge_cache_service`
...
`google.network_services_edge_cache_service.withRouting` constructs a mixin object that can be merged into the `network_services_edge_cache_service`
...
`google.network_services_edge_cache_service.withRoutingMixin` constructs a mixin object that can be merged into the `network_services_edge_cache_service`
Terraform resource block to set or update the routing field.
...
`google.network_services_edge_cache_service.withSslPolicy` constructs a mixin object that can be merged into the `network_services_edge_cache_service`
...
`google.network_services_edge_cache_service.withTimeouts` constructs a mixin object that can be merged into the `network_services_edge_cache_service`
...
`google.network_services_edge_cache_service.withTimeoutsMixin` constructs a mixin object that can be merged into the `network_services_edge_cache_service`
Terraform resource block to set or update the timeouts field.
