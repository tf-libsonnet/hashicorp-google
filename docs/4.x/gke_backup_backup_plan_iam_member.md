---
permalink: /gke_backup_backup_plan_iam_member/
---

# gke_backup_backup_plan_iam_member

`gke_backup_backup_plan_iam_member` represents the `google_gke_backup_backup_plan_iam_member` Terraform resource.
