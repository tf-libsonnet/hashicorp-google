...
`google.memcache_instance.withAuthorizedNetwork` constructs a mixin object that can be merged into the `memcache_instance`
...
`google.memcache_instance.withDisplayName` constructs a mixin object that can be merged into the `memcache_instance`
...
`google.memcache_instance.withLabels` constructs a mixin object that can be merged into the `memcache_instance`
...
`google.memcache_instance.withMaintenancePolicy` constructs a mixin object that can be merged into the `memcache_instance`
...
`google.memcache_instance.withMaintenancePolicyMixin` constructs a mixin object that can be merged into the `memcache_instance`
Terraform resource block to set or update the maintenance_policy field.
...
`google.memcache_instance.withMemcacheParameters` constructs a mixin object that can be merged into the `memcache_instance`
...
`google.memcache_instance.withMemcacheParametersMixin` constructs a mixin object that can be merged into the `memcache_instance`
Terraform resource block to set or update the memcache_parameters field.
...
`google.memcache_instance.withMemcacheVersion` constructs a mixin object that can be merged into the `memcache_instance`
...
`google.memcache_instance.withName` constructs a mixin object that can be merged into the `memcache_instance`
...
`google.memcache_instance.withNodeConfig` constructs a mixin object that can be merged into the `memcache_instance`
...
`google.memcache_instance.withNodeConfigMixin` constructs a mixin object that can be merged into the `memcache_instance`
Terraform resource block to set or update the node_config field.
...
`google.memcache_instance.withNodeCount` constructs a mixin object that can be merged into the `memcache_instance`
...
`google.memcache_instance.withProject` constructs a mixin object that can be merged into the `memcache_instance`
...
`google.memcache_instance.withRegion` constructs a mixin object that can be merged into the `memcache_instance`
...
`google.memcache_instance.withTimeouts` constructs a mixin object that can be merged into the `memcache_instance`
...
`google.memcache_instance.withTimeoutsMixin` constructs a mixin object that can be merged into the `memcache_instance`
Terraform resource block to set or update the timeouts field.
...
`google.memcache_instance.withZones` constructs a mixin object that can be merged into the `memcache_instance`
