...
`google.tags_tag_value.withDescription` constructs a mixin object that can be merged into the `tags_tag_value`
...
`google.tags_tag_value.withParent` constructs a mixin object that can be merged into the `tags_tag_value`
...
`google.tags_tag_value.withShortName` constructs a mixin object that can be merged into the `tags_tag_value`
...
`google.tags_tag_value.withTimeouts` constructs a mixin object that can be merged into the `tags_tag_value`
...
`google.tags_tag_value.withTimeoutsMixin` constructs a mixin object that can be merged into the `tags_tag_value`
Terraform resource block to set or update the timeouts field.
