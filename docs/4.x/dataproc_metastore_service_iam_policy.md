---
permalink: /dataproc_metastore_service_iam_policy/
---

# dataproc_metastore_service_iam_policy

`dataproc_metastore_service_iam_policy` represents the `google_dataproc_metastore_service_iam_policy` Terraform resource.
...
Unlike [google.dataproc_metastore_service_iam_policy.new](#fn-dataprocmetastoreserviceiampolicynew), this function will not inject the `resource`
...
`google.dataproc_metastore_service_iam_policy.withLocation` constructs a mixin object that can be merged into the `dataproc_metastore_service_iam_policy`
...
`google.dataproc_metastore_service_iam_policy.withPolicyData` constructs a mixin object that can be merged into the `dataproc_metastore_service_iam_policy`
...
`google.dataproc_metastore_service_iam_policy.withProject` constructs a mixin object that can be merged into the `dataproc_metastore_service_iam_policy`
...
`google.dataproc_metastore_service_iam_policy.withServiceId` constructs a mixin object that can be merged into the `dataproc_metastore_service_iam_policy`
