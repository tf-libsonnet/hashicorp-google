...
`google.dialogflow_cx_webhook.withDisabled` constructs a mixin object that can be merged into the `dialogflow_cx_webhook`
...
`google.dialogflow_cx_webhook.withDisplayName` constructs a mixin object that can be merged into the `dialogflow_cx_webhook`
...
`google.dialogflow_cx_webhook.withEnableSpellCorrection` constructs a mixin object that can be merged into the `dialogflow_cx_webhook`
...
`google.dialogflow_cx_webhook.withEnableStackdriverLogging` constructs a mixin object that can be merged into the `dialogflow_cx_webhook`
...
`google.dialogflow_cx_webhook.withGenericWebService` constructs a mixin object that can be merged into the `dialogflow_cx_webhook`
...
`google.dialogflow_cx_webhook.withGenericWebServiceMixin` constructs a mixin object that can be merged into the `dialogflow_cx_webhook`
Terraform resource block to set or update the generic_web_service field.
...
`google.dialogflow_cx_webhook.withParent` constructs a mixin object that can be merged into the `dialogflow_cx_webhook`
...
`google.dialogflow_cx_webhook.withSecuritySettings` constructs a mixin object that can be merged into the `dialogflow_cx_webhook`
...
`google.dialogflow_cx_webhook.withServiceDirectory` constructs a mixin object that can be merged into the `dialogflow_cx_webhook`
...
`google.dialogflow_cx_webhook.withServiceDirectoryMixin` constructs a mixin object that can be merged into the `dialogflow_cx_webhook`
Terraform resource block to set or update the service_directory field.
...
`google.dialogflow_cx_webhook.withTimeout` constructs a mixin object that can be merged into the `dialogflow_cx_webhook`
...
`google.dialogflow_cx_webhook.withTimeouts` constructs a mixin object that can be merged into the `dialogflow_cx_webhook`
...
`google.dialogflow_cx_webhook.withTimeoutsMixin` constructs a mixin object that can be merged into the `dialogflow_cx_webhook`
Terraform resource block to set or update the timeouts field.
