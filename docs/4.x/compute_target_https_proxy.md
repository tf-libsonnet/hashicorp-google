...
`google.compute_target_https_proxy.withCertificateMap` constructs a mixin object that can be merged into the `compute_target_https_proxy`
...
`google.compute_target_https_proxy.withDescription` constructs a mixin object that can be merged into the `compute_target_https_proxy`
...
`google.compute_target_https_proxy.withName` constructs a mixin object that can be merged into the `compute_target_https_proxy`
...
`google.compute_target_https_proxy.withProject` constructs a mixin object that can be merged into the `compute_target_https_proxy`
...
`google.compute_target_https_proxy.withProxyBind` constructs a mixin object that can be merged into the `compute_target_https_proxy`
...
`google.compute_target_https_proxy.withQuicOverride` constructs a mixin object that can be merged into the `compute_target_https_proxy`
...
`google.compute_target_https_proxy.withSslCertificates` constructs a mixin object that can be merged into the `compute_target_https_proxy`
...
`google.compute_target_https_proxy.withSslPolicy` constructs a mixin object that can be merged into the `compute_target_https_proxy`
...
`google.compute_target_https_proxy.withTimeouts` constructs a mixin object that can be merged into the `compute_target_https_proxy`
...
`google.compute_target_https_proxy.withTimeoutsMixin` constructs a mixin object that can be merged into the `compute_target_https_proxy`
Terraform resource block to set or update the timeouts field.
...
`google.compute_target_https_proxy.withUrlMap` constructs a mixin object that can be merged into the `compute_target_https_proxy`
