...
`google.cloud_run_domain_mapping.withLocation` constructs a mixin object that can be merged into the `cloud_run_domain_mapping`
...
`google.cloud_run_domain_mapping.withMetadata` constructs a mixin object that can be merged into the `cloud_run_domain_mapping`
...
`google.cloud_run_domain_mapping.withMetadataMixin` constructs a mixin object that can be merged into the `cloud_run_domain_mapping`
Terraform resource block to set or update the metadata field.
...
`google.cloud_run_domain_mapping.withName` constructs a mixin object that can be merged into the `cloud_run_domain_mapping`
...
`google.cloud_run_domain_mapping.withProject` constructs a mixin object that can be merged into the `cloud_run_domain_mapping`
...
`google.cloud_run_domain_mapping.withSpec` constructs a mixin object that can be merged into the `cloud_run_domain_mapping`
...
`google.cloud_run_domain_mapping.withSpecMixin` constructs a mixin object that can be merged into the `cloud_run_domain_mapping`
Terraform resource block to set or update the spec field.
...
`google.cloud_run_domain_mapping.withTimeouts` constructs a mixin object that can be merged into the `cloud_run_domain_mapping`
...
`google.cloud_run_domain_mapping.withTimeoutsMixin` constructs a mixin object that can be merged into the `cloud_run_domain_mapping`
Terraform resource block to set or update the timeouts field.
