...
`google.container_azure_cluster.withAnnotations` constructs a mixin object that can be merged into the `container_azure_cluster`
...
`google.container_azure_cluster.withAuthorization` constructs a mixin object that can be merged into the `container_azure_cluster`
...
`google.container_azure_cluster.withAuthorizationMixin` constructs a mixin object that can be merged into the `container_azure_cluster`
Terraform resource block to set or update the authorization field.
...
`google.container_azure_cluster.withAzureRegion` constructs a mixin object that can be merged into the `container_azure_cluster`
...
`google.container_azure_cluster.withClient` constructs a mixin object that can be merged into the `container_azure_cluster`
...
`google.container_azure_cluster.withControlPlane` constructs a mixin object that can be merged into the `container_azure_cluster`
...
`google.container_azure_cluster.withControlPlaneMixin` constructs a mixin object that can be merged into the `container_azure_cluster`
Terraform resource block to set or update the control_plane field.
...
`google.container_azure_cluster.withDescription` constructs a mixin object that can be merged into the `container_azure_cluster`
...
`google.container_azure_cluster.withFleet` constructs a mixin object that can be merged into the `container_azure_cluster`
...
`google.container_azure_cluster.withFleetMixin` constructs a mixin object that can be merged into the `container_azure_cluster`
Terraform resource block to set or update the fleet field.
...
`google.container_azure_cluster.withLocation` constructs a mixin object that can be merged into the `container_azure_cluster`
...
`google.container_azure_cluster.withName` constructs a mixin object that can be merged into the `container_azure_cluster`
...
`google.container_azure_cluster.withNetworking` constructs a mixin object that can be merged into the `container_azure_cluster`
...
`google.container_azure_cluster.withNetworkingMixin` constructs a mixin object that can be merged into the `container_azure_cluster`
Terraform resource block to set or update the networking field.
...
`google.container_azure_cluster.withProject` constructs a mixin object that can be merged into the `container_azure_cluster`
...
`google.container_azure_cluster.withResourceGroupId` constructs a mixin object that can be merged into the `container_azure_cluster`
...
`google.container_azure_cluster.withTimeouts` constructs a mixin object that can be merged into the `container_azure_cluster`
...
`google.container_azure_cluster.withTimeoutsMixin` constructs a mixin object that can be merged into the `container_azure_cluster`
Terraform resource block to set or update the timeouts field.
