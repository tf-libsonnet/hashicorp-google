...
`google.compute_disk.withDescription` constructs a mixin object that can be merged into the `compute_disk`
...
`google.compute_disk.withDiskEncryptionKey` constructs a mixin object that can be merged into the `compute_disk`
...
`google.compute_disk.withDiskEncryptionKeyMixin` constructs a mixin object that can be merged into the `compute_disk`
Terraform resource block to set or update the disk_encryption_key field.
...
`google.compute_disk.withImage` constructs a mixin object that can be merged into the `compute_disk`
...
`google.compute_disk.withLabels` constructs a mixin object that can be merged into the `compute_disk`
...
`google.compute_disk.withPhysicalBlockSizeBytes` constructs a mixin object that can be merged into the `compute_disk`
...
`google.compute_disk.withProvisionedIops` constructs a mixin object that can be merged into the `compute_disk`
...
`google.compute_disk.withSize` constructs a mixin object that can be merged into the `compute_disk`
...
`google.compute_disk.withSnapshot` constructs a mixin object that can be merged into the `compute_disk`
...
`google.compute_disk.withSourceDisk` constructs a mixin object that can be merged into the `compute_disk`
...
`google.compute_disk.withSourceImageEncryptionKey` constructs a mixin object that can be merged into the `compute_disk`
...
`google.compute_disk.withSourceImageEncryptionKeyMixin` constructs a mixin object that can be merged into the `compute_disk`
Terraform resource block to set or update the source_image_encryption_key field.
...
`google.compute_disk.withSourceSnapshotEncryptionKey` constructs a mixin object that can be merged into the `compute_disk`
...
`google.compute_disk.withSourceSnapshotEncryptionKeyMixin` constructs a mixin object that can be merged into the `compute_disk`
Terraform resource block to set or update the source_snapshot_encryption_key field.
...
`google.compute_disk.withTimeouts` constructs a mixin object that can be merged into the `compute_disk`
...
`google.compute_disk.withTimeoutsMixin` constructs a mixin object that can be merged into the `compute_disk`
Terraform resource block to set or update the timeouts field.
...
`google.compute_disk.withType` constructs a mixin object that can be merged into the `compute_disk`
