...
`google.compute_region_network_firewall_policy_association.withProject` constructs a mixin object that can be merged into the `compute_region_network_firewall_policy_association`
