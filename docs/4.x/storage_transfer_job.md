...
`google.storage_transfer_job.withDescription` constructs a mixin object that can be merged into the `storage_transfer_job`
...
`google.storage_transfer_job.withNotificationConfig` constructs a mixin object that can be merged into the `storage_transfer_job`
...
`google.storage_transfer_job.withNotificationConfigMixin` constructs a mixin object that can be merged into the `storage_transfer_job`
Terraform resource block to set or update the notification_config field.
...
`google.storage_transfer_job.withProject` constructs a mixin object that can be merged into the `storage_transfer_job`
...
`google.storage_transfer_job.withSchedule` constructs a mixin object that can be merged into the `storage_transfer_job`
...
`google.storage_transfer_job.withScheduleMixin` constructs a mixin object that can be merged into the `storage_transfer_job`
Terraform resource block to set or update the schedule field.
...
`google.storage_transfer_job.withStatus` constructs a mixin object that can be merged into the `storage_transfer_job`
...
`google.storage_transfer_job.withTransferSpec` constructs a mixin object that can be merged into the `storage_transfer_job`
...
`google.storage_transfer_job.withTransferSpecMixin` constructs a mixin object that can be merged into the `storage_transfer_job`
Terraform resource block to set or update the transfer_spec field.
