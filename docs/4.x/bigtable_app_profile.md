...
`google.bigtable_app_profile.withAppProfileId` constructs a mixin object that can be merged into the `bigtable_app_profile`
...
`google.bigtable_app_profile.withDescription` constructs a mixin object that can be merged into the `bigtable_app_profile`
...
`google.bigtable_app_profile.withIgnoreWarnings` constructs a mixin object that can be merged into the `bigtable_app_profile`
...
`google.bigtable_app_profile.withInstance` constructs a mixin object that can be merged into the `bigtable_app_profile`
...
`google.bigtable_app_profile.withMultiClusterRoutingClusterIds` constructs a mixin object that can be merged into the `bigtable_app_profile`
...
`google.bigtable_app_profile.withMultiClusterRoutingUseAny` constructs a mixin object that can be merged into the `bigtable_app_profile`
...
`google.bigtable_app_profile.withProject` constructs a mixin object that can be merged into the `bigtable_app_profile`
...
`google.bigtable_app_profile.withSingleClusterRouting` constructs a mixin object that can be merged into the `bigtable_app_profile`
...
`google.bigtable_app_profile.withSingleClusterRoutingMixin` constructs a mixin object that can be merged into the `bigtable_app_profile`
Terraform resource block to set or update the single_cluster_routing field.
...
`google.bigtable_app_profile.withTimeouts` constructs a mixin object that can be merged into the `bigtable_app_profile`
...
`google.bigtable_app_profile.withTimeoutsMixin` constructs a mixin object that can be merged into the `bigtable_app_profile`
Terraform resource block to set or update the timeouts field.
