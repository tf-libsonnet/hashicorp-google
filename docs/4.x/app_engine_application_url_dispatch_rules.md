...
`google.app_engine_application_url_dispatch_rules.withDispatchRules` constructs a mixin object that can be merged into the `app_engine_application_url_dispatch_rules`
...
`google.app_engine_application_url_dispatch_rules.withDispatchRulesMixin` constructs a mixin object that can be merged into the `app_engine_application_url_dispatch_rules`
Terraform resource block to set or update the dispatch_rules field.
...
`google.app_engine_application_url_dispatch_rules.withProject` constructs a mixin object that can be merged into the `app_engine_application_url_dispatch_rules`
...
`google.app_engine_application_url_dispatch_rules.withTimeouts` constructs a mixin object that can be merged into the `app_engine_application_url_dispatch_rules`
...
`google.app_engine_application_url_dispatch_rules.withTimeoutsMixin` constructs a mixin object that can be merged into the `app_engine_application_url_dispatch_rules`
Terraform resource block to set or update the timeouts field.
