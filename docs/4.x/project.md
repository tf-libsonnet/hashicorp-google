...
`google.project.withAutoCreateNetwork` constructs a mixin object that can be merged into the `project`
...
`google.project.withBillingAccount` constructs a mixin object that can be merged into the `project`
...
`google.project.withFolderId` constructs a mixin object that can be merged into the `project`
...
`google.project.withLabels` constructs a mixin object that can be merged into the `project`
...
`google.project.withName` constructs a mixin object that can be merged into the `project`
...
`google.project.withOrgId` constructs a mixin object that can be merged into the `project`
...
`google.project.withSkipDelete` constructs a mixin object that can be merged into the `project`
...
`google.project.withTimeouts` constructs a mixin object that can be merged into the `project`
...
`google.project.withTimeoutsMixin` constructs a mixin object that can be merged into the `project`
Terraform resource block to set or update the timeouts field.
