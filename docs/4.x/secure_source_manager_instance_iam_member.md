---
permalink: /secure_source_manager_instance_iam_member/
---

# secure_source_manager_instance_iam_member

`secure_source_manager_instance_iam_member` represents the `google_secure_source_manager_instance_iam_member` Terraform resource.
