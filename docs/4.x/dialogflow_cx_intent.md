...
`google.dialogflow_cx_intent.withDescription` constructs a mixin object that can be merged into the `dialogflow_cx_intent`
...
`google.dialogflow_cx_intent.withDisplayName` constructs a mixin object that can be merged into the `dialogflow_cx_intent`
...
`google.dialogflow_cx_intent.withIsFallback` constructs a mixin object that can be merged into the `dialogflow_cx_intent`
...
`google.dialogflow_cx_intent.withLabels` constructs a mixin object that can be merged into the `dialogflow_cx_intent`
...
`google.dialogflow_cx_intent.withLanguageCode` constructs a mixin object that can be merged into the `dialogflow_cx_intent`
...
`google.dialogflow_cx_intent.withParameters` constructs a mixin object that can be merged into the `dialogflow_cx_intent`
...
`google.dialogflow_cx_intent.withParametersMixin` constructs a mixin object that can be merged into the `dialogflow_cx_intent`
Terraform resource block to set or update the parameters field.
...
`google.dialogflow_cx_intent.withParent` constructs a mixin object that can be merged into the `dialogflow_cx_intent`
...
`google.dialogflow_cx_intent.withPriority` constructs a mixin object that can be merged into the `dialogflow_cx_intent`
...
`google.dialogflow_cx_intent.withTimeouts` constructs a mixin object that can be merged into the `dialogflow_cx_intent`
...
`google.dialogflow_cx_intent.withTimeoutsMixin` constructs a mixin object that can be merged into the `dialogflow_cx_intent`
Terraform resource block to set or update the timeouts field.
...
`google.dialogflow_cx_intent.withTrainingPhrases` constructs a mixin object that can be merged into the `dialogflow_cx_intent`
...
`google.dialogflow_cx_intent.withTrainingPhrasesMixin` constructs a mixin object that can be merged into the `dialogflow_cx_intent`
Terraform resource block to set or update the training_phrases field.
