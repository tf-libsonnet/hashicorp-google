...
`google.bigquery_connection.withAws` constructs a mixin object that can be merged into the `bigquery_connection`
...
`google.bigquery_connection.withAwsMixin` constructs a mixin object that can be merged into the `bigquery_connection`
Terraform resource block to set or update the aws field.
...
`google.bigquery_connection.withAzure` constructs a mixin object that can be merged into the `bigquery_connection`
...
`google.bigquery_connection.withAzureMixin` constructs a mixin object that can be merged into the `bigquery_connection`
Terraform resource block to set or update the azure field.
...
`google.bigquery_connection.withCloudResource` constructs a mixin object that can be merged into the `bigquery_connection`
...
`google.bigquery_connection.withCloudResourceMixin` constructs a mixin object that can be merged into the `bigquery_connection`
Terraform resource block to set or update the cloud_resource field.
...
`google.bigquery_connection.withCloudSpanner` constructs a mixin object that can be merged into the `bigquery_connection`
...
`google.bigquery_connection.withCloudSpannerMixin` constructs a mixin object that can be merged into the `bigquery_connection`
Terraform resource block to set or update the cloud_spanner field.
...
`google.bigquery_connection.withCloudSql` constructs a mixin object that can be merged into the `bigquery_connection`
...
`google.bigquery_connection.withCloudSqlMixin` constructs a mixin object that can be merged into the `bigquery_connection`
Terraform resource block to set or update the cloud_sql field.
...
`google.bigquery_connection.withConnectionId` constructs a mixin object that can be merged into the `bigquery_connection`
...
`google.bigquery_connection.withDescription` constructs a mixin object that can be merged into the `bigquery_connection`
...
`google.bigquery_connection.withFriendlyName` constructs a mixin object that can be merged into the `bigquery_connection`
...
`google.bigquery_connection.withLocation` constructs a mixin object that can be merged into the `bigquery_connection`
...
`google.bigquery_connection.withProject` constructs a mixin object that can be merged into the `bigquery_connection`
...
`google.bigquery_connection.withTimeouts` constructs a mixin object that can be merged into the `bigquery_connection`
...
`google.bigquery_connection.withTimeoutsMixin` constructs a mixin object that can be merged into the `bigquery_connection`
Terraform resource block to set or update the timeouts field.
