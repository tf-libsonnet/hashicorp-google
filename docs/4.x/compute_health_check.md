...
`google.compute_health_check.withCheckIntervalSec` constructs a mixin object that can be merged into the `compute_health_check`
...
`google.compute_health_check.withDescription` constructs a mixin object that can be merged into the `compute_health_check`
...
`google.compute_health_check.withGrpcHealthCheck` constructs a mixin object that can be merged into the `compute_health_check`
...
`google.compute_health_check.withGrpcHealthCheckMixin` constructs a mixin object that can be merged into the `compute_health_check`
Terraform resource block to set or update the grpc_health_check field.
...
`google.compute_health_check.withHealthyThreshold` constructs a mixin object that can be merged into the `compute_health_check`
...
`google.compute_health_check.withHttp2HealthCheck` constructs a mixin object that can be merged into the `compute_health_check`
...
`google.compute_health_check.withHttp2HealthCheckMixin` constructs a mixin object that can be merged into the `compute_health_check`
Terraform resource block to set or update the http2_health_check field.
...
`google.compute_health_check.withHttpHealthCheck` constructs a mixin object that can be merged into the `compute_health_check`
...
`google.compute_health_check.withHttpHealthCheckMixin` constructs a mixin object that can be merged into the `compute_health_check`
Terraform resource block to set or update the http_health_check field.
...
`google.compute_health_check.withHttpsHealthCheck` constructs a mixin object that can be merged into the `compute_health_check`
...
`google.compute_health_check.withHttpsHealthCheckMixin` constructs a mixin object that can be merged into the `compute_health_check`
Terraform resource block to set or update the https_health_check field.
...
`google.compute_health_check.withLogConfig` constructs a mixin object that can be merged into the `compute_health_check`
...
`google.compute_health_check.withLogConfigMixin` constructs a mixin object that can be merged into the `compute_health_check`
Terraform resource block to set or update the log_config field.
...
`google.compute_health_check.withName` constructs a mixin object that can be merged into the `compute_health_check`
...
`google.compute_health_check.withProject` constructs a mixin object that can be merged into the `compute_health_check`
...
`google.compute_health_check.withSslHealthCheck` constructs a mixin object that can be merged into the `compute_health_check`
...
`google.compute_health_check.withSslHealthCheckMixin` constructs a mixin object that can be merged into the `compute_health_check`
Terraform resource block to set or update the ssl_health_check field.
...
`google.compute_health_check.withTcpHealthCheck` constructs a mixin object that can be merged into the `compute_health_check`
...
`google.compute_health_check.withTcpHealthCheckMixin` constructs a mixin object that can be merged into the `compute_health_check`
Terraform resource block to set or update the tcp_health_check field.
...
`google.compute_health_check.withTimeoutSec` constructs a mixin object that can be merged into the `compute_health_check`
...
`google.compute_health_check.withTimeouts` constructs a mixin object that can be merged into the `compute_health_check`
...
`google.compute_health_check.withTimeoutsMixin` constructs a mixin object that can be merged into the `compute_health_check`
Terraform resource block to set or update the timeouts field.
...
`google.compute_health_check.withUnhealthyThreshold` constructs a mixin object that can be merged into the `compute_health_check`
