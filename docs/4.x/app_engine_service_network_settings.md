...
`google.app_engine_service_network_settings.withNetworkSettings` constructs a mixin object that can be merged into the `app_engine_service_network_settings`
...
`google.app_engine_service_network_settings.withNetworkSettingsMixin` constructs a mixin object that can be merged into the `app_engine_service_network_settings`
Terraform resource block to set or update the network_settings field.
...
`google.app_engine_service_network_settings.withProject` constructs a mixin object that can be merged into the `app_engine_service_network_settings`
...
`google.app_engine_service_network_settings.withService` constructs a mixin object that can be merged into the `app_engine_service_network_settings`
...
`google.app_engine_service_network_settings.withTimeouts` constructs a mixin object that can be merged into the `app_engine_service_network_settings`
...
`google.app_engine_service_network_settings.withTimeoutsMixin` constructs a mixin object that can be merged into the `app_engine_service_network_settings`
Terraform resource block to set or update the timeouts field.
