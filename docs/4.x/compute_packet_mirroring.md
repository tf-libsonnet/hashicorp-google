...
`google.compute_packet_mirroring.withCollectorIlb` constructs a mixin object that can be merged into the `compute_packet_mirroring`
...
`google.compute_packet_mirroring.withCollectorIlbMixin` constructs a mixin object that can be merged into the `compute_packet_mirroring`
Terraform resource block to set or update the collector_ilb field.
...
`google.compute_packet_mirroring.withDescription` constructs a mixin object that can be merged into the `compute_packet_mirroring`
...
`google.compute_packet_mirroring.withFilter` constructs a mixin object that can be merged into the `compute_packet_mirroring`
...
`google.compute_packet_mirroring.withFilterMixin` constructs a mixin object that can be merged into the `compute_packet_mirroring`
Terraform resource block to set or update the filter field.
...
`google.compute_packet_mirroring.withMirroredResources` constructs a mixin object that can be merged into the `compute_packet_mirroring`
...
`google.compute_packet_mirroring.withMirroredResourcesMixin` constructs a mixin object that can be merged into the `compute_packet_mirroring`
Terraform resource block to set or update the mirrored_resources field.
...
`google.compute_packet_mirroring.withName` constructs a mixin object that can be merged into the `compute_packet_mirroring`
...
`google.compute_packet_mirroring.withNetwork` constructs a mixin object that can be merged into the `compute_packet_mirroring`
...
`google.compute_packet_mirroring.withNetworkMixin` constructs a mixin object that can be merged into the `compute_packet_mirroring`
Terraform resource block to set or update the network field.
...
`google.compute_packet_mirroring.withPriority` constructs a mixin object that can be merged into the `compute_packet_mirroring`
...
`google.compute_packet_mirroring.withProject` constructs a mixin object that can be merged into the `compute_packet_mirroring`
...
`google.compute_packet_mirroring.withRegion` constructs a mixin object that can be merged into the `compute_packet_mirroring`
...
`google.compute_packet_mirroring.withTimeouts` constructs a mixin object that can be merged into the `compute_packet_mirroring`
...
`google.compute_packet_mirroring.withTimeoutsMixin` constructs a mixin object that can be merged into the `compute_packet_mirroring`
Terraform resource block to set or update the timeouts field.
