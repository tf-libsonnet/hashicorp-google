...
`google.storage_hmac_key.withProject` constructs a mixin object that can be merged into the `storage_hmac_key`
...
`google.storage_hmac_key.withServiceAccountEmail` constructs a mixin object that can be merged into the `storage_hmac_key`
...
`google.storage_hmac_key.withState` constructs a mixin object that can be merged into the `storage_hmac_key`
...
`google.storage_hmac_key.withTimeouts` constructs a mixin object that can be merged into the `storage_hmac_key`
...
`google.storage_hmac_key.withTimeoutsMixin` constructs a mixin object that can be merged into the `storage_hmac_key`
Terraform resource block to set or update the timeouts field.
