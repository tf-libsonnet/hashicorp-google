---
permalink: /network_security_address_group_iam_binding/
---

# network_security_address_group_iam_binding

`network_security_address_group_iam_binding` represents the `google_network_security_address_group_iam_binding` Terraform resource.
