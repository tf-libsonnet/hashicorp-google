...
`google.compute_target_ssl_proxy.withBackendService` constructs a mixin object that can be merged into the `compute_target_ssl_proxy`
...
`google.compute_target_ssl_proxy.withCertificateMap` constructs a mixin object that can be merged into the `compute_target_ssl_proxy`
...
`google.compute_target_ssl_proxy.withDescription` constructs a mixin object that can be merged into the `compute_target_ssl_proxy`
...
`google.compute_target_ssl_proxy.withName` constructs a mixin object that can be merged into the `compute_target_ssl_proxy`
...
`google.compute_target_ssl_proxy.withProject` constructs a mixin object that can be merged into the `compute_target_ssl_proxy`
...
`google.compute_target_ssl_proxy.withProxyHeader` constructs a mixin object that can be merged into the `compute_target_ssl_proxy`
...
`google.compute_target_ssl_proxy.withSslCertificates` constructs a mixin object that can be merged into the `compute_target_ssl_proxy`
...
`google.compute_target_ssl_proxy.withSslPolicy` constructs a mixin object that can be merged into the `compute_target_ssl_proxy`
...
`google.compute_target_ssl_proxy.withTimeouts` constructs a mixin object that can be merged into the `compute_target_ssl_proxy`
...
`google.compute_target_ssl_proxy.withTimeoutsMixin` constructs a mixin object that can be merged into the `compute_target_ssl_proxy`
Terraform resource block to set or update the timeouts field.
