...
`google.network_connectivity_spoke.withDescription` constructs a mixin object that can be merged into the `network_connectivity_spoke`
...
`google.network_connectivity_spoke.withHub` constructs a mixin object that can be merged into the `network_connectivity_spoke`
...
`google.network_connectivity_spoke.withLabels` constructs a mixin object that can be merged into the `network_connectivity_spoke`
...
`google.network_connectivity_spoke.withLinkedInterconnectAttachments` constructs a mixin object that can be merged into the `network_connectivity_spoke`
...
`google.network_connectivity_spoke.withLinkedInterconnectAttachmentsMixin` constructs a mixin object that can be merged into the `network_connectivity_spoke`
Terraform resource block to set or update the linked_interconnect_attachments field.
...
`google.network_connectivity_spoke.withLinkedRouterApplianceInstances` constructs a mixin object that can be merged into the `network_connectivity_spoke`
...
`google.network_connectivity_spoke.withLinkedRouterApplianceInstancesMixin` constructs a mixin object that can be merged into the `network_connectivity_spoke`
Terraform resource block to set or update the linked_router_appliance_instances field.
...
`google.network_connectivity_spoke.withLinkedVpnTunnels` constructs a mixin object that can be merged into the `network_connectivity_spoke`
...
`google.network_connectivity_spoke.withLinkedVpnTunnelsMixin` constructs a mixin object that can be merged into the `network_connectivity_spoke`
Terraform resource block to set or update the linked_vpn_tunnels field.
...
`google.network_connectivity_spoke.withLocation` constructs a mixin object that can be merged into the `network_connectivity_spoke`
...
`google.network_connectivity_spoke.withName` constructs a mixin object that can be merged into the `network_connectivity_spoke`
...
`google.network_connectivity_spoke.withProject` constructs a mixin object that can be merged into the `network_connectivity_spoke`
...
`google.network_connectivity_spoke.withTimeouts` constructs a mixin object that can be merged into the `network_connectivity_spoke`
...
`google.network_connectivity_spoke.withTimeoutsMixin` constructs a mixin object that can be merged into the `network_connectivity_spoke`
Terraform resource block to set or update the timeouts field.
