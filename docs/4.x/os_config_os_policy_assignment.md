...
`google.os_config_os_policy_assignment.withDescription` constructs a mixin object that can be merged into the `os_config_os_policy_assignment`
...
`google.os_config_os_policy_assignment.withInstanceFilter` constructs a mixin object that can be merged into the `os_config_os_policy_assignment`
...
`google.os_config_os_policy_assignment.withInstanceFilterMixin` constructs a mixin object that can be merged into the `os_config_os_policy_assignment`
Terraform resource block to set or update the instance_filter field.
...
`google.os_config_os_policy_assignment.withLocation` constructs a mixin object that can be merged into the `os_config_os_policy_assignment`
...
`google.os_config_os_policy_assignment.withName` constructs a mixin object that can be merged into the `os_config_os_policy_assignment`
...
`google.os_config_os_policy_assignment.withOsPolicies` constructs a mixin object that can be merged into the `os_config_os_policy_assignment`
...
`google.os_config_os_policy_assignment.withOsPoliciesMixin` constructs a mixin object that can be merged into the `os_config_os_policy_assignment`
Terraform resource block to set or update the os_policies field.
...
`google.os_config_os_policy_assignment.withProject` constructs a mixin object that can be merged into the `os_config_os_policy_assignment`
...
`google.os_config_os_policy_assignment.withRollout` constructs a mixin object that can be merged into the `os_config_os_policy_assignment`
...
`google.os_config_os_policy_assignment.withRolloutMixin` constructs a mixin object that can be merged into the `os_config_os_policy_assignment`
Terraform resource block to set or update the rollout field.
...
`google.os_config_os_policy_assignment.withTimeouts` constructs a mixin object that can be merged into the `os_config_os_policy_assignment`
...
`google.os_config_os_policy_assignment.withTimeoutsMixin` constructs a mixin object that can be merged into the `os_config_os_policy_assignment`
Terraform resource block to set or update the timeouts field.
