...
`google.compute_firewall_policy.withDescription` constructs a mixin object that can be merged into the `compute_firewall_policy`
...
`google.compute_firewall_policy.withParent` constructs a mixin object that can be merged into the `compute_firewall_policy`
...
`google.compute_firewall_policy.withShortName` constructs a mixin object that can be merged into the `compute_firewall_policy`
...
`google.compute_firewall_policy.withTimeouts` constructs a mixin object that can be merged into the `compute_firewall_policy`
...
`google.compute_firewall_policy.withTimeoutsMixin` constructs a mixin object that can be merged into the `compute_firewall_policy`
Terraform resource block to set or update the timeouts field.
