...
`google.compute_node_template.withCpuOvercommitType` constructs a mixin object that can be merged into the `compute_node_template`
...
`google.compute_node_template.withDescription` constructs a mixin object that can be merged into the `compute_node_template`
...
`google.compute_node_template.withName` constructs a mixin object that can be merged into the `compute_node_template`
...
`google.compute_node_template.withNodeAffinityLabels` constructs a mixin object that can be merged into the `compute_node_template`
...
`google.compute_node_template.withNodeType` constructs a mixin object that can be merged into the `compute_node_template`
...
`google.compute_node_template.withNodeTypeFlexibility` constructs a mixin object that can be merged into the `compute_node_template`
...
`google.compute_node_template.withNodeTypeFlexibilityMixin` constructs a mixin object that can be merged into the `compute_node_template`
Terraform resource block to set or update the node_type_flexibility field.
...
`google.compute_node_template.withProject` constructs a mixin object that can be merged into the `compute_node_template`
...
`google.compute_node_template.withRegion` constructs a mixin object that can be merged into the `compute_node_template`
...
`google.compute_node_template.withServerBinding` constructs a mixin object that can be merged into the `compute_node_template`
...
`google.compute_node_template.withServerBindingMixin` constructs a mixin object that can be merged into the `compute_node_template`
Terraform resource block to set or update the server_binding field.
...
`google.compute_node_template.withTimeouts` constructs a mixin object that can be merged into the `compute_node_template`
...
`google.compute_node_template.withTimeoutsMixin` constructs a mixin object that can be merged into the `compute_node_template`
Terraform resource block to set or update the timeouts field.
