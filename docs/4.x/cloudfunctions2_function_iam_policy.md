---
permalink: /cloudfunctions2_function_iam_policy/
---

# cloudfunctions2_function_iam_policy

`cloudfunctions2_function_iam_policy` represents the `google_cloudfunctions2_function_iam_policy` Terraform resource.
...
`google.cloudfunctions2_function_iam_policy.withCloudFunction` constructs a mixin object that can be merged into the `cloudfunctions2_function_iam_policy`
...
`google.cloudfunctions2_function_iam_policy.withLocation` constructs a mixin object that can be merged into the `cloudfunctions2_function_iam_policy`
...
`google.cloudfunctions2_function_iam_policy.withPolicyData` constructs a mixin object that can be merged into the `cloudfunctions2_function_iam_policy`
...
`google.cloudfunctions2_function_iam_policy.withProject` constructs a mixin object that can be merged into the `cloudfunctions2_function_iam_policy`
