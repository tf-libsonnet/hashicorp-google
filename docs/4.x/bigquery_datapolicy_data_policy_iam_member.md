---
permalink: /bigquery_datapolicy_data_policy_iam_member/
---

# bigquery_datapolicy_data_policy_iam_member

`bigquery_datapolicy_data_policy_iam_member` represents the `google_bigquery_datapolicy_data_policy_iam_member` Terraform resource.
