...
`google.cloudbuild_worker_pool.withAnnotations` constructs a mixin object that can be merged into the `cloudbuild_worker_pool`
...
`google.cloudbuild_worker_pool.withDisplayName` constructs a mixin object that can be merged into the `cloudbuild_worker_pool`
...
`google.cloudbuild_worker_pool.withLocation` constructs a mixin object that can be merged into the `cloudbuild_worker_pool`
...
`google.cloudbuild_worker_pool.withName` constructs a mixin object that can be merged into the `cloudbuild_worker_pool`
...
`google.cloudbuild_worker_pool.withNetworkConfig` constructs a mixin object that can be merged into the `cloudbuild_worker_pool`
...
`google.cloudbuild_worker_pool.withNetworkConfigMixin` constructs a mixin object that can be merged into the `cloudbuild_worker_pool`
Terraform resource block to set or update the network_config field.
...
`google.cloudbuild_worker_pool.withProject` constructs a mixin object that can be merged into the `cloudbuild_worker_pool`
...
`google.cloudbuild_worker_pool.withTimeouts` constructs a mixin object that can be merged into the `cloudbuild_worker_pool`
...
`google.cloudbuild_worker_pool.withTimeoutsMixin` constructs a mixin object that can be merged into the `cloudbuild_worker_pool`
Terraform resource block to set or update the timeouts field.
...
`google.cloudbuild_worker_pool.withWorkerConfig` constructs a mixin object that can be merged into the `cloudbuild_worker_pool`
...
`google.cloudbuild_worker_pool.withWorkerConfigMixin` constructs a mixin object that can be merged into the `cloudbuild_worker_pool`
Terraform resource block to set or update the worker_config field.
