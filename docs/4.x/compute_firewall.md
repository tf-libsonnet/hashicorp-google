...
`google.compute_firewall.withAllow` constructs a mixin object that can be merged into the `compute_firewall`
...
`google.compute_firewall.withAllowMixin` constructs a mixin object that can be merged into the `compute_firewall`
Terraform resource block to set or update the allow field.
...
`google.compute_firewall.withDeny` constructs a mixin object that can be merged into the `compute_firewall`
...
`google.compute_firewall.withDenyMixin` constructs a mixin object that can be merged into the `compute_firewall`
Terraform resource block to set or update the deny field.
...
`google.compute_firewall.withDescription` constructs a mixin object that can be merged into the `compute_firewall`
...
`google.compute_firewall.withDestinationRanges` constructs a mixin object that can be merged into the `compute_firewall`
...
`google.compute_firewall.withDirection` constructs a mixin object that can be merged into the `compute_firewall`
...
`google.compute_firewall.withDisabled` constructs a mixin object that can be merged into the `compute_firewall`
...
`google.compute_firewall.withEnableLogging` constructs a mixin object that can be merged into the `compute_firewall`
...
`google.compute_firewall.withLogConfig` constructs a mixin object that can be merged into the `compute_firewall`
...
`google.compute_firewall.withLogConfigMixin` constructs a mixin object that can be merged into the `compute_firewall`
Terraform resource block to set or update the log_config field.
...
`google.compute_firewall.withName` constructs a mixin object that can be merged into the `compute_firewall`
...
`google.compute_firewall.withNetwork` constructs a mixin object that can be merged into the `compute_firewall`
...
`google.compute_firewall.withPriority` constructs a mixin object that can be merged into the `compute_firewall`
...
`google.compute_firewall.withProject` constructs a mixin object that can be merged into the `compute_firewall`
...
`google.compute_firewall.withSourceRanges` constructs a mixin object that can be merged into the `compute_firewall`
...
`google.compute_firewall.withSourceServiceAccounts` constructs a mixin object that can be merged into the `compute_firewall`
...
`google.compute_firewall.withSourceTags` constructs a mixin object that can be merged into the `compute_firewall`
...
`google.compute_firewall.withTargetServiceAccounts` constructs a mixin object that can be merged into the `compute_firewall`
...
`google.compute_firewall.withTargetTags` constructs a mixin object that can be merged into the `compute_firewall`
...
`google.compute_firewall.withTimeouts` constructs a mixin object that can be merged into the `compute_firewall`
...
`google.compute_firewall.withTimeoutsMixin` constructs a mixin object that can be merged into the `compute_firewall`
Terraform resource block to set or update the timeouts field.
