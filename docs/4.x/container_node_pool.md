...
`google.container_node_pool.withAutoscaling` constructs a mixin object that can be merged into the `container_node_pool`
...
`google.container_node_pool.withAutoscalingMixin` constructs a mixin object that can be merged into the `container_node_pool`
Terraform resource block to set or update the autoscaling field.
...
`google.container_node_pool.withCluster` constructs a mixin object that can be merged into the `container_node_pool`
...
`google.container_node_pool.withInitialNodeCount` constructs a mixin object that can be merged into the `container_node_pool`
...
`google.container_node_pool.withLocation` constructs a mixin object that can be merged into the `container_node_pool`
...
`google.container_node_pool.withManagement` constructs a mixin object that can be merged into the `container_node_pool`
...
`google.container_node_pool.withManagementMixin` constructs a mixin object that can be merged into the `container_node_pool`
Terraform resource block to set or update the management field.
...
`google.container_node_pool.withMaxPodsPerNode` constructs a mixin object that can be merged into the `container_node_pool`
...
`google.container_node_pool.withName` constructs a mixin object that can be merged into the `container_node_pool`
...
`google.container_node_pool.withNamePrefix` constructs a mixin object that can be merged into the `container_node_pool`
...
`google.container_node_pool.withNetworkConfig` constructs a mixin object that can be merged into the `container_node_pool`
...
`google.container_node_pool.withNetworkConfigMixin` constructs a mixin object that can be merged into the `container_node_pool`
Terraform resource block to set or update the network_config field.
...
`google.container_node_pool.withNodeConfig` constructs a mixin object that can be merged into the `container_node_pool`
...
`google.container_node_pool.withNodeConfigMixin` constructs a mixin object that can be merged into the `container_node_pool`
Terraform resource block to set or update the node_config field.
...
`google.container_node_pool.withNodeCount` constructs a mixin object that can be merged into the `container_node_pool`
...
`google.container_node_pool.withNodeLocations` constructs a mixin object that can be merged into the `container_node_pool`
...
`google.container_node_pool.withProject` constructs a mixin object that can be merged into the `container_node_pool`
...
`google.container_node_pool.withTimeouts` constructs a mixin object that can be merged into the `container_node_pool`
...
`google.container_node_pool.withTimeoutsMixin` constructs a mixin object that can be merged into the `container_node_pool`
Terraform resource block to set or update the timeouts field.
...
`google.container_node_pool.withUpgradeSettings` constructs a mixin object that can be merged into the `container_node_pool`
...
`google.container_node_pool.withUpgradeSettingsMixin` constructs a mixin object that can be merged into the `container_node_pool`
Terraform resource block to set or update the upgrade_settings field.
...
`google.container_node_pool.withVersion` constructs a mixin object that can be merged into the `container_node_pool`
