...
`google.container_analysis_note.withAttestationAuthority` constructs a mixin object that can be merged into the `container_analysis_note`
...
`google.container_analysis_note.withAttestationAuthorityMixin` constructs a mixin object that can be merged into the `container_analysis_note`
Terraform resource block to set or update the attestation_authority field.
...
`google.container_analysis_note.withExpirationTime` constructs a mixin object that can be merged into the `container_analysis_note`
...
`google.container_analysis_note.withLongDescription` constructs a mixin object that can be merged into the `container_analysis_note`
...
`google.container_analysis_note.withName` constructs a mixin object that can be merged into the `container_analysis_note`
...
`google.container_analysis_note.withProject` constructs a mixin object that can be merged into the `container_analysis_note`
...
`google.container_analysis_note.withRelatedNoteNames` constructs a mixin object that can be merged into the `container_analysis_note`
...
`google.container_analysis_note.withRelatedUrl` constructs a mixin object that can be merged into the `container_analysis_note`
...
`google.container_analysis_note.withRelatedUrlMixin` constructs a mixin object that can be merged into the `container_analysis_note`
Terraform resource block to set or update the related_url field.
...
`google.container_analysis_note.withShortDescription` constructs a mixin object that can be merged into the `container_analysis_note`
...
`google.container_analysis_note.withTimeouts` constructs a mixin object that can be merged into the `container_analysis_note`
...
`google.container_analysis_note.withTimeoutsMixin` constructs a mixin object that can be merged into the `container_analysis_note`
Terraform resource block to set or update the timeouts field.
