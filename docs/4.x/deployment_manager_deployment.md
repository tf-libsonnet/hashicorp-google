...
`google.deployment_manager_deployment.withCreatePolicy` constructs a mixin object that can be merged into the `deployment_manager_deployment`
...
`google.deployment_manager_deployment.withDeletePolicy` constructs a mixin object that can be merged into the `deployment_manager_deployment`
...
`google.deployment_manager_deployment.withDescription` constructs a mixin object that can be merged into the `deployment_manager_deployment`
...
`google.deployment_manager_deployment.withLabels` constructs a mixin object that can be merged into the `deployment_manager_deployment`
...
`google.deployment_manager_deployment.withLabelsMixin` constructs a mixin object that can be merged into the `deployment_manager_deployment`
Terraform resource block to set or update the labels field.
...
`google.deployment_manager_deployment.withName` constructs a mixin object that can be merged into the `deployment_manager_deployment`
...
`google.deployment_manager_deployment.withPreview` constructs a mixin object that can be merged into the `deployment_manager_deployment`
...
`google.deployment_manager_deployment.withProject` constructs a mixin object that can be merged into the `deployment_manager_deployment`
...
`google.deployment_manager_deployment.withTarget` constructs a mixin object that can be merged into the `deployment_manager_deployment`
...
`google.deployment_manager_deployment.withTargetMixin` constructs a mixin object that can be merged into the `deployment_manager_deployment`
Terraform resource block to set or update the target field.
...
`google.deployment_manager_deployment.withTimeouts` constructs a mixin object that can be merged into the `deployment_manager_deployment`
...
`google.deployment_manager_deployment.withTimeoutsMixin` constructs a mixin object that can be merged into the `deployment_manager_deployment`
Terraform resource block to set or update the timeouts field.
