...
`google.logging_billing_account_exclusion.withBillingAccount` constructs a mixin object that can be merged into the `logging_billing_account_exclusion`
...
`google.logging_billing_account_exclusion.withDescription` constructs a mixin object that can be merged into the `logging_billing_account_exclusion`
...
`google.logging_billing_account_exclusion.withDisabled` constructs a mixin object that can be merged into the `logging_billing_account_exclusion`
...
`google.logging_billing_account_exclusion.withFilter` constructs a mixin object that can be merged into the `logging_billing_account_exclusion`
...
`google.logging_billing_account_exclusion.withName` constructs a mixin object that can be merged into the `logging_billing_account_exclusion`
