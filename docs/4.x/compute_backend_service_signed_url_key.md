...
`google.compute_backend_service_signed_url_key.withBackendService` constructs a mixin object that can be merged into the `compute_backend_service_signed_url_key`
...
`google.compute_backend_service_signed_url_key.withKeyValue` constructs a mixin object that can be merged into the `compute_backend_service_signed_url_key`
...
`google.compute_backend_service_signed_url_key.withName` constructs a mixin object that can be merged into the `compute_backend_service_signed_url_key`
...
`google.compute_backend_service_signed_url_key.withProject` constructs a mixin object that can be merged into the `compute_backend_service_signed_url_key`
...
`google.compute_backend_service_signed_url_key.withTimeouts` constructs a mixin object that can be merged into the `compute_backend_service_signed_url_key`
...
`google.compute_backend_service_signed_url_key.withTimeoutsMixin` constructs a mixin object that can be merged into the `compute_backend_service_signed_url_key`
Terraform resource block to set or update the timeouts field.
