...
`google.compute_router_interface.withInterconnectAttachment` constructs a mixin object that can be merged into the `compute_router_interface`
...
`google.compute_router_interface.withIpRange` constructs a mixin object that can be merged into the `compute_router_interface`
...
`google.compute_router_interface.withName` constructs a mixin object that can be merged into the `compute_router_interface`
...
`google.compute_router_interface.withPrivateIpAddress` constructs a mixin object that can be merged into the `compute_router_interface`
...
`google.compute_router_interface.withProject` constructs a mixin object that can be merged into the `compute_router_interface`
...
`google.compute_router_interface.withRedundantInterface` constructs a mixin object that can be merged into the `compute_router_interface`
...
`google.compute_router_interface.withRegion` constructs a mixin object that can be merged into the `compute_router_interface`
...
`google.compute_router_interface.withRouter` constructs a mixin object that can be merged into the `compute_router_interface`
...
`google.compute_router_interface.withSubnetwork` constructs a mixin object that can be merged into the `compute_router_interface`
...
`google.compute_router_interface.withTimeouts` constructs a mixin object that can be merged into the `compute_router_interface`
...
`google.compute_router_interface.withTimeoutsMixin` constructs a mixin object that can be merged into the `compute_router_interface`
Terraform resource block to set or update the timeouts field.
...
`google.compute_router_interface.withVpnTunnel` constructs a mixin object that can be merged into the `compute_router_interface`
