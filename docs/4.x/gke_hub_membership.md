...
`google.gke_hub_membership.withAuthority` constructs a mixin object that can be merged into the `gke_hub_membership`
...
`google.gke_hub_membership.withAuthorityMixin` constructs a mixin object that can be merged into the `gke_hub_membership`
Terraform resource block to set or update the authority field.
...
`google.gke_hub_membership.withEndpoint` constructs a mixin object that can be merged into the `gke_hub_membership`
...
`google.gke_hub_membership.withEndpointMixin` constructs a mixin object that can be merged into the `gke_hub_membership`
Terraform resource block to set or update the endpoint field.
...
`google.gke_hub_membership.withLabels` constructs a mixin object that can be merged into the `gke_hub_membership`
...
`google.gke_hub_membership.withMembershipId` constructs a mixin object that can be merged into the `gke_hub_membership`
...
`google.gke_hub_membership.withProject` constructs a mixin object that can be merged into the `gke_hub_membership`
...
`google.gke_hub_membership.withTimeouts` constructs a mixin object that can be merged into the `gke_hub_membership`
...
`google.gke_hub_membership.withTimeoutsMixin` constructs a mixin object that can be merged into the `gke_hub_membership`
Terraform resource block to set or update the timeouts field.
