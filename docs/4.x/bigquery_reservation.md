...
`google.bigquery_reservation.withConcurrency` constructs a mixin object that can be merged into the `bigquery_reservation`
...
`google.bigquery_reservation.withIgnoreIdleSlots` constructs a mixin object that can be merged into the `bigquery_reservation`
...
`google.bigquery_reservation.withLocation` constructs a mixin object that can be merged into the `bigquery_reservation`
...
`google.bigquery_reservation.withMultiRegionAuxiliary` constructs a mixin object that can be merged into the `bigquery_reservation`
...
`google.bigquery_reservation.withName` constructs a mixin object that can be merged into the `bigquery_reservation`
...
`google.bigquery_reservation.withProject` constructs a mixin object that can be merged into the `bigquery_reservation`
...
`google.bigquery_reservation.withSlotCapacity` constructs a mixin object that can be merged into the `bigquery_reservation`
...
`google.bigquery_reservation.withTimeouts` constructs a mixin object that can be merged into the `bigquery_reservation`
...
`google.bigquery_reservation.withTimeoutsMixin` constructs a mixin object that can be merged into the `bigquery_reservation`
Terraform resource block to set or update the timeouts field.
