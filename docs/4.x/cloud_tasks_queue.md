...
`google.cloud_tasks_queue.withAppEngineRoutingOverride` constructs a mixin object that can be merged into the `cloud_tasks_queue`
...
`google.cloud_tasks_queue.withAppEngineRoutingOverrideMixin` constructs a mixin object that can be merged into the `cloud_tasks_queue`
Terraform resource block to set or update the app_engine_routing_override field.
...
`google.cloud_tasks_queue.withLocation` constructs a mixin object that can be merged into the `cloud_tasks_queue`
...
`google.cloud_tasks_queue.withName` constructs a mixin object that can be merged into the `cloud_tasks_queue`
...
`google.cloud_tasks_queue.withProject` constructs a mixin object that can be merged into the `cloud_tasks_queue`
...
`google.cloud_tasks_queue.withRateLimits` constructs a mixin object that can be merged into the `cloud_tasks_queue`
...
`google.cloud_tasks_queue.withRateLimitsMixin` constructs a mixin object that can be merged into the `cloud_tasks_queue`
Terraform resource block to set or update the rate_limits field.
...
`google.cloud_tasks_queue.withRetryConfig` constructs a mixin object that can be merged into the `cloud_tasks_queue`
...
`google.cloud_tasks_queue.withRetryConfigMixin` constructs a mixin object that can be merged into the `cloud_tasks_queue`
Terraform resource block to set or update the retry_config field.
...
`google.cloud_tasks_queue.withStackdriverLoggingConfig` constructs a mixin object that can be merged into the `cloud_tasks_queue`
...
`google.cloud_tasks_queue.withStackdriverLoggingConfigMixin` constructs a mixin object that can be merged into the `cloud_tasks_queue`
Terraform resource block to set or update the stackdriver_logging_config field.
...
`google.cloud_tasks_queue.withTimeouts` constructs a mixin object that can be merged into the `cloud_tasks_queue`
...
`google.cloud_tasks_queue.withTimeoutsMixin` constructs a mixin object that can be merged into the `cloud_tasks_queue`
Terraform resource block to set or update the timeouts field.
