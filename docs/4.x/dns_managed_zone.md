...
`google.dns_managed_zone.withCloudLoggingConfig` constructs a mixin object that can be merged into the `dns_managed_zone`
...
`google.dns_managed_zone.withCloudLoggingConfigMixin` constructs a mixin object that can be merged into the `dns_managed_zone`
Terraform resource block to set or update the cloud_logging_config field.
...
`google.dns_managed_zone.withDescription` constructs a mixin object that can be merged into the `dns_managed_zone`
...
`google.dns_managed_zone.withDnsName` constructs a mixin object that can be merged into the `dns_managed_zone`
...
`google.dns_managed_zone.withDnssecConfig` constructs a mixin object that can be merged into the `dns_managed_zone`
...
`google.dns_managed_zone.withDnssecConfigMixin` constructs a mixin object that can be merged into the `dns_managed_zone`
Terraform resource block to set or update the dnssec_config field.
...
`google.dns_managed_zone.withForceDestroy` constructs a mixin object that can be merged into the `dns_managed_zone`
...
`google.dns_managed_zone.withForwardingConfig` constructs a mixin object that can be merged into the `dns_managed_zone`
...
`google.dns_managed_zone.withForwardingConfigMixin` constructs a mixin object that can be merged into the `dns_managed_zone`
Terraform resource block to set or update the forwarding_config field.
...
`google.dns_managed_zone.withLabels` constructs a mixin object that can be merged into the `dns_managed_zone`
...
`google.dns_managed_zone.withName` constructs a mixin object that can be merged into the `dns_managed_zone`
...
`google.dns_managed_zone.withPeeringConfig` constructs a mixin object that can be merged into the `dns_managed_zone`
...
`google.dns_managed_zone.withPeeringConfigMixin` constructs a mixin object that can be merged into the `dns_managed_zone`
Terraform resource block to set or update the peering_config field.
...
`google.dns_managed_zone.withPrivateVisibilityConfig` constructs a mixin object that can be merged into the `dns_managed_zone`
...
`google.dns_managed_zone.withPrivateVisibilityConfigMixin` constructs a mixin object that can be merged into the `dns_managed_zone`
Terraform resource block to set or update the private_visibility_config field.
...
`google.dns_managed_zone.withProject` constructs a mixin object that can be merged into the `dns_managed_zone`
...
`google.dns_managed_zone.withTimeouts` constructs a mixin object that can be merged into the `dns_managed_zone`
...
`google.dns_managed_zone.withTimeoutsMixin` constructs a mixin object that can be merged into the `dns_managed_zone`
Terraform resource block to set or update the timeouts field.
...
`google.dns_managed_zone.withVisibility` constructs a mixin object that can be merged into the `dns_managed_zone`
