...
`google.redis_instance.withAlternativeLocationId` constructs a mixin object that can be merged into the `redis_instance`
...
`google.redis_instance.withAuthEnabled` constructs a mixin object that can be merged into the `redis_instance`
...
`google.redis_instance.withAuthorizedNetwork` constructs a mixin object that can be merged into the `redis_instance`
...
`google.redis_instance.withConnectMode` constructs a mixin object that can be merged into the `redis_instance`
...
`google.redis_instance.withCustomerManagedKey` constructs a mixin object that can be merged into the `redis_instance`
...
`google.redis_instance.withDisplayName` constructs a mixin object that can be merged into the `redis_instance`
...
`google.redis_instance.withLabels` constructs a mixin object that can be merged into the `redis_instance`
...
`google.redis_instance.withLocationId` constructs a mixin object that can be merged into the `redis_instance`
...
`google.redis_instance.withMaintenancePolicy` constructs a mixin object that can be merged into the `redis_instance`
...
`google.redis_instance.withMaintenancePolicyMixin` constructs a mixin object that can be merged into the `redis_instance`
Terraform resource block to set or update the maintenance_policy field.
...
`google.redis_instance.withMaintenanceSchedule` constructs a mixin object that can be merged into the `redis_instance`
...
`google.redis_instance.withMaintenanceScheduleMixin` constructs a mixin object that can be merged into the `redis_instance`
Terraform resource block to set or update the maintenance_schedule field.
...
`google.redis_instance.withMemorySizeGb` constructs a mixin object that can be merged into the `redis_instance`
...
`google.redis_instance.withName` constructs a mixin object that can be merged into the `redis_instance`
...
`google.redis_instance.withPersistenceConfig` constructs a mixin object that can be merged into the `redis_instance`
...
`google.redis_instance.withPersistenceConfigMixin` constructs a mixin object that can be merged into the `redis_instance`
Terraform resource block to set or update the persistence_config field.
...
`google.redis_instance.withProject` constructs a mixin object that can be merged into the `redis_instance`
...
`google.redis_instance.withReadReplicasMode` constructs a mixin object that can be merged into the `redis_instance`
...
`google.redis_instance.withRedisConfigs` constructs a mixin object that can be merged into the `redis_instance`
...
`google.redis_instance.withRedisVersion` constructs a mixin object that can be merged into the `redis_instance`
...
`google.redis_instance.withRegion` constructs a mixin object that can be merged into the `redis_instance`
...
`google.redis_instance.withReplicaCount` constructs a mixin object that can be merged into the `redis_instance`
...
`google.redis_instance.withReservedIpRange` constructs a mixin object that can be merged into the `redis_instance`
...
`google.redis_instance.withSecondaryIpRange` constructs a mixin object that can be merged into the `redis_instance`
...
`google.redis_instance.withTier` constructs a mixin object that can be merged into the `redis_instance`
...
`google.redis_instance.withTimeouts` constructs a mixin object that can be merged into the `redis_instance`
...
`google.redis_instance.withTimeoutsMixin` constructs a mixin object that can be merged into the `redis_instance`
Terraform resource block to set or update the timeouts field.
...
`google.redis_instance.withTransitEncryptionMode` constructs a mixin object that can be merged into the `redis_instance`
