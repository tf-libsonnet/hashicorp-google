...
`google.monitoring_service.withBasicService` constructs a mixin object that can be merged into the `monitoring_service`
...
`google.monitoring_service.withBasicServiceMixin` constructs a mixin object that can be merged into the `monitoring_service`
Terraform resource block to set or update the basic_service field.
...
`google.monitoring_service.withDisplayName` constructs a mixin object that can be merged into the `monitoring_service`
...
`google.monitoring_service.withProject` constructs a mixin object that can be merged into the `monitoring_service`
...
`google.monitoring_service.withServiceId` constructs a mixin object that can be merged into the `monitoring_service`
...
`google.monitoring_service.withTimeouts` constructs a mixin object that can be merged into the `monitoring_service`
...
`google.monitoring_service.withTimeoutsMixin` constructs a mixin object that can be merged into the `monitoring_service`
Terraform resource block to set or update the timeouts field.
...
`google.monitoring_service.withUserLabels` constructs a mixin object that can be merged into the `monitoring_service`
