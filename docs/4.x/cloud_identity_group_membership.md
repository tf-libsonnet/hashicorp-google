...
`google.cloud_identity_group_membership.withGroup` constructs a mixin object that can be merged into the `cloud_identity_group_membership`
...
`google.cloud_identity_group_membership.withPreferredMemberKey` constructs a mixin object that can be merged into the `cloud_identity_group_membership`
...
`google.cloud_identity_group_membership.withPreferredMemberKeyMixin` constructs a mixin object that can be merged into the `cloud_identity_group_membership`
Terraform resource block to set or update the preferred_member_key field.
...
`google.cloud_identity_group_membership.withRoles` constructs a mixin object that can be merged into the `cloud_identity_group_membership`
...
`google.cloud_identity_group_membership.withRolesMixin` constructs a mixin object that can be merged into the `cloud_identity_group_membership`
Terraform resource block to set or update the roles field.
...
`google.cloud_identity_group_membership.withTimeouts` constructs a mixin object that can be merged into the `cloud_identity_group_membership`
...
`google.cloud_identity_group_membership.withTimeoutsMixin` constructs a mixin object that can be merged into the `cloud_identity_group_membership`
Terraform resource block to set or update the timeouts field.
