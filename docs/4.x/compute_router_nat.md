...
`google.compute_router_nat.withDrainNatIps` constructs a mixin object that can be merged into the `compute_router_nat`
...
`google.compute_router_nat.withEnableDynamicPortAllocation` constructs a mixin object that can be merged into the `compute_router_nat`
...
`google.compute_router_nat.withEnableEndpointIndependentMapping` constructs a mixin object that can be merged into the `compute_router_nat`
...
`google.compute_router_nat.withIcmpIdleTimeoutSec` constructs a mixin object that can be merged into the `compute_router_nat`
...
`google.compute_router_nat.withLogConfig` constructs a mixin object that can be merged into the `compute_router_nat`
...
`google.compute_router_nat.withLogConfigMixin` constructs a mixin object that can be merged into the `compute_router_nat`
Terraform resource block to set or update the log_config field.
...
`google.compute_router_nat.withMaxPortsPerVm` constructs a mixin object that can be merged into the `compute_router_nat`
...
`google.compute_router_nat.withMinPortsPerVm` constructs a mixin object that can be merged into the `compute_router_nat`
...
`google.compute_router_nat.withName` constructs a mixin object that can be merged into the `compute_router_nat`
...
`google.compute_router_nat.withNatIpAllocateOption` constructs a mixin object that can be merged into the `compute_router_nat`
...
`google.compute_router_nat.withNatIps` constructs a mixin object that can be merged into the `compute_router_nat`
...
`google.compute_router_nat.withProject` constructs a mixin object that can be merged into the `compute_router_nat`
...
`google.compute_router_nat.withRegion` constructs a mixin object that can be merged into the `compute_router_nat`
...
`google.compute_router_nat.withRouter` constructs a mixin object that can be merged into the `compute_router_nat`
...
`google.compute_router_nat.withRules` constructs a mixin object that can be merged into the `compute_router_nat`
...
`google.compute_router_nat.withRulesMixin` constructs a mixin object that can be merged into the `compute_router_nat`
Terraform resource block to set or update the rules field.
...
`google.compute_router_nat.withSourceSubnetworkIpRangesToNat` constructs a mixin object that can be merged into the `compute_router_nat`
...
`google.compute_router_nat.withSubnetwork` constructs a mixin object that can be merged into the `compute_router_nat`
...
`google.compute_router_nat.withSubnetworkMixin` constructs a mixin object that can be merged into the `compute_router_nat`
Terraform resource block to set or update the subnetwork field.
...
`google.compute_router_nat.withTcpEstablishedIdleTimeoutSec` constructs a mixin object that can be merged into the `compute_router_nat`
...
`google.compute_router_nat.withTcpTransitoryIdleTimeoutSec` constructs a mixin object that can be merged into the `compute_router_nat`
...
`google.compute_router_nat.withTimeouts` constructs a mixin object that can be merged into the `compute_router_nat`
...
`google.compute_router_nat.withTimeoutsMixin` constructs a mixin object that can be merged into the `compute_router_nat`
Terraform resource block to set or update the timeouts field.
...
`google.compute_router_nat.withUdpIdleTimeoutSec` constructs a mixin object that can be merged into the `compute_router_nat`
