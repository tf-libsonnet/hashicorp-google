...
`google.dns_record_set.withRoutingPolicy` constructs a mixin object that can be merged into the `dns_record_set`
...
`google.dns_record_set.withRoutingPolicyMixin` constructs a mixin object that can be merged into the `dns_record_set`
Terraform resource block to set or update the routing_policy field.
...
`google.dns_record_set.withRrdatas` constructs a mixin object that can be merged into the `dns_record_set`
...
`google.dns_record_set.withTtl` constructs a mixin object that can be merged into the `dns_record_set`
