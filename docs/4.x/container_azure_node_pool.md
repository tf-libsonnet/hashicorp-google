...
`google.container_azure_node_pool.withAnnotations` constructs a mixin object that can be merged into the `container_azure_node_pool`
...
`google.container_azure_node_pool.withAutoscaling` constructs a mixin object that can be merged into the `container_azure_node_pool`
...
`google.container_azure_node_pool.withAutoscalingMixin` constructs a mixin object that can be merged into the `container_azure_node_pool`
Terraform resource block to set or update the autoscaling field.
...
`google.container_azure_node_pool.withAzureAvailabilityZone` constructs a mixin object that can be merged into the `container_azure_node_pool`
...
`google.container_azure_node_pool.withCluster` constructs a mixin object that can be merged into the `container_azure_node_pool`
...
`google.container_azure_node_pool.withConfig` constructs a mixin object that can be merged into the `container_azure_node_pool`
...
`google.container_azure_node_pool.withConfigMixin` constructs a mixin object that can be merged into the `container_azure_node_pool`
Terraform resource block to set or update the config field.
...
`google.container_azure_node_pool.withLocation` constructs a mixin object that can be merged into the `container_azure_node_pool`
...
`google.container_azure_node_pool.withMaxPodsConstraint` constructs a mixin object that can be merged into the `container_azure_node_pool`
...
`google.container_azure_node_pool.withMaxPodsConstraintMixin` constructs a mixin object that can be merged into the `container_azure_node_pool`
Terraform resource block to set or update the max_pods_constraint field.
...
`google.container_azure_node_pool.withName` constructs a mixin object that can be merged into the `container_azure_node_pool`
...
`google.container_azure_node_pool.withProject` constructs a mixin object that can be merged into the `container_azure_node_pool`
...
`google.container_azure_node_pool.withSubnetId` constructs a mixin object that can be merged into the `container_azure_node_pool`
...
`google.container_azure_node_pool.withTimeouts` constructs a mixin object that can be merged into the `container_azure_node_pool`
...
`google.container_azure_node_pool.withTimeoutsMixin` constructs a mixin object that can be merged into the `container_azure_node_pool`
Terraform resource block to set or update the timeouts field.
...
`google.container_azure_node_pool.withVersion` constructs a mixin object that can be merged into the `container_azure_node_pool`
