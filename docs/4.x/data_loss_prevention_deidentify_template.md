...
`google.data_loss_prevention_deidentify_template.withDeidentifyConfig` constructs a mixin object that can be merged into the `data_loss_prevention_deidentify_template`
...
`google.data_loss_prevention_deidentify_template.withDeidentifyConfigMixin` constructs a mixin object that can be merged into the `data_loss_prevention_deidentify_template`
Terraform resource block to set or update the deidentify_config field.
...
`google.data_loss_prevention_deidentify_template.withDescription` constructs a mixin object that can be merged into the `data_loss_prevention_deidentify_template`
...
`google.data_loss_prevention_deidentify_template.withDisplayName` constructs a mixin object that can be merged into the `data_loss_prevention_deidentify_template`
...
`google.data_loss_prevention_deidentify_template.withParent` constructs a mixin object that can be merged into the `data_loss_prevention_deidentify_template`
...
`google.data_loss_prevention_deidentify_template.withTimeouts` constructs a mixin object that can be merged into the `data_loss_prevention_deidentify_template`
...
`google.data_loss_prevention_deidentify_template.withTimeoutsMixin` constructs a mixin object that can be merged into the `data_loss_prevention_deidentify_template`
Terraform resource block to set or update the timeouts field.
