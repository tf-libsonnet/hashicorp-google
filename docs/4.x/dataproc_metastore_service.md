...
`google.dataproc_metastore_service.withDatabaseType` constructs a mixin object that can be merged into the `dataproc_metastore_service`
...
`google.dataproc_metastore_service.withEncryptionConfig` constructs a mixin object that can be merged into the `dataproc_metastore_service`
...
`google.dataproc_metastore_service.withEncryptionConfigMixin` constructs a mixin object that can be merged into the `dataproc_metastore_service`
Terraform resource block to set or update the encryption_config field.
...
`google.dataproc_metastore_service.withHiveMetastoreConfig` constructs a mixin object that can be merged into the `dataproc_metastore_service`
...
`google.dataproc_metastore_service.withHiveMetastoreConfigMixin` constructs a mixin object that can be merged into the `dataproc_metastore_service`
Terraform resource block to set or update the hive_metastore_config field.
...
`google.dataproc_metastore_service.withLabels` constructs a mixin object that can be merged into the `dataproc_metastore_service`
...
`google.dataproc_metastore_service.withMaintenanceWindow` constructs a mixin object that can be merged into the `dataproc_metastore_service`
...
`google.dataproc_metastore_service.withMaintenanceWindowMixin` constructs a mixin object that can be merged into the `dataproc_metastore_service`
Terraform resource block to set or update the maintenance_window field.
...
`google.dataproc_metastore_service.withNetwork` constructs a mixin object that can be merged into the `dataproc_metastore_service`
...
`google.dataproc_metastore_service.withNetworkConfig` constructs a mixin object that can be merged into the `dataproc_metastore_service`
...
`google.dataproc_metastore_service.withNetworkConfigMixin` constructs a mixin object that can be merged into the `dataproc_metastore_service`
Terraform resource block to set or update the network_config field.
...
`google.dataproc_metastore_service.withPort` constructs a mixin object that can be merged into the `dataproc_metastore_service`
...
`google.dataproc_metastore_service.withReleaseChannel` constructs a mixin object that can be merged into the `dataproc_metastore_service`
...
`google.dataproc_metastore_service.withTier` constructs a mixin object that can be merged into the `dataproc_metastore_service`
...
`google.dataproc_metastore_service.withTimeouts` constructs a mixin object that can be merged into the `dataproc_metastore_service`
...
`google.dataproc_metastore_service.withTimeoutsMixin` constructs a mixin object that can be merged into the `dataproc_metastore_service`
Terraform resource block to set or update the timeouts field.
