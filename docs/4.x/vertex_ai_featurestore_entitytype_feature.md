...
`google.vertex_ai_featurestore_entitytype_feature.withValueType` constructs a mixin object that can be merged into the `vertex_ai_featurestore_entitytype_feature`
