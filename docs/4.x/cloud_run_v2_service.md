...
`google.cloud_run_v2_service.withBinaryAuthorization` constructs a mixin object that can be merged into the `cloud_run_v2_service`
...
`google.cloud_run_v2_service.withBinaryAuthorizationMixin` constructs a mixin object that can be merged into the `cloud_run_v2_service`
Terraform resource block to set or update the binary_authorization field.
...
`google.cloud_run_v2_service.withClient` constructs a mixin object that can be merged into the `cloud_run_v2_service`
...
`google.cloud_run_v2_service.withClientVersion` constructs a mixin object that can be merged into the `cloud_run_v2_service`
...
`google.cloud_run_v2_service.withDescription` constructs a mixin object that can be merged into the `cloud_run_v2_service`
...
`google.cloud_run_v2_service.withIngress` constructs a mixin object that can be merged into the `cloud_run_v2_service`
...
`google.cloud_run_v2_service.withLabels` constructs a mixin object that can be merged into the `cloud_run_v2_service`
...
`google.cloud_run_v2_service.withLaunchStage` constructs a mixin object that can be merged into the `cloud_run_v2_service`
...
`google.cloud_run_v2_service.withLocation` constructs a mixin object that can be merged into the `cloud_run_v2_service`
...
`google.cloud_run_v2_service.withName` constructs a mixin object that can be merged into the `cloud_run_v2_service`
...
`google.cloud_run_v2_service.withProject` constructs a mixin object that can be merged into the `cloud_run_v2_service`
...
`google.cloud_run_v2_service.withTemplate` constructs a mixin object that can be merged into the `cloud_run_v2_service`
...
`google.cloud_run_v2_service.withTemplateMixin` constructs a mixin object that can be merged into the `cloud_run_v2_service`
Terraform resource block to set or update the template field.
...
`google.cloud_run_v2_service.withTimeouts` constructs a mixin object that can be merged into the `cloud_run_v2_service`
...
`google.cloud_run_v2_service.withTimeoutsMixin` constructs a mixin object that can be merged into the `cloud_run_v2_service`
Terraform resource block to set or update the timeouts field.
...
`google.cloud_run_v2_service.withTraffic` constructs a mixin object that can be merged into the `cloud_run_v2_service`
...
`google.cloud_run_v2_service.withTrafficMixin` constructs a mixin object that can be merged into the `cloud_run_v2_service`
Terraform resource block to set or update the traffic field.
