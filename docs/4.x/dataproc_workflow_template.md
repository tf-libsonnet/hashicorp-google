...
`google.dataproc_workflow_template.withDagTimeout` constructs a mixin object that can be merged into the `dataproc_workflow_template`
...
`google.dataproc_workflow_template.withJobs` constructs a mixin object that can be merged into the `dataproc_workflow_template`
...
`google.dataproc_workflow_template.withJobsMixin` constructs a mixin object that can be merged into the `dataproc_workflow_template`
Terraform resource block to set or update the jobs field.
...
`google.dataproc_workflow_template.withLabels` constructs a mixin object that can be merged into the `dataproc_workflow_template`
...
`google.dataproc_workflow_template.withLocation` constructs a mixin object that can be merged into the `dataproc_workflow_template`
...
`google.dataproc_workflow_template.withName` constructs a mixin object that can be merged into the `dataproc_workflow_template`
...
`google.dataproc_workflow_template.withParameters` constructs a mixin object that can be merged into the `dataproc_workflow_template`
...
`google.dataproc_workflow_template.withParametersMixin` constructs a mixin object that can be merged into the `dataproc_workflow_template`
Terraform resource block to set or update the parameters field.
...
`google.dataproc_workflow_template.withPlacement` constructs a mixin object that can be merged into the `dataproc_workflow_template`
...
`google.dataproc_workflow_template.withPlacementMixin` constructs a mixin object that can be merged into the `dataproc_workflow_template`
Terraform resource block to set or update the placement field.
...
`google.dataproc_workflow_template.withProject` constructs a mixin object that can be merged into the `dataproc_workflow_template`
...
`google.dataproc_workflow_template.withTimeouts` constructs a mixin object that can be merged into the `dataproc_workflow_template`
...
`google.dataproc_workflow_template.withTimeoutsMixin` constructs a mixin object that can be merged into the `dataproc_workflow_template`
Terraform resource block to set or update the timeouts field.
...
`google.dataproc_workflow_template.withVersion` constructs a mixin object that can be merged into the `dataproc_workflow_template`
