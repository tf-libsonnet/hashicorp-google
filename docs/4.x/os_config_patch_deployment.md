...
`google.os_config_patch_deployment.withDescription` constructs a mixin object that can be merged into the `os_config_patch_deployment`
...
`google.os_config_patch_deployment.withDuration` constructs a mixin object that can be merged into the `os_config_patch_deployment`
...
`google.os_config_patch_deployment.withInstanceFilter` constructs a mixin object that can be merged into the `os_config_patch_deployment`
...
`google.os_config_patch_deployment.withInstanceFilterMixin` constructs a mixin object that can be merged into the `os_config_patch_deployment`
Terraform resource block to set or update the instance_filter field.
...
`google.os_config_patch_deployment.withOneTimeSchedule` constructs a mixin object that can be merged into the `os_config_patch_deployment`
...
`google.os_config_patch_deployment.withOneTimeScheduleMixin` constructs a mixin object that can be merged into the `os_config_patch_deployment`
Terraform resource block to set or update the one_time_schedule field.
...
`google.os_config_patch_deployment.withPatchConfig` constructs a mixin object that can be merged into the `os_config_patch_deployment`
...
`google.os_config_patch_deployment.withPatchConfigMixin` constructs a mixin object that can be merged into the `os_config_patch_deployment`
Terraform resource block to set or update the patch_config field.
...
`google.os_config_patch_deployment.withPatchDeploymentId` constructs a mixin object that can be merged into the `os_config_patch_deployment`
...
`google.os_config_patch_deployment.withProject` constructs a mixin object that can be merged into the `os_config_patch_deployment`
...
`google.os_config_patch_deployment.withRecurringSchedule` constructs a mixin object that can be merged into the `os_config_patch_deployment`
...
`google.os_config_patch_deployment.withRecurringScheduleMixin` constructs a mixin object that can be merged into the `os_config_patch_deployment`
Terraform resource block to set or update the recurring_schedule field.
...
`google.os_config_patch_deployment.withRollout` constructs a mixin object that can be merged into the `os_config_patch_deployment`
...
`google.os_config_patch_deployment.withRolloutMixin` constructs a mixin object that can be merged into the `os_config_patch_deployment`
Terraform resource block to set or update the rollout field.
...
`google.os_config_patch_deployment.withTimeouts` constructs a mixin object that can be merged into the `os_config_patch_deployment`
...
`google.os_config_patch_deployment.withTimeoutsMixin` constructs a mixin object that can be merged into the `os_config_patch_deployment`
Terraform resource block to set or update the timeouts field.
