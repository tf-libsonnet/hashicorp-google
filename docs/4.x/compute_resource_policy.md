...
`google.compute_resource_policy.withDescription` constructs a mixin object that can be merged into the `compute_resource_policy`
...
`google.compute_resource_policy.withGroupPlacementPolicy` constructs a mixin object that can be merged into the `compute_resource_policy`
...
`google.compute_resource_policy.withGroupPlacementPolicyMixin` constructs a mixin object that can be merged into the `compute_resource_policy`
Terraform resource block to set or update the group_placement_policy field.
...
`google.compute_resource_policy.withInstanceSchedulePolicy` constructs a mixin object that can be merged into the `compute_resource_policy`
...
`google.compute_resource_policy.withInstanceSchedulePolicyMixin` constructs a mixin object that can be merged into the `compute_resource_policy`
Terraform resource block to set or update the instance_schedule_policy field.
...
`google.compute_resource_policy.withName` constructs a mixin object that can be merged into the `compute_resource_policy`
...
`google.compute_resource_policy.withProject` constructs a mixin object that can be merged into the `compute_resource_policy`
...
`google.compute_resource_policy.withRegion` constructs a mixin object that can be merged into the `compute_resource_policy`
...
`google.compute_resource_policy.withSnapshotSchedulePolicy` constructs a mixin object that can be merged into the `compute_resource_policy`
...
`google.compute_resource_policy.withSnapshotSchedulePolicyMixin` constructs a mixin object that can be merged into the `compute_resource_policy`
Terraform resource block to set or update the snapshot_schedule_policy field.
...
`google.compute_resource_policy.withTimeouts` constructs a mixin object that can be merged into the `compute_resource_policy`
...
`google.compute_resource_policy.withTimeoutsMixin` constructs a mixin object that can be merged into the `compute_resource_policy`
Terraform resource block to set or update the timeouts field.
