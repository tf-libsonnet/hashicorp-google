...
`google.dataproc_autoscaling_policy.withBasicAlgorithm` constructs a mixin object that can be merged into the `dataproc_autoscaling_policy`
...
`google.dataproc_autoscaling_policy.withBasicAlgorithmMixin` constructs a mixin object that can be merged into the `dataproc_autoscaling_policy`
Terraform resource block to set or update the basic_algorithm field.
...
`google.dataproc_autoscaling_policy.withLocation` constructs a mixin object that can be merged into the `dataproc_autoscaling_policy`
...
`google.dataproc_autoscaling_policy.withPolicyId` constructs a mixin object that can be merged into the `dataproc_autoscaling_policy`
...
`google.dataproc_autoscaling_policy.withProject` constructs a mixin object that can be merged into the `dataproc_autoscaling_policy`
...
`google.dataproc_autoscaling_policy.withSecondaryWorkerConfig` constructs a mixin object that can be merged into the `dataproc_autoscaling_policy`
...
`google.dataproc_autoscaling_policy.withSecondaryWorkerConfigMixin` constructs a mixin object that can be merged into the `dataproc_autoscaling_policy`
Terraform resource block to set or update the secondary_worker_config field.
...
`google.dataproc_autoscaling_policy.withTimeouts` constructs a mixin object that can be merged into the `dataproc_autoscaling_policy`
...
`google.dataproc_autoscaling_policy.withTimeoutsMixin` constructs a mixin object that can be merged into the `dataproc_autoscaling_policy`
Terraform resource block to set or update the timeouts field.
...
`google.dataproc_autoscaling_policy.withWorkerConfig` constructs a mixin object that can be merged into the `dataproc_autoscaling_policy`
...
`google.dataproc_autoscaling_policy.withWorkerConfigMixin` constructs a mixin object that can be merged into the `dataproc_autoscaling_policy`
Terraform resource block to set or update the worker_config field.
