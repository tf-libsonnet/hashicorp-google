...
`google.sql_database.withCharset` constructs a mixin object that can be merged into the `sql_database`
...
`google.sql_database.withCollation` constructs a mixin object that can be merged into the `sql_database`
...
`google.sql_database.withDeletionPolicy` constructs a mixin object that can be merged into the `sql_database`
...
`google.sql_database.withInstance` constructs a mixin object that can be merged into the `sql_database`
...
`google.sql_database.withName` constructs a mixin object that can be merged into the `sql_database`
...
`google.sql_database.withProject` constructs a mixin object that can be merged into the `sql_database`
...
`google.sql_database.withTimeouts` constructs a mixin object that can be merged into the `sql_database`
...
`google.sql_database.withTimeoutsMixin` constructs a mixin object that can be merged into the `sql_database`
Terraform resource block to set or update the timeouts field.
