...
`google.privateca_certificate_template_iam_member.withCertificateTemplate` constructs a mixin object that can be merged into the `privateca_certificate_template_iam_member`
...
`google.privateca_certificate_template_iam_member.withCondition` constructs a mixin object that can be merged into the `privateca_certificate_template_iam_member`
...
`google.privateca_certificate_template_iam_member.withConditionMixin` constructs a mixin object that can be merged into the `privateca_certificate_template_iam_member`
Terraform resource block to set or update the condition field.
...
`google.privateca_certificate_template_iam_member.withLocation` constructs a mixin object that can be merged into the `privateca_certificate_template_iam_member`
...
`google.privateca_certificate_template_iam_member.withMember` constructs a mixin object that can be merged into the `privateca_certificate_template_iam_member`
...
`google.privateca_certificate_template_iam_member.withProject` constructs a mixin object that can be merged into the `privateca_certificate_template_iam_member`
...
`google.privateca_certificate_template_iam_member.withRole` constructs a mixin object that can be merged into the `privateca_certificate_template_iam_member`
