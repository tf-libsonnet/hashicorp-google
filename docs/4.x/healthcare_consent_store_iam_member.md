...
`google.healthcare_consent_store_iam_member.withCondition` constructs a mixin object that can be merged into the `healthcare_consent_store_iam_member`
...
`google.healthcare_consent_store_iam_member.withConditionMixin` constructs a mixin object that can be merged into the `healthcare_consent_store_iam_member`
Terraform resource block to set or update the condition field.
...
`google.healthcare_consent_store_iam_member.withConsentStoreId` constructs a mixin object that can be merged into the `healthcare_consent_store_iam_member`
...
`google.healthcare_consent_store_iam_member.withDataset` constructs a mixin object that can be merged into the `healthcare_consent_store_iam_member`
...
`google.healthcare_consent_store_iam_member.withMember` constructs a mixin object that can be merged into the `healthcare_consent_store_iam_member`
...
`google.healthcare_consent_store_iam_member.withRole` constructs a mixin object that can be merged into the `healthcare_consent_store_iam_member`
