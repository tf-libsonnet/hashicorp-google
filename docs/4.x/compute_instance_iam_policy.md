...
`google.compute_instance_iam_policy.withInstanceName` constructs a mixin object that can be merged into the `compute_instance_iam_policy`
...
`google.compute_instance_iam_policy.withPolicyData` constructs a mixin object that can be merged into the `compute_instance_iam_policy`
...
`google.compute_instance_iam_policy.withProject` constructs a mixin object that can be merged into the `compute_instance_iam_policy`
...
`google.compute_instance_iam_policy.withZone` constructs a mixin object that can be merged into the `compute_instance_iam_policy`
