...
`google.compute_network_peering.withExportCustomRoutes` constructs a mixin object that can be merged into the `compute_network_peering`
...
`google.compute_network_peering.withExportSubnetRoutesWithPublicIp` constructs a mixin object that can be merged into the `compute_network_peering`
...
`google.compute_network_peering.withImportCustomRoutes` constructs a mixin object that can be merged into the `compute_network_peering`
...
`google.compute_network_peering.withImportSubnetRoutesWithPublicIp` constructs a mixin object that can be merged into the `compute_network_peering`
...
`google.compute_network_peering.withName` constructs a mixin object that can be merged into the `compute_network_peering`
...
`google.compute_network_peering.withNetwork` constructs a mixin object that can be merged into the `compute_network_peering`
...
`google.compute_network_peering.withPeerNetwork` constructs a mixin object that can be merged into the `compute_network_peering`
...
`google.compute_network_peering.withTimeouts` constructs a mixin object that can be merged into the `compute_network_peering`
...
`google.compute_network_peering.withTimeoutsMixin` constructs a mixin object that can be merged into the `compute_network_peering`
Terraform resource block to set or update the timeouts field.
