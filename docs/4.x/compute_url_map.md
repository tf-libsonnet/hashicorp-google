...
`google.compute_url_map.withDefaultRouteAction` constructs a mixin object that can be merged into the `compute_url_map`
...
`google.compute_url_map.withDefaultRouteActionMixin` constructs a mixin object that can be merged into the `compute_url_map`
Terraform resource block to set or update the default_route_action field.
...
`google.compute_url_map.withDefaultService` constructs a mixin object that can be merged into the `compute_url_map`
...
`google.compute_url_map.withDefaultUrlRedirect` constructs a mixin object that can be merged into the `compute_url_map`
...
`google.compute_url_map.withDefaultUrlRedirectMixin` constructs a mixin object that can be merged into the `compute_url_map`
Terraform resource block to set or update the default_url_redirect field.
...
`google.compute_url_map.withDescription` constructs a mixin object that can be merged into the `compute_url_map`
...
`google.compute_url_map.withHeaderAction` constructs a mixin object that can be merged into the `compute_url_map`
...
`google.compute_url_map.withHeaderActionMixin` constructs a mixin object that can be merged into the `compute_url_map`
Terraform resource block to set or update the header_action field.
...
`google.compute_url_map.withHostRule` constructs a mixin object that can be merged into the `compute_url_map`
...
`google.compute_url_map.withHostRuleMixin` constructs a mixin object that can be merged into the `compute_url_map`
Terraform resource block to set or update the host_rule field.
...
`google.compute_url_map.withName` constructs a mixin object that can be merged into the `compute_url_map`
...
`google.compute_url_map.withPathMatcher` constructs a mixin object that can be merged into the `compute_url_map`
...
`google.compute_url_map.withPathMatcherMixin` constructs a mixin object that can be merged into the `compute_url_map`
Terraform resource block to set or update the path_matcher field.
...
`google.compute_url_map.withProject` constructs a mixin object that can be merged into the `compute_url_map`
...
`google.compute_url_map.withTest` constructs a mixin object that can be merged into the `compute_url_map`
...
`google.compute_url_map.withTestMixin` constructs a mixin object that can be merged into the `compute_url_map`
Terraform resource block to set or update the test field.
...
`google.compute_url_map.withTimeouts` constructs a mixin object that can be merged into the `compute_url_map`
...
`google.compute_url_map.withTimeoutsMixin` constructs a mixin object that can be merged into the `compute_url_map`
Terraform resource block to set or update the timeouts field.
