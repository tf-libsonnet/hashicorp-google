...
`google.network_services_edge_cache_origin.withAwsV4Authentication` constructs a mixin object that can be merged into the `network_services_edge_cache_origin`
...
`google.network_services_edge_cache_origin.withAwsV4AuthenticationMixin` constructs a mixin object that can be merged into the `network_services_edge_cache_origin`
Terraform resource block to set or update the aws_v4_authentication field.
...
`google.network_services_edge_cache_origin.withDescription` constructs a mixin object that can be merged into the `network_services_edge_cache_origin`
...
`google.network_services_edge_cache_origin.withFailoverOrigin` constructs a mixin object that can be merged into the `network_services_edge_cache_origin`
...
`google.network_services_edge_cache_origin.withLabels` constructs a mixin object that can be merged into the `network_services_edge_cache_origin`
...
`google.network_services_edge_cache_origin.withMaxAttempts` constructs a mixin object that can be merged into the `network_services_edge_cache_origin`
...
`google.network_services_edge_cache_origin.withName` constructs a mixin object that can be merged into the `network_services_edge_cache_origin`
...
`google.network_services_edge_cache_origin.withOriginAddress` constructs a mixin object that can be merged into the `network_services_edge_cache_origin`
...
`google.network_services_edge_cache_origin.withOriginOverrideAction` constructs a mixin object that can be merged into the `network_services_edge_cache_origin`
...
`google.network_services_edge_cache_origin.withOriginOverrideActionMixin` constructs a mixin object that can be merged into the `network_services_edge_cache_origin`
Terraform resource block to set or update the origin_override_action field.
...
`google.network_services_edge_cache_origin.withOriginRedirect` constructs a mixin object that can be merged into the `network_services_edge_cache_origin`
...
`google.network_services_edge_cache_origin.withOriginRedirectMixin` constructs a mixin object that can be merged into the `network_services_edge_cache_origin`
Terraform resource block to set or update the origin_redirect field.
...
`google.network_services_edge_cache_origin.withPort` constructs a mixin object that can be merged into the `network_services_edge_cache_origin`
...
`google.network_services_edge_cache_origin.withProject` constructs a mixin object that can be merged into the `network_services_edge_cache_origin`
...
`google.network_services_edge_cache_origin.withProtocol` constructs a mixin object that can be merged into the `network_services_edge_cache_origin`
...
`google.network_services_edge_cache_origin.withRetryConditions` constructs a mixin object that can be merged into the `network_services_edge_cache_origin`
...
`google.network_services_edge_cache_origin.withTimeout` constructs a mixin object that can be merged into the `network_services_edge_cache_origin`
...
`google.network_services_edge_cache_origin.withTimeoutMixin` constructs a mixin object that can be merged into the `network_services_edge_cache_origin`
Terraform resource block to set or update the timeout field.
...
`google.network_services_edge_cache_origin.withTimeouts` constructs a mixin object that can be merged into the `network_services_edge_cache_origin`
...
`google.network_services_edge_cache_origin.withTimeoutsMixin` constructs a mixin object that can be merged into the `network_services_edge_cache_origin`
Terraform resource block to set or update the timeouts field.
