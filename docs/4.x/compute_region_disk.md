---
permalink: /compute_region_disk/
---

# compute_region_disk

`compute_region_disk` represents the `google_compute_region_disk` Terraform resource.
...
`google.compute_region_disk.withDescription` constructs a mixin object that can be merged into the `compute_region_disk`
...
`google.compute_region_disk.withDiskEncryptionKey` constructs a mixin object that can be merged into the `compute_region_disk`
...
`google.compute_region_disk.withDiskEncryptionKeyMixin` constructs a mixin object that can be merged into the `compute_region_disk`
Terraform resource block to set or update the disk_encryption_key field.
...
`google.compute_region_disk.withLabels` constructs a mixin object that can be merged into the `compute_region_disk`
...
`google.compute_region_disk.withName` constructs a mixin object that can be merged into the `compute_region_disk`
...
`google.compute_region_disk.withPhysicalBlockSizeBytes` constructs a mixin object that can be merged into the `compute_region_disk`
...
`google.compute_region_disk.withProject` constructs a mixin object that can be merged into the `compute_region_disk`
...
`google.compute_region_disk.withRegion` constructs a mixin object that can be merged into the `compute_region_disk`
...
`google.compute_region_disk.withReplicaZones` constructs a mixin object that can be merged into the `compute_region_disk`
...
`google.compute_region_disk.withSize` constructs a mixin object that can be merged into the `compute_region_disk`
...
`google.compute_region_disk.withSnapshot` constructs a mixin object that can be merged into the `compute_region_disk`
...
`google.compute_region_disk.withSourceDisk` constructs a mixin object that can be merged into the `compute_region_disk`
...
`google.compute_region_disk.withSourceSnapshotEncryptionKey` constructs a mixin object that can be merged into the `compute_region_disk`
...
`google.compute_region_disk.withSourceSnapshotEncryptionKeyMixin` constructs a mixin object that can be merged into the `compute_region_disk`
Terraform resource block to set or update the source_snapshot_encryption_key field.
...
`google.compute_region_disk.withTimeouts` constructs a mixin object that can be merged into the `compute_region_disk`
...
`google.compute_region_disk.withTimeoutsMixin` constructs a mixin object that can be merged into the `compute_region_disk`
Terraform resource block to set or update the timeouts field.
...
`google.compute_region_disk.withType` constructs a mixin object that can be merged into the `compute_region_disk`
