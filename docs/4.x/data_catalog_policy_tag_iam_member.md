---
permalink: /data_catalog_policy_tag_iam_member/
---

# data_catalog_policy_tag_iam_member

`data_catalog_policy_tag_iam_member` represents the `google_data_catalog_policy_tag_iam_member` Terraform resource.
