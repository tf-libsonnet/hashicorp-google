...
`google.cloud_asset_organization_feed.withAssetNames` constructs a mixin object that can be merged into the `cloud_asset_organization_feed`
...
`google.cloud_asset_organization_feed.withAssetTypes` constructs a mixin object that can be merged into the `cloud_asset_organization_feed`
...
`google.cloud_asset_organization_feed.withBillingProject` constructs a mixin object that can be merged into the `cloud_asset_organization_feed`
...
`google.cloud_asset_organization_feed.withCondition` constructs a mixin object that can be merged into the `cloud_asset_organization_feed`
...
`google.cloud_asset_organization_feed.withConditionMixin` constructs a mixin object that can be merged into the `cloud_asset_organization_feed`
Terraform resource block to set or update the condition field.
...
`google.cloud_asset_organization_feed.withContentType` constructs a mixin object that can be merged into the `cloud_asset_organization_feed`
...
`google.cloud_asset_organization_feed.withFeedId` constructs a mixin object that can be merged into the `cloud_asset_organization_feed`
...
`google.cloud_asset_organization_feed.withFeedOutputConfig` constructs a mixin object that can be merged into the `cloud_asset_organization_feed`
...
`google.cloud_asset_organization_feed.withFeedOutputConfigMixin` constructs a mixin object that can be merged into the `cloud_asset_organization_feed`
Terraform resource block to set or update the feed_output_config field.
...
`google.cloud_asset_organization_feed.withOrgId` constructs a mixin object that can be merged into the `cloud_asset_organization_feed`
...
`google.cloud_asset_organization_feed.withTimeouts` constructs a mixin object that can be merged into the `cloud_asset_organization_feed`
...
`google.cloud_asset_organization_feed.withTimeoutsMixin` constructs a mixin object that can be merged into the `cloud_asset_organization_feed`
Terraform resource block to set or update the timeouts field.
