...
`google.pubsub_schema.withDefinition` constructs a mixin object that can be merged into the `pubsub_schema`
...
`google.pubsub_schema.withName` constructs a mixin object that can be merged into the `pubsub_schema`
...
`google.pubsub_schema.withProject` constructs a mixin object that can be merged into the `pubsub_schema`
...
`google.pubsub_schema.withTimeouts` constructs a mixin object that can be merged into the `pubsub_schema`
...
`google.pubsub_schema.withTimeoutsMixin` constructs a mixin object that can be merged into the `pubsub_schema`
Terraform resource block to set or update the timeouts field.
...
`google.pubsub_schema.withType` constructs a mixin object that can be merged into the `pubsub_schema`
