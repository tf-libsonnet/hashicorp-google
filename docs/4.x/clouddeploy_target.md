...
`google.clouddeploy_target.withAnnotations` constructs a mixin object that can be merged into the `clouddeploy_target`
...
`google.clouddeploy_target.withAnthosCluster` constructs a mixin object that can be merged into the `clouddeploy_target`
...
`google.clouddeploy_target.withAnthosClusterMixin` constructs a mixin object that can be merged into the `clouddeploy_target`
Terraform resource block to set or update the anthos_cluster field.
...
`google.clouddeploy_target.withDescription` constructs a mixin object that can be merged into the `clouddeploy_target`
...
`google.clouddeploy_target.withExecutionConfigs` constructs a mixin object that can be merged into the `clouddeploy_target`
...
`google.clouddeploy_target.withExecutionConfigsMixin` constructs a mixin object that can be merged into the `clouddeploy_target`
Terraform resource block to set or update the execution_configs field.
...
`google.clouddeploy_target.withGke` constructs a mixin object that can be merged into the `clouddeploy_target`
...
`google.clouddeploy_target.withGkeMixin` constructs a mixin object that can be merged into the `clouddeploy_target`
Terraform resource block to set or update the gke field.
...
`google.clouddeploy_target.withLabels` constructs a mixin object that can be merged into the `clouddeploy_target`
...
`google.clouddeploy_target.withLocation` constructs a mixin object that can be merged into the `clouddeploy_target`
...
`google.clouddeploy_target.withName` constructs a mixin object that can be merged into the `clouddeploy_target`
...
`google.clouddeploy_target.withProject` constructs a mixin object that can be merged into the `clouddeploy_target`
...
`google.clouddeploy_target.withRequireApproval` constructs a mixin object that can be merged into the `clouddeploy_target`
...
`google.clouddeploy_target.withTimeouts` constructs a mixin object that can be merged into the `clouddeploy_target`
...
`google.clouddeploy_target.withTimeoutsMixin` constructs a mixin object that can be merged into the `clouddeploy_target`
Terraform resource block to set or update the timeouts field.
