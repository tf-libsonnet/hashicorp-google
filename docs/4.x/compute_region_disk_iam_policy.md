...
`google.compute_region_disk_iam_policy.withName` constructs a mixin object that can be merged into the `compute_region_disk_iam_policy`
...
`google.compute_region_disk_iam_policy.withPolicyData` constructs a mixin object that can be merged into the `compute_region_disk_iam_policy`
...
`google.compute_region_disk_iam_policy.withProject` constructs a mixin object that can be merged into the `compute_region_disk_iam_policy`
...
`google.compute_region_disk_iam_policy.withRegion` constructs a mixin object that can be merged into the `compute_region_disk_iam_policy`
