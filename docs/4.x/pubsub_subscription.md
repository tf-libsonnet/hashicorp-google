...
`google.pubsub_subscription.withAckDeadlineSeconds` constructs a mixin object that can be merged into the `pubsub_subscription`
...
`google.pubsub_subscription.withBigqueryConfig` constructs a mixin object that can be merged into the `pubsub_subscription`
...
`google.pubsub_subscription.withBigqueryConfigMixin` constructs a mixin object that can be merged into the `pubsub_subscription`
Terraform resource block to set or update the bigquery_config field.
...
`google.pubsub_subscription.withDeadLetterPolicy` constructs a mixin object that can be merged into the `pubsub_subscription`
...
`google.pubsub_subscription.withDeadLetterPolicyMixin` constructs a mixin object that can be merged into the `pubsub_subscription`
Terraform resource block to set or update the dead_letter_policy field.
...
`google.pubsub_subscription.withEnableExactlyOnceDelivery` constructs a mixin object that can be merged into the `pubsub_subscription`
...
`google.pubsub_subscription.withEnableMessageOrdering` constructs a mixin object that can be merged into the `pubsub_subscription`
...
`google.pubsub_subscription.withExpirationPolicy` constructs a mixin object that can be merged into the `pubsub_subscription`
...
`google.pubsub_subscription.withExpirationPolicyMixin` constructs a mixin object that can be merged into the `pubsub_subscription`
Terraform resource block to set or update the expiration_policy field.
...
`google.pubsub_subscription.withFilter` constructs a mixin object that can be merged into the `pubsub_subscription`
...
`google.pubsub_subscription.withLabels` constructs a mixin object that can be merged into the `pubsub_subscription`
...
`google.pubsub_subscription.withMessageRetentionDuration` constructs a mixin object that can be merged into the `pubsub_subscription`
...
`google.pubsub_subscription.withName` constructs a mixin object that can be merged into the `pubsub_subscription`
...
`google.pubsub_subscription.withProject` constructs a mixin object that can be merged into the `pubsub_subscription`
...
`google.pubsub_subscription.withPushConfig` constructs a mixin object that can be merged into the `pubsub_subscription`
...
`google.pubsub_subscription.withPushConfigMixin` constructs a mixin object that can be merged into the `pubsub_subscription`
Terraform resource block to set or update the push_config field.
...
`google.pubsub_subscription.withRetainAckedMessages` constructs a mixin object that can be merged into the `pubsub_subscription`
...
`google.pubsub_subscription.withRetryPolicy` constructs a mixin object that can be merged into the `pubsub_subscription`
...
`google.pubsub_subscription.withRetryPolicyMixin` constructs a mixin object that can be merged into the `pubsub_subscription`
Terraform resource block to set or update the retry_policy field.
...
`google.pubsub_subscription.withTimeouts` constructs a mixin object that can be merged into the `pubsub_subscription`
...
`google.pubsub_subscription.withTimeoutsMixin` constructs a mixin object that can be merged into the `pubsub_subscription`
Terraform resource block to set or update the timeouts field.
...
`google.pubsub_subscription.withTopic` constructs a mixin object that can be merged into the `pubsub_subscription`
