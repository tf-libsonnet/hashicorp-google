...
`google.firestore_document.withCollection` constructs a mixin object that can be merged into the `firestore_document`
...
`google.firestore_document.withDatabase` constructs a mixin object that can be merged into the `firestore_document`
...
`google.firestore_document.withDocumentId` constructs a mixin object that can be merged into the `firestore_document`
...
`google.firestore_document.withFields` constructs a mixin object that can be merged into the `firestore_document`
...
`google.firestore_document.withProject` constructs a mixin object that can be merged into the `firestore_document`
...
`google.firestore_document.withTimeouts` constructs a mixin object that can be merged into the `firestore_document`
...
`google.firestore_document.withTimeoutsMixin` constructs a mixin object that can be merged into the `firestore_document`
Terraform resource block to set or update the timeouts field.
