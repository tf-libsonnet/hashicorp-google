...
`google.binary_authorization_policy.withAdmissionWhitelistPatterns` constructs a mixin object that can be merged into the `binary_authorization_policy`
...
`google.binary_authorization_policy.withAdmissionWhitelistPatternsMixin` constructs a mixin object that can be merged into the `binary_authorization_policy`
Terraform resource block to set or update the admission_whitelist_patterns field.
...
`google.binary_authorization_policy.withClusterAdmissionRules` constructs a mixin object that can be merged into the `binary_authorization_policy`
...
`google.binary_authorization_policy.withClusterAdmissionRulesMixin` constructs a mixin object that can be merged into the `binary_authorization_policy`
Terraform resource block to set or update the cluster_admission_rules field.
...
`google.binary_authorization_policy.withDefaultAdmissionRule` constructs a mixin object that can be merged into the `binary_authorization_policy`
...
`google.binary_authorization_policy.withDefaultAdmissionRuleMixin` constructs a mixin object that can be merged into the `binary_authorization_policy`
Terraform resource block to set or update the default_admission_rule field.
...
`google.binary_authorization_policy.withDescription` constructs a mixin object that can be merged into the `binary_authorization_policy`
...
`google.binary_authorization_policy.withGlobalPolicyEvaluationMode` constructs a mixin object that can be merged into the `binary_authorization_policy`
...
`google.binary_authorization_policy.withProject` constructs a mixin object that can be merged into the `binary_authorization_policy`
...
`google.binary_authorization_policy.withTimeouts` constructs a mixin object that can be merged into the `binary_authorization_policy`
...
`google.binary_authorization_policy.withTimeoutsMixin` constructs a mixin object that can be merged into the `binary_authorization_policy`
Terraform resource block to set or update the timeouts field.
