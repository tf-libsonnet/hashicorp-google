...
`google.logging_organization_exclusion.withDescription` constructs a mixin object that can be merged into the `logging_organization_exclusion`
...
`google.logging_organization_exclusion.withDisabled` constructs a mixin object that can be merged into the `logging_organization_exclusion`
...
`google.logging_organization_exclusion.withFilter` constructs a mixin object that can be merged into the `logging_organization_exclusion`
...
`google.logging_organization_exclusion.withName` constructs a mixin object that can be merged into the `logging_organization_exclusion`
...
`google.logging_organization_exclusion.withOrgId` constructs a mixin object that can be merged into the `logging_organization_exclusion`
