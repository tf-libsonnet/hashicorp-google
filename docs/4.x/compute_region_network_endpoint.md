---
permalink: /compute_region_network_endpoint/
---

# compute_region_network_endpoint

`compute_region_network_endpoint` represents the `google_compute_region_network_endpoint` Terraform resource.
...
`google.string.withRegionNetworkEndpointGroup` constructs a mixin object that can be merged into the `string`
