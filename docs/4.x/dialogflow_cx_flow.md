...
`google.dialogflow_cx_flow.withDescription` constructs a mixin object that can be merged into the `dialogflow_cx_flow`
...
`google.dialogflow_cx_flow.withDisplayName` constructs a mixin object that can be merged into the `dialogflow_cx_flow`
...
`google.dialogflow_cx_flow.withEventHandlers` constructs a mixin object that can be merged into the `dialogflow_cx_flow`
...
`google.dialogflow_cx_flow.withEventHandlersMixin` constructs a mixin object that can be merged into the `dialogflow_cx_flow`
Terraform resource block to set or update the event_handlers field.
...
`google.dialogflow_cx_flow.withLanguageCode` constructs a mixin object that can be merged into the `dialogflow_cx_flow`
...
`google.dialogflow_cx_flow.withNluSettings` constructs a mixin object that can be merged into the `dialogflow_cx_flow`
...
`google.dialogflow_cx_flow.withNluSettingsMixin` constructs a mixin object that can be merged into the `dialogflow_cx_flow`
Terraform resource block to set or update the nlu_settings field.
...
`google.dialogflow_cx_flow.withParent` constructs a mixin object that can be merged into the `dialogflow_cx_flow`
...
`google.dialogflow_cx_flow.withTimeouts` constructs a mixin object that can be merged into the `dialogflow_cx_flow`
...
`google.dialogflow_cx_flow.withTimeoutsMixin` constructs a mixin object that can be merged into the `dialogflow_cx_flow`
Terraform resource block to set or update the timeouts field.
...
`google.dialogflow_cx_flow.withTransitionRouteGroups` constructs a mixin object that can be merged into the `dialogflow_cx_flow`
...
`google.dialogflow_cx_flow.withTransitionRoutes` constructs a mixin object that can be merged into the `dialogflow_cx_flow`
...
`google.dialogflow_cx_flow.withTransitionRoutesMixin` constructs a mixin object that can be merged into the `dialogflow_cx_flow`
Terraform resource block to set or update the transition_routes field.
