...
`google.notebooks_instance.withAcceleratorConfig` constructs a mixin object that can be merged into the `notebooks_instance`
...
`google.notebooks_instance.withAcceleratorConfigMixin` constructs a mixin object that can be merged into the `notebooks_instance`
Terraform resource block to set or update the accelerator_config field.
...
`google.notebooks_instance.withBootDiskSizeGb` constructs a mixin object that can be merged into the `notebooks_instance`
...
`google.notebooks_instance.withBootDiskType` constructs a mixin object that can be merged into the `notebooks_instance`
...
`google.notebooks_instance.withContainerImage` constructs a mixin object that can be merged into the `notebooks_instance`
...
`google.notebooks_instance.withContainerImageMixin` constructs a mixin object that can be merged into the `notebooks_instance`
Terraform resource block to set or update the container_image field.
...
`google.notebooks_instance.withCreateTime` constructs a mixin object that can be merged into the `notebooks_instance`
...
`google.notebooks_instance.withCustomGpuDriverPath` constructs a mixin object that can be merged into the `notebooks_instance`
...
`google.notebooks_instance.withDataDiskSizeGb` constructs a mixin object that can be merged into the `notebooks_instance`
...
`google.notebooks_instance.withDataDiskType` constructs a mixin object that can be merged into the `notebooks_instance`
...
`google.notebooks_instance.withDiskEncryption` constructs a mixin object that can be merged into the `notebooks_instance`
...
`google.notebooks_instance.withInstallGpuDriver` constructs a mixin object that can be merged into the `notebooks_instance`
...
`google.notebooks_instance.withInstanceOwners` constructs a mixin object that can be merged into the `notebooks_instance`
...
`google.notebooks_instance.withKmsKey` constructs a mixin object that can be merged into the `notebooks_instance`
...
`google.notebooks_instance.withLabels` constructs a mixin object that can be merged into the `notebooks_instance`
...
`google.notebooks_instance.withLocation` constructs a mixin object that can be merged into the `notebooks_instance`
...
`google.notebooks_instance.withMachineType` constructs a mixin object that can be merged into the `notebooks_instance`
...
`google.notebooks_instance.withMetadata` constructs a mixin object that can be merged into the `notebooks_instance`
...
`google.notebooks_instance.withName` constructs a mixin object that can be merged into the `notebooks_instance`
...
`google.notebooks_instance.withNetwork` constructs a mixin object that can be merged into the `notebooks_instance`
...
`google.notebooks_instance.withNicType` constructs a mixin object that can be merged into the `notebooks_instance`
...
`google.notebooks_instance.withNoProxyAccess` constructs a mixin object that can be merged into the `notebooks_instance`
...
`google.notebooks_instance.withNoPublicIp` constructs a mixin object that can be merged into the `notebooks_instance`
...
`google.notebooks_instance.withNoRemoveDataDisk` constructs a mixin object that can be merged into the `notebooks_instance`
...
`google.notebooks_instance.withPostStartupScript` constructs a mixin object that can be merged into the `notebooks_instance`
...
`google.notebooks_instance.withProject` constructs a mixin object that can be merged into the `notebooks_instance`
...
`google.notebooks_instance.withReservationAffinity` constructs a mixin object that can be merged into the `notebooks_instance`
...
`google.notebooks_instance.withReservationAffinityMixin` constructs a mixin object that can be merged into the `notebooks_instance`
Terraform resource block to set or update the reservation_affinity field.
...
`google.notebooks_instance.withServiceAccount` constructs a mixin object that can be merged into the `notebooks_instance`
...
`google.notebooks_instance.withServiceAccountScopes` constructs a mixin object that can be merged into the `notebooks_instance`
...
`google.notebooks_instance.withShieldedInstanceConfig` constructs a mixin object that can be merged into the `notebooks_instance`
...
`google.notebooks_instance.withShieldedInstanceConfigMixin` constructs a mixin object that can be merged into the `notebooks_instance`
Terraform resource block to set or update the shielded_instance_config field.
...
`google.notebooks_instance.withSubnet` constructs a mixin object that can be merged into the `notebooks_instance`
...
`google.notebooks_instance.withTags` constructs a mixin object that can be merged into the `notebooks_instance`
...
`google.notebooks_instance.withTimeouts` constructs a mixin object that can be merged into the `notebooks_instance`
...
`google.notebooks_instance.withTimeoutsMixin` constructs a mixin object that can be merged into the `notebooks_instance`
Terraform resource block to set or update the timeouts field.
...
`google.notebooks_instance.withUpdateTime` constructs a mixin object that can be merged into the `notebooks_instance`
...
`google.notebooks_instance.withVmImage` constructs a mixin object that can be merged into the `notebooks_instance`
...
`google.notebooks_instance.withVmImageMixin` constructs a mixin object that can be merged into the `notebooks_instance`
Terraform resource block to set or update the vm_image field.
