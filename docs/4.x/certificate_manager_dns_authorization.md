...
and all following characters must be a dash, underscore, letter or digit.
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google.certificate_manager_dns_authorization.timeouts.new](#fn-certificate_manager_dns_authorizationtimeoutsnew) constructor.
...
Unlike [google.certificate_manager_dns_authorization.new](#fn-certificate_manager_dns_authorizationnew), this function will not inject the `resource`
