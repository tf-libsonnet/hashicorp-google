...
**Args**:
  ...
  - `role` (`string`): 
  - `table_id` (`string`): 
  - `condition` (`list[obj]`):  When `null`, the `condition` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google.bigquery_table_iam_member.condition.new](#fn-bigquery_table_iam_memberconditionnew) constructor.
...
Unlike [google.bigquery_table_iam_member.new](#fn-bigquery_table_iam_membernew), this function will not inject the `resource`
