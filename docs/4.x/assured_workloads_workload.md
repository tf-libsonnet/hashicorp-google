...
`google.assured_workloads_workload.withBillingAccount` constructs a mixin object that can be merged into the `assured_workloads_workload`
...
`google.assured_workloads_workload.withComplianceRegime` constructs a mixin object that can be merged into the `assured_workloads_workload`
...
`google.assured_workloads_workload.withDisplayName` constructs a mixin object that can be merged into the `assured_workloads_workload`
...
`google.assured_workloads_workload.withKmsSettings` constructs a mixin object that can be merged into the `assured_workloads_workload`
...
`google.assured_workloads_workload.withKmsSettingsMixin` constructs a mixin object that can be merged into the `assured_workloads_workload`
Terraform resource block to set or update the kms_settings field.
...
`google.assured_workloads_workload.withLabels` constructs a mixin object that can be merged into the `assured_workloads_workload`
...
`google.assured_workloads_workload.withLocation` constructs a mixin object that can be merged into the `assured_workloads_workload`
...
`google.assured_workloads_workload.withOrganization` constructs a mixin object that can be merged into the `assured_workloads_workload`
...
`google.assured_workloads_workload.withProvisionedResourcesParent` constructs a mixin object that can be merged into the `assured_workloads_workload`
...
`google.assured_workloads_workload.withResourceSettings` constructs a mixin object that can be merged into the `assured_workloads_workload`
...
`google.assured_workloads_workload.withResourceSettingsMixin` constructs a mixin object that can be merged into the `assured_workloads_workload`
Terraform resource block to set or update the resource_settings field.
...
`google.assured_workloads_workload.withTimeouts` constructs a mixin object that can be merged into the `assured_workloads_workload`
...
`google.assured_workloads_workload.withTimeoutsMixin` constructs a mixin object that can be merged into the `assured_workloads_workload`
Terraform resource block to set or update the timeouts field.
