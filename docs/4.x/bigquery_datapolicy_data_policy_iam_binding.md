---
permalink: /bigquery_datapolicy_data_policy_iam_binding/
---

# bigquery_datapolicy_data_policy_iam_binding

`bigquery_datapolicy_data_policy_iam_binding` represents the `google_bigquery_datapolicy_data_policy_iam_binding` Terraform resource.
