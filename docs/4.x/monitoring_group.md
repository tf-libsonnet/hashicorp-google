...
groups with no parent, parentName is the empty string, &#34;&#34;. When `null`, the `parent_name` field will be omitted from the resulting object.
  ...
  - `timeouts` (`obj`): Set the `timeouts` field on the resulting resource block. When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google.monitoring_group.timeouts.new](#fn-timeoutsnew) constructor.
...
Unlike [google.monitoring_group.new](#fn-new), this function will not inject the `resource`
...
groups with no parent, parentName is the empty string, &#34;&#34;. When `null`, the `parent_name` field will be omitted from the resulting object.
  ...
  - `timeouts` (`obj`): Set the `timeouts` field on the resulting object. When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google.monitoring_group.timeouts.new](#fn-timeoutsnew) constructor.
...
`google.string.withParentName` constructs a mixin object that can be merged into the `string`
