...
`google.storage_transfer_agent_pool.withBandwidthLimit` constructs a mixin object that can be merged into the `storage_transfer_agent_pool`
...
`google.storage_transfer_agent_pool.withBandwidthLimitMixin` constructs a mixin object that can be merged into the `storage_transfer_agent_pool`
Terraform resource block to set or update the bandwidth_limit field.
...
`google.storage_transfer_agent_pool.withDisplayName` constructs a mixin object that can be merged into the `storage_transfer_agent_pool`
...
`google.storage_transfer_agent_pool.withName` constructs a mixin object that can be merged into the `storage_transfer_agent_pool`
...
`google.storage_transfer_agent_pool.withProject` constructs a mixin object that can be merged into the `storage_transfer_agent_pool`
...
`google.storage_transfer_agent_pool.withTimeouts` constructs a mixin object that can be merged into the `storage_transfer_agent_pool`
...
`google.storage_transfer_agent_pool.withTimeoutsMixin` constructs a mixin object that can be merged into the `storage_transfer_agent_pool`
Terraform resource block to set or update the timeouts field.
