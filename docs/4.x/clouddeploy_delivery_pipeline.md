...
`google.clouddeploy_delivery_pipeline.withAnnotations` constructs a mixin object that can be merged into the `clouddeploy_delivery_pipeline`
...
`google.clouddeploy_delivery_pipeline.withDescription` constructs a mixin object that can be merged into the `clouddeploy_delivery_pipeline`
...
`google.clouddeploy_delivery_pipeline.withLabels` constructs a mixin object that can be merged into the `clouddeploy_delivery_pipeline`
...
`google.clouddeploy_delivery_pipeline.withLocation` constructs a mixin object that can be merged into the `clouddeploy_delivery_pipeline`
...
`google.clouddeploy_delivery_pipeline.withName` constructs a mixin object that can be merged into the `clouddeploy_delivery_pipeline`
...
`google.clouddeploy_delivery_pipeline.withProject` constructs a mixin object that can be merged into the `clouddeploy_delivery_pipeline`
...
`google.clouddeploy_delivery_pipeline.withSerialPipeline` constructs a mixin object that can be merged into the `clouddeploy_delivery_pipeline`
...
`google.clouddeploy_delivery_pipeline.withSerialPipelineMixin` constructs a mixin object that can be merged into the `clouddeploy_delivery_pipeline`
Terraform resource block to set or update the serial_pipeline field.
...
`google.clouddeploy_delivery_pipeline.withSuspended` constructs a mixin object that can be merged into the `clouddeploy_delivery_pipeline`
...
`google.clouddeploy_delivery_pipeline.withTimeouts` constructs a mixin object that can be merged into the `clouddeploy_delivery_pipeline`
...
`google.clouddeploy_delivery_pipeline.withTimeoutsMixin` constructs a mixin object that can be merged into the `clouddeploy_delivery_pipeline`
Terraform resource block to set or update the timeouts field.
