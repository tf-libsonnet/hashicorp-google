---
permalink: /container_azure_client/
---

# container_azure_client

`container_azure_client` represents the `google_container_azure_client` Terraform resource.
...
`google.container_azure_client.withApplicationId` constructs a mixin object that can be merged into the `container_azure_client`
...
`google.container_azure_client.withLocation` constructs a mixin object that can be merged into the `container_azure_client`
...
`google.container_azure_client.withName` constructs a mixin object that can be merged into the `container_azure_client`
...
`google.container_azure_client.withProject` constructs a mixin object that can be merged into the `container_azure_client`
...
`google.container_azure_client.withTenantId` constructs a mixin object that can be merged into the `container_azure_client`
...
`google.container_azure_client.withTimeouts` constructs a mixin object that can be merged into the `container_azure_client`
...
`google.container_azure_client.withTimeoutsMixin` constructs a mixin object that can be merged into the `container_azure_client`
Terraform resource block to set or update the timeouts field.
