...
`google.storage_bucket_object.withCacheControl` constructs a mixin object that can be merged into the `storage_bucket_object`
...
`google.storage_bucket_object.withContent` constructs a mixin object that can be merged into the `storage_bucket_object`
...
`google.storage_bucket_object.withContentDisposition` constructs a mixin object that can be merged into the `storage_bucket_object`
...
`google.storage_bucket_object.withContentEncoding` constructs a mixin object that can be merged into the `storage_bucket_object`
...
`google.storage_bucket_object.withContentLanguage` constructs a mixin object that can be merged into the `storage_bucket_object`
...
`google.storage_bucket_object.withContentType` constructs a mixin object that can be merged into the `storage_bucket_object`
...
`google.storage_bucket_object.withCustomerEncryption` constructs a mixin object that can be merged into the `storage_bucket_object`
...
`google.storage_bucket_object.withCustomerEncryptionMixin` constructs a mixin object that can be merged into the `storage_bucket_object`
Terraform resource block to set or update the customer_encryption field.
...
`google.storage_bucket_object.withDetectMd5Hash` constructs a mixin object that can be merged into the `storage_bucket_object`
...
`google.storage_bucket_object.withEventBasedHold` constructs a mixin object that can be merged into the `storage_bucket_object`
...
`google.storage_bucket_object.withKmsKeyName` constructs a mixin object that can be merged into the `storage_bucket_object`
...
`google.storage_bucket_object.withMetadata` constructs a mixin object that can be merged into the `storage_bucket_object`
...
`google.storage_bucket_object.withSource` constructs a mixin object that can be merged into the `storage_bucket_object`
...
`google.storage_bucket_object.withStorageClass` constructs a mixin object that can be merged into the `storage_bucket_object`
...
`google.storage_bucket_object.withTemporaryHold` constructs a mixin object that can be merged into the `storage_bucket_object`
...
`google.storage_bucket_object.withTimeouts` constructs a mixin object that can be merged into the `storage_bucket_object`
...
`google.storage_bucket_object.withTimeoutsMixin` constructs a mixin object that can be merged into the `storage_bucket_object`
Terraform resource block to set or update the timeouts field.
