...
`google.compute_instance_from_template.withAdvancedMachineFeatures` constructs a mixin object that can be merged into the `compute_instance_from_template`
...
`google.compute_instance_from_template.withAdvancedMachineFeaturesMixin` constructs a mixin object that can be merged into the `compute_instance_from_template`
Terraform resource block to set or update the advanced_machine_features field.
...
`google.compute_instance_from_template.withAllowStoppingForUpdate` constructs a mixin object that can be merged into the `compute_instance_from_template`
...
`google.compute_instance_from_template.withAttachedDisk` constructs a mixin object that can be merged into the `compute_instance_from_template`
...
`google.compute_instance_from_template.withBootDisk` constructs a mixin object that can be merged into the `compute_instance_from_template`
...
`google.compute_instance_from_template.withBootDiskMixin` constructs a mixin object that can be merged into the `compute_instance_from_template`
Terraform resource block to set or update the boot_disk field.
...
`google.compute_instance_from_template.withCanIpForward` constructs a mixin object that can be merged into the `compute_instance_from_template`
...
`google.compute_instance_from_template.withConfidentialInstanceConfig` constructs a mixin object that can be merged into the `compute_instance_from_template`
...
`google.compute_instance_from_template.withConfidentialInstanceConfigMixin` constructs a mixin object that can be merged into the `compute_instance_from_template`
Terraform resource block to set or update the confidential_instance_config field.
...
`google.compute_instance_from_template.withDeletionProtection` constructs a mixin object that can be merged into the `compute_instance_from_template`
...
`google.compute_instance_from_template.withDescription` constructs a mixin object that can be merged into the `compute_instance_from_template`
...
`google.compute_instance_from_template.withDesiredStatus` constructs a mixin object that can be merged into the `compute_instance_from_template`
...
`google.compute_instance_from_template.withEnableDisplay` constructs a mixin object that can be merged into the `compute_instance_from_template`
...
`google.compute_instance_from_template.withGuestAccelerator` constructs a mixin object that can be merged into the `compute_instance_from_template`
...
`google.compute_instance_from_template.withHostname` constructs a mixin object that can be merged into the `compute_instance_from_template`
...
`google.compute_instance_from_template.withLabels` constructs a mixin object that can be merged into the `compute_instance_from_template`
...
`google.compute_instance_from_template.withMachineType` constructs a mixin object that can be merged into the `compute_instance_from_template`
...
`google.compute_instance_from_template.withMetadata` constructs a mixin object that can be merged into the `compute_instance_from_template`
...
`google.compute_instance_from_template.withMetadataStartupScript` constructs a mixin object that can be merged into the `compute_instance_from_template`
...
`google.compute_instance_from_template.withMinCpuPlatform` constructs a mixin object that can be merged into the `compute_instance_from_template`
...
`google.compute_instance_from_template.withName` constructs a mixin object that can be merged into the `compute_instance_from_template`
...
`google.compute_instance_from_template.withNetworkInterface` constructs a mixin object that can be merged into the `compute_instance_from_template`
...
`google.compute_instance_from_template.withNetworkInterfaceMixin` constructs a mixin object that can be merged into the `compute_instance_from_template`
Terraform resource block to set or update the network_interface field.
...
`google.compute_instance_from_template.withProject` constructs a mixin object that can be merged into the `compute_instance_from_template`
...
`google.compute_instance_from_template.withReservationAffinity` constructs a mixin object that can be merged into the `compute_instance_from_template`
...
`google.compute_instance_from_template.withReservationAffinityMixin` constructs a mixin object that can be merged into the `compute_instance_from_template`
Terraform resource block to set or update the reservation_affinity field.
...
`google.compute_instance_from_template.withResourcePolicies` constructs a mixin object that can be merged into the `compute_instance_from_template`
...
`google.compute_instance_from_template.withScheduling` constructs a mixin object that can be merged into the `compute_instance_from_template`
...
`google.compute_instance_from_template.withSchedulingMixin` constructs a mixin object that can be merged into the `compute_instance_from_template`
Terraform resource block to set or update the scheduling field.
...
`google.compute_instance_from_template.withScratchDisk` constructs a mixin object that can be merged into the `compute_instance_from_template`
...
`google.compute_instance_from_template.withServiceAccount` constructs a mixin object that can be merged into the `compute_instance_from_template`
...
`google.compute_instance_from_template.withShieldedInstanceConfig` constructs a mixin object that can be merged into the `compute_instance_from_template`
...
`google.compute_instance_from_template.withShieldedInstanceConfigMixin` constructs a mixin object that can be merged into the `compute_instance_from_template`
Terraform resource block to set or update the shielded_instance_config field.
...
`google.compute_instance_from_template.withSourceInstanceTemplate` constructs a mixin object that can be merged into the `compute_instance_from_template`
...
`google.compute_instance_from_template.withTags` constructs a mixin object that can be merged into the `compute_instance_from_template`
...
`google.compute_instance_from_template.withTimeouts` constructs a mixin object that can be merged into the `compute_instance_from_template`
...
`google.compute_instance_from_template.withTimeoutsMixin` constructs a mixin object that can be merged into the `compute_instance_from_template`
Terraform resource block to set or update the timeouts field.
...
`google.compute_instance_from_template.withZone` constructs a mixin object that can be merged into the `compute_instance_from_template`
