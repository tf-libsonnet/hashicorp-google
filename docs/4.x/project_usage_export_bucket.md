...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [google.project_usage_export_bucket.timeouts.new](#fn-project_usage_export_buckettimeoutsnew) constructor.
...
Unlike [google.project_usage_export_bucket.new](#fn-project_usage_export_bucketnew), this function will not inject the `resource`
