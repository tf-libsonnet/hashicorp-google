...
`google.datastream_private_connection.withDisplayName` constructs a mixin object that can be merged into the `datastream_private_connection`
...
`google.datastream_private_connection.withLabels` constructs a mixin object that can be merged into the `datastream_private_connection`
...
`google.datastream_private_connection.withLocation` constructs a mixin object that can be merged into the `datastream_private_connection`
...
`google.datastream_private_connection.withPrivateConnectionId` constructs a mixin object that can be merged into the `datastream_private_connection`
...
`google.datastream_private_connection.withProject` constructs a mixin object that can be merged into the `datastream_private_connection`
...
`google.datastream_private_connection.withTimeouts` constructs a mixin object that can be merged into the `datastream_private_connection`
...
`google.datastream_private_connection.withTimeoutsMixin` constructs a mixin object that can be merged into the `datastream_private_connection`
Terraform resource block to set or update the timeouts field.
...
`google.datastream_private_connection.withVpcPeeringConfig` constructs a mixin object that can be merged into the `datastream_private_connection`
...
`google.datastream_private_connection.withVpcPeeringConfigMixin` constructs a mixin object that can be merged into the `datastream_private_connection`
Terraform resource block to set or update the vpc_peering_config field.
