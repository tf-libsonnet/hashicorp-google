...
`google.org_policy_policy.withName` constructs a mixin object that can be merged into the `org_policy_policy`
...
`google.org_policy_policy.withParent` constructs a mixin object that can be merged into the `org_policy_policy`
...
`google.org_policy_policy.withSpec` constructs a mixin object that can be merged into the `org_policy_policy`
...
`google.org_policy_policy.withSpecMixin` constructs a mixin object that can be merged into the `org_policy_policy`
Terraform resource block to set or update the spec field.
...
`google.org_policy_policy.withTimeouts` constructs a mixin object that can be merged into the `org_policy_policy`
...
`google.org_policy_policy.withTimeoutsMixin` constructs a mixin object that can be merged into the `org_policy_policy`
Terraform resource block to set or update the timeouts field.
